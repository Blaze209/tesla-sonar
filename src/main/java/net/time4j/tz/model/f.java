...
final class f extends g {
    ...
    private final transient byte f94800f;

    f(c0 c0Var, int i11, int i12, i iVar, int i13) {
        super(c0Var, i12, iVar, i13);
        net.time4j.base.b.a(2000, c0Var.getValue(), i11);
        this.f94800f = (byte) i11;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof f) {
            f fVar = (f) obj;
            if (this.f94800f == fVar.f94800f && super.l(fVar)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f94800f + (k() * 37);
    }

    @Override // net.time4j.tz.model.g
    protected g0 j(int i11) {
        return g0.I0(i11, k(), this.f94800f);
    }
