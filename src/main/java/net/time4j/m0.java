...
public enum m0 implements net.time4j.engine.n<net.time4j.base.a>, net.time4j.engine.u<g0> {
    ...
    public static m0 parse(CharSequence charSequence, Locale locale, net.time4j.format.v vVar, net.time4j.format.m mVar) throws ParseException {
    ...
    public g0 apply(g0 g0Var) {
        return (g0) g0Var.B(g0.f94491r, this);
    }
