...
public final class Uint8Array implements TypedArray, GenericTypedArray<y>, RawTypedArrayHolder {
    ...
    public /* bridge */ /* synthetic */ y get(int i11) {
        return y.a(m188getWa3L5BU(i11));
    }

    /* JADX INFO: renamed from: get-Wa3L5BU, reason: not valid java name */
    public byte m188getWa3L5BU(int index) {
    ...
    public /* bridge */ /* synthetic */ void set(int i11, y yVar) {
        m189setEK6454(i11, yVar.getData());
    }

    /* JADX INFO: renamed from: set-EK-6454, reason: not valid java name */
    public void m189setEK6454(int index, byte value) {
        if (index < 0 || index >= getLength()) {
            throw new IndexOutOfBoundsException();
        }
