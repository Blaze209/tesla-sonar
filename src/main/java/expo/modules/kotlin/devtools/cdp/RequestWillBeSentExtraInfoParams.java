...
public final /* data */ class RequestWillBeSentExtraInfoParams implements JsonSerializable {
    ...
    public RequestWillBeSentExtraInfoParams(String requestId, Map<String, String> associatedCookies, Map<String, String> headers, ConnectTiming connectTiming) {
        ...
        s.k(associatedCookies, "associatedCookies");
        s.k(headers, "headers");
        s.k(connectTiming, "connectTiming");
    ...
    public static /* synthetic */ RequestWillBeSentExtraInfoParams copy$default(RequestWillBeSentExtraInfoParams requestWillBeSentExtraInfoParams, String str, Map map, Map map2, ConnectTiming connectTiming, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.requestId, requestWillBeSentExtraInfoParams.requestId) && s.f(this.associatedCookies, requestWillBeSentExtraInfoParams.associatedCookies) && s.f(this.headers, requestWillBeSentExtraInfoParams.headers) && s.f(this.connectTiming, requestWillBeSentExtraInfoParams.connectTiming);
    }
    ...
    public /* synthetic */ RequestWillBeSentExtraInfoParams(String str, Map map, Map map2, ConnectTiming connectTiming, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, (i11 & 2) != 0 ? v0.i() : map, map2, connectTiming);
    }
