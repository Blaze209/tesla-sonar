...
public final /* data */ class ConnectTiming implements JsonSerializable {
    ...
    public static /* synthetic */ ConnectTiming copy$default(ConnectTiming connectTiming, BigDecimal bigDecimal, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ConnectTiming) && s.f(this.requestTime, ((ConnectTiming) other).requestTime);
    }
