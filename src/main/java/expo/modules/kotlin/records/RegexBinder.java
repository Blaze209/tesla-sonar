...
public final class RegexBinder implements ValidationBinder {
    ...
    public FieldValidator<?> bind(Annotation annotation, q fieldType) {
        ...
        return new RegexValidator(new p013kotlin.text.q(((RegularExpression) annotation).regex()));
    }
}
