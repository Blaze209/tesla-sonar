...
final class ImagePickerModule$definition$1$5$1 extends SuspendLambda implements l<Continuation<? super ImagePickerContractResult>, Object> {
    ...
    public final Object invoke(Continuation<? super ImagePickerContractResult> continuation) {
        return ((ImagePickerModule$definition$1$5$1) create(continuation)).invokeSuspend(h0.f84049a);
    }
}
