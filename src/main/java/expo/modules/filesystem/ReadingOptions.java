...
public final /* data */ class ReadingOptions implements Record {
    ...
    public static /* synthetic */ ReadingOptions copy$default(ReadingOptions readingOptions, EncodingType encodingType, Integer num, Integer num2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return this.encoding == readingOptions.encoding && s.f(this.position, readingOptions.position) && s.f(this.length, readingOptions.length);
    }
    ...
    public /* synthetic */ ReadingOptions(EncodingType encodingType, Integer num, Integer num2, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? EncodingType.UTF8 : encodingType, num, num2);
    }
}
