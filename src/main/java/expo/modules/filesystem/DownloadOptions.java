...
public final /* data */ class DownloadOptions implements Record {
    ...
    public DownloadOptions(boolean z11, Boolean bool, Map<String, String> map, SessionType sessionType) {
    ...
    public static /* synthetic */ DownloadOptions copy$default(DownloadOptions downloadOptions, boolean z11, Boolean bool, Map map, SessionType sessionType, int i11, Object obj) {
        if ((i11 & 1) != 0) {
            z11 = downloadOptions.md5;
        }
        if ((i11 & 2) != 0) {
        ...
        return downloadOptions.copy(z11, bool, map, sessionType);
    }
    ...
    public boolean equals(Object other) {
        ...
        return this.md5 == downloadOptions.md5 && s.f(this.cache, downloadOptions.cache) && s.f(this.headers, downloadOptions.headers) && this.sessionType == downloadOptions.sessionType;
    }
    ...
    public /* synthetic */ DownloadOptions(boolean z11, Boolean bool, Map map, SessionType sessionType, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this((i11 & 1) != 0 ? false : z11, bool, map, (i11 & 8) != 0 ? SessionType.BACKGROUND : sessionType);
    }
}
