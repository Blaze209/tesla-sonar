...
public final /* data */ class RenderToImageOptions implements Record {
    ...
    public static /* synthetic */ RenderToImageOptions copy$default(RenderToImageOptions renderToImageOptions, String str, float f11, int i11, int i12, Object obj) {
        if ((i12 & 1) != 0) {
            str = renderToImageOptions.fontFamily;
        }
        if ((i12 & 2) != 0) {
            f11 = renderToImageOptions.size;
        }
        if ((i12 & 4) != 0) {
            i11 = renderToImageOptions.color;
        }
        return renderToImageOptions.copy(str, f11, i11);
    }
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.fontFamily, renderToImageOptions.fontFamily) && Float.compare(this.size, renderToImageOptions.size) == 0 && this.color == renderToImageOptions.color;
    }
    ...
    public RenderToImageOptions(String fontFamily, float f11, int i11) {
        s.k(fontFamily, "fontFamily");
    ...
    public /* synthetic */ RenderToImageOptions(String str, float f11, int i11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
        this((i12 & 1) != 0 ? "" : str, (i12 & 2) != 0 ? 24.0f : f11, (i12 & 4) != 0 ? -16777216 : i11);
    }
}
