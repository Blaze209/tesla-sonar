...
public class LinearGradientView extends View {
    ...
    public LinearGradientView(Context context) {
        ...
        this.mStartPos = new float[]{0.5f, BitmapDescriptorFactory.HUE_RED};
    ...
    private void drawGradient() {
        ...
        if (iArr != null) {
            ...
            if (fArr == null || iArr.length == fArr.length) {
                ...
                this.mPaint.setShader(new LinearGradient(f11 * i11, f12 * i12, i11 * fArr3[0], fArr3[1] * i12, this.mColors, this.mLocations, Shader.TileMode.CLAMP));
                invalidate();
            }
        }
    }
