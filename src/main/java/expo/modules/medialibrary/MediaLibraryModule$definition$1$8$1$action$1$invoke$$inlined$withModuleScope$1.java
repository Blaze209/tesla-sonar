...
public final class MediaLibraryModule$definition$1$8$1$action$1$invoke$$inlined$withModuleScope$1 extends SuspendLambda implements p<CoroutineScope, Continuation<? super h0>, Object> {
    ...
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super h0> continuation) {
        return ((MediaLibraryModule$definition$1$8$1$action$1$invoke$$inlined$withModuleScope$1) create(coroutineScope, continuation)).invokeSuspend(h0.f84049a);
    }
}
