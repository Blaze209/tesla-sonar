...
public final class GeocodeResponse implements Record, Serializable {
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0010\u0010\u0004\u001a\u0004\u0018\u00010\u00052\u0006\u0010\u0006\u001a\u00020\u0007¨\u0006\b"}, d2 = {"Lexpo/modules/location/records/GeocodeResponse$Companion;", "", "<init>", "()V", "from", "Lexpo/modules/location/records/GeocodeResponse;", "location", "Landroid/location/Location;", "expo-location_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Companion {
        ...
        public final GeocodeResponse from(Location location) {
            ...
            try {
                ...
                if (!(e11 instanceof IllegalAccessException) && !(e11 instanceof InstantiationException)) {
                    return null;
                }
                Log.e(LocationModule.INSTANCE.getTAG$expo_location_release(), "Unexpected exception was thrown when converting location to coords bundle: ", e11);
                return null;
            }
        }
    ...
    public GeocodeResponse(double d11, double d12, Float f11, Double d13) {
        this.latitude = d11;
        this.longitude = d12;
        this.accuracy = f11;
        this.altitude = d13;
    ...
    public /* synthetic */ GeocodeResponse(double d11, double d12, Float f11, Double d13, int i11, DefaultConstructorMarker defaultConstructorMarker) {
