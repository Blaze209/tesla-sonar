...
public final class PermissionRequestResponse implements Record, Serializable {
    ...
    public PermissionRequestResponse(Boolean bool, String str, boolean z11, String str2, PermissionDetailsLocationAndroid permissionDetailsLocationAndroid) {
    ...
    public PermissionRequestResponse(Bundle bundle) throws ConversionException {
        ...
        if (string != null) {
            boolean z11 = bundle.getBoolean(PermissionsResponse.GRANTED_KEY);
            String string2 = bundle.getString(PermissionsResponse.STATUS_KEY);
            if (string2 != null) {
                Bundle bundle2 = bundle.getBundle("android");
                this(boolValueOf, string, z11, string2, bundle2 != null ? new PermissionDetailsLocationAndroid(bundle2) : null);
                return;
            }
