...
/* synthetic */ class CalendarModule$saveAttendeeForEvent$attendeeBuilder$2 extends p implements l<String, Integer> {
    ...
    public final Integer invoke(String p11) {
        s.k(p11, "p0");
        return Integer.valueOf(JsValuesMappersKt.attendeeTypeConstantMatchingString(p11));
    }
}
