...
public class UIManagerModuleWrapper implements ActivityProvider, InternalModule, JavaScriptContextProvider, UIManager {
    ...
    private void addToUIManager(UIBlockInterface uIBlockInterface) {
        UIManagerModule uIManagerModule = (UIManagerModule) getContext().getNativeModule(UIManagerModule.class);
        Objects.requireNonNull(uIManagerModule);
        uIManagerModule.addUIBlock(uIBlockInterface);
    }
    ...
    public <T> void addUIBlock(final int i11, final UIManager.UIBlock<T> uIBlock, final Class<T> cls) {
        addToUIManager(new UIBlockInterface() { // from class: expo.modules.adapters.react.services.UIManagerModuleWrapper.1
            private void executeImpl(t tVar, UIBlockViewResolver uIBlockViewResolver) {
                View viewResolveView = tVar.resolveView(i11);
            ...
            @Override // expo.modules.adapters.react.services.UIBlockInterface, com.facebook.react.uimanager.z0
            public void execute(t tVar) {
                executeImpl(tVar, null);
            }
    ...
    public View resolveView(int i11) {
        com.facebook.react.bridge.UIManager uIManagerI = b1.i(getContext(), i11);
        if (uIManagerI == null) {
            return null;
        }
        return uIManagerI.resolveView(i11);
    }
    ...
    public void addUIBlock(final UIManager.GroupUIBlock groupUIBlock) {
        addToUIManager(new UIBlockInterface() { // from class: expo.modules.adapters.react.services.UIManagerModuleWrapper.2
            private void executeImpl(final t tVar, UIBlockViewResolver uIBlockViewResolver) {
                groupUIBlock.execute(new UIManager.ViewHolder() { // from class: expo.modules.adapters.react.services.UIManagerModuleWrapper.2.1
                    ...
                    public View get(Object obj) {
                        if (obj instanceof Number) {
                            try {
                                return tVar.resolveView(((Number) obj).intValue());
