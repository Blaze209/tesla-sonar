...
public final class a {
    ...
    public static boolean f(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C1989a.d(location) : a(location, "bearingAccuracy");
    }

    public static boolean g(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C1989a.e(location) : a(location, "speedAccuracy");
    }

    public static boolean h(Location location) {
        return Build.VERSION.SDK_INT >= 26 ? C1989a.f(location) : a(location, FusedLocationProviderClient.KEY_VERTICAL_ACCURACY);
    }
