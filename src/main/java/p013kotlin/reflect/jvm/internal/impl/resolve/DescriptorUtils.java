...
public class DescriptorUtils {
    ...
    private static <D extends CallableDescriptor> void b(D d11, Set<D> set) {
        if (d11 == null) {
            a(73);
        }
        if (set == 0) {
        ...
        Iterator<? extends CallableDescriptor> it = d11.getOriginal().getOverriddenDescriptors().iterator();
        while (it.hasNext()) {
    ...
    private static boolean f(KotlinType kotlinType, DeclarationDescriptor declarationDescriptor) {
        ...
        DeclarationDescriptor original = classifierDescriptorMo500getDeclarationDescriptor.getOriginal();
    ...
    public static <D extends CallableDescriptor> Set<D> getAllOverriddenDescriptors(D d11) {
        if (d11 == null) {
            a(71);
        }
        LinkedHashSet linkedHashSet = new LinkedHashSet();
        b(d11.getOriginal(), linkedHashSet);
    ...
    public static ClassDescriptor getClassDescriptorForTypeConstructor(TypeConstructor typeConstructor) {
        ...
        ClassDescriptor classDescriptor = (ClassDescriptor) typeConstructor.mo500getDeclarationDescriptor();
    ...
    public static ModuleDescriptor getContainingModuleOrNull(KotlinType kotlinType) {
        ...
        return getContainingModuleOrNull(classifierDescriptorMo500getDeclarationDescriptor);
    }
    ...
    public static DescriptorVisibility getDefaultConstructorVisibility(ClassDescriptor classDescriptor, boolean z11) {
        if (classDescriptor == null) {
            a(48);
        }
    ...
    public static <D extends CallableMemberDescriptor> D unwrapFakeOverride(D d11) {
        if (d11 == null) {
            a(59);
        }
        while (d11.getKind() == CallableMemberDescriptor.Kind.FAKE_OVERRIDE) {
            Collection<? extends CallableMemberDescriptor> overriddenDescriptors = d11.getOverriddenDescriptors();
            if (overriddenDescriptors.isEmpty()) {
                throw new IllegalStateException("Fake override should have at least one overridden descriptor: " + d11);
            }
            d11 = (D) overriddenDescriptors.iterator().next();
        }
        return d11;
    }

    public static <D extends DeclarationDescriptorWithVisibility> D unwrapFakeOverrideToAnyDeclaration(D d11) {
        if (d11 == null) {
            a(64);
        }
    ...
    public static <D extends DeclarationDescriptor> D getParentOfType(DeclarationDescriptor declarationDescriptor, Class<D> cls, boolean z11) {
        if (cls == null) {
            a(19);
        }
        if (declarationDescriptor == null) {
