...
public interface TypeSystemContext extends TypeSystemOptimizationContext {
    ...
    TypeArgumentMarker get(TypeArgumentListMarker typeArgumentListMarker, int i11);

    TypeArgumentMarker getArgument(KotlinTypeMarker kotlinTypeMarker, int i11);

    TypeArgumentMarker getArgumentOrNull(SimpleTypeMarker simpleTypeMarker, int i11);
    ...
    KotlinTypeMarker makeDefinitelyNotNullOrNotNull(KotlinTypeMarker kotlinTypeMarker, boolean z11);
