...
public class TypeProjectionImpl extends TypeProjectionBase {
    ...
    private final Variance f88936a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final KotlinType f88937b;
    ...
    public TypeProjectionImpl(Variance variance, KotlinType kotlinType) {
        ...
        this.f88936a = variance;
        this.f88937b = kotlinType;
    }
    ...
    public Variance getProjectionKind() {
        Variance variance = this.f88936a;
        if (variance == null) {
            a(4);
        }
        return variance;
    ...
    public KotlinType getType() {
        KotlinType kotlinType = this.f88937b;
        if (kotlinType == null) {
            a(5);
        }
        return kotlinType;
    ...
    public TypeProjection refine(KotlinTypeRefiner kotlinTypeRefiner) {
        ...
        return new TypeProjectionImpl(this.f88936a, kotlinTypeRefiner.refineType((KotlinTypeMarker) this.f88937b));
    }
