...
public final class CodedOutputStream {
    ...
    private final byte[] f88263a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final int f88264b;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private final OutputStream f88267e;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private int f88266d = 0;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private int f88265c = 0;
    ...
    private CodedOutputStream(OutputStream outputStream, byte[] bArr) {
        this.f88267e = outputStream;
        this.f88263a = bArr;
        this.f88264b = bArr.length;
    }
    ...
    private void b() throws IOException {
        OutputStream outputStream = this.f88267e;
        if (outputStream == null) {
            throw new OutOfSpaceException();
        }
        outputStream.write(this.f88263a, 0, this.f88265c);
        this.f88265c = 0;
    }
    ...
    public void writeEnumNoTag(int i11) {
        writeInt32NoTag(i11);
    }
    ...
    public void writeGroup(int i11, MessageLite messageLite) {
        writeTag(i11, 3);
    ...
    public void writeRawByte(byte b11) throws IOException {
        if (this.f88265c == this.f88264b) {
            b();
        }
        byte[] bArr = this.f88263a;
        int i11 = this.f88265c;
        this.f88265c = i11 + 1;
        bArr[i11] = b11;
        this.f88266d++;
    }
    ...
    public void writeRawVarint32(int i11) {
    ...
    public void writeSInt32NoTag(int i11) {
    ...
    public void writeRawBytes(byte[] bArr, int i11, int i12) throws IOException {
        int i13 = this.f88264b;
        int i14 = this.f88265c;
        if (i13 - i14 >= i12) {
            System.arraycopy(bArr, i11, this.f88263a, i14, i12);
            this.f88265c += i12;
            this.f88266d += i12;
            return;
        }
        int i15 = i13 - i14;
        System.arraycopy(bArr, i11, this.f88263a, i14, i15);
        int i16 = i11 + i15;
        int i17 = i12 - i15;
        this.f88265c = this.f88264b;
        this.f88266d += i15;
        b();
        if (i17 <= this.f88264b) {
            System.arraycopy(bArr, i16, this.f88263a, 0, i17);
            this.f88265c = i17;
        } else {
            this.f88267e.write(bArr, i16, i17);
        }
        this.f88266d += i17;
    }
    ...
    public void writeRawBytes(ByteString byteString, int i11, int i12) throws IOException {
        ...
        int i14 = this.f88265c;
        if (i13 - i14 >= i12) {
            byteString.copyTo(this.f88263a, i11, i14, i12);
            this.f88265c += i12;
            this.f88266d += i12;
            return;
        }
        int i15 = i13 - i14;
        byteString.copyTo(this.f88263a, i11, i14, i15);
        int i16 = i11 + i15;
        int i17 = i12 - i15;
        this.f88265c = this.f88264b;
        this.f88266d += i15;
        b();
        if (i17 <= this.f88264b) {
            byteString.copyTo(this.f88263a, i16, 0, i17);
            this.f88265c = i17;
        } else {
            byteString.i(this.f88267e, i16, i17);
        }
        this.f88266d += i17;
    }
}
