...
public final class e {
    ...
    @DebugMetadata(c = "com.stripe.android.financialconnections.domain.CancelAuthorizationSession", f = "CancelAuthorizationSession.kt", i = {0}, l = {18, 21}, m = "invoke", n = {"this"}, s = {"L$0"})
    static final class a extends ContinuationImpl {
        ...
        public final Object invokeSuspend(Object obj) {
            this.f93079o = obj;
            this.f93081q |= Integer.MIN_VALUE;
            return e.this.a(null, this);
        }
    }

    public e(p0 coordinator, t50.p repository, com.stripe.android.financialconnections.a.Configuration configuration) {
    ...
    public final Object a(String str, Continuation<? super FinancialConnectionsAuthorizationSession> continuation) {
        ...
        if (continuation instanceof a) {
            aVar = (a) continuation;
            int i11 = aVar.f93081q;
            if ((i11 & Integer.MIN_VALUE) != 0) {
                aVar.f93081q = i11 - Integer.MIN_VALUE;
            } else {
        ...
        Object objM = aVar.f93079o;
        Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
        int i12 = aVar.f93081q;
        if (i12 == 0) {
            jn0.t.b(objM);
            ...
            aVar.f93078n = this;
            aVar.f93081q = 1;
            objM = pVar.m(financialConnectionsSessionClientSecret, str, aVar);
        ...
        if (i12 != 1) {
            ...
            Object obj = aVar.f93078n;
            jn0.t.b(objM);
            return obj;
        }
        eVar = (e) aVar.f93078n;
        jn0.t.b(objM);
        MutableSharedFlow<p0.a> mutableSharedFlowA = eVar.coordinator.a();
        p0.a.C1987a c1987a = p0.a.C1987a.f93230a;
        aVar.f93078n = objM;
        aVar.f93081q = 2;
        return mutableSharedFlowA.emit(c1987a, aVar) == coroutine_suspended ? coroutine_suspended : objM;
    }
}
