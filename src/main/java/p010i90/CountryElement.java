...
public final /* data */ class CountryElement extends n1 {
    ...
    public CountryElement(IdentifierSpec identifier, y controller) {
        super(identifier);
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof CountryElement)) {
            return false;
        }
        CountryElement countryElement = (CountryElement) other;
        return s.f(this.identifier, countryElement.identifier) && s.f(this.controller, countryElement.controller);
    }
