...
public final class MediaMetadataCompat implements Parcelable {
    ...
    static final androidx.collection.a<String, Integer> f1786c;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static final String[] f1787d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private static final String[] f1788e;

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private static final String[] f1789f;

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    final Bundle f1790a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private MediaMetadata f1791b;
    ...
    static {
        ...
        f1787d = new String[]{"android.media.metadata.TITLE", "android.media.metadata.ARTIST", "android.media.metadata.ALBUM", "android.media.metadata.ALBUM_ARTIST", "android.media.metadata.WRITER", "android.media.metadata.AUTHOR", "android.media.metadata.COMPOSER"};
        f1788e = new String[]{"android.media.metadata.DISPLAY_ICON", "android.media.metadata.ART", "android.media.metadata.ALBUM_ART"};
        f1789f = new String[]{"android.media.metadata.DISPLAY_ICON_URI", "android.media.metadata.ART_URI", "android.media.metadata.ALBUM_ART_URI"};
        CREATOR = new a();
    }

    MediaMetadataCompat(Parcel parcel) {
        this.f1790a = parcel.readBundle(MediaSessionCompat.class.getClassLoader());
    }
    ...
    public static MediaMetadataCompat a(Object obj) {
        ...
        mediaMetadataCompatCreateFromParcel.f1791b = mediaMetadata;
    ...
    public void writeToParcel(Parcel parcel, int i11) {
        parcel.writeBundle(this.f1790a);
    }
}
