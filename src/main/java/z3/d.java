...
public final class d implements f, c {
    ...
    private final /* synthetic */ c f126651b;

    public d(c cVar, w4.t tVar) {
    ...
    public long C(long j11) {
        return this.f126651b.C(j11);
    }

    @Override // w4.l
    public long E(float f11) {
        return this.f126651b.E(f11);
    }

    @Override // w4.l
    /* JADX INFO: renamed from: M1 */
    public float getFontScale() {
        return this.f126651b.getFontScale();
    }

    @Override // w4.d
    public float O1(float f11) {
        return this.f126651b.O1(f11);
    }

    @Override // w4.d
    public int Q1(long j11) {
        return this.f126651b.Q1(j11);
    }
    ...
    @Override // z3.r
    public boolean d1() {
        return this.f126651b.d1();
    }

    @Override // w4.d
    public float getDensity() {
        return this.f126651b.getDensity();
    }
    ...
    public int i1(float f11) {
        return this.f126651b.i1(f11);
    }

    @Override // w4.d
    public float m1(long j11) {
        return this.f126651b.m1(j11);
    }

    @Override // w4.d
    public long o(long j11) {
        return this.f126651b.o(j11);
    }

    @Override // w4.l
    public float p(long j11) {
        return this.f126651b.p(j11);
    }

    @Override // w4.d
    public long s(float f11) {
        return this.f126651b.s(f11);
    }

    @Override // w4.d
    public float w(int i11) {
        return this.f126651b.w(i11);
    }

    @Override // w4.d
    public float x(float f11) {
        return this.f126651b.x(f11);
    }

    @Metadata(d1 = {"\u00001\n\u0000\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010$\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004*\u0001\u0000\b\n\u0018\u00002\u00020\u0001J\u000f\u0010\u0003\u001a\u00020\u0002H\u0016¢\u0006\u0004\b\u0003\u0010\u0004R\u0014\u0010\b\u001a\u00020\u00058VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0006\u0010\u0007R\u0014\u0010\n\u001a\u00020\u00058VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\t\u0010\u0007R \u0010\u000f\u001a\u000e\u0012\u0004\u0012\u00020\f\u0012\u0004\u0012\u00020\u00050\u000b8VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\r\u0010\u000eR\"\u0010\u0014\u001a\u0010\u0012\u0004\u0012\u00020\u0011\u0012\u0004\u0012\u00020\u0002\u0018\u00010\u00108VX\u0096\u0004¢\u0006\u0006\u001a\u0004\b\u0012\u0010\u0013¨\u0006\u0015"}, d2 = {"z3/d$a", "Lz3/j0;", "Ljn0/h0;", "k", "()V", "", "getWidth", "()I", Snapshot.WIDTH, "getHeight", Snapshot.HEIGHT, "", "Lz3/a;", "q", "()Ljava/util/Map;", "alignmentLines", "Lkotlin/Function1;", "Lz3/c1;", "g", "()Lwn0/l;", "rulers", "ui_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    public static final class a implements j0 {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        final /* synthetic */ int f126652a;

        /* JADX INFO: renamed from: b, reason: collision with root package name */
        final /* synthetic */ int f126653b;

        /* JADX INFO: renamed from: c, reason: collision with root package name */
        final /* synthetic */ Map<z3.a, Integer> f126654c;

        /* JADX INFO: renamed from: d, reason: collision with root package name */
        final /* synthetic */ wn0.l<c1, jn0.h0> f126655d;
