...
public final class p2 implements p010i90.u1 {
    ...
    private final int keyboard = o4.y.INSTANCE.c();
    ...
    static final class a extends p013kotlin.jvm.internal.u implements wn0.a<p013kotlin.text.q> {
        ...
        public static final a f127685c = new a();
        ...
        public final p013kotlin.text.q invoke() {
            return new p013kotlin.text.q("[a-zA-Z0-9.\\-_]{2,256}@[a-zA-Z]{2,64}");
        }
    }

    private final p013kotlin.text.q l() {
        return (p013kotlin.text.q) this.upiPattern.getValue();
    }
    ...
    public p010i90.x1 g(String input) {
        ...
        boolean z11 = l().i(input) && input.length() <= 30;
        if (input.length() == 0) {
            return i90.y1.a.f77113c;
        }
        return z11 ? i90.z1.b.f77177a : new i90.y1.b(w80.n.f121546y);
    }
    ...
    public String j(String userTyped) {
        ...
        return p013kotlin.text.t.F1(userTyped).toString();
    }
