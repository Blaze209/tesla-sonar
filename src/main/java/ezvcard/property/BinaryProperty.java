...
public abstract class BinaryProperty<T extends MediaTypeParameter> extends VCardProperty implements HasAltId {
    ...
    public int hashCode() {
        ...
        T t11 = this.contentType;
        int iHashCode2 = (((iHashCode + (t11 == null ? 0 : t11.hashCode())) * 31) + Arrays.hashCode(this.data)) * 31;
        String str = this.url;
    ...
    protected Map<String, Object> toStringValues() {
        ...
        if (this.data == null) {
            str = com.adyen.checkout.components.core.Address.ADDRESS_NULL_PLACEHOLDER;
        } else {
