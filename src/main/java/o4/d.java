...
public final class d {
    ...
    private static final CursorAnchorInfo.Builder a(CursorAnchorInfo.Builder builder, int i11, int i12, f0 f0Var, TextLayoutResult textLayoutResult, j3.i iVar) {
        ?? r11;
    ...
    @jn0.e
    public static final CursorAnchorInfo b(CursorAnchorInfo.Builder builder, TextFieldValue textFieldValue, f0 f0Var, TextLayoutResult textLayoutResult, Matrix matrix, j3.i iVar, j3.i iVar2, boolean z11, boolean z12, boolean z13, boolean z14) {
        builder.reset();
        ...
        if (i11 >= 34 && z14) {
            c.a(builder, textLayoutResult, iVar);
        }
        return builder.build();
    }

    private static final boolean c(j3.i iVar, float f11, float f12) {
    ...
    private static final CursorAnchorInfo.Builder d(CursorAnchorInfo.Builder builder, int i11, f0 f0Var, TextLayoutResult textLayoutResult, j3.i iVar) {
        if (i11 < 0) {
            return builder;
        }
        int iOriginalToTransformed = f0Var.originalToTransformed(i11);
