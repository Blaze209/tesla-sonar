...
class k {
    ...
    @NonNull
    private final Deque<WeakReference<XmlPullParser>> f2119a = new ArrayDeque();
    ...
    boolean a(@NonNull AttributeSet attributeSet) {
        ...
        XmlPullParser xmlPullParserC = c(this.f2119a);
        this.f2119a.push(new WeakReference<>(xmlPullParser));
