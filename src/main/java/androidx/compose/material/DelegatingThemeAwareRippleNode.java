...
final class DelegatingThemeAwareRippleNode extends m implements h, e1 {
    ...
    static final class a implements s1 {
        ...
        public final long a() {
            ...
            RippleConfiguration rippleConfiguration = (RippleConfiguration) i.a(DelegatingThemeAwareRippleNode.this, d.d());
            return (rippleConfiguration == null || rippleConfiguration.getColor() == 16) ? y1.f75453a.b(((p1) i.a(DelegatingThemeAwareRippleNode.this, z.a())).getValue(), ((Colors) i.a(DelegatingThemeAwareRippleNode.this, s.e())).o()) : rippleConfiguration.getColor();
        }
    }
    ...
    static final class b extends u implements wn0.a<RippleAlpha> {
        ...
        public final RippleAlpha invoke() {
            ...
            RippleConfiguration rippleConfiguration = (RippleConfiguration) i.a(DelegatingThemeAwareRippleNode.this, d.d());
            return (rippleConfiguration == null || (rippleAlpha = rippleConfiguration.getRippleAlpha()) == null) ? y1.f75453a.a(((p1) i.a(DelegatingThemeAwareRippleNode.this, z.a())).getValue(), ((Colors) i.a(DelegatingThemeAwareRippleNode.this, s.e())).o()) : rippleAlpha;
        }
    }
    ...
    static final class c extends u implements wn0.a<h0> {
        ...
        public final void b() {
            if (((RippleConfiguration) i.a(DelegatingThemeAwareRippleNode.this, d.d())) == null) {
