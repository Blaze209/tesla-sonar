...
class v extends u {
    ...
    public void b(g0 statusBarStyle, g0 navigationBarStyle, Window window, View view, boolean statusBarIsDark, boolean navigationBarIsDark) {
        ...
        windowInsetsControllerCompat.f(true ^ navigationBarIsDark);
    }
}
