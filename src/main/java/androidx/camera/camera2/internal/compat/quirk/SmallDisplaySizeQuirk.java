...
public class SmallDisplaySizeQuirk implements m2 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private static final Map<String, Size> f3011a;
    ...
    static boolean h() {
        return f3011a.containsKey(Build.MODEL.toUpperCase(Locale.US));
    }

    @NonNull
    public Size g() {
        return f3011a.get(Build.MODEL.toUpperCase(Locale.US));
    }
}
