...
public class l {
    ...
    private static Method f7821b = null;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static boolean f7822c = false;

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private static Field f7823d;
    ...
    private static boolean a(ActionBar actionBar, KeyEvent keyEvent) {
        if (!f7820a) {
            try {
                f7821b = actionBar.getClass().getMethod("onMenuKeyEvent", KeyEvent.class);
            } catch (NoSuchMethodException unused) {
            }
            f7820a = true;
        }
        Method method = f7821b;
        if (method != null) {
            try {
    ...
    public static boolean e(a aVar, View view, Window.Callback callback, KeyEvent keyEvent) {
        ...
        return (view != null && ViewCompat.h(view, keyEvent)) || aVar.superDispatchKeyEvent(keyEvent);
    }
