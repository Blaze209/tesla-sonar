...
public abstract class SharedElementCallback {
    ...
    private static Bitmap a(Drawable drawable) {
        ...
        int i11 = (int) (intrinsicWidth * fMin);
        int i12 = (int) (intrinsicHeight * fMin);
    ...
    public Parcelable b(View view, Matrix matrix, RectF rectF) {
        ...
        int i11 = (int) (iRound * fMin);
        int i12 = (int) (iRound2 * fMin);
        if (this.f7443a == null) {
            this.f7443a = new Matrix();
        }
        this.f7443a.set(matrix);
        this.f7443a.postTranslate(-rectF.left, -rectF.top);
        this.f7443a.postScale(fMin, fMin);
        Bitmap bitmapCreateBitmap = Bitmap.createBitmap(i11, i12, Bitmap.Config.ARGB_8888);
        Canvas canvas = new Canvas(bitmapCreateBitmap);
        canvas.concat(this.f7443a);
        view.draw(canvas);
        return bitmapCreateBitmap;
    }
