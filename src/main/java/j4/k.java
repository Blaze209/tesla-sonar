...
final class k {
    ...
    public final void h(Canvas canvas, MeasuredText text, int start, int end, int contextStart, int contextEnd, float x11, float y11, boolean isRtl, Paint paint) {
