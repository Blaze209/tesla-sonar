...
public final class o {
    ...
    static final class a extends SuspendLambda implements p<CoroutineScope, Continuation<? super h0>, Object> {
        ...
        final /* synthetic */ j f115287o;

        /* JADX INFO: renamed from: p, reason: collision with root package name */
        final /* synthetic */ p1<Boolean> f115288p;

        /* JADX INFO: renamed from: u1.o$a$a, reason: collision with other inner class name */
        @Metadata(d1 = {"\u0000\u000e\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\u0010\u0003\u001a\u00020\u00022\u0006\u0010\u0001\u001a\u00020\u0000H\u008a@¢\u0006\u0004\b\u0003\u0010\u0004"}, d2 = {"Lu1/i;", "interaction", "Ljn0/h0;", "a", "(Lu1/i;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;"}, k = 3, mv = {1, 8, 0})
        static final class C2466a<T> implements FlowCollector {

            /* JADX INFO: renamed from: a, reason: collision with root package name */
            final /* synthetic */ List<n.b> f115289a;

            /* JADX INFO: renamed from: b, reason: collision with root package name */
            final /* synthetic */ p1<Boolean> f115290b;

            C2466a(List<n.b> list, p1<Boolean> p1Var) {
                this.f115289a = list;
                this.f115290b = p1Var;
            }
            ...
            public final Object emit(i iVar, Continuation<? super h0> continuation) {
                if (iVar instanceof n.b) {
                    this.f115289a.add(iVar);
                } else if (iVar instanceof n.c) {
                    this.f115289a.remove(((n.c) iVar).getPress());
                } else if (iVar instanceof n.a) {
                    this.f115289a.remove(((n.a) iVar).getPress());
                }
                this.f115290b.setValue(Boxing.boxBoolean(!this.f115289a.isEmpty()));
                return h0.f84049a;
            }
        }
        ...
        public final Continuation<h0> create(Object obj, Continuation<?> continuation) {
            return new a(this.f115287o, this.f115288p, continuation);
        }

        @Override // p013kotlin.coroutines.jvm.internal.BaseContinuationImpl
        public final Object invokeSuspend(Object obj) {
            Object coroutine_suspended = IntrinsicsKt.getCOROUTINE_SUSPENDED();
            int i11 = this.f115286n;
            if (i11 == 0) {
                t.b(obj);
                ArrayList arrayList = new ArrayList();
                Flow<i> flowC = this.f115287o.c();
                C2466a c2466a = new C2466a(arrayList, this.f115288p);
                this.f115286n = 1;
                if (flowC.collect(c2466a, this) == coroutine_suspended) {
    ...
    public static final y3<Boolean> a(j jVar, p020r2.l lVar, int i11) {
        if (p020r2.o.J()) {
            p020r2.o.S(-1692965168, i11, -1, "androidx.compose.foundation.interaction.collectIsPressedAsState (PressInteraction.kt:83)");
        }
        Object objI = lVar.I();
