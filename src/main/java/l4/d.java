...
public final class d {
    ...
    public /* synthetic */ class a {
        ...
        public static final /* synthetic */ int[] f89605a;
    ...
    public static final float a(Layout layout, int i11, Paint paint) {
        ...
        if (!k0.m(layout, i11) || layout.getParagraphDirection(i11) != 1 || lineLeft >= BitmapDescriptorFactory.HUE_RED) {
        ...
        if ((paragraphAlignment == null ? -1 : a.f89605a[paragraphAlignment.ordinal()]) == 1) {
    ...
    public static final float c(Layout layout, int i11, Paint paint) {
        ...
        Layout.Alignment paragraphAlignment = layout.getParagraphAlignment(i11);
        if ((paragraphAlignment != null ? a.f89605a[paragraphAlignment.ordinal()] : -1) == 1) {
