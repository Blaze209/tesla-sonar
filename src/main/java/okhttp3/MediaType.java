...
public final class MediaType {
    ...
    public static final class Companion {
        ...
        public final MediaType m685deprecated_get(String mediaType) {
        ...
        public final MediaType m686deprecated_parse(String mediaType) {
            s.k(mediaType, "mediaType");
        ...
        public final MediaType get(String str) {
            ...
            while (iEnd < str.length()) {
                ...
                if (strGroup3 == null) {
                    ...
                    } else if (t.b0(strGroup4, "'", false, 2, null) && t.L(strGroup4, "'", false, 2, null) && strGroup4.length() > 2) {
                        strGroup4 = strGroup4.substring(1, strGroup4.length() - 1);
                        s.j(strGroup4, "this as java.lang.String…ing(startIndex, endIndex)");
                    }
    ...
    public boolean equals(Object other) {
        return (other instanceof MediaType) && s.f(((MediaType) other).mediaType, this.mediaType);
    }
    ...
    public final String parameter(String name) {
        ...
        while (!t.M(this.parameterNamesAndValues[i11], name, true)) {
            if (i11 == iC) {
                return null;
            }
            i11 += 2;
