...
public final class ConnectionSpec {
    ...
    private final ConnectionSpec supportedSpec(SSLSocket sslSocket, boolean isFallback) {
        ...
        if (this.cipherSuitesAsString != null) {
            ...
            s.j(enabledCipherSuites, "sslSocket.enabledCipherSuites");
        ...
        if (this.tlsVersionsAsString != null) {
            ...
            s.j(enabledProtocols, "sslSocket.enabledProtocols");
            tlsVersionsIntersection = Util.intersect(enabledProtocols, this.tlsVersionsAsString, a.f());
        } else {
            tlsVersionsIntersection = sslSocket.getEnabledProtocols();
        }
        String[] supportedCipherSuites = sslSocket.getSupportedCipherSuites();
        s.j(supportedCipherSuites, "supportedCipherSuites");
        ...
        if (isFallback && iIndexOf != -1) {
            s.j(cipherSuitesIntersection, "cipherSuitesIntersection");
            String str = supportedCipherSuites[iIndexOf];
            s.j(str, "supportedCipherSuites[indexOfFallbackScsv]");
        ...
        s.j(tlsVersionsIntersection, "tlsVersionsIntersection");
    ...
    public final List<CipherSuite> m636deprecated_cipherSuites() {
        return cipherSuites();
    }
    ...
    public final List<TlsVersion> m638deprecated_tlsVersions() {
        return tlsVersions();
    }
    ...
    public final boolean isCompatible(SSLSocket socket) {
        ...
        if (strArr != null && !Util.hasIntersection(strArr, socket.getEnabledProtocols(), a.f())) {
            return false;
        }
    ...
    public static final class Builder {
        ...
        public Builder(ConnectionSpec connectionSpec) {
            s.k(connectionSpec, "connectionSpec");
