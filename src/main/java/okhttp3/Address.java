...
public final class Address {
    ...
    public final List<ConnectionSpec> m610deprecated_connectionSpecs() {
    ...
    public final List<Protocol> m613deprecated_protocols() {
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.url, address.url) && equalsNonHost$okhttp(address);
    }

    public final boolean equalsNonHost$okhttp(Address that) {
        s.k(that, "that");
        return s.f(this.dns, that.dns) && s.f(this.proxyAuthenticator, that.proxyAuthenticator) && s.f(this.protocols, that.protocols) && s.f(this.connectionSpecs, that.connectionSpecs) && s.f(this.proxySelector, that.proxySelector) && s.f(this.proxy, that.proxy) && s.f(this.sslSocketFactory, that.sslSocketFactory) && s.f(this.hostnameVerifier, that.hostnameVerifier) && s.f(this.certificatePinner, that.certificatePinner) && this.url.port() == that.url.port();
    }
