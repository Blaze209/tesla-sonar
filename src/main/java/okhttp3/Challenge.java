...
public final class Challenge {
    ...
    public final Charset charset() {
        ...
        if (str != null) {
            try {
                ...
                s.j(charsetForName, "forName(charset)");
    ...
    public boolean equals(Object other) {
        ...
        return s.f(challenge.scheme, this.scheme) && s.f(challenge.authParams, this.authParams);
    }
    ...
    public final Challenge withCharset(Charset charset) {
        s.k(charset, "charset");
        Map mapD = v0.D(this.authParams);
        String strName = charset.name();
        s.j(strName, "charset.name()");
        mapD.put("charset", strName);
    ...
    public Challenge(String scheme, String realm) {
        ...
        s.j(mapSingletonMap, "singletonMap(\"realm\", realm)");
