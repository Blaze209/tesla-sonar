...
public final class BasicCertificateChainCleaner extends CertificateChainCleaner {
    ...
    public List<Certificate> clean(List<? extends Certificate> chain, String hostname) throws SSLPeerUnverifiedException {
        ...
        s.j(objRemoveFirst, "queue.removeFirst()");
        arrayList.add(objRemoveFirst);
        boolean z11 = false;
        for (int i11 = 0; i11 < 9; i11++) {
            Object obj = arrayList.get(arrayList.size() - 1);
            s.i(obj, "null cannot be cast to non-null type java.security.cert.X509Certificate");
            ...
            if (x509CertificateFindByIssuerAndSignature != null) {
                if (arrayList.size() > 1 || !s.f(x509Certificate2, x509CertificateFindByIssuerAndSignature)) {
                ...
                do {
                    ...
                    Object next = it.next();
                    s.i(next, "null cannot be cast to non-null type java.security.cert.X509Certificate");
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof BasicCertificateChainCleaner) && s.f(((BasicCertificateChainCleaner) other).trustRootIndex, this.trustRootIndex);
    }
