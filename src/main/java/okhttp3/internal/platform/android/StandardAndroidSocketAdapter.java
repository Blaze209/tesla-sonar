...
public final class StandardAndroidSocketAdapter extends AndroidSocketAdapter {
    ...
    public static final class Companion {
        ...
        public final SocketAdapter buildIfSupported(String packageName) {
            ...
            try {
                ...
                s.i(cls, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocket>");
                Class<?> cls2 = Class.forName(packageName + ".OpenSSLSocketFactoryImpl");
                s.i(cls2, "null cannot be cast to non-null type java.lang.Class<in javax.net.ssl.SSLSocketFactory>");
                Class<?> paramsClass = Class.forName(packageName + ".SSLParametersImpl");
                s.j(paramsClass, "paramsClass");
    ...
    public StandardAndroidSocketAdapter(Class<? super SSLSocket> sslSocketClass, Class<? super SSLSocketFactory> sslSocketFactoryClass, Class<?> paramClass) {
        ...
        s.k(sslSocketFactoryClass, "sslSocketFactoryClass");
        s.k(paramClass, "paramClass");
