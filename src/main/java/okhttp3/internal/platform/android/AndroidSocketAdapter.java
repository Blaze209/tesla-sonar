...
public class AndroidSocketAdapter implements SocketAdapter {
    ...
    public static final class Companion {
        ...
        public final AndroidSocketAdapter build(Class<? super SSLSocket> actualSSLSocketClass) {
            ...
            while (superclass != null && !s.f(superclass.getSimpleName(), "OpenSSLSocketImpl")) {
        ...
        public final DeferredSocketAdapter.Factory factory(final String packageName) {
            ...
            return new DeferredSocketAdapter.Factory() { // from class: okhttp3.internal.platform.android.AndroidSocketAdapter$Companion$factory$1
                ...
                public boolean matchesSocket(SSLSocket sslSocket) {
                    ...
                    s.j(name, "sslSocket.javaClass.name");
                    return t.b0(name, packageName + CoreConstants.DOT, false, 2, null);
                }
            };
        }
    ...
    public AndroidSocketAdapter(Class<? super SSLSocket> sslSocketClass) throws NoSuchMethodException {
        s.k(sslSocketClass, "sslSocketClass");
        this.sslSocketClass = sslSocketClass;
        Method declaredMethod = sslSocketClass.getDeclaredMethod("setUseSessionTickets", Boolean.TYPE);
        s.j(declaredMethod, "sslSocketClass.getDeclar…:class.javaPrimitiveType)");
