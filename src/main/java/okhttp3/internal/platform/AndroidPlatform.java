...
public final class AndroidPlatform extends Platform {
    ...
    public static final /* data */ class CustomTrustRootIndex implements TrustRootIndex {
        ...
        public boolean equals(Object other) {
            ...
            return s.f(this.trustManager, customTrustRootIndex.trustManager) && s.f(this.findByIssuerAndSignatureMethod, customTrustRootIndex.findByIssuerAndSignatureMethod);
        }
        ...
        public X509Certificate findByIssuerAndSignature(X509Certificate cert) {
            ...
            try {
                ...
                s.i(objInvoke, "null cannot be cast to non-null type java.security.cert.TrustAnchor");
