...
public final class TaskRunner {
    ...
    public static final class RealBackend implements Backend {
        ...
        public RealBackend(ThreadFactory threadFactory) {
            s.k(threadFactory, "threadFactory");
    ...
    static {
        ...
        s.j(logger2, "getLogger(TaskRunner::class.java.name)");
        logger = logger2;
    }
    ...
    public final List<TaskQueue> activeQueues() {
        List<TaskQueue> listP0;
        synchronized (this) {
            listP0 = v.P0(this.busyQueues, this.readyQueues);
        }
        return listP0;
    }
