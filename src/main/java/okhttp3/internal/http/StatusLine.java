...
public final class StatusLine {
    ...
    public static final class Companion {
        ...
        public final StatusLine parse(String statusLine) throws ProtocolException {
            ...
            int i11;
            String strSubstring;
            s.k(statusLine, "statusLine");
            if (t.b0(statusLine, "HTTP/1.", false, 2, null)) {
                i11 = 9;
                ...
                if (!t.b0(statusLine, "ICY ", false, 2, null)) {
                    throw new ProtocolException("Unexpected status line: " + statusLine);
                }
                protocol = Protocol.HTTP_1_0;
                i11 = 4;
            ...
            try {
                ...
                int i13 = Integer.parseInt(strSubstring2);
                if (statusLine.length() <= i12) {
                    strSubstring = "";
                } else {
                ...
                return new StatusLine(protocol, i13, strSubstring);
