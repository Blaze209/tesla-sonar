...
public final class k implements gb.a {
    ...
    @NonNull
    private final TextInputLayout f108358a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    @NonNull
    public final TextInputEditText f108359b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    @NonNull
    public final TextInputLayout f108360c;
    ...
    private k(@NonNull TextInputLayout textInputLayout, @NonNull TextInputEditText textInputEditText, @NonNull TextInputLayout textInputLayout2) {
        this.f108358a = textInputLayout;
        this.f108359b = textInputEditText;
        this.f108360c = textInputLayout2;
    }
    ...
    public static k d(@NonNull LayoutInflater layoutInflater, ViewGroup viewGroup, boolean z11) {
        View viewInflate = layoutInflater.inflate(mi0.f.f92221l, viewGroup, false);
        if (z11) {
