...
public class RNDeviceModule extends ReactContextBaseJavaModule {
    ...
    private final vy.a deviceIdResolver;
    private final vy.b deviceTypeResolver;
    ...
    class a extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            double d11 = powerStateFromIntent.getDouble(RNDeviceModule.BATTERY_LEVEL);
            Double dValueOf = Double.valueOf(d11);
            boolean z11 = powerStateFromIntent.getBoolean(RNDeviceModule.LOW_POWER_MODE);
            if (!RNDeviceModule.this.mLastBatteryState.equalsIgnoreCase(string) || RNDeviceModule.this.mLastPowerSaveState != z11) {
                ...
                RNDeviceModule.this.mLastPowerSaveState = z11;
            }
            if (RNDeviceModule.this.mLastBatteryLevel != d11) {
                ...
                RNDeviceModule.this.mLastBatteryLevel = d11;
            }
        }
    }
    ...
    public RNDeviceModule(ReactApplicationContext reactApplicationContext) {
        ...
        this.deviceTypeResolver = new vy.b(reactApplicationContext);
        this.deviceIdResolver = new vy.a(reactApplicationContext);
    ...
    public WritableMap getPowerStateFromIntent(Intent intent) {
        ...
        writableMapCreateMap.putDouble(BATTERY_LEVEL, f11);
    ...
    public Map<String, Object> getConstants() {
        ...
        map.put("deviceType", this.deviceTypeResolver.a().getValue());
        return map;
    }
    ...
    public String getDeviceNameSync() {
        ...
        try {
            ...
            if (i11 > 31 || (string2 = Settings.Secure.getString(getReactApplicationContext().getContentResolver(), "bluetooth_name")) == null) {
                return (i11 < 25 || (string = Settings.Global.getString(getReactApplicationContext().getContentResolver(), "device_name")) == null) ? "unknown" : string;
            }
            return string2;
        } catch (Exception unused) {
            return "unknown";
    ...
    public String getPhoneNumberSync() {
        ...
        if (getReactApplicationContext().checkCallingOrSelfPermission("android.permission.READ_PHONE_STATE") != 0) {
            int i11 = Build.VERSION.SDK_INT;
            if (getReactApplicationContext().checkCallingOrSelfPermission("android.permission.READ_SMS") != 0 && (i11 < 26 || getReactApplicationContext().checkCallingOrSelfPermission("android.permission.READ_PHONE_NUMBERS") != 0)) {
                return "unknown";
            }
        }
        TelephonyManager telephonyManager = (TelephonyManager) getReactApplicationContext().getSystemService("phone");
        ...
        try {
            ...
            System.err.println("getLine1Number called with permission, but threw anyway: " + e11.getMessage());
            return "unknown";
        }
    }
    ...
    public String getSerialNumberSync() {
        try {
            ...
            System.err.println("getSerialNumber failed, it probably should not be used: " + e11.getMessage());
            return "unknown";
        }
    }
    ...
    public WritableArray getSupportedMediaTypeListSync() {
        ...
        for (int i11 = 0; i11 < MediaCodecList.getCodecCount(); i11++) {
            for (String str : MediaCodecList.getCodecInfoAt(i11).getSupportedTypes()) {
                writableNativeArray.pushString(str);
            }
        }
        return writableNativeArray;
    ...
    public boolean isBatteryChargingSync() {
        ...
        return (intentRegisterReceiver != null ? intentRegisterReceiver.getIntExtra(PermissionsResponse.STATUS_KEY, -1) : 0) == 2;
    }
