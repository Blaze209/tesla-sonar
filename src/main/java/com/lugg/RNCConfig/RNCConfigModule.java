...
public class RNCConfigModule extends ReactContextBaseJavaModule {
    ...
    public Map<String, Object> getConstants() {
        ...
        try {
            ...
            try {
                packageName = reactApplicationContext.getString(reactApplicationContext.getResources().getIdentifier("build_config_package", InquiryField.StringField.TYPE, reactApplicationContext.getPackageName()));
