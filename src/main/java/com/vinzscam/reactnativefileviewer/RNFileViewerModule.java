...
public class RNFileViewerModule extends ReactContextBaseJavaModule {
    ...
    public void sendEvent(String str, Integer num, String str2) {
        ...
        writableMapCreateMap.putInt("id", num.intValue());
        if (str2 != null) {
            writableMapCreateMap.putString(AnalyticsAttribute.Error, str2);
        }
    ...
    public void open(String str, Integer num, ReadableMap readableMap) {
        Uri uriForFile;
        boolean z11 = readableMap.hasKey(SHOW_OPEN_WITH_DIALOG) ? readableMap.getBoolean(SHOW_OPEN_WITH_DIALOG) : false;
        boolean z12 = readableMap.hasKey(SHOW_STORE_SUGGESTIONS) ? readableMap.getBoolean(SHOW_STORE_SUGGESTIONS) : false;
        ...
        Intent intentCreateChooser = z11 ? Intent.createChooser(intent, "Open with") : intent;
