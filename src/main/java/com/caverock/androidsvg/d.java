        ...
        if (cCharAt5 != '+') {
            ...
            while (true) {
                ...
                if (cCharAt4 != '0') {
                    ...
                    i16 = this.f21218a - i25;
                    z12 = true;
                }
                this.f21218a++;
            }
            if (!z12 && this.f21218a == i16 + 1) {
                return Float.NaN;
            }
            if (i13 == 0) {
                if (i15 == 0) {
