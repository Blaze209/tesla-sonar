...
class d extends DefaultHttpClient {
    ...
    public final /* synthetic */ b f19992a;
    ...
    public BasicHttpProcessor createHttpProcessor() {
        ...
        basicHttpProcessorCreateHttpProcessor.addRequestInterceptor(b.f19985c);
        basicHttpProcessorCreateHttpProcessor.addRequestInterceptor(new b.a(this.f19992a, null));
