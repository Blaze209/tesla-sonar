...
public final class b implements HttpClient {
    ...
    public static long f19983a = 160;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static String[] f19984b = {"text/", "application/xml", "application/json"};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private static final HttpRequestInterceptor f19985c = new c();

    /* JADX INFO: renamed from: d, reason: collision with root package name */
    private final HttpClient f19986d;

    /* JADX INFO: renamed from: e, reason: collision with root package name */
    private RuntimeException f19987e = new IllegalStateException("AndroidHttpClient created and never closed");

    /* JADX INFO: renamed from: f, reason: collision with root package name */
    private volatile C0407b f19988f;
    ...
    public class a implements HttpRequestInterceptor {
        ...
        public void process(HttpRequest httpRequest, HttpContext httpContext) {
            C0407b c0407b = b.this.f19988f;
            if (c0407b != null && c0407b.a() && (httpRequest instanceof HttpUriRequest)) {
                c0407b.a(b.b((HttpUriRequest) httpRequest, false));
            }
        }
    ...
    public static class C0407b {
        ...
        public void a(String str) {
            Log.println(this.f19991b, this.f19990a, str);
        }

        /* JADX INFO: Access modifiers changed from: private */
        public boolean a() {
            return Log.isLoggable(this.f19990a, this.f19991b);
        }
    }

    private b(ClientConnectionManager clientConnectionManager, HttpParams httpParams) {
        this.f19986d = new d(this, clientConnectionManager, httpParams);
    }
    ...
    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler) {
        return (T) FirebasePerfHttpClient.execute(this.f19986d, httpHost, httpRequest, responseHandler);
    }

    @Override // org.apache.http.client.HttpClient
    public ClientConnectionManager getConnectionManager() {
        return this.f19986d.getConnectionManager();
    }

    @Override // org.apache.http.client.HttpClient
    public HttpParams getParams() {
        return this.f19986d.getParams();
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static String b(HttpUriRequest httpUriRequest, boolean z11) throws IOException {
        HttpEntity entity;
        String str;
        StringBuilder sb2 = new StringBuilder();
        sb2.append("curl ");
        for (Header header : httpUriRequest.getAllHeaders()) {
            if (z11 || (!header.getName().equals("Authorization") && !header.getName().equals("Cookie"))) {
                sb2.append("--header \"");
    ...
    public <T> T execute(HttpHost httpHost, HttpRequest httpRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) {
        return (T) FirebasePerfHttpClient.execute(this.f19986d, httpHost, httpRequest, responseHandler, httpContext);
    }
    ...
    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler) {
        return (T) FirebasePerfHttpClient.execute(this.f19986d, httpUriRequest, responseHandler);
    }
    ...
    public <T> T execute(HttpUriRequest httpUriRequest, ResponseHandler<? extends T> responseHandler, HttpContext httpContext) {
        return (T) FirebasePerfHttpClient.execute(this.f19986d, httpUriRequest, responseHandler, httpContext);
    }
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest) {
        return FirebasePerfHttpClient.execute(this.f19986d, httpHost, httpRequest);
    }

    @Override // org.apache.http.client.HttpClient
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) {
        return FirebasePerfHttpClient.execute(this.f19986d, httpHost, httpRequest, httpContext);
    }

    @Override // org.apache.http.client.HttpClient
    public HttpResponse execute(HttpUriRequest httpUriRequest) {
        return FirebasePerfHttpClient.execute(this.f19986d, httpUriRequest);
    }
    ...
    public HttpResponse execute(HttpUriRequest httpUriRequest, HttpContext httpContext) {
        return FirebasePerfHttpClient.execute(this.f19986d, httpUriRequest, httpContext);
    }
    ...
    public void a(HttpRequestRetryHandler httpRequestRetryHandler) {
        ((DefaultHttpClient) this.f19986d).setHttpRequestRetryHandler(httpRequestRetryHandler);
    }
