...
public final class k {
    ...
    private static final Pattern f20000a = Pattern.compile("([0-9]{1,2})[- ]([A-Za-z]{3,9})[- ]([0-9]{2,4})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])");

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final Pattern f20001b = Pattern.compile("[ ]([A-Za-z]{3,9})[ ]+([0-9]{1,2})[ ]([0-9]{1,2}:[0-9][0-9]:[0-9][0-9])[ ]([0-9]{2,4})");
    ...
    public static long a(String str) {
        ...
        int i12;
        int i13;
        Matcher matcher = f20000a.matcher(str);
        if (matcher.find()) {
            ...
            Matcher matcher2 = f20001b.matcher(str);
            if (!matcher2.find()) {
        ...
        time.set(aVarE.f20004c, aVarE.f20003b, aVarE.f20002a, i11, i12, i13);
    ...
    private static a e(String str) {
        ...
        return new a(iCharAt, ((str.charAt(i11 + 1) - '0') * 10) + (str.charAt(i11 + 2) - '0'), ((str.charAt(i11 + 4) - '0') * 10) + (str.charAt(i11 + 5) - '0'));
    }
}
