...
public final class LinkCustomizations$DocumentPreference extends GeneratedMessageLite<LinkCustomizations$DocumentPreference, a> implements b {
    ...
    private void mergeAtLeast(Int32Value int32Value) {
        ...
        if (int32Value2 == null || int32Value2 == Int32Value.getDefaultInstance()) {
            ...
            this.atLeast_ = Int32Value.newBuilder(this.atLeast_).mergeFrom(int32Value).buildPartial();
        }
        this.bitField0_ |= 1;
    }
    ...
    private void mergeAtMost(Int32Value int32Value) {
        ...
        if (int32Value2 == null || int32Value2 == Int32Value.getDefaultInstance()) {
            ...
            this.atMost_ = Int32Value.newBuilder(this.atMost_).mergeFrom(int32Value).buildPartial();
        }
        this.bitField0_ |= 2;
    }
    ...
    public com.plaid.internal.core.protos.income_verification_manager.b getDocumentType() {
        com.plaid.internal.core.protos.income_verification_manager.b bVarForNumber = com.plaid.internal.core.protos.income_verification_manager.b.forNumber(this.documentType_);
        return bVarForNumber == null ? com.plaid.internal.core.protos.income_verification_manager.b.UNRECOGNIZED : bVarForNumber;
    }
