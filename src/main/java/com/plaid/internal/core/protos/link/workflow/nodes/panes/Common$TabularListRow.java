...
public final class Common$TabularListRow extends GeneratedMessageLite<Common$TabularListRow, a> implements T {
    ...
    private void addValues(int i11, Common$AttributedLocalizedString common$AttributedLocalizedString) {
    ...
    private void mergeButtonModal(Common$Modal common$Modal) {
        ...
        if (common$Modal2 != null && common$Modal2 != Common$Modal.getDefaultInstance()) {
            common$Modal = Common$Modal.newBuilder(this.buttonModal_).mergeFrom(common$Modal).buildPartial();
        }
    ...
    private void mergeLabel(Common$AttributedLocalizedString common$AttributedLocalizedString) {
        ...
        if (common$AttributedLocalizedString2 != null && common$AttributedLocalizedString2 != Common$AttributedLocalizedString.getDefaultInstance()) {
            common$AttributedLocalizedString = Common$AttributedLocalizedString.newBuilder(this.label_).mergeFrom(common$AttributedLocalizedString).buildPartial();
        }
    ...
    private void removeValues(int i11) {
        ensureValuesIsMutable();
    ...
    private void setValues(int i11, Common$AttributedLocalizedString common$AttributedLocalizedString) {
        common$AttributedLocalizedString.getClass();
        ensureValuesIsMutable();
    ...
    public InterfaceC4378l getValuesOrBuilder(int i11) {
        return this.values_.get(i11);
    }

    public List<? extends InterfaceC4378l> getValuesOrBuilderList() {
        return this.values_;
    }
