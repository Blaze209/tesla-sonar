...
public final class Common$SDKEncryptionMetadata extends GeneratedMessageLite<Common$SDKEncryptionMetadata, a> implements MessageLiteOrBuilder {
    ...
    private void setScheme(L l11) {
        this.scheme_ = l11.getNumber();
    }

    private void setSchemeValue(int i11) {
        this.scheme_ = i11;
    }
    ...
    public L getScheme() {
        L lForNumber = L.forNumber(this.scheme_);
        return lForNumber == null ? L.UNRECOGNIZED : lForNumber;
    }
