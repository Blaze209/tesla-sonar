...
public final class Common$OrderedList extends GeneratedMessageLite<Common$OrderedList, a> implements MessageLiteOrBuilder {
    ...
    private void addItems(int i11, Common$OrderedListItem common$OrderedListItem) {
        common$OrderedListItem.getClass();
        ensureItemsIsMutable();
        this.items_.add(i11, common$OrderedListItem);
    }
    ...
    private void setItems(int i11, Common$OrderedListItem common$OrderedListItem) {
        common$OrderedListItem.getClass();
        ensureItemsIsMutable();
        this.items_.set(i11, common$OrderedListItem);
    }
    ...
    public Common$OrderedListItem getItems(int i11) {
    ...
    public H getItemsOrBuilder(int i11) {
        return this.items_.get(i11);
    }
