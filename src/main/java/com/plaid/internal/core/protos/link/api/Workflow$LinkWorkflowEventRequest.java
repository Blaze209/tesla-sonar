...
public final class Workflow$LinkWorkflowEventRequest extends GeneratedMessageLite<Workflow$LinkWorkflowEventRequest, a> implements MessageLiteOrBuilder {
    ...
    private void setEvents(int i11, ClientEventOuterClass$ClientEvent clientEventOuterClass$ClientEvent) {
        clientEventOuterClass$ClientEvent.getClass();
        ensureEventsIsMutable();
        this.events_.set(i11, clientEventOuterClass$ClientEvent);
    }
    ...
    public ClientEventOuterClass$ClientEvent getEvents(int i11) {
    ...
    public c getEventsOrBuilder(int i11) {
        return this.events_.get(i11);
    }
    ...
    private void addEvents(int i11, ClientEventOuterClass$ClientEvent clientEventOuterClass$ClientEvent) {
        clientEventOuterClass$ClientEvent.getClass();
        ensureEventsIsMutable();
        this.events_.add(i11, clientEventOuterClass$ClientEvent);
    }
