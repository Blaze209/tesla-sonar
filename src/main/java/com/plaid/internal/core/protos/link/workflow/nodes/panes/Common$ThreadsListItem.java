...
public final class Common$ThreadsListItem extends GeneratedMessageLite<Common$ThreadsListItem, a> implements MessageLiteOrBuilder {
    ...
    public static final class ListItemSection extends GeneratedMessageLite<ListItemSection, a> implements MessageLiteOrBuilder {
        ...
        private void addComponents(int i11, ListItemRow listItemRow) {
            listItemRow.getClass();
            ensureComponentsIsMutable();
            this.components_.add(i11, listItemRow);
        }
        ...
        private void setComponents(int i11, ListItemRow listItemRow) {
            listItemRow.getClass();
            ensureComponentsIsMutable();
            this.components_.set(i11, listItemRow);
        }
        ...
        public ListItemRow getComponents(int i11) {
            return this.components_.get(i11);
        }
        ...
        public b getComponentsOrBuilder(int i11) {
            return this.components_.get(i11);
        }
    ...
    private void mergeLeadingContents(ListItemSection listItemSection) {
        ...
        if (listItemSection2 != null && listItemSection2 != ListItemSection.getDefaultInstance()) {
            listItemSection = ListItemSection.newBuilder(this.leadingContents_).mergeFrom(listItemSection).buildPartial();
        }
    ...
    private void mergeLeadingTextRows(ListItemSection listItemSection) {
        ...
        if (listItemSection2 != null && listItemSection2 != ListItemSection.getDefaultInstance()) {
            listItemSection = ListItemSection.newBuilder(this.leadingTextRows_).mergeFrom(listItemSection).buildPartial();
        }
    ...
    private void mergeTrailingContentsColumns(ListItemSection listItemSection) {
        ...
        if (listItemSection2 != null && listItemSection2 != ListItemSection.getDefaultInstance()) {
            listItemSection = ListItemSection.newBuilder(this.trailingContentsColumns_).mergeFrom(listItemSection).buildPartial();
        }
