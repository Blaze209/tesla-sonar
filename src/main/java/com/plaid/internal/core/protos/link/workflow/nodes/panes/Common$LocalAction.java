...
public final class Common$LocalAction extends GeneratedMessageLite<Common$LocalAction, b> implements B {
    ...
    public static final class OopwvOpen extends GeneratedMessageLite<OopwvOpen, a> implements MessageLiteOrBuilder {
        ...
        public static final class AndroidCallbacks extends GeneratedMessageLite<AndroidCallbacks, a> implements MessageLiteOrBuilder {
            ...
            private void mergeSubmitOutputOnCancel(Any any) {
                ...
                if (any2 == null || any2 == Any.getDefaultInstance()) {
                    ...
                    this.submitOutputOnCancel_ = Any.newBuilder(this.submitOutputOnCancel_).mergeFrom(any).buildPartial();
                }
                this.bitField0_ |= 2;
            }
            ...
            private void mergeSubmitOutputOnFinish(Any any) {
                ...
                if (any2 == null || any2 == Any.getDefaultInstance()) {
                    ...
                    this.submitOutputOnFinish_ = Any.newBuilder(this.submitOutputOnFinish_).mergeFrom(any).buildPartial();
                }
                this.bitField0_ |= 1;
            }
        ...
        public static final class IosCallbacks extends GeneratedMessageLite<IosCallbacks, a> implements MessageLiteOrBuilder {
            ...
            private void mergeSubmitOutputOnDeclineOpenSessionOnly(Any any) {
                ...
                if (any2 == null || any2 == Any.getDefaultInstance()) {
                    ...
                    this.submitOutputOnDeclineOpenSessionOnly_ = Any.newBuilder(this.submitOutputOnDeclineOpenSessionOnly_).mergeFrom(any).buildPartial();
                }
                this.bitField0_ |= 2;
            }
        ...
        private void mergeAndroidCallbacks(AndroidCallbacks androidCallbacks) {
            ...
            if (this.submitCallbacksCase_ != 6 || this.submitCallbacks_ == AndroidCallbacks.getDefaultInstance()) {
                ...
                this.submitCallbacks_ = AndroidCallbacks.newBuilder((AndroidCallbacks) this.submitCallbacks_).mergeFrom(androidCallbacks).buildPartial();
            }
        ...
        private void mergeIosCallbacks(IosCallbacks iosCallbacks) {
            ...
            if (this.submitCallbacksCase_ != 5 || this.submitCallbacks_ == IosCallbacks.getDefaultInstance()) {
                ...
                this.submitCallbacks_ = IosCallbacks.newBuilder((IosCallbacks) this.submitCallbacks_).mergeFrom(iosCallbacks).buildPartial();
            }
        ...
        private void mergeLegacyEventsChannelInfo(LegacyEventsChannelInfo legacyEventsChannelInfo) {
            ...
            if (legacyEventsChannelInfo2 == null || legacyEventsChannelInfo2 == LegacyEventsChannelInfo.getDefaultInstance()) {
                ...
                this.legacyEventsChannelInfo_ = LegacyEventsChannelInfo.newBuilder(this.legacyEventsChannelInfo_).mergeFrom(legacyEventsChannelInfo).buildPartial();
            }
            this.bitField0_ |= 2;
        }
        ...
        private void mergeOpenMessage(OauthInitializationOptions$MobileSdkUrlOpenMessage oauthInitializationOptions$MobileSdkUrlOpenMessage) {
            ...
            if (oauthInitializationOptions$MobileSdkUrlOpenMessage2 == null || oauthInitializationOptions$MobileSdkUrlOpenMessage2 == OauthInitializationOptions$MobileSdkUrlOpenMessage.getDefaultInstance()) {
                ...
                this.openMessage_ = OauthInitializationOptions$MobileSdkUrlOpenMessage.newBuilder(this.openMessage_).mergeFrom(oauthInitializationOptions$MobileSdkUrlOpenMessage).buildPartial();
            }
            this.bitField0_ |= 1;
        }
    ...
    private void mergeEmbeddedSessionHandoff(EmbeddedSessionHandoff embeddedSessionHandoff) {
        ...
        if (this.actionCase_ != 22 || this.action_ == EmbeddedSessionHandoff.getDefaultInstance()) {
            ...
            this.action_ = EmbeddedSessionHandoff.newBuilder((EmbeddedSessionHandoff) this.action_).mergeFrom(embeddedSessionHandoff).buildPartial();
        }
        this.actionCase_ = 22;
    }
    ...
    private void mergeEmitSdkInternalEvent(Common$SDKInternalEvent common$SDKInternalEvent) {
        ...
        if (this.actionCase_ != 11 || this.action_ == Common$SDKInternalEvent.getDefaultInstance()) {
            ...
            this.action_ = Common$SDKInternalEvent.newBuilder((Common$SDKInternalEvent) this.action_).mergeFrom(common$SDKInternalEvent).buildPartial();
        }
        this.actionCase_ = 11;
    }
    ...
    private void mergeEventMetadata(EventMetadata eventMetadata) {
        ...
        if (eventMetadata2 == null || eventMetadata2 == EventMetadata.getDefaultInstance()) {
            ...
            this.eventMetadata_ = EventMetadata.newBuilder(this.eventMetadata_).mergeFrom(eventMetadata).buildPartial();
        }
        this.bitField0_ |= 1;
    }
    ...
    private void mergeOopwvClose(OopwvClose oopwvClose) {
        ...
        if (this.actionCase_ != 17 || this.action_ == OopwvClose.getDefaultInstance()) {
            ...
            this.action_ = OopwvClose.newBuilder((OopwvClose) this.action_).mergeFrom(oopwvClose).buildPartial();
        }
        this.actionCase_ = 17;
    }
    ...
    private void mergeOopwvOpen(OopwvOpen oopwvOpen) {
        ...
        if (this.actionCase_ != 16 || this.action_ == OopwvOpen.getDefaultInstance()) {
            ...
            this.action_ = OopwvOpen.newBuilder((OopwvOpen) this.action_).mergeFrom(oopwvOpen).buildPartial();
        }
        this.actionCase_ = 16;
    }
    ...
    private void mergeSdkEvent(Common$SDKEvent common$SDKEvent) {
        ...
        if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
            ...
            this.sdkEvent_ = Common$SDKEvent.newBuilder(this.sdkEvent_).mergeFrom(common$SDKEvent).buildPartial();
        }
        this.bitField0_ |= 2;
    }
    ...
    private void mergeSfpcRequest(SfpcRequest sfpcRequest) {
        ...
        if (this.actionCase_ != 18 || this.action_ == SfpcRequest.getDefaultInstance()) {
            ...
            this.action_ = SfpcRequest.newBuilder((SfpcRequest) this.action_).mergeFrom(sfpcRequest).buildPartial();
        }
        this.actionCase_ = 18;
    }
    ...
    private void mergeShowModal(Common$Modal common$Modal) {
        ...
        if (this.actionCase_ != 4 || this.action_ == Common$Modal.getDefaultInstance()) {
            ...
            this.action_ = Common$Modal.newBuilder((Common$Modal) this.action_).mergeFrom(common$Modal).buildPartial();
        }
        this.actionCase_ = 4;
    }
    ...
    private void mergeTriggerAction(Any any) {
        ...
        if (this.actionCase_ != 21 || this.action_ == Any.getDefaultInstance()) {
            ...
            this.action_ = Any.newBuilder((Any) this.action_).mergeFrom(any).buildPartial();
        }
        this.actionCase_ = 21;
    }
    ...
    private void setAlsoSubmitAction(boolean z11) {
        this.alsoSubmitAction_ = z11;
    }

    private void setAuthorizeFinancekit(boolean z11) {
        this.actionCase_ = 15;
    ...
    private void setCloseLinkFromHostedLinkSecurityModal(boolean z11) {
        this.actionCase_ = 19;
        this.action_ = Boolean.valueOf(z11);
    }
    ...
    private void setExecuteRecaptchaEnterprise(boolean z11) {
        this.actionCase_ = 9;
        this.action_ = Boolean.valueOf(z11);
    }
    ...
    private void setGoBack(boolean z11) {
        this.actionCase_ = 7;
        this.action_ = Boolean.valueOf(z11);
    }
    ...
    private void setHideModal(boolean z11) {
        this.actionCase_ = 6;
        this.action_ = Boolean.valueOf(z11);
    }
    ...
    private void setTriggerHaptic(EnumC4391z enumC4391z) {
        this.action_ = Integer.valueOf(enumC4391z.getNumber());
        this.actionCase_ = 20;
    }

    private void setTriggerHapticValue(int i11) {
        this.actionCase_ = 20;
    ...
    public EnumC4391z getTriggerHaptic() {
        if (this.actionCase_ != 20) {
            return EnumC4391z.HAPTIC_TYPE_UNKNOWN;
        }
        EnumC4391z enumC4391zForNumber = EnumC4391z.forNumber(((Integer) this.action_).intValue());
        return enumC4391zForNumber == null ? EnumC4391z.UNRECOGNIZED : enumC4391zForNumber;
    }
