...
public final class Common$SelectionListItem extends GeneratedMessageLite<Common$SelectionListItem, a> implements P {
    ...
    private void mergeLeadingAsset(Common$RenderedAsset common$RenderedAsset) {
        ...
        if (common$RenderedAsset2 == null || common$RenderedAsset2 == Common$RenderedAsset.getDefaultInstance()) {
            ...
            this.leadingAsset_ = Common$RenderedAsset.newBuilder(this.leadingAsset_).mergeFrom(common$RenderedAsset).buildPartial();
        }
        this.bitField0_ |= 32;
    }
    ...
    private void mergeNote(Common$Note common$Note) {
        ...
        if (common$Note2 == null || common$Note2 == Common$Note.getDefaultInstance()) {
            ...
            this.note_ = Common$Note.newBuilder(this.note_).mergeFrom(common$Note).buildPartial();
        }
        this.bitField0_ |= 2;
    }
    ...
    private void mergeTrailingAsset(Common$RenderedAsset common$RenderedAsset) {
        ...
        if (common$RenderedAsset2 == null || common$RenderedAsset2 == Common$RenderedAsset.getDefaultInstance()) {
            ...
            this.trailingAsset_ = Common$RenderedAsset.newBuilder(this.trailingAsset_).mergeFrom(common$RenderedAsset).buildPartial();
        }
        this.bitField0_ |= 64;
    }
    ...
    private void removeChildren(int i11) {
        ensureChildrenIsMutable();
        this.children_.remove(i11);
    }

    private void setChildren(int i11, Common$SelectionListItem common$SelectionListItem) {
        common$SelectionListItem.getClass();
        ensureChildrenIsMutable();
        this.children_.set(i11, common$SelectionListItem);
    }
    ...
    public Common$SelectionListItem getChildren(int i11) {
    ...
    public P getChildrenOrBuilder(int i11) {
        return this.children_.get(i11);
    }
    ...
    private void addChildren(int i11, Common$SelectionListItem common$SelectionListItem) {
        common$SelectionListItem.getClass();
        ensureChildrenIsMutable();
        this.children_.add(i11, common$SelectionListItem);
    }
