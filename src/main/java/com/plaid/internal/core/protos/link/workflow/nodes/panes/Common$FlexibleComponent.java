...
public final class Common$FlexibleComponent extends GeneratedMessageLite<Common$FlexibleComponent, a> implements InterfaceC4388w {
    ...
    public static final class Spacing extends GeneratedMessageLite<Spacing, a> implements MessageLiteOrBuilder {
        ...
        private void clearMarginBottom() {
            this.marginBottom_ = BitmapDescriptorFactory.HUE_RED;
        }

        private void clearMarginLeft() {
            this.marginLeft_ = BitmapDescriptorFactory.HUE_RED;
        }

        private void clearMarginRight() {
            this.marginRight_ = BitmapDescriptorFactory.HUE_RED;
        }
        ...
        private void clearPaddingLeft() {
            this.paddingLeft_ = BitmapDescriptorFactory.HUE_RED;
        }

        private void clearPaddingRight() {
            this.paddingRight_ = BitmapDescriptorFactory.HUE_RED;
        }
        ...
        private void setMarginBottom(float f11) {
            this.marginBottom_ = f11;
        }

        private void setMarginLeft(float f11) {
            this.marginLeft_ = f11;
        }

        private void setMarginRight(float f11) {
            this.marginRight_ = f11;
        }
        ...
        private void setPaddingLeft(float f11) {
            this.paddingLeft_ = f11;
        }

        private void setPaddingRight(float f11) {
            this.paddingRight_ = f11;
        }
    ...
    public static final class a extends GeneratedMessageLite.Builder<Common$FlexibleComponent, a> implements InterfaceC4388w {
        public a() {
    ...
    private void mergeAccordion(Common$Accordion common$Accordion) {
        ...
        if (this.typeCase_ == 14 && this.type_ != Common$Accordion.getDefaultInstance()) {
            common$Accordion = Common$Accordion.newBuilder((Common$Accordion) this.type_).mergeFrom(common$Accordion).buildPartial();
        }
    ...
    private void mergeAsset(Common$RenderedAsset common$RenderedAsset) {
        ...
        if (this.typeCase_ == 11 && this.type_ != Common$RenderedAsset.getDefaultInstance()) {
            common$RenderedAsset = Common$RenderedAsset.newBuilder((Common$RenderedAsset) this.type_).mergeFrom(common$RenderedAsset).buildPartial();
        }
    ...
    private void mergeAttributedString(Common$AttributedLocalizedString common$AttributedLocalizedString) {
        ...
        if (this.typeCase_ == 8 && this.type_ != Common$AttributedLocalizedString.getDefaultInstance()) {
            common$AttributedLocalizedString = Common$AttributedLocalizedString.newBuilder((Common$AttributedLocalizedString) this.type_).mergeFrom(common$AttributedLocalizedString).buildPartial();
        }
    ...
    private void mergeBox(Common$Box common$Box) {
        ...
        if (this.typeCase_ == 21 && this.type_ != Common$Box.getDefaultInstance()) {
            common$Box = Common$Box.newBuilder((Common$Box) this.type_).mergeFrom(common$Box).buildPartial();
        }
    ...
    private void mergeButton(Common$ButtonContent common$ButtonContent) {
        ...
        if (this.typeCase_ == 9 && this.type_ != Common$ButtonContent.getDefaultInstance()) {
            common$ButtonContent = Common$ButtonContent.newBuilder((Common$ButtonContent) this.type_).mergeFrom(common$ButtonContent).buildPartial();
        }
    ...
    private void mergeCheckList(Common$CheckList common$CheckList) {
        ...
        if (this.typeCase_ == 18 && this.type_ != Common$CheckList.getDefaultInstance()) {
            common$CheckList = Common$CheckList.newBuilder((Common$CheckList) this.type_).mergeFrom(common$CheckList).buildPartial();
        }
    ...
    private void mergeCobrandedAsset(Common$CobrandedAsset common$CobrandedAsset) {
        ...
        if (this.typeCase_ == 29 && this.type_ != Common$CobrandedAsset.getDefaultInstance()) {
            common$CobrandedAsset = Common$CobrandedAsset.newBuilder((Common$CobrandedAsset) this.type_).mergeFrom(common$CobrandedAsset).buildPartial();
        }
    ...
    private void mergeDisclaimer(Common$Disclaimer common$Disclaimer) {
        ...
        if (this.typeCase_ == 26 && this.type_ != Common$Disclaimer.getDefaultInstance()) {
            common$Disclaimer = Common$Disclaimer.newBuilder((Common$Disclaimer) this.type_).mergeFrom(common$Disclaimer).buildPartial();
        }
    ...
    private void mergeListGroup(Common$ListGroup common$ListGroup) {
        ...
        if (this.typeCase_ == 24 && this.type_ != Common$ListGroup.getDefaultInstance()) {
            common$ListGroup = Common$ListGroup.newBuilder((Common$ListGroup) this.type_).mergeFrom(common$ListGroup).buildPartial();
        }
    ...
    private void mergeListItem(Common$ListItem common$ListItem) {
        ...
        if (this.typeCase_ == 12 && this.type_ != Common$ListItem.getDefaultInstance()) {
            common$ListItem = Common$ListItem.newBuilder((Common$ListItem) this.type_).mergeFrom(common$ListItem).buildPartial();
        }
    ...
    private void mergeNote(Common$Note common$Note) {
        ...
        if (this.typeCase_ == 15 && this.type_ != Common$Note.getDefaultInstance()) {
            common$Note = Common$Note.newBuilder((Common$Note) this.type_).mergeFrom(common$Note).buildPartial();
        }
    ...
    private void mergeOauthGuidance(Common$OAuthGuidance common$OAuthGuidance) {
        ...
        if (this.typeCase_ == 28 && this.type_ != Common$OAuthGuidance.getDefaultInstance()) {
            common$OAuthGuidance = Common$OAuthGuidance.newBuilder((Common$OAuthGuidance) this.type_).mergeFrom(common$OAuthGuidance).buildPartial();
        }
    ...
    private void mergeOnTap(Common$SDKEvent common$SDKEvent) {
        ...
        if (common$SDKEvent2 != null && common$SDKEvent2 != Common$SDKEvent.getDefaultInstance()) {
            common$SDKEvent = Common$SDKEvent.newBuilder(this.onTap_).mergeFrom(common$SDKEvent).buildPartial();
        }
    ...
    private void mergeOrderedList(Common$OrderedList common$OrderedList) {
        ...
        if (this.typeCase_ == 19 && this.type_ != Common$OrderedList.getDefaultInstance()) {
            common$OrderedList = Common$OrderedList.newBuilder((Common$OrderedList) this.type_).mergeFrom(common$OrderedList).buildPartial();
        }
    ...
    private void mergePassportModal(Common$PassportModal common$PassportModal) {
        ...
        if (this.typeCase_ == 32 && this.type_ != Common$PassportModal.getDefaultInstance()) {
            common$PassportModal = Common$PassportModal.newBuilder((Common$PassportModal) this.type_).mergeFrom(common$PassportModal).buildPartial();
        }
    ...
    private void mergePhoneInput(Common$PhoneInput common$PhoneInput) {
        ...
        if (this.typeCase_ == 30 && this.type_ != Common$PhoneInput.getDefaultInstance()) {
            common$PhoneInput = Common$PhoneInput.newBuilder((Common$PhoneInput) this.type_).mergeFrom(common$PhoneInput).buildPartial();
        }
    ...
    private void mergePrimaryHeading(Common$LocalizedString common$LocalizedString) {
        ...
        if (this.typeCase_ == 7 && this.type_ != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder((Common$LocalizedString) this.type_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void mergeSpacing(Spacing spacing) {
        ...
        if (spacing2 != null && spacing2 != Spacing.getDefaultInstance()) {
            spacing = Spacing.newBuilder(this.spacing_).mergeFrom(spacing).buildPartial();
        }
    ...
    private void mergeSteppedTransitionText(Common$SteppedTransitionText common$SteppedTransitionText) {
        ...
        if (this.typeCase_ == 27 && this.type_ != Common$SteppedTransitionText.getDefaultInstance()) {
            common$SteppedTransitionText = Common$SteppedTransitionText.newBuilder((Common$SteppedTransitionText) this.type_).mergeFrom(common$SteppedTransitionText).buildPartial();
        }
    ...
    private void mergeTable(Common$Table common$Table) {
        ...
        if (this.typeCase_ == 16 && this.type_ != Common$Table.getDefaultInstance()) {
            common$Table = Common$Table.newBuilder((Common$Table) this.type_).mergeFrom(common$Table).buildPartial();
        }
    ...
    private void mergeTextContent(Common$TextContent common$TextContent) {
        ...
        if (this.typeCase_ == 23 && this.type_ != Common$TextContent.getDefaultInstance()) {
            common$TextContent = Common$TextContent.newBuilder((Common$TextContent) this.type_).mergeFrom(common$TextContent).buildPartial();
        }
    ...
    private void mergeTextInput(Common$TextInput common$TextInput) {
        ...
        if (this.typeCase_ == 10 && this.type_ != Common$TextInput.getDefaultInstance()) {
            common$TextInput = Common$TextInput.newBuilder((Common$TextInput) this.type_).mergeFrom(common$TextInput).buildPartial();
        }
    ...
    private void mergeThreadsListItem(Common$ThreadsListItem common$ThreadsListItem) {
        ...
        if (this.typeCase_ == 20 && this.type_ != Common$ThreadsListItem.getDefaultInstance()) {
            common$ThreadsListItem = Common$ThreadsListItem.newBuilder((Common$ThreadsListItem) this.type_).mergeFrom(common$ThreadsListItem).buildPartial();
        }
    ...
    private void mergeTouchable(Common$Touchable common$Touchable) {
        ...
        if (this.typeCase_ == 22 && this.type_ != Common$Touchable.getDefaultInstance()) {
            common$Touchable = Common$Touchable.newBuilder((Common$Touchable) this.type_).mergeFrom(common$Touchable).buildPartial();
        }
    ...
    private void mergeValuePropositionSheet(Common$ValuePropositionSheet common$ValuePropositionSheet) {
        ...
        if (this.typeCase_ == 31 && this.type_ != Common$ValuePropositionSheet.getDefaultInstance()) {
            common$ValuePropositionSheet = Common$ValuePropositionSheet.newBuilder((Common$ValuePropositionSheet) this.type_).mergeFrom(common$ValuePropositionSheet).buildPartial();
        }
    ...
    private void setComponentAction(EnumC4387v enumC4387v) {
        this.componentAction_ = enumC4387v.getNumber();
    }

    private void setComponentActionValue(int i11) {
        this.componentAction_ = i11;
    }
    ...
    public EnumC4387v getComponentAction() {
        EnumC4387v enumC4387vForNumber = EnumC4387v.forNumber(this.componentAction_);
        return enumC4387vForNumber == null ? EnumC4387v.UNRECOGNIZED : enumC4387vForNumber;
    }
