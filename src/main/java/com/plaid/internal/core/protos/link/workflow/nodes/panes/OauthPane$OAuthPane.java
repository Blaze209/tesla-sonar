    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ExitAction extends GeneratedMessageLite<ExitAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (k0.f47467a[methodToInvoke.ordinal()]) {
                    case 1:
        ...
        public static final class SubmitAction extends GeneratedMessageLite<SubmitAction, a> implements MessageLiteOrBuilder {
            ...
            private void setOauthSubmissionMethod(F f11) {
                this.oauthSubmissionMethod_ = f11.getNumber();
            }

            private void setOauthSubmissionMethodValue(int i11) {
                this.oauthSubmissionMethod_ = i11;
            }
            ...
            public F getOauthSubmissionMethod() {
                F fForNumber = F.forNumber(this.oauthSubmissionMethod_);
                return fForNumber == null ? F.UNRECOGNIZED : fForNumber;
            }
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final class Content extends GeneratedMessageLite<Content, a> implements MessageLiteOrBuilder {
            ...
            public static final class OrderedList extends GeneratedMessageLite<OrderedList, a> implements MessageLiteOrBuilder {
                ...
                private void setItems(int i11, Common$LocalizedString common$LocalizedString) {
                    common$LocalizedString.getClass();
                    ensureItemsIsMutable();
                ...
                private void addItems(int i11, Common$LocalizedString common$LocalizedString) {
                    common$LocalizedString.getClass();
                    ensureItemsIsMutable();
            ...
            private void mergeDetailOrderedList(OrderedList orderedList) {
                ...
                if (this.detailCase_ != 6 || this.detail_ == OrderedList.getDefaultInstance()) {
                    ...
                    this.detail_ = OrderedList.newBuilder((OrderedList) this.detail_).mergeFrom(orderedList).buildPartial();
                }
                this.detailCase_ = 6;
            }
            ...
            private void mergeDetailText(Common$LocalizedString common$LocalizedString) {
                ...
                if (this.detailCase_ != 5 || this.detail_ == Common$LocalizedString.getDefaultInstance()) {
                    ...
                    this.detail_ = Common$LocalizedString.newBuilder((Common$LocalizedString) this.detail_).mergeFrom(common$LocalizedString).buildPartial();
                }
                this.detailCase_ = 5;
            }
        ...
        public static final class ContentFlexible extends GeneratedMessageLite<ContentFlexible, a> implements MessageLiteOrBuilder {
            ...
            private void mergePaneBody(PaneBody paneBody) {
                ...
                if (paneBody2 == null || paneBody2 == PaneBody.getDefaultInstance()) {
                    ...
                    this.paneBody_ = PaneBody.newBuilder(this.paneBody_).mergeFrom(paneBody).buildPartial();
                }
                this.bitField0_ |= 1;
            }
        ...
        public static final class Events extends GeneratedMessageLite<Events, a> implements MessageLiteOrBuilder {
            ...
            private void removeOnCloseRedirect(int i11) {
                ensureOnCloseRedirectIsMutable();
                this.onCloseRedirect_.remove(i11);
            }

            private void removeOnFailRedirect(int i11) {
                ensureOnFailRedirectIsMutable();
                this.onFailRedirect_.remove(i11);
            }

            private void removeOnRedirect(int i11) {
                ensureOnRedirectIsMutable();
            ...
            private void setOnCloseRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnCloseRedirectIsMutable();
                this.onCloseRedirect_.set(i11, common$SDKEvent);
            }

            private void setOnFailRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnFailRedirectIsMutable();
                this.onFailRedirect_.set(i11, common$SDKEvent);
            }

            private void setOnRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnRedirectIsMutable();
            ...
            public M getOnCloseRedirectOrBuilder(int i11) {
                return this.onCloseRedirect_.get(i11);
            }
            ...
            public M getOnFailRedirectOrBuilder(int i11) {
                return this.onFailRedirect_.get(i11);
            }
            ...
            public M getOnRedirectOrBuilder(int i11) {
                return this.onRedirect_.get(i11);
            }
            ...
            private void addOnCloseRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnCloseRedirectIsMutable();
                this.onCloseRedirect_.add(i11, common$SDKEvent);
            }

            private void addOnFailRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnFailRedirectIsMutable();
                this.onFailRedirect_.add(i11, common$SDKEvent);
            }

            private void addOnRedirect(int i11, Common$SDKEvent common$SDKEvent) {
                common$SDKEvent.getClass();
                ensureOnRedirectIsMutable();
        ...
        private void mergeAfter(Content content) {
            ...
            if (content2 == null || content2 == Content.getDefaultInstance()) {
                ...
                this.after_ = Content.newBuilder(this.after_).mergeFrom(content).buildPartial();
            }
            this.bitField0_ |= 256;
        }
        ...
        private void mergeAfterFlexible(ContentFlexible contentFlexible) {
            ...
            if (contentFlexible2 == null || contentFlexible2 == ContentFlexible.getDefaultInstance()) {
                ...
                this.afterFlexible_ = ContentFlexible.newBuilder(this.afterFlexible_).mergeFrom(contentFlexible).buildPartial();
            }
            this.bitField0_ |= 512;
        }
        ...
        private void mergeAutoLoginOpen(Common$AutoLoginOpenOptions common$AutoLoginOpenOptions) {
            ...
            if (common$AutoLoginOpenOptions2 == null || common$AutoLoginOpenOptions2 == Common$AutoLoginOpenOptions.getDefaultInstance()) {
                ...
                this.autoLoginOpen_ = Common$AutoLoginOpenOptions.newBuilder(this.autoLoginOpen_).mergeFrom(common$AutoLoginOpenOptions).buildPartial();
            }
            this.bitField0_ |= 2;
        }
        ...
        private void mergeBefore(Content content) {
            ...
            if (content2 == null || content2 == Content.getDefaultInstance()) {
                ...
                this.before_ = Content.newBuilder(this.before_).mergeFrom(content).buildPartial();
            }
            this.bitField0_ |= 16;
        }
        ...
        private void mergeBeforeFlexible(ContentFlexible contentFlexible) {
            ...
            if (contentFlexible2 == null || contentFlexible2 == ContentFlexible.getDefaultInstance()) {
                ...
                this.beforeFlexible_ = ContentFlexible.newBuilder(this.beforeFlexible_).mergeFrom(contentFlexible).buildPartial();
            }
            this.bitField0_ |= 32;
        }
        ...
        private void mergeDuring(Content content) {
            ...
            if (content2 == null || content2 == Content.getDefaultInstance()) {
                ...
                this.during_ = Content.newBuilder(this.during_).mergeFrom(content).buildPartial();
            }
            this.bitField0_ |= 64;
        }
        ...
        private void mergeDuringFlexible(ContentFlexible contentFlexible) {
            ...
            if (contentFlexible2 == null || contentFlexible2 == ContentFlexible.getDefaultInstance()) {
                ...
                this.duringFlexible_ = ContentFlexible.newBuilder(this.duringFlexible_).mergeFrom(contentFlexible).buildPartial();
            }
            this.bitField0_ |= 128;
        }
        ...
        private void mergeOutOfProcessIosPopup(Common$OutOfProcessIOSPopupOptions common$OutOfProcessIOSPopupOptions) {
            ...
            if (this.openMethodCase_ != 16 || this.openMethod_ == Common$OutOfProcessIOSPopupOptions.getDefaultInstance()) {
                ...
                this.openMethod_ = Common$OutOfProcessIOSPopupOptions.newBuilder((Common$OutOfProcessIOSPopupOptions) this.openMethod_).mergeFrom(common$OutOfProcessIOSPopupOptions).buildPartial();
            }
        ...
        private void mergePollForLoginUri(PollForLoginURI pollForLoginURI) {
            ...
            if (this.loginUriOptionsCase_ != 23 || this.loginUriOptions_ == PollForLoginURI.getDefaultInstance()) {
                ...
                this.loginUriOptions_ = PollForLoginURI.newBuilder((PollForLoginURI) this.loginUriOptions_).mergeFrom(pollForLoginURI).buildPartial();
            }
        ...
        private void mergePolling(Common$PollingOptions common$PollingOptions) {
            ...
            if (common$PollingOptions2 == null || common$PollingOptions2 == Common$PollingOptions.getDefaultInstance()) {
                ...
                this.polling_ = Common$PollingOptions.newBuilder(this.polling_).mergeFrom(common$PollingOptions).buildPartial();
            }
            this.bitField0_ |= 1;
        }
        ...
        private void mergePopup(Common$PopupOptions common$PopupOptions) {
            ...
            if (this.openMethodCase_ != 10 || this.openMethod_ == Common$PopupOptions.getDefaultInstance()) {
                ...
                this.openMethod_ = Common$PopupOptions.newBuilder((Common$PopupOptions) this.openMethod_).mergeFrom(common$PopupOptions).buildPartial();
            }
        ...
        private void mergeRedirect(Common$RedirectOptions common$RedirectOptions) {
            ...
            if (this.openMethodCase_ != 11 || this.openMethod_ == Common$RedirectOptions.getDefaultInstance()) {
                ...
                this.openMethod_ = Common$RedirectOptions.newBuilder((Common$RedirectOptions) this.openMethod_).mergeFrom(common$RedirectOptions).buildPartial();
            }
        ...
        private void setConfiguredWithRedirectUri(boolean z11) {
        ...
        private void setHideFairyBits(boolean z11) {
        ...
        private void setOauthUiExperience(G g11) {
            this.oauthUiExperience_ = g11.getNumber();
        }

        private void setOauthUiExperienceValue(int i11) {
            this.oauthUiExperience_ = i11;
        }
        ...
        private void setShouldAwaitOauthLogging(boolean z11) {
            this.shouldAwaitOauthLogging_ = z11;
        }
        ...
        public G getOauthUiExperience() {
            G gForNumber = G.forNumber(this.oauthUiExperience_);
            return gForNumber == null ? G.UNRECOGNIZED : gForNumber;
        }
