...
public final class Common$GridSelectionImageItem extends GeneratedMessageLite<Common$GridSelectionImageItem, a> implements InterfaceC4390y {
    ...
    public static final class a extends GeneratedMessageLite.Builder<Common$GridSelectionImageItem, a> implements InterfaceC4390y {
        public a() {
    ...
    private void mergeImage(Common$RenderedAsset common$RenderedAsset) {
        ...
        if (common$RenderedAsset2 == null || common$RenderedAsset2 == Common$RenderedAsset.getDefaultInstance()) {
            ...
            this.image_ = Common$RenderedAsset.newBuilder(this.image_).mergeFrom(common$RenderedAsset).buildPartial();
        }
        this.bitField0_ |= 1;
    }
