...
public final class Common$ListItem extends GeneratedMessageLite<Common$ListItem, a> implements A {
    ...
    private void mergeChildItemsHeader(Common$ChildItemsHeader common$ChildItemsHeader) {
        ...
        if (common$ChildItemsHeader2 == null || common$ChildItemsHeader2 == Common$ChildItemsHeader.getDefaultInstance()) {
            ...
            this.childItemsHeader_ = Common$ChildItemsHeader.newBuilder(this.childItemsHeader_).mergeFrom(common$ChildItemsHeader).buildPartial();
        }
        this.bitField0_ |= 32;
    }
    ...
    private void mergeSecondarySubtitle(Common$AttributedLocalizedString common$AttributedLocalizedString) {
        ...
        if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
            ...
            this.secondarySubtitle_ = Common$AttributedLocalizedString.newBuilder(this.secondarySubtitle_).mergeFrom(common$AttributedLocalizedString).buildPartial();
        }
        this.bitField0_ |= 8;
    }
    ...
    private void removeChildItems(int i11) {
        ensureChildItemsIsMutable();
    ...
    private void setChildItems(int i11, Common$ListItem common$ListItem) {
        common$ListItem.getClass();
        ensureChildItemsIsMutable();
    ...
    public A getChildItemsOrBuilder(int i11) {
        return this.childItems_.get(i11);
    }
    ...
    private void addChildItems(int i11, Common$ListItem common$ListItem) {
        common$ListItem.getClass();
        ensureChildItemsIsMutable();
