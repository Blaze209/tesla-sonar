...
public final class Common$AttributedLocalizedString extends GeneratedMessageLite<Common$AttributedLocalizedString, c> implements InterfaceC4378l {
    ...
    public static final class a {
        ...
        public static final MapEntryLite<String, Common$LocalAction> f47104a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Common$LocalAction.getDefaultInstance());
    }

    public static final class b {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        public static final MapEntryLite<String, Common$RenderedAssetAppearance> f47105a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Common$RenderedAssetAppearance.getDefaultInstance());
    }

    public static final class c extends GeneratedMessageLite.Builder<Common$AttributedLocalizedString, c> implements InterfaceC4378l {
        public c() {
    ...
    private void mergeLocalizedString(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
            ...
            this.localizedString_ = Common$LocalizedString.newBuilder(this.localizedString_).mergeFrom(common$LocalizedString).buildPartial();
        }
        this.bitField0_ |= 1;
    }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (C4376j.f47465a[methodToInvoke.ordinal()]) {
            ...
            case 2:
                return new c();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0002\u0000\u0000\u0001ဉ\u0000\u00022\u00032", new Object[]{"bitField0_", "localizedString_", "actions_", a.f47104a, "assets_", b.f47105a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
