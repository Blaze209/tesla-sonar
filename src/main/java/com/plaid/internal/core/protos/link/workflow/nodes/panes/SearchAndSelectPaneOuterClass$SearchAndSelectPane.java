    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ExitAction extends GeneratedMessageLite<ExitAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (s0.f47500a[methodToInvoke.ordinal()]) {
                    case 1:
        ...
        private void mergeTapEndOfResults(TapEndOfResultsAction tapEndOfResultsAction) {
            ...
            if (this.actionCase_ != 4 || this.action_ == TapEndOfResultsAction.getDefaultInstance()) {
                ...
                this.action_ = TapEndOfResultsAction.newBuilder((TapEndOfResultsAction) this.action_).mergeFrom(tapEndOfResultsAction).buildPartial();
            }
            this.actionCase_ = 4;
        }
        ...
        private void mergeTapFixedButton(TapFixedButtonAction tapFixedButtonAction) {
            ...
            if (this.actionCase_ != 6 || this.action_ == TapFixedButtonAction.getDefaultInstance()) {
                ...
                this.action_ = TapFixedButtonAction.newBuilder((TapFixedButtonAction) this.action_).mergeFrom(tapFixedButtonAction).buildPartial();
            }
            this.actionCase_ = 6;
        }
        ...
        private void mergeTapNoResults(TapNoResultsAction tapNoResultsAction) {
            ...
            if (this.actionCase_ != 2 || this.action_ == TapNoResultsAction.getDefaultInstance()) {
                ...
                this.action_ = TapNoResultsAction.newBuilder((TapNoResultsAction) this.action_).mergeFrom(tapNoResultsAction).buildPartial();
            }
            this.actionCase_ = 2;
        }
        ...
        private void mergeTapSelectUnsupportedInstitutionHandoffButton(TapSelectUnsupportedInstitutionHandoffButtonAction tapSelectUnsupportedInstitutionHandoffButtonAction) {
            ...
            if (this.actionCase_ != 5 || this.action_ == TapSelectUnsupportedInstitutionHandoffButtonAction.getDefaultInstance()) {
                ...
                this.action_ = TapSelectUnsupportedInstitutionHandoffButtonAction.newBuilder((TapSelectUnsupportedInstitutionHandoffButtonAction) this.action_).mergeFrom(tapSelectUnsupportedInstitutionHandoffButtonAction).buildPartial();
            }
            this.actionCase_ = 5;
        }
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final class Events extends GeneratedMessageLite<Events, a> implements MessageLiteOrBuilder {
            ...
            private void mergeOnSearch(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onSearch_ = Common$SDKEvent.newBuilder(this.onSearch_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 1;
            }
            ...
            private void mergeOnSubmit(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onSubmit_ = Common$SDKEvent.newBuilder(this.onSubmit_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 2;
            }
            ...
            private void mergeOnSubmitOverride(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onSubmitOverride_ = Common$SDKEvent.newBuilder(this.onSubmitOverride_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 8;
            }
            ...
            private void mergeOnTapEndOfResults(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapEndOfResults_ = Common$SDKEvent.newBuilder(this.onTapEndOfResults_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 16;
            }
            ...
            private void mergeOnTapFixedButton(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapFixedButton_ = Common$SDKEvent.newBuilder(this.onTapFixedButton_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 128;
            }
            ...
            private void mergeOnTapNoResults(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapNoResults_ = Common$SDKEvent.newBuilder(this.onTapNoResults_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 4;
            }
            ...
            private void mergeOnTapResultWithChildren(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapResultWithChildren_ = Common$SDKEvent.newBuilder(this.onTapResultWithChildren_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 32;
            }
            ...
            private void mergeOnTapSelectUnsupportedInstitutionHandoffButton(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapSelectUnsupportedInstitutionHandoffButton_ = Common$SDKEvent.newBuilder(this.onTapSelectUnsupportedInstitutionHandoffButton_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 64;
            }
        ...
        public static final class SearchAPI extends GeneratedMessageLite<SearchAPI, a> implements MessageLiteOrBuilder {
            ...
            public static final class b {
                ...
                /* JADX INFO: renamed from: a, reason: collision with root package name */
                public static final MapEntryLite<String, String> f47373a;

                static {
                    WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
                    f47373a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
                }
            }
            ...
            public static final class c {
                ...
                /* JADX INFO: renamed from: a, reason: collision with root package name */
                public static final MapEntryLite<String, String> f47374a;

                static {
                    WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
                    f47374a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
                }
            }
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (s0.f47500a[methodToInvoke.ordinal()]) {
                    ...
                    case 2:
                        return new a();
                    case 3:
                        return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0006\u0000\u0000\u0001\u0006\u0006\u0002\u0000\u0000\u0001Ȉ\u0002Ȉ\u0003Ȉ\u00042\u0005Ȉ\u00062", new Object[]{"urlPath_", "postBody_", "postBodyQueryReplacementToken_", "extraHeaders_", b.f47373a, "responseResultsJsonKey_", "responseResultItemKeyPathMapping_", c.f47374a});
                    case 4:
                        return DEFAULT_INSTANCE;
                    case 5:
        ...
        public enum b implements Internal.EnumLite {
            ...
            public static final a f47375b = new a();
            ...
            /* JADX INFO: renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.SearchAndSelectPaneOuterClass$SearchAndSelectPane$Rendering$b$b, reason: collision with other inner class name */
            public static final class C0753b implements Internal.EnumVerifier {

                /* JADX INFO: renamed from: a, reason: collision with root package name */
                public static final C0753b f47378a = new C0753b();
        ...
        private void mergeEndOfResultsButton(Common$ButtonContent common$ButtonContent) {
            ...
            if (common$ButtonContent2 == null || common$ButtonContent2 == Common$ButtonContent.getDefaultInstance()) {
                ...
                this.endOfResultsButton_ = Common$ButtonContent.newBuilder(this.endOfResultsButton_).mergeFrom(common$ButtonContent).buildPartial();
            }
            this.bitField0_ |= 32;
        }
        ...
        private void mergeEndOfResultsButtonText(Common$AttributedLocalizedString common$AttributedLocalizedString) {
            ...
            if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                ...
                this.endOfResultsButtonText_ = Common$AttributedLocalizedString.newBuilder(this.endOfResultsButtonText_).mergeFrom(common$AttributedLocalizedString).buildPartial();
            }
            this.bitField0_ |= 64;
        }
        ...
        private void mergeEndOfResultsTextButton(Common$ButtonContent common$ButtonContent) {
            ...
            if (common$ButtonContent2 == null || common$ButtonContent2 == Common$ButtonContent.getDefaultInstance()) {
                ...
                this.endOfResultsTextButton_ = Common$ButtonContent.newBuilder(this.endOfResultsTextButton_).mergeFrom(common$ButtonContent).buildPartial();
            }
            this.bitField0_ |= 256;
        }
        ...
        private void mergeFixedButton(Common$ButtonContent common$ButtonContent) {
            ...
            if (common$ButtonContent2 == null || common$ButtonContent2 == Common$ButtonContent.getDefaultInstance()) {
                ...
                this.fixedButton_ = Common$ButtonContent.newBuilder(this.fixedButton_).mergeFrom(common$ButtonContent).buildPartial();
            }
            this.bitField0_ |= 512;
        }
        ...
        private void mergeSearchApi(SearchAPI searchAPI) {
            ...
            if (searchAPI2 == null || searchAPI2 == SearchAPI.getDefaultInstance()) {
                ...
                this.searchApi_ = SearchAPI.newBuilder(this.searchApi_).mergeFrom(searchAPI).buildPartial();
            }
            this.bitField0_ |= 1;
        }
        ...
        private void mergeSearchInput(Common$SearchInput common$SearchInput) {
            ...
            if (common$SearchInput2 == null || common$SearchInput2 == Common$SearchInput.getDefaultInstance()) {
                ...
                this.searchInput_ = Common$SearchInput.newBuilder(this.searchInput_).mergeFrom(common$SearchInput).buildPartial();
            }
            this.bitField0_ |= 4;
        }
        ...
        private void mergeSearchNoResults(Common$LocalizedString common$LocalizedString) {
            ...
            if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
                ...
                this.searchNoResults_ = Common$LocalizedString.newBuilder(this.searchNoResults_).mergeFrom(common$LocalizedString).buildPartial();
            }
            this.bitField0_ |= 8;
        }
        ...
        private void mergeSearchNoResultsButton(Common$ButtonContent common$ButtonContent) {
            ...
            if (common$ButtonContent2 == null || common$ButtonContent2 == Common$ButtonContent.getDefaultInstance()) {
                ...
                this.searchNoResultsButton_ = Common$ButtonContent.newBuilder(this.searchNoResultsButton_).mergeFrom(common$ButtonContent).buildPartial();
            }
            this.bitField0_ |= 16;
        }
        ...
        private void removeIncrementalResults(int i11) {
            ensureIncrementalResultsIsMutable();
            this.incrementalResults_.remove(i11);
        }

        private void removeInitialItems(int i11) {
            ensureInitialItemsIsMutable();
        ...
        private void setIncrementalResults(int i11, SdkIncrementalResult$SDKIncrementalResult sdkIncrementalResult$SDKIncrementalResult) {
            sdkIncrementalResult$SDKIncrementalResult.getClass();
            ensureIncrementalResultsIsMutable();
            this.incrementalResults_.set(i11, sdkIncrementalResult$SDKIncrementalResult);
        }

        private void setInitialItems(int i11, Common$ListItem common$ListItem) {
            common$ListItem.getClass();
            ensureInitialItemsIsMutable();
        ...
        private void setListStyleValue(int i11) {
            this.listStyle_ = i11;
        }

        private void setOnSubmitOverrideItems(int i11, String str) {
            str.getClass();
            ensureOnSubmitOverrideItemsIsMutable();
        ...
        private void setPreviewModeValue(int i11) {
        ...
        private void setSearchBehavior(N n11) {
            this.searchBehavior_ = n11.getNumber();
        }

        private void setSearchBehaviorValue(int i11) {
        ...
        private void setShouldTrimInstitutionName(boolean z11) {
            this.shouldTrimInstitutionName_ = z11;
        }

        private void setShouldUseCondensedSearchUi(boolean z11) {
            this.shouldUseCondensedSearchUi_ = z11;
        }

        private void setShouldUseSearchLoadingSpinner(boolean z11) {
            this.shouldUseSearchLoadingSpinner_ = z11;
        }

        private void setShowBrandPaneSearchBar(boolean z11) {
            this.showBrandPaneSearchBar_ = z11;
        }
        ...
        public com.plaid.internal.core.protos.link.workflow.primitives.r getIncrementalResultsOrBuilder(int i11) {
            return this.incrementalResults_.get(i11);
        }
        ...
        public A getInitialItemsOrBuilder(int i11) {
            return this.initialItems_.get(i11);
        }
        ...
        public b getListStyle() {
            b bVarForNumber = b.forNumber(this.listStyle_);
        ...
        public c getPreviewMode() {
            c cVarForNumber = c.forNumber(this.previewMode_);
        ...
        public N getSearchBehavior() {
            N nForNumber = N.forNumber(this.searchBehavior_);
            return nForNumber == null ? N.UNRECOGNIZED : nForNumber;
        }
        ...
        private void addIncrementalResults(int i11, SdkIncrementalResult$SDKIncrementalResult sdkIncrementalResult$SDKIncrementalResult) {
            sdkIncrementalResult$SDKIncrementalResult.getClass();
            ensureIncrementalResultsIsMutable();
            this.incrementalResults_.add(i11, sdkIncrementalResult$SDKIncrementalResult);
        }

        private void addInitialItems(int i11, Common$ListItem common$ListItem) {
            common$ListItem.getClass();
            ensureInitialItemsIsMutable();
