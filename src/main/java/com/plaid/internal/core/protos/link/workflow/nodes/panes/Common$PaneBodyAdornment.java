...
public final class Common$PaneBodyAdornment extends GeneratedMessageLite<Common$PaneBodyAdornment, a> implements MessageLiteOrBuilder {
    ...
    public static final class OverlappingIcons extends GeneratedMessageLite<OverlappingIcons, a> implements MessageLiteOrBuilder {
        ...
        private void addIcons(int i11, Common$RenderedAssetAppearance common$RenderedAssetAppearance) {
            common$RenderedAssetAppearance.getClass();
            ensureIconsIsMutable();
            this.icons_.add(i11, common$RenderedAssetAppearance);
        }
        ...
        private void removeIcons(int i11) {
            ensureIconsIsMutable();
            this.icons_.remove(i11);
        }

        private void setIcons(int i11, Common$RenderedAssetAppearance common$RenderedAssetAppearance) {
            common$RenderedAssetAppearance.getClass();
            ensureIconsIsMutable();
            this.icons_.set(i11, common$RenderedAssetAppearance);
        }
        ...
        public Common$RenderedAssetAppearance getIcons(int i11) {
            return this.icons_.get(i11);
        }
        ...
        public K getIconsOrBuilder(int i11) {
            return this.icons_.get(i11);
        }
    ...
    private void mergeFirstLineContent(Common$TextContent common$TextContent) {
        ...
        if (common$TextContent2 != null && common$TextContent2 != Common$TextContent.getDefaultInstance()) {
            common$TextContent = Common$TextContent.newBuilder(this.firstLineContent_).mergeFrom(common$TextContent).buildPartial();
        }
    ...
    private void mergeOverlappingIcons(OverlappingIcons overlappingIcons) {
        ...
        if (overlappingIcons2 != null && overlappingIcons2 != OverlappingIcons.getDefaultInstance()) {
            overlappingIcons = OverlappingIcons.newBuilder(this.overlappingIcons_).mergeFrom(overlappingIcons).buildPartial();
        }
    ...
    private void mergeSecondLineContent(Common$TextContent common$TextContent) {
        ...
        if (common$TextContent2 != null && common$TextContent2 != Common$TextContent.getDefaultInstance()) {
            common$TextContent = Common$TextContent.newBuilder(this.secondLineContent_).mergeFrom(common$TextContent).buildPartial();
        }
