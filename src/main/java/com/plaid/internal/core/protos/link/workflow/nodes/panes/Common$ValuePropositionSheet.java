...
public final class Common$ValuePropositionSheet extends GeneratedMessageLite<Common$ValuePropositionSheet, a> implements MessageLiteOrBuilder {
    ...
    public static final class ValueProposition extends GeneratedMessageLite<ValueProposition, a> implements b {
        ...
        private void mergeText(Common$TwoToneText common$TwoToneText) {
            ...
            if (common$TwoToneText2 != null && common$TwoToneText2 != Common$TwoToneText.getDefaultInstance()) {
                common$TwoToneText = Common$TwoToneText.newBuilder(this.text_).mergeFrom(common$TwoToneText).buildPartial();
            }
    ...
    private void addValuePropositions(int i11, ValueProposition valueProposition) {
        valueProposition.getClass();
        ensureValuePropositionsIsMutable();
        this.valuePropositions_.add(i11, valueProposition);
    }
    ...
    private void mergeBody(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.body_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void mergeSubtitle(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.subtitle_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void removeValuePropositions(int i11) {
        ensureValuePropositionsIsMutable();
        this.valuePropositions_.remove(i11);
    }
    ...
    private void setValuePropositions(int i11, ValueProposition valueProposition) {
        valueProposition.getClass();
        ensureValuePropositionsIsMutable();
        this.valuePropositions_.set(i11, valueProposition);
    }
    ...
    public ValueProposition getValuePropositions(int i11) {
    ...
    public b getValuePropositionsOrBuilder(int i11) {
        return this.valuePropositions_.get(i11);
    }
