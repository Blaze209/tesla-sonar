...
public final class Common$PhoneInput extends GeneratedMessageLite<Common$PhoneInput, a> implements MessageLiteOrBuilder {
    ...
    public static final class Country extends GeneratedMessageLite<Country, a> implements b {
        ...
        private void mergeCallingCode(Common$LocalizedString common$LocalizedString) {
            ...
            if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
                common$LocalizedString = Common$LocalizedString.newBuilder(this.callingCode_).mergeFrom(common$LocalizedString).buildPartial();
            }
        ...
        private void mergeName(Common$LocalizedString common$LocalizedString) {
            ...
            if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
                common$LocalizedString = Common$LocalizedString.newBuilder(this.name_).mergeFrom(common$LocalizedString).buildPartial();
            }
    ...
    private void addCountryCodes(int i11, Country country) {
        country.getClass();
        ensureCountryCodesIsMutable();
        this.countryCodes_.add(i11, country);
    }
    ...
    private void mergeCallingCodeLabel(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.callingCodeLabel_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void mergePhoneNumberLabel(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.phoneNumberLabel_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void mergePrefillOptions(Common$TextInput.PrefillOptions prefillOptions) {
        ...
        if (prefillOptions2 != null && prefillOptions2 != Common$TextInput.PrefillOptions.getDefaultInstance()) {
            prefillOptions = Common$TextInput.PrefillOptions.newBuilder(this.prefillOptions_).mergeFrom(prefillOptions).buildPartial();
        }
    ...
    private void mergePrefilledCountry(Country country) {
        ...
        if (country2 != null && country2 != Country.getDefaultInstance()) {
            country = Country.newBuilder(this.prefilledCountry_).mergeFrom(country).buildPartial();
        }
    ...
    private void mergePrefilledText(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.prefilledText_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void removeCountryCodes(int i11) {
        ensureCountryCodesIsMutable();
        this.countryCodes_.remove(i11);
    }
    ...
    private void setCountryCodes(int i11, Country country) {
        country.getClass();
        ensureCountryCodesIsMutable();
        this.countryCodes_.set(i11, country);
    }
    ...
    private void setShouldHideCallingCodeFlag(boolean z11) {
        this.shouldHideCallingCodeFlag_ = z11;
    }
    ...
    public Country getCountryCodes(int i11) {
    ...
    public b getCountryCodesOrBuilder(int i11) {
        return this.countryCodes_.get(i11);
    }
