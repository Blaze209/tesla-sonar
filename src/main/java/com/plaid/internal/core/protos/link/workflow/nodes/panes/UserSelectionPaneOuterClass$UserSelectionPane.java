    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ExitAction extends GeneratedMessageLite<ExitAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (x0.f47521a[methodToInvoke.ordinal()]) {
                    case 1:
        ...
        public static final class SubmitAction extends GeneratedMessageLite<SubmitAction, a> implements MessageLiteOrBuilder {
            ...
            public static final class Response extends GeneratedMessageLite<Response, a> implements b {
                ...
                private void setResponseIds(int i11, String str) {
                    str.getClass();
                    ensureResponseIdsIsMutable();
        ...
        private void mergeTapEndOfSelectionList(TapEndOfSelectionListAction tapEndOfSelectionListAction) {
            ...
            if (this.actionCase_ != 4 || this.action_ == TapEndOfSelectionListAction.getDefaultInstance()) {
                ...
                this.action_ = TapEndOfSelectionListAction.newBuilder((TapEndOfSelectionListAction) this.action_).mergeFrom(tapEndOfSelectionListAction).buildPartial();
            }
            this.actionCase_ = 4;
        }
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final class Events extends GeneratedMessageLite<Events, a> implements MessageLiteOrBuilder {
            ...
            private void mergeOnSubmitTap(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onSubmitTap_ = Common$SDKEvent.newBuilder(this.onSubmitTap_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 1;
            }
            ...
            private void mergeOnTapEndOfSelectionList(Common$SDKEvent common$SDKEvent) {
                ...
                if (common$SDKEvent2 == null || common$SDKEvent2 == Common$SDKEvent.getDefaultInstance()) {
                    ...
                    this.onTapEndOfSelectionList_ = Common$SDKEvent.newBuilder(this.onTapEndOfSelectionList_).mergeFrom(common$SDKEvent).buildPartial();
                }
                this.bitField0_ |= 4;
            }
        ...
        public static final class Selection extends GeneratedMessageLite<Selection, a> implements b {
            ...
            public enum b implements Internal.EnumLite {
                ...
                public static final a f47401b = new a();
                ...
                /* JADX INFO: renamed from: com.plaid.internal.core.protos.link.workflow.nodes.panes.UserSelectionPaneOuterClass$UserSelectionPane$Rendering$Selection$b$b, reason: collision with other inner class name */
                public static final class C0754b implements Internal.EnumVerifier {

                    /* JADX INFO: renamed from: a, reason: collision with root package name */
                    public static final C0754b f47404a = new C0754b();
            ...
            private void mergeAttributedPrompt(Common$AttributedLocalizedString common$AttributedLocalizedString) {
                ...
                if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                    ...
                    this.attributedPrompt_ = Common$AttributedLocalizedString.newBuilder(this.attributedPrompt_).mergeFrom(common$AttributedLocalizedString).buildPartial();
                }
                this.bitField0_ |= 2;
            }
            ...
            private void mergePrompt(Common$LocalizedString common$LocalizedString) {
                ...
                if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
                    ...
                    this.prompt_ = Common$LocalizedString.newBuilder(this.prompt_).mergeFrom(common$LocalizedString).buildPartial();
                }
                this.bitField0_ |= 1;
            }
            ...
            private void setResponseRenderingModeValue(int i11) {
                this.responseRenderingMode_ = i11;
            }

            private void setResponses(int i11, Common$SelectionListItem common$SelectionListItem) {
                common$SelectionListItem.getClass();
                ensureResponsesIsMutable();
            ...
            public b getResponseRenderingMode() {
                b bVarForNumber = b.forNumber(this.responseRenderingMode_);
            ...
            public P getResponsesOrBuilder(int i11) {
                return this.responses_.get(i11);
            }
            ...
            private void addResponses(int i11, Common$SelectionListItem common$SelectionListItem) {
                common$SelectionListItem.getClass();
                ensureResponsesIsMutable();
        ...
        public static final class SelectionTileStyleOverride extends GeneratedMessageLite<SelectionTileStyleOverride, a> implements MessageLiteOrBuilder {
            ...
            private void setTileStyleOverrideValue(int i11) {
                this.tileStyleOverride_ = i11;
            }
            ...
            public c getTileStyleOverride() {
                c cVarForNumber = c.forNumber(this.tileStyleOverride_);
        ...
        private void mergeDisclaimer(Common$Disclaimer common$Disclaimer) {
            ...
            if (common$Disclaimer2 == null || common$Disclaimer2 == Common$Disclaimer.getDefaultInstance()) {
                ...
                this.disclaimer_ = Common$Disclaimer.newBuilder(this.disclaimer_).mergeFrom(common$Disclaimer).buildPartial();
            }
        ...
        private void mergeEndOfSelectionListButton(Common$ButtonContent common$ButtonContent) {
            ...
            if (common$ButtonContent2 == null || common$ButtonContent2 == Common$ButtonContent.getDefaultInstance()) {
                ...
                this.endOfSelectionListButton_ = Common$ButtonContent.newBuilder(this.endOfSelectionListButton_).mergeFrom(common$ButtonContent).buildPartial();
            }
            this.bitField0_ |= 256;
        }
        ...
        private void mergeSelectAllToggle(SelectAllToggle selectAllToggle) {
            ...
            if (selectAllToggle2 == null || selectAllToggle2 == SelectAllToggle.getDefaultInstance()) {
                ...
                this.selectAllToggle_ = SelectAllToggle.newBuilder(this.selectAllToggle_).mergeFrom(selectAllToggle).buildPartial();
            }
            this.bitField0_ |= 16;
        }
        ...
        private void mergeSelectionTileStyleOverride(SelectionTileStyleOverride selectionTileStyleOverride) {
            ...
            if (selectionTileStyleOverride2 == null || selectionTileStyleOverride2 == SelectionTileStyleOverride.getDefaultInstance()) {
                ...
                this.selectionTileStyleOverride_ = SelectionTileStyleOverride.newBuilder(this.selectionTileStyleOverride_).mergeFrom(selectionTileStyleOverride).buildPartial();
            }
            this.bitField0_ |= 512;
        }
        ...
        private void mergeUnselectConfirmationModal(Common$Modal common$Modal) {
            ...
            if (common$Modal2 == null || common$Modal2 == Common$Modal.getDefaultInstance()) {
                ...
                this.unselectConfirmationModal_ = Common$Modal.newBuilder(this.unselectConfirmationModal_).mergeFrom(common$Modal).buildPartial();
            }
        ...
        private void removeEndOfSelectionFlexibleComponents(int i11) {
            ensureEndOfSelectionFlexibleComponentsIsMutable();
            this.endOfSelectionFlexibleComponents_.remove(i11);
        }

        private void removeSelections(int i11) {
            ensureSelectionsIsMutable();
        ...
        private void setEndOfSelectionFlexibleComponents(int i11, Common$FlexibleComponent common$FlexibleComponent) {
            common$FlexibleComponent.getClass();
            ensureEndOfSelectionFlexibleComponentsIsMutable();
            this.endOfSelectionFlexibleComponents_.set(i11, common$FlexibleComponent);
        }
        ...
        private void setSelections(int i11, Selection selection) {
            selection.getClass();
            ensureSelectionsIsMutable();
        ...
        public Common$FlexibleComponent getEndOfSelectionFlexibleComponents(int i11) {
            return this.endOfSelectionFlexibleComponents_.get(i11);
        }
        ...
        public InterfaceC4388w getEndOfSelectionFlexibleComponentsOrBuilder(int i11) {
            return this.endOfSelectionFlexibleComponents_.get(i11);
        }

        public List<? extends InterfaceC4388w> getEndOfSelectionFlexibleComponentsOrBuilderList() {
            return this.endOfSelectionFlexibleComponents_;
        }
        ...
        private void addEndOfSelectionFlexibleComponents(int i11, Common$FlexibleComponent common$FlexibleComponent) {
            common$FlexibleComponent.getClass();
            ensureEndOfSelectionFlexibleComponentsIsMutable();
            this.endOfSelectionFlexibleComponents_.add(i11, common$FlexibleComponent);
        }

        private void addSelections(int i11, Selection selection) {
            selection.getClass();
            ensureSelectionsIsMutable();
    ...
    public static final class SelectAllToggle extends GeneratedMessageLite<SelectAllToggle, a> implements MessageLiteOrBuilder {
        ...
        private void mergeSubtitle(SelectAllToggleSubtitle selectAllToggleSubtitle) {
            ...
            if (selectAllToggleSubtitle2 == null || selectAllToggleSubtitle2 == SelectAllToggleSubtitle.getDefaultInstance()) {
                ...
                this.subtitle_ = SelectAllToggleSubtitle.newBuilder(this.subtitle_).mergeFrom(selectAllToggleSubtitle).buildPartial();
            }
            this.bitField0_ |= 2;
        }
        ...
        private void mergeTitle(Common$AttributedLocalizedString common$AttributedLocalizedString) {
            ...
            if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                ...
                this.title_ = Common$AttributedLocalizedString.newBuilder(this.title_).mergeFrom(common$AttributedLocalizedString).buildPartial();
            }
            this.bitField0_ |= 1;
        }
        ...
        private void setPreselected(boolean z11) {
    ...
    public static final class SelectAllToggleSubtitle extends GeneratedMessageLite<SelectAllToggleSubtitle, a> implements MessageLiteOrBuilder {
        ...
        private void mergeContentMultipleSelected(Common$AttributedLocalizedString common$AttributedLocalizedString) {
            ...
            if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                ...
                this.contentMultipleSelected_ = Common$AttributedLocalizedString.newBuilder(this.contentMultipleSelected_).mergeFrom(common$AttributedLocalizedString).buildPartial();
            }
            this.bitField0_ |= 4;
        }
        ...
        private void mergeContentOneSelected(Common$AttributedLocalizedString common$AttributedLocalizedString) {
            ...
            if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                ...
                this.contentOneSelected_ = Common$AttributedLocalizedString.newBuilder(this.contentOneSelected_).mergeFrom(common$AttributedLocalizedString).buildPartial();
            }
            this.bitField0_ |= 2;
        }
        ...
        private void mergeContentZeroSelected(Common$AttributedLocalizedString common$AttributedLocalizedString) {
            ...
            if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
                ...
                this.contentZeroSelected_ = Common$AttributedLocalizedString.newBuilder(this.contentZeroSelected_).mergeFrom(common$AttributedLocalizedString).buildPartial();
            }
            this.bitField0_ |= 1;
        }
