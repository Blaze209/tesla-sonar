...
public final class Common$TwoToneText extends GeneratedMessageLite<Common$TwoToneText, b> implements MessageLiteOrBuilder {
    ...
    public static final class a {
        ...
        public static final MapEntryLite<String, Common$RenderedAssetAppearance> f47234a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.MESSAGE, Common$RenderedAssetAppearance.getDefaultInstance());
    }
    ...
    private void mergeLeading(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.leading_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        switch (C4376j.f47465a[methodToInvoke.ordinal()]) {
            ...
            case 2:
                return new b();
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0000\u0003\u0000\u0001\u0001\u0003\u0003\u0001\u0000\u0000\u0001ဉ\u0000\u0002ဉ\u0001\u00032", new Object[]{"bitField0_", "leading_", "content_", "assets_", a.f47234a});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
