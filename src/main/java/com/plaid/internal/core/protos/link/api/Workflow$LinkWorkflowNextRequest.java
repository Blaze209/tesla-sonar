...
public final class Workflow$LinkWorkflowNextRequest extends GeneratedMessageLite<Workflow$LinkWorkflowNextRequest, a> implements MessageLiteOrBuilder {
    ...
    private void removePaneMetaOutputs(int i11) {
        ensurePaneMetaOutputsIsMutable();
        this.paneMetaOutputs_.remove(i11);
    }

    private void removePaneOutputs(int i11) {
        ensurePaneOutputsIsMutable();
    ...
    private void setPaneMetaOutputs(int i11, PaneMetaOutput paneMetaOutput) {
        paneMetaOutput.getClass();
        ensurePaneMetaOutputsIsMutable();
        this.paneMetaOutputs_.set(i11, paneMetaOutput);
    }

    private void setPaneOutputs(int i11, Pane$PaneOutput pane$PaneOutput) {
        pane$PaneOutput.getClass();
        ensurePaneOutputsIsMutable();
    ...
    public PaneMetaOutput getPaneMetaOutputs(int i11) {
        return this.paneMetaOutputs_.get(i11);
    }
    ...
    public b getPaneMetaOutputsOrBuilder(int i11) {
        return this.paneMetaOutputs_.get(i11);
    }
    ...
    public o0 getPaneOutputsOrBuilder(int i11) {
        return this.paneOutputs_.get(i11);
    }
    ...
    private void addPaneMetaOutputs(int i11, PaneMetaOutput paneMetaOutput) {
        paneMetaOutput.getClass();
        ensurePaneMetaOutputsIsMutable();
        this.paneMetaOutputs_.add(i11, paneMetaOutput);
    }

    private void addPaneOutputs(int i11, Pane$PaneOutput pane$PaneOutput) {
        pane$PaneOutput.getClass();
        ensurePaneOutputsIsMutable();
