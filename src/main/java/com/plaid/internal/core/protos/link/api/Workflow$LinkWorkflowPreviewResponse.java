...
public final class Workflow$LinkWorkflowPreviewResponse extends GeneratedMessageLite<Workflow$LinkWorkflowPreviewResponse, a> implements MessageLiteOrBuilder {
    ...
    public static final class RenderedPreset extends GeneratedMessageLite<RenderedPreset, a> implements b {
        ...
        private void mergePane(Pane$PaneRendering pane$PaneRendering) {
            ...
            if (pane$PaneRendering2 == null || pane$PaneRendering2 == Pane$PaneRendering.getDefaultInstance()) {
                ...
                this.pane_ = Pane$PaneRendering.newBuilder(this.pane_).mergeFrom(pane$PaneRendering).buildPartial();
            }
            this.bitField0_ |= 1;
        }
        ...
        private void mergeRenderingOptions(PreviewOuterClass$Preview.RenderingOptions renderingOptions) {
            ...
            if (renderingOptions2 == null || renderingOptions2 == PreviewOuterClass$Preview.RenderingOptions.getDefaultInstance()) {
                ...
                this.renderingOptions_ = PreviewOuterClass$Preview.RenderingOptions.newBuilder(this.renderingOptions_).mergeFrom(renderingOptions).buildPartial();
            }
            this.bitField0_ |= 2;
        }
    ...
    private void removeRenderedPresets(int i11) {
        ensureRenderedPresetsIsMutable();
        this.renderedPresets_.remove(i11);
    }

    private void setRenderedPresets(int i11, RenderedPreset renderedPreset) {
        renderedPreset.getClass();
        ensureRenderedPresetsIsMutable();
    ...
    private void addRenderedPresets(int i11, RenderedPreset renderedPreset) {
        renderedPreset.getClass();
        ensureRenderedPresetsIsMutable();
