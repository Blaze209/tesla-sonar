...
public final class Common$OAuthGuidance extends GeneratedMessageLite<Common$OAuthGuidance, a> implements MessageLiteOrBuilder {
    ...
    private void addGuidanceChecklistItems(int i11, Common$AttributedLocalizedString common$AttributedLocalizedString) {
        common$AttributedLocalizedString.getClass();
        ensureGuidanceChecklistItemsIsMutable();
        this.guidanceChecklistItems_.add(i11, common$AttributedLocalizedString);
    }
    ...
    private void removeGuidanceChecklistItems(int i11) {
        ensureGuidanceChecklistItemsIsMutable();
        this.guidanceChecklistItems_.remove(i11);
    }
    ...
    private void setGuidanceChecklistItems(int i11, Common$AttributedLocalizedString common$AttributedLocalizedString) {
        common$AttributedLocalizedString.getClass();
        ensureGuidanceChecklistItemsIsMutable();
        this.guidanceChecklistItems_.set(i11, common$AttributedLocalizedString);
    }
    ...
    public Common$AttributedLocalizedString getGuidanceChecklistItems(int i11) {
        return this.guidanceChecklistItems_.get(i11);
    }
    ...
    public InterfaceC4378l getGuidanceChecklistItemsOrBuilder(int i11) {
        return this.guidanceChecklistItems_.get(i11);
    }

    public List<? extends InterfaceC4378l> getGuidanceChecklistItemsOrBuilderList() {
        return this.guidanceChecklistItems_;
    }
