...
public final class PreviewOuterClass$Preview extends GeneratedMessageLite<PreviewOuterClass$Preview, a> implements MessageLiteOrBuilder {
    ...
    public static final class CobrandingConfig extends GeneratedMessageLite<CobrandingConfig, a> implements MessageLiteOrBuilder {
        ...
        public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
            ...
            switch (p.f47594a[methodToInvoke.ordinal()]) {
                case 1:
    ...
    public static final class RenderingOptions extends GeneratedMessageLite<RenderingOptions, a> implements MessageLiteOrBuilder {
        ...
        private void setExecuteActionIds(int i11, String str) {
            str.getClass();
            ensureExecuteActionIdsIsMutable();
            this.executeActionIds_.set(i11, str);
        }

        private void setPaneDisabled(boolean z11) {
            this.paneDisabled_ = z11;
        }

        private void setShowTransition(boolean z11) {
        ...
        public String getExecuteActionIds(int i11) {
            return this.executeActionIds_.get(i11);
        }

        public ByteString getExecuteActionIdsBytes(int i11) {
            return ByteString.copyFromUtf8(this.executeActionIds_.get(i11));
        }
    ...
    public enum b implements Internal.EnumLite {
        ...
        /* JADX INFO: renamed from: com.plaid.internal.core.protos.link.workflow.primitives.PreviewOuterClass$Preview$b$b, reason: collision with other inner class name */
        public static final class C0755b implements Internal.EnumVerifier {

            /* JADX INFO: renamed from: a, reason: collision with root package name */
            public static final C0755b f47538a = new C0755b();
    ...
    public enum c implements Internal.EnumLite {
        ...
        /* JADX INFO: renamed from: b, reason: collision with root package name */
        public static final a f47539b = new a();
    ...
    private void mergeCobrandingConfig(CobrandingConfig cobrandingConfig) {
        ...
        if (cobrandingConfig2 == null || cobrandingConfig2 == CobrandingConfig.getDefaultInstance()) {
            ...
            this.cobrandingConfig_ = CobrandingConfig.newBuilder(this.cobrandingConfig_).mergeFrom(cobrandingConfig).buildPartial();
        }
        this.bitField0_ |= 8;
    }
    ...
    private void mergeLinkCustomization(LinkCustomizations$LinkCustomization linkCustomizations$LinkCustomization) {
        ...
        if (linkCustomizations$LinkCustomization2 == null || linkCustomizations$LinkCustomization2 == LinkCustomizations$LinkCustomization.getDefaultInstance()) {
            ...
            this.linkCustomization_ = LinkCustomizations$LinkCustomization.newBuilder(this.linkCustomization_).mergeFrom(linkCustomizations$LinkCustomization).buildPartial();
        }
        this.bitField0_ |= 2;
    }
    ...
    private void mergeLocale(LocaleOuterClass$Locale localeOuterClass$Locale) {
        ...
        if (localeOuterClass$Locale2 == null || localeOuterClass$Locale2 == LocaleOuterClass$Locale.getDefaultInstance()) {
            ...
            this.locale_ = LocaleOuterClass$Locale.newBuilder(this.locale_).mergeFrom(localeOuterClass$Locale).buildPartial();
        }
        this.bitField0_ |= 1;
    }
    ...
    private void setPresetValue(int i11) {
        this.preset_ = i11;
    }

    private void setProducts(int i11, String str) {
        str.getClass();
        ensureProductsIsMutable();
    ...
    private void setScenarioValue(int i11) {
        this.scenario_ = i11;
    }
    ...
    public b getPreset() {
        b bVarForNumber = b.forNumber(this.preset_);
    ...
    public c getScenario() {
        c cVarForNumber = c.forNumber(this.scenario_);
