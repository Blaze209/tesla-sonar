...
public final class Pane$AutomaticActions extends GeneratedMessageLite<Pane$AutomaticActions, a> implements MessageLiteOrBuilder {
    ...
    private void setOnAppear(int i11, Common$LocalAction common$LocalAction) {
        common$LocalAction.getClass();
        ensureOnAppearIsMutable();
        this.onAppear_.set(i11, common$LocalAction);
    }
    ...
    public Common$LocalAction getOnAppear(int i11) {
    ...
    private void addOnAppear(int i11, Common$LocalAction common$LocalAction) {
        common$LocalAction.getClass();
        ensureOnAppearIsMutable();
        this.onAppear_.add(i11, common$LocalAction);
    }
