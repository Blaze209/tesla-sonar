...
public final class Common$Banner extends GeneratedMessageLite<Common$Banner, a> implements MessageLiteOrBuilder {
    ...
    private void mergeButtonAction(Common$LocalAction common$LocalAction) {
        ...
        if (common$LocalAction2 != null && common$LocalAction2 != Common$LocalAction.getDefaultInstance()) {
            common$LocalAction = Common$LocalAction.newBuilder(this.buttonAction_).mergeFrom(common$LocalAction).buildPartial();
        }
    ...
    private void mergeContent(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.content_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void mergeTitle(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 != null && common$LocalizedString2 != Common$LocalizedString.getDefaultInstance()) {
            common$LocalizedString = Common$LocalizedString.newBuilder(this.title_).mergeFrom(common$LocalizedString).buildPartial();
        }
    ...
    private void setAppearance(EnumC4380n enumC4380n) {
        this.appearance_ = enumC4380n.getNumber();
    }
    ...
    private void setType(EnumC4381o enumC4381o) {
        this.type_ = enumC4381o.getNumber();
    }
    ...
    public EnumC4380n getAppearance() {
        EnumC4380n enumC4380nForNumber = EnumC4380n.forNumber(this.appearance_);
        return enumC4380nForNumber == null ? EnumC4380n.UNRECOGNIZED : enumC4380nForNumber;
    }
    ...
    public EnumC4381o getType() {
        EnumC4381o enumC4381oForNumber = EnumC4381o.forNumber(this.type_);
        return enumC4381oForNumber == null ? EnumC4381o.UNRECOGNIZED : enumC4381oForNumber;
    }
