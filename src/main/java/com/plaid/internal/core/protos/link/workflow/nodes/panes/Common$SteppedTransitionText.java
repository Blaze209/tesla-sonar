...
public final class Common$SteppedTransitionText extends GeneratedMessageLite<Common$SteppedTransitionText, a> implements MessageLiteOrBuilder {
    ...
    private void addTextSteps(int i11, TextStep textStep) {
        textStep.getClass();
        ensureTextStepsIsMutable();
        this.textSteps_.add(i11, textStep);
    }
    ...
    private void removeTextSteps(int i11) {
        ensureTextStepsIsMutable();
        this.textSteps_.remove(i11);
    }

    private void setTextSteps(int i11, TextStep textStep) {
        textStep.getClass();
        ensureTextStepsIsMutable();
        this.textSteps_.set(i11, textStep);
    }
    ...
    public TextStep getTextSteps(int i11) {
        return this.textSteps_.get(i11);
    }
    ...
    public b getTextStepsOrBuilder(int i11) {
        return this.textSteps_.get(i11);
    }
