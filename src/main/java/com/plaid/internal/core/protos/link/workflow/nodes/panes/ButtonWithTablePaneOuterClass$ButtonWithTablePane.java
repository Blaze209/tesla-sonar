    ...
    public static final class Actions extends GeneratedMessageLite<Actions, b> implements MessageLiteOrBuilder {
        ...
        public static final class ButtonTapAction extends GeneratedMessageLite<ButtonTapAction, a> implements MessageLiteOrBuilder {
            ...
            public final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
                ...
                switch (C4372f.f47457a[methodToInvoke.ordinal()]) {
                    case 1:
    ...
    public static final class Rendering extends GeneratedMessageLite<Rendering, a> implements MessageLiteOrBuilder {
        ...
        public static final class TableRow extends GeneratedMessageLite<TableRow, a> implements b {
            ...
            private void mergeValue(Common$LocalizedString common$LocalizedString) {
                ...
                if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
                    ...
                    this.value_ = Common$LocalizedString.newBuilder(this.value_).mergeFrom(common$LocalizedString).buildPartial();
                }
                this.bitField0_ |= 2;
            }
            ...
            private void setStyle(S s11) {
                this.style_ = s11.getNumber();
            }

            private void setStyleValue(int i11) {
                this.style_ = i11;
            }
            ...
            public S getStyle() {
                S sForNumber = S.forNumber(this.style_);
                return sForNumber == null ? S.UNRECOGNIZED : sForNumber;
            }
        ...
        private void mergeTableTitle(Common$LocalizedString common$LocalizedString) {
            ...
            if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
                ...
                this.tableTitle_ = Common$LocalizedString.newBuilder(this.tableTitle_).mergeFrom(common$LocalizedString).buildPartial();
            }
            this.bitField0_ |= 64;
        }
        ...
        private void removeTableRows(int i11) {
            ensureTableRowsIsMutable();
        ...
        private void setTableRows(int i11, TableRow tableRow) {
            tableRow.getClass();
            ensureTableRowsIsMutable();
        ...
        private void addTableRows(int i11, TableRow tableRow) {
            tableRow.getClass();
            ensureTableRowsIsMutable();
