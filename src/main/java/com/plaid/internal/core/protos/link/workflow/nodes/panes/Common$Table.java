...
public final class Common$Table extends GeneratedMessageLite<Common$Table, a> implements MessageLiteOrBuilder {
    ...
    private void addTableRows(int i11, Common$TableRow common$TableRow) {
        common$TableRow.getClass();
        ensureTableRowsIsMutable();
        this.tableRows_.add(i11, common$TableRow);
    }
    ...
    private void setTableRows(int i11, Common$TableRow common$TableRow) {
        common$TableRow.getClass();
        ensureTableRowsIsMutable();
        this.tableRows_.set(i11, common$TableRow);
    }
    ...
    public Common$TableRow getTableRows(int i11) {
    ...
    public Q getTableRowsOrBuilder(int i11) {
        return this.tableRows_.get(i11);
    }
