...
public final class Common$Prompt extends GeneratedMessageLite<Common$Prompt, a> implements J {
    ...
    private void mergeErrorMessage(Common$LocalizedString common$LocalizedString) {
        ...
        if (common$LocalizedString2 == null || common$LocalizedString2 == Common$LocalizedString.getDefaultInstance()) {
            ...
            this.errorMessage_ = Common$LocalizedString.newBuilder(this.errorMessage_).mergeFrom(common$LocalizedString).buildPartial();
        }
        this.bitField0_ |= 128;
    }
    ...
    private void mergeNoteText(Common$AttributedLocalizedString common$AttributedLocalizedString) {
        ...
        if (common$AttributedLocalizedString2 == null || common$AttributedLocalizedString2 == Common$AttributedLocalizedString.getDefaultInstance()) {
            ...
            this.noteText_ = Common$AttributedLocalizedString.newBuilder(this.noteText_).mergeFrom(common$AttributedLocalizedString).buildPartial();
        }
        this.bitField0_ |= 32;
    }
