...
public final class InvalidRequestException extends StripeException {
    ...
    public /* synthetic */ InvalidRequestException(StripeError stripeError, String str, int i11, String str2, Throwable th2, int i12, DefaultConstructorMarker defaultConstructorMarker) {
