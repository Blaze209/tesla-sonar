...
@Metadata(d1 = {"\u0000\"\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\u0010\u000e\n\u0000\u0018\u00002\u00020\u0001B\u0007¢\u0006\u0004\b\u0002\u0010\u0003J&\u0010\u0004\u001a\u00060\u0005j\u0002`\u00062\n\u0010\u0007\u001a\u00060\u0005j\u0002`\u00062\f\u0010\b\u001a\b\u0012\u0004\u0012\u00020\n0\tH\u0016¨\u0006\u000b"}, d2 = {"Lcom/fourthline/adapters/CommonExceptionMapper;", "Lcom/fourthline/adapters/common/ExceptionMapper;", "<init>", "()V", "mapException", "Ljava/lang/Exception;", "Lkotlin/Exception;", "exception", "paths", "", "", "fourthline-adapters-json_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
public final class CommonExceptionMapper implements ExceptionMapper {
    ...
    public Exception mapException(Exception exception, List<String> paths) {
        ...
        if (!(exception instanceof JSONException)) {
            if (!(exception instanceof SerializationException)) {
                return CommonJsonError.IncorrectConfiguration.INSTANCE;
            }
        ...
        try {
            ...
            return new CommonJsonError.DecodingError(JSONExtensionsKt.getAndroidOptString(new JSONObject(message2), "errorDescription") + " at path 'configuration.kycInfo'.");
