...
public final class Hy implements Dy {
    ...
    public boolean a(G5 g11, MA taxationCountry, DocumentType documentType) {
        ...
        if (p013kotlin.jvm.internal.s.f(g11 != null ? g11.c() : null, taxationCountry.d())) {
            return documentType == DocumentType.PASSPORT || documentType == DocumentType.ID_CARD || documentType == DocumentType.RESIDENCE_PERMIT || documentType == DocumentType.DRIVERS_LICENSE;
        }
        return false;
    }
}
