...
/* JADX INFO: renamed from: com.fourthline.vision.internal.y2, reason: case insensitive filesystem */
/* JADX INFO: loaded from: classes4.dex */
public final class C4322y2 implements Q2 {

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private InterfaceC4227k4 f39114a;

    public C4322y2(InterfaceC4227k4 dataSource) {
        p013kotlin.jvm.internal.s.k(dataSource, "dataSource");
        this.f39114a = dataSource;
    }
    ...
    public Object process(List<? extends AbstractC4273r2> list, Continuation<? super List<? extends SelfieScannerWarning>> continuation) {
        final C4165c4 c4165c4ContentDetectionArea = this.f39114a.contentDetectionArea();
        return ho0.l.c0(ho0.l.U(ho0.l.a0(ho0.l.U(ho0.l.U(ho0.l.U(p013kotlin.collections.v.e0(list), new wn0.l() { // from class: com.fourthline.vision.internal.yb
            @Override // wn0.l
            public final Object invoke(Object obj) {
                return C4322y2.process$lambda$0((AbstractC4273r2) obj);
            }
        }), new wn0.l() { // from class: com.fourthline.vision.internal.zb
            @Override // wn0.l
            public final Object invoke(Object obj) {
                return C4322y2.process$lambda$1(c4165c4ContentDetectionArea, (C4165c4) obj);
            }
        }), new wn0.l() { // from class: com.fourthline.vision.internal.ac
            @Override // wn0.l
            public final Object invoke(Object obj) {
                return Float.valueOf(C4322y2.process$lambda$2((Pair) obj));
            }
        }), new wn0.l() { // from class: com.fourthline.vision.internal.bc
            @Override // wn0.l
            public final Object invoke(Object obj) {
                return Boolean.valueOf(C4322y2.process$lambda$3(((Float) obj).floatValue()));
            }
        }), new wn0.l() { // from class: com.fourthline.vision.internal.cc
            @Override // wn0.l
            public final Object invoke(Object obj) {
                return C4322y2.process$lambda$4(((Float) obj).floatValue());
            }
        }));
    }
}
