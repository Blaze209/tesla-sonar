...
public final /* data */ class InputCurrencyComponent implements n5, y4<InputCurrencyComponent>, v, e0 {
    ...
    public static /* synthetic */ InputCurrencyComponent d(InputCurrencyComponent inputCurrencyComponent, String str, Number number, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public final InputCurrencyComponent c(String name, Number value, JsonLogicBoolean hidden, JsonLogicBoolean disabled, TextBasedComponentStyle errorTextStyle) {
        s.k(name, "name");
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.name, inputCurrencyComponent.name) && s.f(this.value, inputCurrencyComponent.value) && s.f(this.hidden, inputCurrencyComponent.hidden) && s.f(this.disabled, inputCurrencyComponent.disabled) && s.f(this.errorTextStyle, inputCurrencyComponent.errorTextStyle);
    }
    ...
    public InputCurrencyComponent a(Number newValue) {
        InputCurrencyComponent inputCurrencyComponentD = d(this, null, newValue, null, null, null, 29, null);
        inputCurrencyComponentD.g(getNumberController());
