...
public final /* data */ class InputSelectComponent implements n5, d4<InputSelectComponent>, c2, v, e0 {
    ...
    /* JADX INFO: renamed from: com.withpersona.sdk2.inquiry.steps.ui.components.e$a, reason: from kotlin metadata */
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0086\u0003\u0018\u00002\u00020\u0001B\t\b\u0002¢\u0006\u0004\b\u0002\u0010\u0003J\u0015\u0010\u0007\u001a\u00020\u00062\u0006\u0010\u0005\u001a\u00020\u0004¢\u0006\u0004\b\u0007\u0010\b¨\u0006\t"}, d2 = {"Lcom/withpersona/sdk2/inquiry/steps/ui/components/e$a;", "", "<init>", "()V", "Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/InputSelect;", "config", "Lcom/withpersona/sdk2/inquiry/steps/ui/components/e;", "a", "(Lcom/withpersona/sdk2/inquiry/network/dto/ui/components/InputSelect;)Lcom/withpersona/sdk2/inquiry/steps/ui/components/e;", "ui-step-renderer_release"}, k = 1, mv = {2, 0, 0}, xi = 48)
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
        }

        public final InputSelectComponent a(InputSelect config) {
            List listM;
            List listM2;
            ...
            if (options2 != null) {
                ...
                for (Object obj : options2) {
                    ...
                    if (s.f(value, attributes2 != null ? attributes2.getPrefill() : null)) {
                        arrayList.add(obj);
                    }
                }
            ...
            return new InputSelectComponent(name, styles, list, hidden, disabled, label, placeholder, listM2);
        }
    ...
    /* JADX INFO: renamed from: com.withpersona.sdk2.inquiry.steps.ui.components.e$b */
    ...
    public static final class b implements Parcelable.Creator<InputSelectComponent> {
        ...
        public final InputSelectComponent createFromParcel(Parcel parcel) {
            ...
            return new InputSelectComponent(string, inputSelectComponentStyle, arrayList, jsonLogicBoolean, jsonLogicBoolean2, string2, string3, arrayList2);
        }
    ...
    public static /* synthetic */ InputSelectComponent f(InputSelectComponent inputSelectComponent, String str, InputSelectComponentStyle inputSelectComponentStyle, List list, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, String str2, String str3, List list2, int i11, Object obj) {
        if ((i11 & 1) != 0) {
        ...
        String str5 = str2;
        return inputSelectComponent.e(str, inputSelectComponentStyle, list, jsonLogicBoolean, jsonLogicBoolean3, str5, str4, list3);
    }
    ...
    public final InputSelectComponent e(String name, InputSelectComponentStyle styles, List<Option> selectedOptions, JsonLogicBoolean hidden, JsonLogicBoolean disabled, String label, String placeholder, List<Option> options) {
        s.k(name, "name");
        s.k(selectedOptions, "selectedOptions");
        s.k(options, "options");
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.name, inputSelectComponent.name) && s.f(this.styles, inputSelectComponent.styles) && s.f(this.selectedOptions, inputSelectComponent.selectedOptions) && s.f(this.hidden, inputSelectComponent.hidden) && s.f(this.disabled, inputSelectComponent.disabled) && s.f(this.label, inputSelectComponent.label) && s.f(this.placeholder, inputSelectComponent.placeholder) && s.f(this.options, inputSelectComponent.options);
    }
    ...
    public InputSelectComponent b(List<Option> selectedOptions) {
        s.k(selectedOptions, "selectedOptions");
        InputSelectComponent inputSelectComponentF = f(this, null, null, p013kotlin.collections.v.d1(selectedOptions, 1), null, null, null, null, null, EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_SECOND_DEPOSIT_VALUE, null);
        inputSelectComponentF.i(getSelectedOptionsController());
        return inputSelectComponentF;
    }
