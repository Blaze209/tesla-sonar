...
public final /* data */ class InputTextComponent implements n5, z4<InputTextComponent>, v, e0 {
    ...
    public static /* synthetic */ InputTextComponent d(InputTextComponent inputTextComponent, String str, String str2, JsonLogicBoolean jsonLogicBoolean, JsonLogicBoolean jsonLogicBoolean2, TextBasedComponentStyle textBasedComponentStyle, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public final InputTextComponent c(String name, String value, JsonLogicBoolean hidden, JsonLogicBoolean disabled, TextBasedComponentStyle errorTextStyle) {
        s.k(name, "name");
        s.k(value, "value");
    ...
    public boolean equals(Object other) {
        ...
        return s.f(this.name, inputTextComponent.name) && s.f(this.value, inputTextComponent.value) && s.f(this.hidden, inputTextComponent.hidden) && s.f(this.disabled, inputTextComponent.disabled) && s.f(this.errorTextStyle, inputTextComponent.errorTextStyle);
    }
    ...
    public InputTextComponent a(String newString) {
        ...
        InputTextComponent inputTextComponentD = d(this, null, newString, null, null, null, 29, null);
        inputTextComponentD.f(getTextController());
        return inputTextComponentD;
    }
