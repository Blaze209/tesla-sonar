...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedPdfErrorJsonAdapter(u uVar) {
        this.stringAdapter = uVar.f(String.class, d1.d(), "title");
        this.detailsAdapter = uVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError.Details.class, d1.d(), "details");
    }
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedPdfError malformedPdfError) {
        if (malformedPdfError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("title");
        this.stringAdapter.toJson(rVar, malformedPdfError.getTitle());
        rVar.b0("code");
        this.stringAdapter.toJson(rVar, malformedPdfError.getCode());
        rVar.b0("details");
        this.detailsAdapter.toJson(rVar, malformedPdfError.getDetails());
        rVar.C();
    }
}
