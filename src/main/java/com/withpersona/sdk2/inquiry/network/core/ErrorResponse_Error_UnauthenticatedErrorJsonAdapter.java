...
public final class ErrorResponse_Error_UnauthenticatedErrorJsonAdapter extends h<ErrorResponse.Error.UnauthenticatedError> {
    ...
    public ErrorResponse_Error_UnauthenticatedErrorJsonAdapter(u uVar) {
    ...
    public ErrorResponse.Error.UnauthenticatedError fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, ErrorResponse.Error.UnauthenticatedError unauthenticatedError) {
        if (unauthenticatedError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("title");
        this.nullableStringAdapter.toJson(rVar, unauthenticatedError.getTitle());
        rVar.b0("details");
        this.nullableStringAdapter.toJson(rVar, unauthenticatedError.getDetails());
        rVar.C();
    }
}
