...
public final class NetworkInquiryModule_ProvideMoshiJsonAdapterFactoryFactory implements e<Set<h.e>> {
    ...
    public static Set<h.e> provideMoshiJsonAdapterFactory() {
        return (Set) qj0.h.d(NetworkInquiryModule.provideMoshiJsonAdapterFactory());
    }
