...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededError_DetailsJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_FileLimitExceededError_DetailsJsonAdapter(u uVar) {
    }
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details fromJson(k kVar) {
        kVar.h();
        while (kVar.hasNext()) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, GenericFileUploadErrorResponse.DocumentErrorResponse.FileLimitExceededError.Details details) {
        if (details == null) {
