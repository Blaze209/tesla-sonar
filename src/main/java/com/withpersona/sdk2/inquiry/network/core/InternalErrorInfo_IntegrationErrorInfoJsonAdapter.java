...
public final class InternalErrorInfo_IntegrationErrorInfoJsonAdapter extends h<InternalErrorInfo.IntegrationErrorInfo> {
    ...
    public InternalErrorInfo_IntegrationErrorInfoJsonAdapter(u uVar) {
    ...
    public InternalErrorInfo.IntegrationErrorInfo fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, InternalErrorInfo.IntegrationErrorInfo integrationErrorInfo) {
        if (integrationErrorInfo == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("message");
        this.stringAdapter.toJson(rVar, integrationErrorInfo.getMessage());
        rVar.C();
    }
}
