...
public final class InternalErrorInfo_PermissionErrorInfoJsonAdapter extends h<InternalErrorInfo.PermissionErrorInfo> {
    ...
    public InternalErrorInfo_PermissionErrorInfoJsonAdapter(u uVar) {
    ...
    public InternalErrorInfo.PermissionErrorInfo fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, InternalErrorInfo.PermissionErrorInfo permissionErrorInfo) {
        if (permissionErrorInfo == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("message");
        this.stringAdapter.toJson(rVar, permissionErrorInfo.getMessage());
        rVar.C();
    }
}
