...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_GovernmentIdDimensionSizeErrorJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_GovernmentIdDimensionSizeErrorJsonAdapter(u uVar) {
        this.stringAdapter = uVar.f(String.class, d1.d(), "title");
        this.detailsAdapter = uVar.f(GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError.Details.class, d1.d(), "details");
    }
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, GenericFileUploadErrorResponse.DocumentErrorResponse.GovernmentIdDimensionSizeError governmentIdDimensionSizeError) {
        if (governmentIdDimensionSizeError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("title");
        this.stringAdapter.toJson(rVar, governmentIdDimensionSizeError.getTitle());
        rVar.b0("code");
        this.stringAdapter.toJson(rVar, governmentIdDimensionSizeError.getCode());
        rVar.b0("details");
        this.detailsAdapter.toJson(rVar, governmentIdDimensionSizeError.getDetails());
        rVar.C();
    }
}
