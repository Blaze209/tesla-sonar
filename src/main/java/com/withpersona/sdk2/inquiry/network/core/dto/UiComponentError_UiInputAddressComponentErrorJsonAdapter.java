...
public final class UiComponentError_UiInputAddressComponentErrorJsonAdapter extends h<UiComponentError.UiInputAddressComponentError> {
    ...
    public UiComponentError_UiInputAddressComponentErrorJsonAdapter(u uVar) {
    ...
    public UiComponentError.UiInputAddressComponentError fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, UiComponentError.UiInputAddressComponentError uiInputAddressComponentError) {
        if (uiInputAddressComponentError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("name");
        this.stringAdapter.toJson(rVar, uiInputAddressComponentError.getName());
        rVar.b0("type");
        this.stringAdapter.toJson(rVar, uiInputAddressComponentError.getType());
        rVar.b0("message");
        this.mapOfStringStringAdapter.toJson(rVar, uiInputAddressComponentError.getMessage());
        rVar.C();
    }
}
