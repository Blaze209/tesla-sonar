...
public final class ErrorResponse_Error_FieldNotFoundErrorJsonAdapter extends h<ErrorResponse.Error.FieldNotFoundError> {
    ...
    public ErrorResponse_Error_FieldNotFoundErrorJsonAdapter(u uVar) {
    ...
    public ErrorResponse.Error.FieldNotFoundError fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, ErrorResponse.Error.FieldNotFoundError fieldNotFoundError) {
        if (fieldNotFoundError == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("title");
        this.nullableStringAdapter.toJson(rVar, fieldNotFoundError.getTitle());
        rVar.b0("details");
        this.nullableStringAdapter.toJson(rVar, fieldNotFoundError.getDetails());
        rVar.C();
    }
}
