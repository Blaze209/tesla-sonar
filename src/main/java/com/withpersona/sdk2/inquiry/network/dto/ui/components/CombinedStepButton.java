...
public final class CombinedStepButton implements Button {
    ...
    public CombinedStepButton(String name, BasicButtonAttributes basicButtonAttributes, ButtonCombinedStepComponentStyle buttonCombinedStepComponentStyle) {
        s.k(name, "name");
        this.name = name;
    ...
    public /* synthetic */ CombinedStepButton(String str, BasicButtonAttributes basicButtonAttributes, ButtonCombinedStepComponentStyle buttonCombinedStepComponentStyle, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, basicButtonAttributes, (i11 & 4) != 0 ? null : buttonCombinedStepComponentStyle);
    }
}
