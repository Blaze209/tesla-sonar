...
public final class InternalErrorInfo_UnknownErrorInfoJsonAdapter extends h<InternalErrorInfo.UnknownErrorInfo> {
    ...
    public InternalErrorInfo_UnknownErrorInfoJsonAdapter(u uVar) {
    ...
    public InternalErrorInfo.UnknownErrorInfo fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, InternalErrorInfo.UnknownErrorInfo unknownErrorInfo) {
        if (unknownErrorInfo == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("message");
        this.stringAdapter.toJson(rVar, unknownErrorInfo.getMessage());
        rVar.C();
    }
}
