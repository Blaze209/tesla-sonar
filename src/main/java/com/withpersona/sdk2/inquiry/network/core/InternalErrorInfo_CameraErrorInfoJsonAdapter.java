...
public final class InternalErrorInfo_CameraErrorInfoJsonAdapter extends h<InternalErrorInfo.CameraErrorInfo> {
    ...
    public InternalErrorInfo_CameraErrorInfoJsonAdapter(u uVar) {
    ...
    public InternalErrorInfo.CameraErrorInfo fromJson(k kVar) {
        kVar.h();
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, InternalErrorInfo.CameraErrorInfo cameraErrorInfo) {
        if (cameraErrorInfo == null) {
            throw new NullPointerException("value_ was null! Wrap in .nullSafe() to write nullable values.");
        }
        rVar.o();
        rVar.b0("message");
        this.stringAdapter.toJson(rVar, cameraErrorInfo.getMessage());
        rVar.C();
    }
}
