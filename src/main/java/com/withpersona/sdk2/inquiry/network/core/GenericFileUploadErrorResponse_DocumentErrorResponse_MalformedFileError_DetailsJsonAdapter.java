...
public final class GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedFileError_DetailsJsonAdapter extends h<GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError.Details> {
    ...
    public GenericFileUploadErrorResponse_DocumentErrorResponse_MalformedFileError_DetailsJsonAdapter(u uVar) {
    }
    ...
    public GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError.Details fromJson(k kVar) {
        kVar.h();
        while (kVar.hasNext()) {
    ...
    @Override // com.squareup.moshi.h
    public void toJson(r rVar, GenericFileUploadErrorResponse.DocumentErrorResponse.MalformedFileError.Details details) {
        if (details == null) {
