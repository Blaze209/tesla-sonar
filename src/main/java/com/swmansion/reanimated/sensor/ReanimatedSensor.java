...
public class ReanimatedSensor {
    ...
    ReanimatedSensor(WeakReference<ReactApplicationContext> weakReference, ReanimatedSensorType reanimatedSensorType, int i11, SensorSetter sensorSetter) {
        this.listener = new ReanimatedSensorListener(sensorSetter, i11, ((WindowManager) weakReference.get().getSystemService("window")).getDefaultDisplay());
