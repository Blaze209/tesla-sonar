...
public class ReanimatedSensorListener implements SensorEventListener {
    ...
    ReanimatedSensorListener(SensorSetter sensorSetter, double d11, Display display) {
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        ...
        if (rotation == 1) {
            ...
            i11 = rotation != 3 ? 0 : EnumC4419g.SDK_ASSET_HEADER_RTP_AUTHORIZE_MICRODEPOSITS_VALUE;
        } else {
            i11 = 180;
        }
        if (type == 2 || type == 4) {
            float[] fArr = sensorEvent.values;
            this.setter.sensorSetter(new float[]{fArr[0], fArr[1], fArr[2]}, i11);
            return;
        }
        switch (type) {
            case 9:
            case 10:
                ...
                this.setter.sensorSetter(new float[]{-fArr2[0], -fArr2[1], -fArr2[2]}, i11);
                return;
            case 11:
                ...
                this.setter.sensorSetter(new float[]{f11, f12, f13, f14, -fArr4[0], -fArr4[1], fArr4[2]}, i11);
                return;
            default:
