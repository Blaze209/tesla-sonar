...
public class Snapshot {
    ...
    Snapshot(View view, t tVar) {
        ...
        try {
            this.viewManager = tVar.resolveViewManager(view.getId());
            this.parentViewManager = tVar.resolveViewManager(this.parent.getId());
    ...
    private View findTransformedView(View view) {
        ...
        while (true) {
            ...
            boolean z12 = !zEquals;
            if (!zEquals || view2.getClass().getSimpleName().equals(com.swmansion.rnscreens.t.TAG)) {
                z11 = z12;
                break;
            }
            z11 = z12;
    ...
    public Snapshot(View view) {
        ...
        if (viewFindTransformedView != null) {
            ...
            for (int i11 = 0; i11 < 9; i11++) {
                this.transformMatrix.add(Float.valueOf(fArr[i11]));
            }
            ...
            int i12 = this.width;
            this.originX = (int) (f11 - ((i12 - (i12 * viewFindTransformedView.getScaleX())) / 2.0f));
            float f12 = this.originY;
            int i13 = this.height;
            this.originY = (int) (f12 - ((i13 - (i13 * viewFindTransformedView.getScaleY())) / 2.0f));
        }
