...
public abstract class ReanimatedNativeHierarchyManagerBase extends t {
    public ReanimatedNativeHierarchyManagerBase(p1 p1Var) {
        super(p1Var);
    }
    ...
    */
    ...
    public abstract void updateLayoutCommon(int i11, int i12, int i13, int i14, int i15, int i16);
}
