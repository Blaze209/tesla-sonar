...
public final class TraceMetric extends GeneratedMessageLite<TraceMetric, b> implements g {
    ...
    static /* synthetic */ class a {
        ...
        static final /* synthetic */ int[] f44582a;
        ...
        static {
            ...
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f44582a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    private static final class c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final MapEntryLite<String, Long> f44583a = MapEntryLite.newDefaultInstance(WireFormat.FieldType.STRING, "", WireFormat.FieldType.INT64, 0L);
    }

    private static final class d {

        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final MapEntryLite<String, String> f44584a;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f44584a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
        }
    }
    ...
    protected final Object dynamicMethod(GeneratedMessageLite.MethodToInvoke methodToInvoke, Object obj, Object obj2) {
        ...
        a aVar = null;
        switch (a.f44582a[methodToInvoke.ordinal()]) {
            case 1:
                return new TraceMetric();
            case 2:
                return new b(aVar);
            case 3:
                return GeneratedMessageLite.newMessageInfo(DEFAULT_INSTANCE, "\u0001\b\u0000\u0001\u0001\t\b\u0002\u0002\u0000\u0001ဈ\u0000\u0002ဇ\u0001\u0004ဂ\u0002\u0005ဂ\u0003\u00062\u0007\u001b\b2\t\u001b", new Object[]{"bitField0_", "name_", "isAuto_", "clientStartTimeUs_", "durationUs_", "counters_", c.f44583a, "subtraces_", TraceMetric.class, "customAttributes_", d.f44584a, "perfSessions_", PerfSession.class});
            case 4:
                return DEFAULT_INSTANCE;
            case 5:
    ...
    public long getCountersOrDefault(String str, long j11) {
        ...
        return mapFieldLiteInternalGetCounters.containsKey(str) ? mapFieldLiteInternalGetCounters.get(str).longValue() : j11;
    }
