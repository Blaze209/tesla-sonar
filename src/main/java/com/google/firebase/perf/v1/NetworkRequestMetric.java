...
public final class NetworkRequestMetric extends GeneratedMessageLite<NetworkRequestMetric, b> implements MessageLiteOrBuilder {
    ...
    static /* synthetic */ class a {
        ...
        static {
            ...
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.NEW_BUILDER.ordinal()] = 2;
            } catch (NoSuchFieldError unused2) {
            }
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.BUILD_MESSAGE_INFO.ordinal()] = 3;
            } catch (NoSuchFieldError unused3) {
            }
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.GET_DEFAULT_INSTANCE.ordinal()] = 4;
            } catch (NoSuchFieldError unused4) {
            }
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.GET_PARSER.ordinal()] = 5;
            } catch (NoSuchFieldError unused5) {
            }
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.GET_MEMOIZED_IS_INITIALIZED.ordinal()] = 6;
            } catch (NoSuchFieldError unused6) {
            }
            try {
                f44576a[GeneratedMessageLite.MethodToInvoke.SET_MEMOIZED_IS_INITIALIZED.ordinal()] = 7;
    ...
    private static final class c {
        ...
        /* JADX INFO: renamed from: a, reason: collision with root package name */
        static final MapEntryLite<String, String> f44577a;

        static {
            WireFormat.FieldType fieldType = WireFormat.FieldType.STRING;
            f44577a = MapEntryLite.newDefaultInstance(fieldType, "", fieldType, "");
        }
    }
    ...
    public enum d implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            static final Internal.EnumVerifier f44578a = new b();
    ...
    public enum e implements Internal.EnumLite {
        ...
        private static final class b implements Internal.EnumVerifier {
            ...
            /* JADX INFO: renamed from: a, reason: collision with root package name */
            static final Internal.EnumVerifier f44579a = new b();
    ...
    public d getHttpMethod() {
        d dVarForNumber = d.forNumber(this.httpMethod_);
        return dVarForNumber == null ? d.HTTP_METHOD_UNKNOWN : dVarForNumber;
    }
    ...
    public e getNetworkClientErrorReason() {
        e eVarForNumber = e.forNumber(this.networkClientErrorReason_);
        return eVarForNumber == null ? e.NETWORK_CLIENT_ERROR_REASON_UNKNOWN : eVarForNumber;
    }
