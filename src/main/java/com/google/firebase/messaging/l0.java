...
public class l0 {
    ...
    @NonNull
    private final Bundle f44323a;

    public l0(@NonNull Bundle bundle) {
        if (bundle == null) {
            throw new NullPointerException("data");
        }
        this.f44323a = new Bundle(bundle);
    }
    ...
    private String w(String str) {
        if (!this.f44323a.containsKey(str) && str.startsWith("gcm.n.")) {
            String strV = v(str);
            if (this.f44323a.containsKey(strV)) {
                return strV;
            }
        }
        return str;
    ...
    public String i(Resources resources, String str, String str2) {
        ...
        int identifier = resources.getIdentifier(strH, InquiryField.StringField.TYPE, str);
        if (identifier == 0) {
    ...
    public String p(String str) {
        return this.f44323a.getString(w(str));
    }
    ...
    public Bundle x() {
        Bundle bundle = new Bundle(this.f44323a);
        for (String str : this.f44323a.keySet()) {
            if (!s(str)) {
                bundle.remove(str);
            }
        }
