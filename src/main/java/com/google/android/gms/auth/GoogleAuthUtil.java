...
public final class GoogleAuthUtil extends zzl {
    ...
    @NonNull
    public static List<AccountChangeEvent> getAccountChangeEvents(@NonNull Context context, int i11, @NonNull String str) {
    ...
    private static TokenData zzg(Context context, Account account, String str, Bundle bundle, long j11) throws GoogleAuthException, IOException {
        try {
