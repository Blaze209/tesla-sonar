...
public interface RestoreCredentialClient extends HasApiKey<Api.ApiOptions.NoOptions> {
    Task<Boolean> clearRestoreCredential(@NonNull ClearRestoreCredentialRequest request);

    Task<CreateRestoreCredentialResponse> createRestoreCredential(@NonNull CreateRestoreCredentialRequest request);

    Task<GetRestoreCredentialResponse> getRestoreCredential(@NonNull GetRestoreCredentialRequest request);
}
