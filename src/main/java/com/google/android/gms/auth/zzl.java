...
public class zzl {
    ...
    @ShowFirstParty
    public static TokenData zza(final Context context, final Account account, final String str, Bundle bundle, long j11, Executor executor) throws GoogleAuthException, IOException {
        Preconditions.checkNotMainThread("Calling this from your main thread can lead to deadlock");
    ...
    private static Object zzh(Context context, ComponentName componentName, zzk zzkVar, long j11, Executor executor) throws IOException {
    ...
    private static Object zzi(Task task, String str) throws IOException, ApiException {
        try {
            ...
            throw new IOException(str3, e12);
            ...
            throw new IOException(str4, e13);
        }
    }
