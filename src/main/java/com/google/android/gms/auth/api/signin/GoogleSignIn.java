...
public final class GoogleSignIn {
    ...
    public static void requestPermissions(@NonNull Fragment fragment, int i11, GoogleSignInAccount googleSignInAccount, @NonNull GoogleSignInOptionsExtension googleSignInOptionsExtension) {
    ...
    public static void requestPermissions(@NonNull Fragment fragment, int i11, GoogleSignInAccount googleSignInAccount, @NonNull Scope... scopeArr) {
        Preconditions.checkNotNull(fragment, "Please provide a non-null Fragment");
        Preconditions.checkNotNull(scopeArr, "Please provide at least one scope");
