...
public final class GiftCardWalletObject extends AbstractSafeParcelable {
    ...
    public final class Builder {
        ...
        public GiftCardWalletObject build() {
            ...
            CommonWalletObject commonWalletObjectZzz = zzbVar.zzz();
            giftCardWalletObject.zza = commonWalletObjectZzz;
            Preconditions.checkArgument(!TextUtils.isEmpty(commonWalletObjectZzz.zzm()), "Card name is required.");
