...
public final class ButtonOptions extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = WebrtcBuildVersion.maint_version, getter = "getButtonType", id = 1)
    int zza;

    @SafeParcelable.Field(defaultValueUnchecked = WebrtcBuildVersion.maint_version, getter = "getButtonTheme", id = 2)
    int zzb;

    @SafeParcelable.Field(defaultValueUnchecked = WebrtcBuildVersion.maint_version, getter = "getCornerRadius", id = 3)
    int zzc;
    ...
    public final class Builder {
        ...
        @NonNull
        public Builder setButtonTheme(int i11) {
            ButtonOptions.this.zzb = i11;
            return this;
        }

        @NonNull
        public Builder setButtonType(int i11) {
            ButtonOptions.this.zza = i11;
            return this;
        }
    ...
    ButtonOptions(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) int i13, @SafeParcelable.Param(id = 4) String str) {
        this.zza = ((Integer) Preconditions.checkNotNull(Integer.valueOf(i11))).intValue();
        this.zzb = ((Integer) Preconditions.checkNotNull(Integer.valueOf(i12))).intValue();
        this.zzc = ((Integer) Preconditions.checkNotNull(Integer.valueOf(i13))).intValue();
