...
public final class CardRequirements extends AbstractSafeParcelable {
    ...
    CardRequirements(@SafeParcelable.Param(id = 1) ArrayList arrayList, @SafeParcelable.Param(id = 2) boolean z11, @SafeParcelable.Param(id = 3) boolean z12, @SafeParcelable.Param(id = 4) int i11) {
        this.zza = arrayList;
        this.zzb = z11;
        this.zzc = z12;
        this.zzd = i11;
