...
final class zzoq {
    ...
    static /* synthetic */ void zzb(byte b11, byte b12, char[] cArr, int i11) throws zzmr {
        if (b11 < -62 || zze(b12)) {
    ...
    static /* synthetic */ void zzc(byte b11, byte b12, byte b13, char[] cArr, int i11) throws zzmr {
        if (!zze(b12)) {
            if (b11 != -32) {
                if (b11 != -19) {
                    if (!zze(b13)) {
    ...
    static /* synthetic */ void zzd(byte b11, byte b12, byte b13, byte b14, char[] cArr, int i11) throws zzmr {
