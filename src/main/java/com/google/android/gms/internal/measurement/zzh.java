...
public final class zzh {
    public static void zza(String str, int i11, List list) {
        if (list.size() != i11) {
    ...
    public static void zzb(String str, int i11, List list) {
        if (list.size() < i11) {
    ...
    public static void zzc(String str, int i11, List list) {
        if (list.size() > i11) {
    ...
    public static int zzg(double d11) {
    ...
    public static long zzh(double d11) {
        return ((long) zzg(d11)) & 4294967295L;
    }

    public static double zzi(double d11) {
        if (Double.isNaN(d11)) {
            return 0.0d;
        }
