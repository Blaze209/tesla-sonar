...
final class zzrv extends zzsi {
    ...
    public final zzsj zzh() {
        ...
        l lVar;
        zzna zznaVar;
        if (this.zzh == 7 && (zzmuVar = this.zza) != null && (str = this.zzb) != null && (lVar = this.zze) != null && (zznaVar = this.zzf) != null) {
            return new zzrx(zzmuVar, str, this.zzc, this.zzd, lVar, zznaVar, this.zzg, null);
        }
