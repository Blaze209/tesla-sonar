...
public final class zzvd extends AbstractSafeParcelable {
    ...
    public zzvd(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) Rect rect, @SafeParcelable.Param(id = 3) List list, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 5) List list2, @SafeParcelable.Param(id = 6) float f11, @SafeParcelable.Param(id = 7) float f12) {
        this.zza = str;
        this.zzb = rect;
        this.zzc = list;
        this.zzd = str2;
