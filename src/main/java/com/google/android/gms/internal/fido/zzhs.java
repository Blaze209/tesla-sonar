...
public final class zzhs implements Closeable {
    ...
    private final long zzh() throws IOException {
        ...
        if (this.zzb.zza() == 26) {
            ...
            long j11 = bArr2[0];
            long j12 = bArr2[1];
            return (((long) bArr2[3]) & 255) | ((j12 & 255) << 16) | ((j11 & 255) << 24) | ((bArr2[2] & 255) << 8);
        }
        if (this.zzb.zza() != 27) {
        ...
        long j15 = bArr3[2];
        long j16 = bArr3[3];
        return (((long) bArr3[7]) & 255) | ((j15 & 255) << 40) | ((j13 & 255) << 56) | ((j14 & 255) << 48) | ((j16 & 255) << 32) | ((bArr3[4] & 255) << 24) | ((bArr3[5] & 255) << 16) | ((bArr3[6] & 255) << 8);
    }
    ...
    private final void zzj(byte b11) throws IOException {
        zzd();
        if (this.zzb.zzb() != b11) {
            throw new IllegalStateException(String.format("expected major type %s but found %s", Integer.valueOf((b11 >> 5) & 7), Integer.valueOf(this.zzb.zzc())));
        }
    }
    ...
    private final void zzk(byte[] bArr, int i11) throws IOException {
        int i12 = 0;
        while (i12 != i11) {
            int i13 = this.zza.read(bArr, i12, i11 - i12);
            if (i13 == -1) {
                throw new EOFException();
            }
            i12 += i13;
