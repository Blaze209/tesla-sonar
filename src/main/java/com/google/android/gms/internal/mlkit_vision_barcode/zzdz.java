...
public abstract class zzdz<V> extends zzex implements zzet<V> {
    ...
    public static Object zzq(zzet zzetVar) {
        ...
        try {
            ...
            return !zIsCancelled ? new zzc(new IllegalArgumentException("get() threw CancellationException, despite reporting isCancelled() == false: ".concat(String.valueOf(zzetVar)), e12)) : new zzb(false, e12);
        } catch (ExecutionException e13) {
            return zIsCancelled ? new zzb(false, new IllegalArgumentException("get() did not throw CancellationException, despite reporting isCancelled() == true: ".concat(String.valueOf(zzetVar)), e13)) : new zzc(e13.getCause());
        }
    }
    ...
    private final void zzt(StringBuilder sb2) {
        ...
        if (obj instanceof zzf) {
            ...
            try {
                ...
                strConcat = "Exception thrown from implementation: ".concat(String.valueOf(e11.getClass()));
            }
            if (strConcat != null) {
                sb2.append(", info=[");
