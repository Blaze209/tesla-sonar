...
public abstract class zzx extends zzt implements List, RandomAccess {
    private static final zzaj zza = new zzv(zzab.zza, 0);
    public static final /* synthetic */ int zzd = 0;

    zzx() {
    }

    static zzx zzg(Object[] objArr, int i11) {
        return i11 == 0 ? zzab.zza : new zzab(objArr, i11);
    }
    ...
    public zzx subList(int i11, int i12) {
        zzn.zzf(i11, i12, size());
        int i13 = i12 - i11;
        if (i13 == size()) {
            return this;
        }
        return i13 == 0 ? zzab.zza : new zzw(this, i11, i13);
    }

    @Override // java.util.List
    /* JADX INFO: renamed from: zzh, reason: merged with bridge method [inline-methods] */
    public final zzaj listIterator(int i11) {
        zzn.zze(i11, size(), "index");
        return isEmpty() ? zza : new zzv(this, i11);
    }
}
