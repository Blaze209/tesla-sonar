...
public final class ClientIdentity extends AbstractSafeParcelable {
    ...
    public static final C4336zzd zza = new C4336zzd(null);
    public static final Parcelable.Creator<ClientIdentity> CREATOR = new C4337zzf();
    ...
    public final boolean equals(Object other) {
        if (other instanceof ClientIdentity) {
            ...
            if (this.zzb == clientIdentity.zzb && s.f(this.zzc, clientIdentity.zzc) && s.f(this.zzd, clientIdentity.zzd) && s.f(this.zze, clientIdentity.zze) && s.f(this.zzg, clientIdentity.zzg) && s.f(this.zzf, clientIdentity.zzf)) {
                return true;
            }
        }
        return false;
    ...
    public final String toString() {
        ...
        if (str2 != null) {
            sb2.append("[");
            if (t.b0(str2, this.zzc, false, 2, null)) {
