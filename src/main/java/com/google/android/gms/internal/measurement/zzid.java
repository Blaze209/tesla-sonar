...
public final class zzid extends zzmf implements zznn {
    ...
    final /* synthetic */ void zzaG(int i11) {
        this.zzb |= 1;
        this.zze = 1;
    }

    final /* synthetic */ void zzaH(int i11, zzhs zzhsVar) {
        zzhsVar.getClass();
        zzcy();
        this.zzf.set(i11, zzhsVar);
    }
    ...
    final /* synthetic */ void zzaL(int i11) {
        zzcy();
        this.zzf.remove(i11);
    }

    final /* synthetic */ void zzaM(int i11, zziu zziuVar) {
        zziuVar.getClass();
        zzcz();
        this.zzg.set(i11, zziuVar);
    }
    ...
    final /* synthetic */ void zzaP(int i11) {
        zzcz();
        this.zzg.remove(i11);
    }

    final /* synthetic */ void zzaQ(long j11) {
        this.zzb |= 2;
        this.zzh = j11;
    }
    ...
    final /* synthetic */ void zzaS(long j11) {
        this.zzb |= 4;
        this.zzi = j11;
    }

    final /* synthetic */ void zzaT(long j11) {
        this.zzb |= 8;
        this.zzj = j11;
    }

    final /* synthetic */ void zzaU(long j11) {
        this.zzb |= 16;
        this.zzk = j11;
    }
    ...
    final /* synthetic */ void zzaW(long j11) {
        this.zzb |= 32;
        this.zzl = j11;
    }
    ...
    final /* synthetic */ void zzbA(long j11) {
    ...
    final /* synthetic */ void zzbD(int i11) {
        this.zzd |= 2;
        this.zzO = i11;
    }
    ...
    final /* synthetic */ void zzbG(long j11) {
        this.zzd |= 16;
        this.zzS = j11;
    }

    final /* synthetic */ void zzbH(long j11) {
        this.zzd |= 32;
        this.zzT = j11;
    }
    ...
    final /* synthetic */ void zzbJ(String str) {
        str.getClass();
        this.zzd |= PKIFailureInfo.certRevoked;
        this.zzab = str;
    }
    ...
    final /* synthetic */ void zzbN(long j11) {
        this.zzd |= 32768;
        this.zzae = j11;
    }

    final /* synthetic */ void zzbO(boolean z11) {
        this.zzd |= 65536;
        this.zzaf = z11;
    }
    ...
    final /* synthetic */ void zzbQ(boolean z11) {
        this.zzd |= 262144;
        this.zzah = z11;
    }
    ...
    final /* synthetic */ void zzbS(int i11) {
    ...
    final /* synthetic */ void zzbU(int i11) {
        this.zzd |= 8388608;
        this.zzam = i11;
    }
    ...
    final /* synthetic */ void zzbX(long j11) {
        this.zzd |= 134217728;
        this.zzaq = j11;
    }
    ...
    final /* synthetic */ void zzbi(long j11) {
        this.zzb |= 32768;
        this.zzv = 133005L;
    }
    ...
    final /* synthetic */ void zzbl(boolean z11) {
        this.zzb |= 131072;
        this.zzx = z11;
    }
    ...
    final /* synthetic */ void zzbp(long j11) {
        this.zzb |= PKIFailureInfo.signerNotTrusted;
        this.zzz = j11;
    }

    final /* synthetic */ void zzbq(int i11) {
    ...
    final /* synthetic */ void zzbu(boolean z11) {
        this.zzb |= 8388608;
        this.zzD = z11;
    }
    ...
    final /* synthetic */ void zzby(int i11) {
        this.zzb |= 33554432;
        this.zzG = i11;
    }
    ...
    public final zzhs zze(int i11) {
        return (zzhs) this.zzf.get(i11);
    }
    ...
    public final zziu zzh(int i11) {
        return (zziu) this.zzg.get(i11);
    }
