...
public final class zzpe implements zzpd {
    ...
    static {
        ...
        zzb = zzkgVarZzb.zzc("measurement.app_uninstalled_additional_ad_id_cache_time", CoreConstants.MILLIS_IN_ONE_HOUR);
        ...
        zzf = zzkgVarZzb.zzc("measurement.config.cache_time", CoreConstants.MILLIS_IN_ONE_DAY);
        ...
        zzj = zzkgVarZzb.zzc("measurement.session.engagement_interval", CoreConstants.MILLIS_IN_ONE_HOUR);
        ...
        zzA = zzkgVarZzb.zzc("measurement.monitoring.sample_period_millis", CoreConstants.MILLIS_IN_ONE_DAY);
        ...
        zzF = zzkgVarZzb.zzc("measurement.upload.refresh_blacklisted_config_interval", CoreConstants.MILLIS_IN_ONE_WEEK);
        zzkgVarZzb.zzc("measurement.config.cache_time.service", CoreConstants.MILLIS_IN_ONE_HOUR);
        zzG = zzkgVarZzb.zzc("measurement.service_client.idle_disconnect_millis", DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
        zzkgVarZzb.zzf("measurement.log_tag.service", "FA-SVC");
        zzH = zzkgVarZzb.zzc("measurement.service_client.reconnect_millis", 1000L);
        zzkgVarZzb.zzf("measurement.sgtm.app_allowlist", Marker.ANY_MARKER);
        zzI = zzkgVarZzb.zzc("measurement.sgtm.batch.long_queuing_threshold", 240000L);
        zzJ = zzkgVarZzb.zzc("measurement.sgtm.batch.retry_interval", ComponentTracker.DEFAULT_TIMEOUT);
        ...
        zzP = zzkgVarZzb.zzc("measurement.sgtm.upload.max_queued_batches", DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
        ...
        zzS = zzkgVarZzb.zzc("measurement.sgtm.upload.min_delay_after_startup", DeviceOrientationRequest.OUTPUT_PERIOD_FAST);
        ...
        zzV = zzkgVarZzb.zzc("measurement.upload.stale_data_deletion_interval", CoreConstants.MILLIS_IN_ONE_DAY);
        ...
        zzad = zzkgVarZzb.zzc("measurement.sdk.attribution.cache.ttl", CoreConstants.MILLIS_IN_ONE_WEEK);
        ...
        zzah = zzkgVarZzb.zzc("measurement.upload.interval", CoreConstants.MILLIS_IN_ONE_HOUR);
        ...
        zzat = zzkgVarZzb.zzc("measurement.upload.retry_time", ComponentTracker.DEFAULT_TIMEOUT);
        zzau = zzkgVarZzb.zzf("measurement.upload.url", "https://app-measurement.com/a");
        zzav = zzkgVarZzb.zzc("measurement.upload.window_interval", CoreConstants.MILLIS_IN_ONE_HOUR);
