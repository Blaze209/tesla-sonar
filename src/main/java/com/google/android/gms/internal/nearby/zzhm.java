...
public final class zzhm {
    ...
    static Payload zza(Context context, zzhk zzhkVar) {
        ...
        try {
            ...
            Log.w("NearbyConnections", String.format("Failed to create Payload from ParcelablePayload: unable to open uri %s for file %s.", uriZze, strZzj), e11);
            return null;
        } catch (SecurityException e12) {
            Log.w("NearbyConnections", String.format("Failed to create Payload from ParcelablePayload: unable to open uri %s for file %s.", uriZze, strZzj), e12);
            return null;
        }
    }
