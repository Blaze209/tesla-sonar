    ...
    public final zzao zza(String str, zzg zzgVar, List list) {
        ...
        if (iOrdinal == 14) {
            ...
            while (i11 < list.size() - 1) {
                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i11));
                ...
                zzgVar.zzg(zzaoVarZza3.zzc(), zzgVar.zza((zzao) list.get(i11 + 1)));
                i11 += 2;
            }
            return zzao.zzf;
        }
        if (iOrdinal == 24) {
            ...
            while (i11 < list.size()) {
                zzaoVarZza4 = zzgVar.zza((zzao) list.get(i11));
        ...
        if (iOrdinal == 18) {
            ...
            while (i11 < list.size() - 1) {
                zzao zzaoVarZza10 = zzgVar.zza((zzao) list.get(i11));
                zzao zzaoVarZza11 = zzgVar.zza((zzao) list.get(i11 + 1));
