...
final class zzcw implements d {
    ...
    zzcw(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private final zzcw zzk(c cVar, b bVar, Object obj, boolean z11) throws IOException {
    ...
    final zzcw zzd(@NonNull b bVar, int i11, boolean z11) throws IOException {
        if (!z11 || i11 != 0) {
            zzcu zzcuVarZzj = zzj(bVar);
    ...
    final zzcw zze(@NonNull b bVar, long j11, boolean z11) throws IOException {
        if (!z11 || j11 != 0) {
            zzcu zzcuVarZzj = zzj(bVar);
            zzct zzctVar = zzct.DEFAULT;
            int iOrdinal = zzcuVarZzj.zzb().ordinal();
