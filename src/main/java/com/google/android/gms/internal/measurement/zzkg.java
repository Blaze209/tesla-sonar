...
public final class zzkg {
    ...
    private zzkg(String str, Uri uri, String str2, String str3, boolean z11, boolean z12, boolean z13, boolean z14, h hVar) {
        this.zza = uri;
        this.zzb = "";
        this.zzc = "";
        this.zzd = z11;
    ...
    public final zzkm zzc(String str, long j11) {
        Long lValueOf = Long.valueOf(j11);
        int i11 = zzkm.zzc;
        return new zzkc(this, str, lValueOf, true);
    }

    public final zzkm zzd(String str, boolean z11) {
        Boolean boolValueOf = Boolean.valueOf(z11);
        int i11 = zzkm.zzc;
        return new zzkd(this, str, boolValueOf, true);
    }

    public final zzkm zze(String str, double d11) {
