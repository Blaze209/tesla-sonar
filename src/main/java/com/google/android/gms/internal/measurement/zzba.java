...
public final class zzba {
        ...
        switch (str.hashCode()) {
            ...
            case -895859076:
                if (str.equals("splice")) {
                    ...
                    if (list.size() > 1) {
                        ...
                        if (iMax > 0) {
                            for (int i12 = iZzi; i12 < Math.min(iZzh2, iZzi + iMax); i12++) {
                        ...
                        if (list.size() > 2) {
                            for (int i13 = 2; i13 < list.size(); i13++) {
                                zzao zzaoVarZza3 = zzgVar.zza((zzao) list.get(i13));
                                if (zzaoVarZza3 instanceof zzag) {
                                    throw new IllegalArgumentException("Failed to parse elements to add");
                                }
                                zzaeVar.zzq((iZzi + i13) - 2, zzaoVarZza3);
                            }
                        }
                    } else {
                        while (iZzi < iZzh2) {
            ...
            case 111185:
                if (str.equals("pop")) {
                    ...
                    int i14 = iZzh5 - 1;
                    zzao zzaoVarZzl = zzaeVar.zzl(i14);
                    zzaeVar.zzr(i14);
                    return zzaoVarZzl;
                }
                throw new IllegalArgumentException("Command not supported");
            ...
            case 109526418:
                if (str.equals("slice")) {
                    ...
                    for (int i15 = (int) dMax; i15 < dZzh3; i15++) {
                        zzaeVar8.zzn(zzaeVar8.zzh(), zzaeVar.zzl(i15));
                    }
                    return zzaeVar8;
                }
                throw new IllegalArgumentException("Command not supported");
            ...
            case 1099846370:
                if (str.equals("reverse")) {
                    ...
                    if (iZzh6 != 0) {
                        while (i11 < iZzh6 / 2) {
                            if (zzaeVar.zzo(i11)) {
                                zzao zzaoVarZzl3 = zzaeVar.zzl(i11);
                                zzaeVar.zzn(i11, null);
                                int i16 = (iZzh6 - 1) - i11;
                                if (zzaeVar.zzo(i16)) {
                                    zzaeVar.zzn(i11, zzaeVar.zzl(i16));
                                }
                                zzaeVar.zzn(i16, zzaoVarZzl3);
                            }
                            i11++;
                        }
                    }
            ...
            case 1943291465:
                if (str.equals("indexOf")) {
                    ...
                    while (itZzg6.hasNext()) {
                        ...
                        if (d11 >= dZzh2 && zzh.zzf(zzaeVar.zzl(iIntValue2), zzaoVarZza13)) {
    ...
    private static zzao zzb(zzae zzaeVar, zzg zzgVar, List list, boolean z11) {
        zzao zzaoVarZza;
        ...
        int i11 = z11 ? 0 : iZzh - 1;
        int i12 = z11 ? iZzh - 1 : 0;
        int i13 = true == z11 ? 1 : -1;
        if (zzaoVarZza == null) {
            zzaoVarZza = zzaeVar.zzl(i11);
            i11 += i13;
        }
        while ((i12 - i11) * i13 >= 0) {
            if (zzaeVar.zzo(i11)) {
                zzaoVarZza = zzaiVar.zza(zzgVar, Arrays.asList(zzaoVarZza, zzaeVar.zzl(i11), new zzah(Double.valueOf(i11)), zzaeVar));
                if (zzaoVarZza instanceof zzag) {
