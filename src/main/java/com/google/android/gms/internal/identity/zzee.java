...
public final class zzee extends AbstractSafeParcelable {
    ...
    zzee(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) IBinder iBinder, @SafeParcelable.Param(id = 3) IBinder iBinder2, @SafeParcelable.Param(id = 4) PendingIntent pendingIntent, @SafeParcelable.Param(id = 6) String str) {
        this.zza = i11;
        this.zzb = iBinder;
        this.zzc = iBinder2;
