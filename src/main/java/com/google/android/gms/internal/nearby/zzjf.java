...
public final class zzjf implements Parcelable.Creator {
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        while (parcel.dataPosition() < iValidateObjectHeader) {
            ...
            switch (SafeParcelReader.getFieldId(header)) {
                ...
                case 5:
                    ...
                    break;
                case 6:
                    arrayListCreateTypedList2 = SafeParcelReader.createTypedList(parcel, header, com.google.android.gms.nearby.connection.zzae.CREATOR);
                    break;
                case 7:
        ...
        return new zzje(zzjmVar, zzjcVar, bArrCreateByteArray, z11, arrayListCreateTypedList, arrayListCreateTypedList2, arrayListCreateTypedList3, zzjoVar, zzjgVar);
    }
