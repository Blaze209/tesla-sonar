...
public final class zzdz extends GmsClient {
    ...
    public final void zzC(ListenerHolder listenerHolder, DeviceOrientationRequest deviceOrientationRequest, TaskCompletionSource taskCompletionSource) {
        ...
        synchronized (this.zzh) {
            try {
                ...
                ((zzv) getService()).zzF(new zzj(1, new C4339zzh(deviceOrientationRequest, C4339zzh.zza, null), zzdqVar, new zzdn(null, taskCompletionSource)));
            } catch (Throwable th2) {
                throw th2;
            }
        }
    ...
    public final void zzv(ListenerHolder.ListenerKey listenerKey, boolean z11, TaskCompletionSource taskCompletionSource) {
        synchronized (this.zzf) {
            try {
    ...
    public final void zzw(ListenerHolder.ListenerKey listenerKey, boolean z11, TaskCompletionSource taskCompletionSource) {
        synchronized (this.zzg) {
            try {
