...
public final class zzvj extends AbstractSafeParcelable {
    ...
    public zzvj(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) Rect rect, @SafeParcelable.Param(id = 3) List list, @SafeParcelable.Param(id = 4) float f11, @SafeParcelable.Param(id = 5) float f12) {
        this.zza = str;
        this.zzb = rect;
        this.zzc = list;
        this.zzd = f11;
