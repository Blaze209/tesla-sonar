...
final class zzfg implements d {
    ...
    static {
        ...
        zzd = new c() { // from class: com.google.android.gms.internal.mlkit_vision_barcode.zzff
            @Override // rv.c
            public final void encode(Object obj, Object obj2) {
                zzfg.zzg((Map.Entry) obj, (d) obj2);
            }
        };
    }

    zzfg(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private static int zzh(b bVar) {
        zzfe zzfeVar = (zzfe) bVar.c(zzfe.class);
        if (zzfeVar != null) {
            return zzfeVar.zza();
        }
    ...
    private static zzfe zzj(b bVar) {
        zzfe zzfeVar = (zzfe) bVar.c(zzfe.class);
        if (zzfeVar != null) {
            return zzfeVar;
        }
    ...
    private final zzfg zzk(c cVar, b bVar, Object obj, boolean z11) throws IOException {
    ...
    private final zzfg zzl(e eVar, b bVar, Object obj, boolean z11) {
    ...
    final zzfg zzd(@NonNull b bVar, int i11, boolean z11) throws IOException {
        if (!z11 || i11 != 0) {
            zzfe zzfeVarZzj = zzj(bVar);
    ...
    final zzfg zze(@NonNull b bVar, long j11, boolean z11) throws IOException {
        if (!z11 || j11 != 0) {
            zzfe zzfeVarZzj = zzj(bVar);
            int iOrdinal = zzfeVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
