...
final class zzak implements d {
    ...
    zzak(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private final zzak zzk(c cVar, b bVar, Object obj, boolean z11) throws IOException {
    ...
    final zzak zzd(@NonNull b bVar, int i11, boolean z11) throws IOException {
        if (!z11 || i11 != 0) {
            zzai zzaiVarZzj = zzj(bVar);
    ...
    final zzak zze(@NonNull b bVar, long j11, boolean z11) throws IOException {
        if (!z11 || j11 != 0) {
            zzai zzaiVarZzj = zzj(bVar);
            zzah zzahVar = zzah.DEFAULT;
            int iOrdinal = zzaiVarZzj.zzb().ordinal();
