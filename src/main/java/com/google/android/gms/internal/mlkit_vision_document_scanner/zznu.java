...
public enum zznu implements zzan {
    UNKNOWN_EVENT(0),
    ...
    ON_DEVICE_ENTITY_EXTRACTION_ANNOTATE(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_NAVBAR_VALUE),
    ON_DEVICE_ENTITY_EXTRACTION_CREATE(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_ACCOUNT_NUMBER_CONFIRMED_VALUE),
    ON_DEVICE_ENTITY_EXTRACTION_LOAD(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_ACCOUNT_NUMBER_SEARCH_VALUE),
    ON_DEVICE_ENTITY_EXTRACTION_CLOSE(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_BALANCE_BEAM_01_VALUE),
    ON_DEVICE_ENTITY_EXTRACTION_DOWNLOAD(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_BALANCE_BEAM_02_VALUE),
    ON_DEVICE_OBJECT_CREATE(191),
    ON_DEVICE_OBJECT_LOAD(192),
    ON_DEVICE_OBJECT_INFERENCE(193),
    ON_DEVICE_OBJECT_CLOSE(194),
    ON_DEVICE_DI_CREATE(EnumC4419g.SDK_ASSET_ILLUSTRATION_FACE_BIOMETRIC_PASSKEY_VALUE),
    ON_DEVICE_DI_LOAD(EnumC4419g.SDK_ASSET_ILLUSTRATION_FACE_BIOMETRIC_PASSKEY_DARK_APPEARANCE_VALUE),
    ON_DEVICE_DI_DOWNLOAD(EnumC4419g.SDK_ASSET_ICON_CHECKMARK_FILLED_BLUE_VALUE),
    ON_DEVICE_DI_RECOGNIZE(EnumC4419g.SDK_ASSET_ICON_CHECKMARK_GRAY_VALUE),
    ON_DEVICE_DI_CLOSE(EnumC4419g.SDK_ASSET_ILLUSTRATION_SECURE_DATA_VALUE),
    ON_DEVICE_POSE_CREATE(EnumC4419g.SDK_ASSET_BANK_ICON_CIRCLE_LIGHT_VALUE),
    ON_DEVICE_POSE_LOAD(EnumC4419g.SDK_ASSET_PLAID_PROFILE_CIRCLE_VALUE),
    ON_DEVICE_POSE_INFERENCE(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_CHECK_LOGO_NAVBAR_DARK_APPEARANCE_VALUE),
    ON_DEVICE_POSE_CLOSE(EnumC4419g.SDK_ASSET_ICON_CHECKMARK_WITH_CIRCLE_VALUE),
    ON_DEVICE_POSE_PRELOAD(EnumC4419g.SDK_ASSET_ICON_REPORT_VALUE),
    ...
    MODEL_DOWNLOAD(100),
    MODEL_UPDATE(101),
    REMOTE_MODEL_IS_DOWNLOADED(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_OVERLAY_SECOND_DEPOSIT_VALUE),
    REMOTE_MODEL_DELETE_ON_DEVICE(EnumC4419g.SDK_ASSET_ILLUSTRATION_ROUTING_NUMBER_CONFIRMED_CIRCLE_VALUE),
    ACCELERATION_ANALYTICS(EnumC4419g.SDK_ASSET_HEADER_FINAL_FAULTY_DATA_VALUE),
    PIPELINE_ACCELERATION_ANALYTICS(EnumC4419g.SDK_ASSET_ILLUSTRATION_SEND_DEPOSIT_AUTHORIZATION_HEADER_VALUE),
    AGGREGATED_AUTO_ML_IMAGE_LABELING_INFERENCE(200),
    AGGREGATED_CUSTOM_MODEL_INFERENCE(EnumC4419g.SDK_ASSET_ICON_CHEVRON_LEFT_DOUBLE_S2_VALUE),
    AGGREGATED_ON_DEVICE_BARCODE_DETECTION(EnumC4419g.SDK_ASSET_ICON_CHEVRON_RIGHT_DOUBLE_S1_VALUE),
    AGGREGATED_ON_DEVICE_FACE_DETECTION(EnumC4419g.SDK_ASSET_ICON_CHEVRON_RIGHT_DOUBLE_S2_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_LABEL_DETECTION(EnumC4419g.SDK_ASSET_ICON_CLEARED_REC_VALUE),
    AGGREGATED_ON_DEVICE_OBJECT_INFERENCE(EnumC4419g.SDK_ASSET_ICON_CLIPBOARD_VALUE),
    AGGREGATED_ON_DEVICE_TEXT_DETECTION(EnumC4419g.SDK_ASSET_ICON_CLOCK_VALUE),
    AGGREGATED_ON_DEVICE_POSE_DETECTION(EnumC4419g.SDK_ASSET_ICON_COMMENT_VALUE),
    AGGREGATED_ON_DEVICE_SEGMENTATION(EnumC4419g.SDK_ASSET_ICON_INCOME_VALUE),
    AGGREGATED_CUSTOM_OBJECT_INFERENCE(EnumC4419g.SDK_ASSET_ICON_INCOMPLETE_VALUE),
    AGGREGATED_CUSTOM_IMAGE_LABEL_DETECTION(EnumC4419g.SDK_ASSET_ICON_NEW_WINDOW_VALUE),
    AGGREGATED_ON_DEVICE_EXPLICIT_CONTENT_DETECTION(211),
    AGGREGATED_ON_DEVICE_FACE_MESH_DETECTION(EnumC4419g.SDK_ASSET_ICON_OVERRIDE_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_QUALITY_ANALYSIS_DETECTION(EnumC4419g.SDK_ASSET_ICON_PAUSE_VALUE),
    AGGREGATED_ON_DEVICE_IMAGE_CAPTIONING_INFERENCE(EnumC4419g.SDK_ASSET_ICON_PIN_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_DETECT_PROCESS(EnumC4419g.SDK_ASSET_ICON_PRODUCT_IDV_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_CROP_PROCESS(EnumC4419g.SDK_ASSET_ICON_PRODUCT_MONITOR_VALUE),
    AGGREGATED_ON_DEVICE_DOCUMENT_ENHANCE_PROCESS(EnumC4419g.SDK_ASSET_ICON_PROGRESS_VALUE),
    AGGREGATED_ON_DEVICE_STAIN_REMOVAL_PROCESS(EnumC4419g.SDK_ASSET_ICON_QUESTION_VALUE),
    AGGREGATED_ON_DEVICE_SHADOW_REMOVAL_PROCESS(EnumC4419g.SDK_ASSET_ICON_REJECTED_REC_VALUE),
    AGGREGATED_ON_DEVICE_SUBJECT_SEGMENTATION_INFERENCE(EnumC4419g.SDK_ASSET_ICON_SHIELD_CAUTION_VALUE),
    REMOTE_CONFIG_FETCH(EnumC4419g.SDK_ASSET_ILLUSTRATION_INSTITUTION_BRUSHSTROKE_VALUE),
    REMOTE_CONFIG_ACTIVATE(EnumC4419g.SDK_ASSET_ILLUSTRATION_USER_BRUSHSTROKE_VALUE),
    REMOTE_CONFIG_LOAD(EnumC4419g.SDK_ASSET_ILLUSTRATION_ACCOUNT_BRUSHSTROKE_VALUE),
    REMOTE_CONFIG_FRC_FETCH(EnumC4419g.SDK_ASSET_ILLUSTRATION_BANK_VALUE),
    INSTALLATION_ID_INIT(EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_CHECK_LOGO_NAVBAR_LIGHT_APPEARANCE_VALUE),
    INSTALLATION_ID_REGISTER_NEW_ID(EnumC4419g.SDK_ASSET_ILLUSTRATION_ERROR_BRUSHSTROKE_VALUE),
    INSTALLATION_ID_REFRESH_TEMPORARY_TOKEN(EnumC4419g.SDK_ASSET_ILLUSTRATION_EXIT_BRUSHSTROKE_VALUE),
    INSTALLATION_ID_FIS_CREATE_INSTALLATION(EnumC4419g.SDK_ASSET_CASH_ICON_CIRCLE_VALUE),
    INSTALLATION_ID_FIS_GENERATE_AUTH_TOKEN(EnumC4419g.SDK_ASSET_ANIMATION_MOBILE_AUTH_LOADING_VALUE),
