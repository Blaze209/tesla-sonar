...
public abstract class zzah extends zzac implements List, RandomAccess {
    ...
    static zzah zzq(Object[] objArr, int i11) {
        return i11 == 0 ? zzaj.zza : new zzaj(objArr, i11);
    }
