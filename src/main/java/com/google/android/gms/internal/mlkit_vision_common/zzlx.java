...
public class zzlx implements Closeable {
    ...
    public void zzc(long j11) {
        ...
        long j12 = this.zzf;
        if (j12 != 0 && jElapsedRealtimeNanos - j12 >= 1000000) {
            zza();
        }
        ...
        if (this.zzc % 50 == 0) {
            String.format(Locale.US, "[%s] cur=%dus, counts=%d, min=%dus, max=%dus, avg=%dus", this.zzb, Long.valueOf(j11), Integer.valueOf(this.zzc), Long.valueOf(this.zzg), Long.valueOf(this.zzh), Integer.valueOf((int) (this.zzd / ((double) this.zzc))));
            zzmw.zza();
        }
        if (this.zzc % 500 == 0) {
            zza();
