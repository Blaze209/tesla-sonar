...
final class zzhq {
        ...
        try {
            ...
            try {
                ...
                while (i13 < jZzc) {
                    ...
                    zzhlVarArr[i13] = new zzhl(zzhpVarZzb, zzb(inputStream, zzhsVar));
                    i13++;
                    zzhpVar = zzhpVarZzb;
                }
    ...
    private static final void zzc(byte b11, long j11, InputStream inputStream, zzhs zzhsVar) throws zzhf {
        switch (b11) {
            case 24:
                if (j11 >= 24) {
                    return;
