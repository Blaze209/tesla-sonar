...
public class zzmb<MessageType extends zzmf<MessageType, BuilderType>, BuilderType extends zzmb<MessageType, BuilderType>> extends zzkr<MessageType, BuilderType> {
    ...
    public final /* bridge */ /* synthetic */ zzkr zzaS(byte[] bArr, int i11, int i12) throws zzmr {
        int i13 = zzlr.zzb;
        int i14 = zznu.zza;
        zzbe(bArr, 0, i12, zzlr.zza);
        return this;
    }

    @Override // com.google.android.gms.internal.measurement.zzkr
    public final /* bridge */ /* synthetic */ zzkr zzaT(byte[] bArr, int i11, int i12, zzlr zzlrVar) throws zzmr {
        zzbe(bArr, 0, i12, zzlrVar);
        return this;
    }
    ...
    public final zzmb zzbe(byte[] bArr, int i11, int i12, zzlr zzlrVar) throws zzmr {
        if (!this.zza.zzcf()) {
            zzaY();
        }
        try {
            zznu.zza().zzb(this.zza.getClass()).zzi(this.zza, bArr, 0, i12, new zzkw(zzlrVar));
            return this;
        } catch (zzmr e11) {
            throw e11;
