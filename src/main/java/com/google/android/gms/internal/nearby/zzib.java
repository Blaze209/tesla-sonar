...
public final class zzib extends AbstractSafeParcelable {
    ...
    zzib(@SafeParcelable.Param(id = 1) IBinder iBinder, @SafeParcelable.Param(id = 2) IBinder iBinder2, @SafeParcelable.Param(id = 3) String str, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 5) long j11, @SafeParcelable.Param(id = 6) AdvertisingOptions advertisingOptions, @SafeParcelable.Param(id = 7) IBinder iBinder3, @SafeParcelable.Param(id = 8) byte[] bArr) {
        zzfv zzftVar;
        zzey zzewVar;
        zzfe zzfcVar = null;
        if (iBinder == null) {
