...
final class zzcz implements d {
    ...
    zzcz(OutputStream outputStream, Map map, Map map2, c cVar) {
    ...
    private static int zzh(b bVar) {
        zzcx zzcxVar = (zzcx) bVar.c(zzcx.class);
        if (zzcxVar != null) {
            return zzcxVar.zza();
        }
    ...
    private final zzcz zzk(c cVar, b bVar, Object obj, boolean z11) throws IOException {
    ...
    private final zzcz zzl(e eVar, b bVar, Object obj, boolean z11) {
    ...
    final zzcz zzd(@NonNull b bVar, int i11, boolean z11) throws IOException {
        if (!z11 || i11 != 0) {
            zzcx zzcxVarZzj = zzj(bVar);
    ...
    final zzcz zze(@NonNull b bVar, long j11, boolean z11) throws IOException {
        if (!z11 || j11 != 0) {
            zzcx zzcxVarZzj = zzj(bVar);
            int iOrdinal = zzcxVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
