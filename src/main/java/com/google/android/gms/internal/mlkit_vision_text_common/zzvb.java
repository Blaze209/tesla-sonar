...
public final class zzvb extends AbstractSafeParcelable {
    ...
    public zzvb(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) Rect rect, @SafeParcelable.Param(id = 3) List list, @SafeParcelable.Param(id = 4) String str2, @SafeParcelable.Param(id = 5) float f11, @SafeParcelable.Param(id = 6) float f12, @SafeParcelable.Param(id = 7) List list2) {
        this.zza = str;
        this.zzb = rect;
        this.zzc = list;
        this.zzd = str2;
