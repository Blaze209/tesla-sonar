...
public final class zzeu extends AbstractSafeParcelable {
    ...
    zzeu(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i11, @SafeParcelable.Param(id = 3) zzjk zzjkVar, @SafeParcelable.Param(id = 4) com.google.android.gms.nearby.connection.zzo zzoVar) {
        this.zza = str;
        this.zzb = i11;
        this.zzc = zzjkVar;
        this.zzd = zzoVar;
