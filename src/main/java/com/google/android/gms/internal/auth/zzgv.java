...
class zzgv extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        int i12 = 0;
        if (i11 >= 0) {
            int iCompareTo = comparable.compareTo(((zzgp) this.zzb.get(i11)).zza());
            if (iCompareTo > 0) {
                return -(size + 1);
            }
            if (iCompareTo == 0) {
        ...
        while (i12 <= i11) {
            int i13 = (i12 + i11) / 2;
            int iCompareTo2 = comparable.compareTo(((zzgp) this.zzb.get(i13)).zza());
            if (iCompareTo2 < 0) {
                i11 = i13 - 1;
            } else {
                if (iCompareTo2 <= 0) {
    ...
    public final int hashCode() {
        ...
        int iHashCode = 0;
        for (int i11 = 0; i11 < iZzb; i11++) {
            iHashCode += ((zzgp) this.zzb.get(i11)).hashCode();
        }
