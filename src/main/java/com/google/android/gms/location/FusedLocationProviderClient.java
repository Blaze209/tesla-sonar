...
public interface FusedLocationProviderClient extends HasApiKey<Api.ApiOptions.NoOptions> {
    ...
    @NonNull
    @Deprecated
    Task<Void> requestDeviceOrientationUpdates(@NonNull DeviceOrientationRequest deviceOrientationRequest, @NonNull DeviceOrientationListener deviceOrientationListener, Looper looper);
