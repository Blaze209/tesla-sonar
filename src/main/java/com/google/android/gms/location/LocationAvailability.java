...
public final class LocationAvailability extends AbstractSafeParcelable implements ReflectedParcelable {
    ...
    @SafeParcelable.Field(defaultValueUnchecked = WebrtcBuildVersion.maint_version, getter = "getElapsedRealtimeNs", id = 3)
    ...
    LocationAvailability(@SafeParcelable.Param(id = 4) int i11, @SafeParcelable.Param(id = 1) int i12, @SafeParcelable.Param(id = 2) int i13, @SafeParcelable.Param(id = 3) long j11, @SafeParcelable.Param(id = 5) zzal[] zzalVarArr, @SafeParcelable.Param(id = 6) boolean z11) {
    ...
    public String toString() {
        ...
        StringBuilder sb2 = new StringBuilder(String.valueOf(zIsLocationAvailable).length() + 22);
