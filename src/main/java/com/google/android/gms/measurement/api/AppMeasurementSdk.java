...
public class AppMeasurementSdk {
    ...
    public Map<String, Object> getUserProperties(String str, String str2, boolean z11) {
        return this.zza.zzC(str, str2, z11);
    }
    ...
    @KeepForSdk
    public void logEventNoInterceptor(@NonNull String str, @NonNull String str2, Bundle bundle, long j11) {
        this.zza.zzj(str, str2, bundle, j11);
    }
