...
final class zzkx implements Runnable {
    ...
    zzkx(zzky zzkyVar, boolean z11, Uri uri, String str, String str2) {
        this.zza = z11;
        this.zzb = uri;
        this.zzc = str;
        this.zzd = str2;
    ...
    public final void run() {
        ...
        try {
            ...
            if (this.zza && (bundleZzi2 = zzicVar.zzk().zzi(uri)) != null) {
                bundleZzi2.putString("_cis", AnalyticsAttribute.Intent);
            ...
            zzkyVar.zza.zzu.zzaV().zzb().zzb("Throwable caught in handleReferrerForOnActivityCreated", e11);
        }
    }
}
