...
final class zzmc implements Runnable {
    ...
    zzmc(zznl zznlVar, String str, String str2, zzr zzrVar, boolean z11, com.google.android.gms.internal.measurement.zzcu zzcuVar) {
        this.zza = str;
        this.zzb = str2;
        this.zzc = zzrVar;
        this.zzd = z11;
        ...
        try {
            ...
            if (listZzp != null) {
                for (zzpl zzplVar : listZzp) {
                    ...
                    if (str != null) {
                        ...
                        Long l11 = zzplVar.zzd;
                        if (l11 != null) {
                            bundle.putLong(zzplVar.zzb, l11.longValue());
                        } else {
                            Double d11 = zzplVar.zzg;
                            if (d11 != null) {
                                bundle.putDouble(zzplVar.zzb, d11.doubleValue());
                            }
                        }
                    }
                }
            ...
            try {
                try {
                    ...
                    e11 = e12;
                    this.zzf.zzu.zzaV().zzb().zzc("Failed to get user properties; remote exception", this.zza, e11);
