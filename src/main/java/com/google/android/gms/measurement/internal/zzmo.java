...
final class zzmo implements Runnable {
    ...
    zzmo(zznl zznlVar, boolean z11, zzr zzrVar, boolean z12, zzbe zzbeVar, Bundle bundle) {
        this.zza = zzrVar;
        this.zzb = z12;
        this.zzc = zzbeVar;
        this.zzd = bundle;
    ...
    public final void run() {
        ...
        try {
            ...
            this.zze.zzu.zzaV().zzb().zzb("Failed to send default event parameters to service", e11);
        }
    }
}
