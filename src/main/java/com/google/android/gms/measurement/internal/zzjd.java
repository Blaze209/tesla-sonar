...
public final class zzjd extends zzga {
    ...
    private final void zzN(zzr zzrVar, boolean z11) {
    ...
    private final void zzO(String str, boolean z11) {
    ...
    final /* synthetic */ void zzH(zzr zzrVar, Bundle bundle, zzge zzgeVar, String str) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to return trigger URIs for app", str, e11);
        }
    }
    ...
    final /* synthetic */ void zzI(String str, zzoo zzooVar, zzgh zzghVar) {
            ...
            if (zzpgVar.zzO(str, zzpjVar.zze())) {
                ...
                try {
                    ...
                    for (int i11 = 0; i11 < zzhzVar.zzb(); i11++) {
                        com.google.android.gms.internal.measurement.zzic zzicVar = (com.google.android.gms.internal.measurement.zzic) zzhzVar.zzc(i11).zzcl();
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("[sgtm] Failed to return upload batches for app", str, e11);
        }
    }
    ...
    final /* synthetic */ void zzK(Bundle bundle, String str, zzr zzrVar) {
        ...
        if (bundle.isEmpty() && zZzp) {
            ...
            try {
                ...
                zzavVarZzj.zzu.zzaV().zzb().zzb("Error clearing default event params", e11);
                return;
            }
        }
        ...
        try {
            ...
            zzavVarZzj2.zzu.zzaV().zzb().zzc("Error storing default event parameters. appId", zzgu.zzl(str), e12);
        }
        zzpg zzpgVar2 = this.zza;
        zzav zzavVarZzj3 = zzpgVar2.zzj();
        long j11 = zzrVar.zzD;
        if (zzavVarZzj3.zzV(str, j11)) {
            zzpgVar2.zzj().zzW(str, Long.valueOf(j11), null, bundle);
        }
    }
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    public final List zzj(zzr zzrVar, boolean z11) {
        zzN(zzrVar, false);
        String str = zzrVar.zza;
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    public final void zzl(long j11, String str, String str2, String str3) {
        zzd(new zzig(this, str2, str3, str, j11));
    }
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    public final List zzp(String str, String str2, boolean z11, zzr zzrVar) {
        zzN(zzrVar, false);
    ...
    @Override // com.google.android.gms.measurement.internal.zzgb
    public final List zzq(String str, String str2, String str3, boolean z11) {
        zzO(str, true);
        try {
    ...
    public final List zzr(String str, String str2, zzr zzrVar) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzb("Failed to get conditional user properties", e11);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final List zzs(String str, String str2, String str3) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzb("Failed to get conditional user properties as", e11);
            return Collections.EMPTY_LIST;
        }
    }
    ...
    public final zzao zzw(zzr zzrVar) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get consent. appId", zzgu.zzl(zzrVar.zza), e11);
    ...
    public final List zzx(zzr zzrVar, Bundle bundle) {
        ...
        try {
            ...
            this.zza.zzaV().zzb().zzc("Failed to get trigger URIs. appId", zzgu.zzl(zzrVar.zza), e12);
            return Collections.EMPTY_LIST;
        }
    }
