...
final class zza extends zzc {
    ...
    public final void zzb(String str, String str2, Bundle bundle, long j11) {
        this.zzb.zzC(str, str2, bundle, true, false, j11);
    }

    @Override // com.google.android.gms.measurement.zzc
    public final Map zzc(boolean z11) {
        List<zzpl> listZzO = this.zzb.zzO(z11);
    ...
    public final Map zzd(String str, String str2, boolean z11) {
        return this.zzb.zzP(str, str2, z11);
    }
    ...
    public final Object zzx(int i11) {
        ...
        if (i11 != 2) {
            return i11 != 3 ? this.zzb.zzi() : this.zzb.zzl();
        }
        return this.zzb.zzm();
    }
}
