...
final class zzhh extends zzjf {
    ...
    zzhh(zzic zzicVar) {
        super(zzicVar);
        this.zzf = new zzhe(this, "session_timeout", ComponentTracker.DEFAULT_TIMEOUT);
    ...
    final Pair zzb(String str) {
        ...
        try {
            ...
            this.zzu.zzaV().zzj().zzb("Unable to get advertising id", e11);
            this.zzx = "";
        }
    ...
    final boolean zzk(int i11) {
        return zzjl.zzu(i11, zzd().getInt("consent_source", 100));
    }
    ...
    final void zzn(boolean z11) {
        zzg();
        this.zzu.zzaV().zzk().zzb("App measurement setting deferred collection", Boolean.valueOf(z11));
        SharedPreferences.Editor editorEdit = zzd().edit();
