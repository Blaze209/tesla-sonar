...
public final class zzht extends zzos implements zzak {
    ...
    private final void zzF(String str, com.google.android.gms.internal.measurement.zzgk zzgkVar) {
        ...
        for (int i11 = 0; i11 < zzgkVar.zza(); i11++) {
            com.google.android.gms.internal.measurement.zzgi zzgiVar = (com.google.android.gms.internal.measurement.zzgi) zzgkVar.zzb(i11).zzcl();
    ...
    private final com.google.android.gms.internal.measurement.zzgl zzH(String str, byte[] bArr) {
        ...
        try {
            ...
            return zzglVar;
        } catch (com.google.android.gms.internal.measurement.zzmr e11) {
            this.zzu.zzaV().zze().zzc("Unable to merge remote config. appId", zzgu.zzl(str), e11);
            return com.google.android.gms.internal.measurement.zzgl.zzs();
        } catch (RuntimeException e12) {
            this.zzu.zzaV().zze().zzc("Unable to merge remote config. appId", zzgu.zzl(str), e12);
            return com.google.android.gms.internal.measurement.zzgl.zzs();
        }
    }
    ...
    private static final zzjk zzJ(int i11) {
        int i12 = i11 - 1;
        if (i12 == 1) {
    ...
    protected final boolean zzi(String str, byte[] bArr, String str2, String str3) throws Throwable {
        ...
        try {
            ...
            this.zzu.zzaV().zze().zzc("Unable to serialize reduced-size config. Storing full config instead. appId", zzgu.zzl(str), e11);
        }
        ...
        try {
            ...
            zzavVarZzj.zzu.zzaV().zzb().zzc("Error storing remote config. appId", zzgu.zzl(str), e12);
        }
        zzgkVar.zzf();
        this.zzh.put(str, (com.google.android.gms.internal.measurement.zzgl) zzgkVar.zzbc());
        return true;
