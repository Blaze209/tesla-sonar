...
public final class zzgu extends zzjf {
    ...
    static String zzo(boolean z11, String str, Object obj, Object obj2, Object obj3) {
        String strZzp = zzp(z11, obj);
        String strZzp2 = zzp(z11, obj2);
        String strZzp3 = zzp(z11, obj3);
    ...
    protected final void zzm(int i11, boolean z11, boolean z12, String str, Object obj, Object obj2, Object obj3) {
        if (!z11 && Log.isLoggable(zzn(), i11)) {
            Log.println(i11, zzn(), zzo(false, str, obj, obj2, obj3));
        }
        if (z12 || i11 < 5) {
            return;
        }
        ...
        if (zzhzVarZzi == null) {
            ...
            zzhzVarZzi.zzj(new zzgr(this, i11, str, obj, obj2, obj3));
        }
    }
    ...
    final /* synthetic */ void zzs(char c11) {
        this.zza = c11;
    }
    ...
    final /* synthetic */ void zzu(long j11) {
        this.zzb = 133005L;
    }
}
