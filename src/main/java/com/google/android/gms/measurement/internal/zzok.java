...
public final class zzok extends zzos {
    ...
    public final void zzc(long j11) {
        ...
        zzd();
        zzicVar.zzaV().zzk().zzb("Scheduling upload, millis", Long.valueOf(j11));
        zzicVar.zzaZ().elapsedRealtime();
        zzicVar.zzc();
        if (j11 < Math.max(0L, ((Long) zzfy.zzL.zzb(null)).longValue()) && !zzf().zzc()) {
            zzf().zzb(j11);
        }
        zzicVar.zzaU();
        ...
        com.google.android.gms.internal.measurement.zzch.zza(contextZzaY2, new JobInfo.Builder(iZzi, componentName).setMinimumLatency(j11).setOverrideDeadline(j11 + j11).setExtras(persistableBundle).build(), "com.google.android.gms", "UploadAlarm");
    }
