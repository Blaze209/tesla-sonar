...
public final class zzat {
    ...
    public final List zza() {
        ...
        try {
            try {
                ...
                if (cursorQuery.moveToFirst()) {
                    do {
                        ...
                        try {
                            ...
                            arrayList.add(new zzas(j11, j12, z11, (com.google.android.gms.internal.measurement.zzhs) zzhrVar.zzbc()));
                        } catch (IOException e11) {
                            this.zza.zzu.zzaV().zzb().zzc("Data loss. Failed to merge raw event. appId", zzgu.zzl(this.zzb), e11);
                        }
                ...
                this.zza.zzu.zzaV().zzb().zzc("Data loss. Error querying raw events batch. appId", zzgu.zzl(this.zzb), e12);
            }
            return arrayList;
        } finally {
            if (0 != 0) {
    ...
    public zzat(zzav zzavVar, String str, long j11) {
        Objects.requireNonNull(zzavVar);
        this.zza = zzavVar;
        Preconditions.checkNotEmpty(str);
        this.zzb = str;
        this.zzc = zzavVar.zzah("select rowid from raw_events where app_id = ? and timestamp < ? order by rowid desc limit 1", new String[]{str, String.valueOf(j11)}, -1L);
    }
}
