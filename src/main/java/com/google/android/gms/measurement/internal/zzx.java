    ...
    final void zza() {
        ...
        if (zze()) {
            if (zzd()) {
                ...
                bundle.putString("_cis", AnalyticsAttribute.Intent);
                ...
                if (TextUtils.isEmpty(strZza)) {
                    ...
                    long jZza = zzicVar.zzd().zzs.zza() / CoreConstants.MILLIS_IN_ONE_HOUR;
                    ...
                    ((Bundle) pair.second).putLong("_cc", (jZza - 1) * CoreConstants.MILLIS_IN_ONE_HOUR);
