...
public final class zzd extends zzf {
    ...
    private final void zzh(long j11, zzlu zzluVar) {
        if (zzluVar == null) {
            this.zzu.zzaV().zzk().zza("Not logging ad exposure. No active activity");
            return;
        }
        if (j11 < 1000) {
            this.zzu.zzaV().zzk().zzb("Not logging ad exposure. Less than 1000 ms. exposure", Long.valueOf(j11));
            return;
        }
    ...
    private final void zzi(String str, long j11, zzlu zzluVar) {
        if (zzluVar == null) {
            this.zzu.zzaV().zzk().zza("Not logging ad unit exposure. No active activity");
            return;
        }
        if (j11 < 1000) {
            this.zzu.zzaV().zzk().zzb("Not logging ad unit exposure. Less than 1000 ms. exposure", Long.valueOf(j11));
            return;
        }
        Bundle bundle = new Bundle();
    ...
    public final void zzf(long j11) {
        ...
        while (it.hasNext()) {
            map.put((String) it.next(), Long.valueOf(j11));
        }
        if (map.isEmpty()) {
            return;
        }
    ...
    public final void zza(String str, long j11) {
        if (str == null || str.length() == 0) {
            ...
            this.zzu.zzaW().zzj(new zza(this, str, j11));
        }
    }
    ...
    public final void zzb(String str, long j11) {
        if (str == null || str.length() == 0) {
            ...
            this.zzu.zzaW().zzj(new zzb(this, str, j11));
        }
    }
    ...
    public final void zzc(long j11) {
        ...
        for (String str : map.keySet()) {
            zzi(str, j11 - ((Long) map.get(str)).longValue(), zzluVarZzh);
        }
        if (!map.isEmpty()) {
            zzh(j11 - this.zzc, zzluVarZzh);
        }
        zzf(j11);
    }

    final /* synthetic */ void zzd(String str, long j11) {
        zzg();
    ...
    final /* synthetic */ void zze(String str, long j11) {
        zzg();
        Preconditions.checkNotEmpty(str);
        Map map = this.zzb;
        Integer num = (Integer) map.get(str);
