...
public final class zzjl {
    ...
    public zzjl(Boolean bool, Boolean bool2, int i11) {
    ...
    public static zzjl zza(zzji zzjiVar, zzji zzjiVar2, int i11) {
        EnumMap enumMap = new EnumMap(zzjk.class);
    ...
    public static zzjl zze(Bundle bundle, int i11) {
        if (bundle == null) {
            return new zzjl(null, null, i11);
        }
        EnumMap enumMap = new EnumMap(zzjk.class);
    ...
    public static zzjl zzf(String str, int i11) {
        EnumMap enumMap = new EnumMap(zzjk.class);
        zzjk[] zzjkVarArrZza = zzjj.STORAGE.zza();
        for (int i12 = 0; i12 < zzjkVarArrZza.length; i12++) {
            String str2 = str == null ? "" : str;
            zzjk zzjkVar = zzjkVarArrZza[i12];
            int i13 = i12 + 2;
            if (i13 < str2.length()) {
                enumMap.put(zzjkVar, zzj(str2.charAt(i13)));
            } else {
    ...
    public static boolean zzu(int i11, int i12) {
        int i13 = -30;
        if (i11 == -20) {
            if (i12 == -30) {
                return true;
    ...
    private zzjl(EnumMap enumMap, int i11) {
