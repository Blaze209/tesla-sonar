...
public final class zzbh implements Parcelable.Creator {
    static void zza(zzbg zzbgVar, Parcel parcel, int i11) {
        String str = zzbgVar.zza;
        int iBeginObjectHeader = SafeParcelWriter.beginObjectHeader(parcel);
        SafeParcelWriter.writeString(parcel, 2, str, false);
        SafeParcelWriter.writeParcelable(parcel, 3, zzbgVar.zzb, i11, false);
    ...
    public final /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        return new zzbg(strCreateString, zzbeVar, strCreateString2, j11);
    }
