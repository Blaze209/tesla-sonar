...
final class zzob {
    ...
    final void zzb(long j11, boolean z11) {
        ...
        zzocVar.zzj();
        zzic zzicVar = zzocVar.zzu;
        if (zzicVar.zzd().zzp(j11)) {
            zzicVar.zzd().zzg.zzb(true);
            zzocVar.zzu.zzv().zzi();
        }
        zzicVar.zzd().zzk.zzb(j11);
    ...
    final void zzc(long j11, boolean z11) {
        ...
        if (zzocVar.zzu.zzB()) {
            ...
            zzicVar2.zzj().zzN(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_sid", Long.valueOf(j12), j11);
            zzicVar.zzd().zzl.zzb(j12);
            zzicVar.zzd().zzg.zzb(false);
            Bundle bundle = new Bundle();
            bundle.putLong("_sid", j12);
            zzicVar2.zzj().zzG(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_s", j11, bundle);
            ...
            zzicVar2.zzj().zzG(DebugKt.DEBUG_PROPERTY_VALUE_AUTO, "_ssr", j11, bundle2);
        }
    }
}
