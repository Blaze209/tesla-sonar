...
public interface Connections {
    ...
    public interface MessageListener {
        ...
        @Deprecated
        void onMessageReceived(@NonNull String str, @NonNull byte[] bArr, boolean z11);
    }
    ...
    @NonNull
    PendingResult<Status> cancelPayload(@NonNull GoogleApiClient googleApiClient, long j11);
    ...
    @NonNull
    PendingResult<Status> requestConnection(@NonNull GoogleApiClient googleApiClient, String str, @NonNull String str2, @NonNull ConnectionLifecycleCallback connectionLifecycleCallback);
    ...
    @NonNull
    @Deprecated
    PendingResult<StartAdvertisingResult> startAdvertising(@NonNull GoogleApiClient googleApiClient, @NonNull String str, @NonNull AppMetadata appMetadata, long j11, @NonNull ConnectionRequestListener connectionRequestListener);
    ...
    @NonNull
    @Deprecated
    PendingResult<Status> startDiscovery(@NonNull GoogleApiClient googleApiClient, @NonNull String str, long j11, @NonNull EndpointDiscoveryListener endpointDiscoveryListener);
