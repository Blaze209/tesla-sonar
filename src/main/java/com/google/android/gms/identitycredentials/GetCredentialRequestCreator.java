...
public final class GetCredentialRequestCreator implements Parcelable.Creator<GetCredentialRequest> {
    static void writeToParcel(GetCredentialRequest getCredentialRequest, Parcel parcel, int i11) {
        ...
        SafeParcelWriter.writeParcelable(parcel, 4, getCredentialRequest.getResultReceiver(), i11, false);
