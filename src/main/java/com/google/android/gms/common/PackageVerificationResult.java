...
public class PackageVerificationResult {
    ...
    private PackageVerificationResult(String str, int i11, boolean z11, String str2, Throwable th2, com.google.android.gms.common.signatureverification.zza zzaVar) {
        this.zza = str;
        this.zzb = z11;
        this.zzc = str2;
        this.zzd = th2;
    ...
    public static PackageVerificationResult zzd(String str, int i11, com.google.android.gms.common.signatureverification.zza zzaVar) {
        return new PackageVerificationResult(str, i11, true, null, null, null);
    }
