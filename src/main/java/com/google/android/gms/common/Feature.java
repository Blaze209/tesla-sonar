...
public class Feature extends AbstractSafeParcelable {
    ...
    public Feature(@NonNull @SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) int i11, @SafeParcelable.Param(id = 3) long j11, @SafeParcelable.Param(id = 4) boolean z11) {
        this.zza = str;
        this.zzb = i11;
        this.zzc = j11;
        this.zzd = z11;
    ...
    @KeepForSdk
    public Feature(@NonNull String str, long j11, boolean z11) {
        this(str, -1, j11, z11);
    }
}
