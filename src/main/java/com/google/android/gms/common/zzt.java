...
public final class zzt extends AbstractSafeParcelable {
    ...
    zzt(String str, zzj zzjVar, boolean z11, boolean z12) {
        this.zza = str;
        this.zzb = zzjVar;
        this.zzc = z11;
        this.zzd = z12;
    ...
    zzt(@SafeParcelable.Param(id = 1) String str, @SafeParcelable.Param(id = 2) IBinder iBinder, @SafeParcelable.Param(id = 3) boolean z11, @SafeParcelable.Param(id = 4) boolean z12) {
        this.zza = str;
        zzk zzkVar = null;
        if (iBinder != null) {
            try {
