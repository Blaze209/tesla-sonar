...
public final class ComplianceOptions extends AbstractSafeParcelable {
    ...
    ComplianceOptions(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) int i13, @SafeParcelable.Param(id = 4) boolean z11) {
        this.zzb = i11;
        this.zzc = i12;
        this.zzd = i13;
        this.zze = z11;
