...
public final class ApiMetadata extends AbstractSafeParcelable {
    ...
    public static final class Builder {
        ...
        @NonNull
        @KeepForSdk
        public Builder setCallbackSupportEnabled(boolean z11) {
            this.zzb = z11;
            return this;
        }
        ...
        final /* synthetic */ Builder zza(boolean z11) {
            this.zzc = z11;
            return this;
        }
    }
    ...
    ApiMetadata(@SafeParcelable.Param(id = 1) ComplianceOptions complianceOptions, @SafeParcelable.Param(id = 2) boolean z11) {
    ...
    final /* synthetic */ void zza(boolean z11) {
        this.zze = z11;
    }
}
