...
public final class zac {
    ...
    public static String zab(Context context, int i11) {
        ...
        if (i11 != 2) {
            return i11 != 3 ? resources.getString(android.R.string.ok) : resources.getString(R.string.common_google_play_services_enable_button);
        }
    ...
    public static String zae(Context context, int i11) {
        String strZah = i11 == 6 ? zah(context, "common_google_play_services_resolution_required_title") : zaf(context, i11);
    ...
    private static String zah(Context context, String str) {
        ...
        synchronized (x0Var) {
            try {
                Locale localeC = f.a(context.getResources().getConfiguration()).c(0);
                ...
                int identifier = remoteResource.getIdentifier(str, InquiryField.StringField.TYPE, "com.google.android.gms");
                if (identifier == 0) {
