...
public final class GooglePlayServicesUtil extends GooglePlayServicesUtilLight {
    ...
    public static boolean showErrorDialogFragment(int i11, @NonNull Activity activity, Fragment fragment, int i12, DialogInterface.OnCancelListener onCancelListener) {
        ...
        Dialog dialogZaa = googleApiAvailability.zaa(activity, i13, zag.zac(fragment, GoogleApiAvailability.getInstance().getErrorResolutionIntent(activity, i13, DateTokenConverter.CONVERTER_KEY), i12), onCancelListener, null);
        if (dialogZaa == null) {
            return false;
        }
