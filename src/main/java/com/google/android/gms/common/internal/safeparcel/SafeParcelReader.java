...
public class SafeParcelReader {
    ...
    public static SparseArray<byte[]> createByteArraySparseArray(@NonNull Parcel parcel, int i11) {
        ...
        int i12 = parcel.readInt();
        SparseArray<byte[]> sparseArray = new SparseArray<>(i12);
        for (int i13 = 0; i13 < i12; i13++) {
    ...
    public static SparseArray<IBinder> createIBinderSparseArray(@NonNull Parcel parcel, int i11) {
        ...
        int i12 = parcel.readInt();
        SparseArray<IBinder> sparseArray = new SparseArray<>(i12);
        for (int i13 = 0; i13 < i12; i13++) {
    ...
    public static SparseArray<Parcel> createParcelSparseArray(@NonNull Parcel parcel, int i11) {
        ...
        for (int i13 = 0; i13 < i12; i13++) {
            ...
            if (i15 != 0) {
                ...
                sparseArray.append(i14, parcelObtain);
                parcel.setDataPosition(iDataPosition2 + i15);
            } else {
                sparseArray.append(i14, null);
            }
        }
        parcel.setDataPosition(iDataPosition + size);
        return sparseArray;
    ...
    private static void zzb(Parcel parcel, int i11, int i12, int i13) {
        if (i12 == i13) {
            return;
        }
