...
public final class ConnectionResult extends AbstractSafeParcelable {
    ...
    ConnectionResult(@SafeParcelable.Param(id = 1) int i11, @SafeParcelable.Param(id = 2) int i12, @SafeParcelable.Param(id = 3) PendingIntent pendingIntent, @SafeParcelable.Param(id = 4) String str, @SafeParcelable.Param(id = 5) Integer num) {
        this.zza = i11;
        this.zzb = i12;
    ...
    @KeepForSdk
    public ConnectionResult(int i11, PendingIntent pendingIntent, String str, Integer num) {
        this(1, i11, pendingIntent, str, num);
    }
}
