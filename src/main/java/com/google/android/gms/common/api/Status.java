...
public final class Status extends AbstractSafeParcelable implements Result, ReflectedParcelable {
    ...
    public void startResolutionForResult(@NonNull ActivityResultLauncher<e> activityResultLauncher) {
        if (hasResolution()) {
            PendingIntent pendingIntent = this.zzc;
            Preconditions.checkNotNull(pendingIntent);
            activityResultLauncher.b(new e.a(pendingIntent.getIntentSender()).a());
        }
    }
}
