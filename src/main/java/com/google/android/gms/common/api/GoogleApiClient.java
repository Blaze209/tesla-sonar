...
public abstract class GoogleApiClient {
    ...
    public abstract void stopAutoManage(@NonNull u uVar);
    ...
    public static final class Builder {
        ...
        public GoogleApiClient build() {
            ...
            for (Api api2 : this.zaj.keySet()) {
                ...
                boolean z12 = mapZad.get(api2) != null;
        ...
        @NonNull
        public Builder enableAutoManage(@NonNull u uVar, int i11, OnConnectionFailedListener onConnectionFailedListener) {
        ...
        @NonNull
        public Builder enableAutoManage(@NonNull u uVar, OnConnectionFailedListener onConnectionFailedListener) {
            enableAutoManage(uVar, 0, onConnectionFailedListener);
            return this;
        }
