...
public class ConnectionTracker {
    ...
    private final boolean zzb(Context context, String str, Intent intent, ServiceConnection serviceConnection, int i11, boolean z11, Executor executor) {
        ...
        try {
            boolean zZze = zze(context, intent, serviceConnection, i11, executor);
            if (zZze) {
                return zZze;
            }
    ...
    public boolean bindService(@NonNull Context context, @NonNull Intent intent, @NonNull ServiceConnection serviceConnection, int i11) {
        return zzb(context, context.getClass().getName(), intent, serviceConnection, i11, true, null);
    }
