...
public final class zzdo implements PlacesClient {
    ...
    zzdo(zzcs zzcsVar, zzci zzciVar, zzcn zzcnVar, zzfr zzfrVar, zzbx zzbxVar) {
        this.zza = zzcsVar;
        this.zzb = zzciVar;
        this.zzc = zzcnVar;
        this.zzd = zzfrVar;
    ...
    public final Task<FetchPhotoResponse> fetchPhoto(final FetchPhotoRequest fetchPhotoRequest) {
        try {
            ...
            zzcc.zza();
            final zzcg zzcgVarZza = zzcg.zza();
            return this.zza.zza(fetchPhotoRequest).continueWith(new Continuation() { // from class: com.google.android.libraries.places.internal.zzdi
                ...
                public final Object then(Task task) {
                    return this.zza.zzc(fetchPhotoRequest, zzcgVarZza, task);
                }
    ...
    public final Task<FetchPlaceResponse> fetchPlace(final FetchPlaceRequest fetchPlaceRequest) {
        try {
            ...
            return this.zza.zzb(fetchPlaceRequest).continueWith(new Continuation() { // from class: com.google.android.libraries.places.internal.zzdm
                @Override // com.google.android.gms.tasks.Continuation
                public final Object then(Task task) {
                    return this.zza.zzd(fetchPlaceRequest, zzcgVarZza, task);
                }
            }).continueWithTask(zzdj.zza);
        } catch (Error | RuntimeException e11) {
            zzgb.zzb(e11);
    ...
    public final Task<FindAutocompletePredictionsResponse> findAutocompletePredictions(final FindAutocompletePredictionsRequest findAutocompletePredictionsRequest) {
        try {
            ...
            return this.zza.zzc(findAutocompletePredictionsRequest).continueWith(new Continuation() { // from class: com.google.android.libraries.places.internal.zzdn
                @Override // com.google.android.gms.tasks.Continuation
                public final Object then(Task task) {
                    return this.zza.zze(findAutocompletePredictionsRequest, zzcgVarZza, task);
                }
            }).continueWithTask(zzdj.zza);
        } catch (Error | RuntimeException e11) {
            zzgb.zzb(e11);
    ...
    public final Task zza(final FindCurrentPlaceRequest findCurrentPlaceRequest, String str) {
        try {
            ...
            return this.zzb.zza(findCurrentPlaceRequest.getCancellationToken()).onSuccessTask(new SuccessContinuation(findCurrentPlaceRequest, str2) { // from class: com.google.android.libraries.places.internal.zzdk
                ...
                @Override // com.google.android.gms.tasks.Continuation
                public final Object then(Task task) {
                    return this.zza.zzf(findCurrentPlaceRequest, jZza, zzcgVarZza, task);
                }
            }).continueWithTask(zzdj.zza);
        } catch (Error | RuntimeException e11) {
            zzgb.zzb(e11);
    ...
    final /* synthetic */ Task zzb(FindCurrentPlaceRequest findCurrentPlaceRequest, String str, Location location) {
        zzig.zzc(location, "Location must not be null.");
        return this.zza.zzd(findCurrentPlaceRequest, location, this.zzc.zza(null));
    }

    final /* synthetic */ FetchPhotoResponse zzc(FetchPhotoRequest fetchPhotoRequest, zzcg zzcgVar, Task task) {
        this.zzd.zza(fetchPhotoRequest);
        zzg(zzcf.zzb("FetchPhoto"), zzcgVar);
        return (FetchPhotoResponse) task.getResult();
    }

    final /* synthetic */ FetchPlaceResponse zzd(FetchPlaceRequest fetchPlaceRequest, zzcg zzcgVar, Task task) {
        this.zzd.zzc(fetchPlaceRequest);
        zzg(zzcf.zzb("FetchPlace"), zzcgVar);
        return (FetchPlaceResponse) task.getResult();
    }

    final /* synthetic */ FindAutocompletePredictionsResponse zze(FindAutocompletePredictionsRequest findAutocompletePredictionsRequest, zzcg zzcgVar, Task task) {
    ...
    final /* synthetic */ FindCurrentPlaceResponse zzf(FindCurrentPlaceRequest findCurrentPlaceRequest, long j11, zzcg zzcgVar, Task task) {
