...
public class AutocompleteSupportFragment extends Fragment {
    ...
    public void onActivityResult(int i11, int i12, Intent intent) throws Throwable {
        if (i11 == 30421) {
            try {
    ...
    public void onViewCreated(@RecentlyNonNull View view, Bundle bundle) {
        ...
        this.zza.observe(getViewLifecycleOwner(), new j0() { // from class: com.google.android.libraries.places.widget.zzh
            @Override // androidx.p003lifecycle.j0
            public final void onChanged(Object obj) {
                this.zza.zzc(editText, viewFindViewById2, (CharSequence) obj);
            }
        });
        this.zzb.observe(getViewLifecycleOwner(), new j0() { // from class: com.google.android.libraries.places.widget.zzi
            @Override // androidx.p003lifecycle.j0
            public final void onChanged(Object obj) {
