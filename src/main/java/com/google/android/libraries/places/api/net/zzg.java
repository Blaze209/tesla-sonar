...
final class zzg extends FetchPlaceRequest {
    ...
    public final int hashCode() {
        int iHashCode = (((this.zza.hashCode() ^ 1000003) * 1000003) ^ this.zzb.hashCode()) * 1000003;
        AutocompleteSessionToken autocompleteSessionToken = this.zzc;
        int iHashCode2 = (iHashCode ^ (autocompleteSessionToken == null ? 0 : autocompleteSessionToken.hashCode())) * 1000003;
        CancellationToken cancellationToken = this.zzd;
        return iHashCode2 ^ (cancellationToken != null ? cancellationToken.hashCode() : 0);
    }
