...
public final class zzyh extends zzaey implements zzagh {
    ...
    static /* synthetic */ void zzd(zzyh zzyhVar, int i11) {
        zzyhVar.zzd |= 4;
        zzyhVar.zzg = i11;
    }

    static /* synthetic */ void zze(zzyh zzyhVar, zzxv zzxvVar) {
        zzxvVar.getClass();
        zzyhVar.zzj = zzxvVar;
        zzyhVar.zzd |= 32;
    }

    static /* synthetic */ void zzf(zzyh zzyhVar, zzxj zzxjVar) {
        zzxjVar.getClass();
        zzyhVar.zzl = zzxjVar;
        zzyhVar.zzd |= 128;
    }

    static /* synthetic */ void zzg(zzyh zzyhVar, zzxq zzxqVar) {
        zzxqVar.getClass();
        zzyhVar.zzn = zzxqVar;
        zzyhVar.zzd |= 512;
    }

    static /* synthetic */ void zzh(zzyh zzyhVar, int i11) {
        zzyhVar.zze = i11 - 1;
        zzyhVar.zzd |= 1;
    }

    static /* synthetic */ void zzi(zzyh zzyhVar, int i11) {
        zzyhVar.zzf = i11 - 1;
        zzyhVar.zzd |= 2;
    }
