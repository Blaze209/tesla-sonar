...
public final class zzafn extends zzadr implements RandomAccess, zzafo {
    ...
    private static String zzi(Object obj) {
        ...
        return obj instanceof zzaed ? ((zzaed) obj).zzm(zzafh.zzb) : zzafh.zzg((byte[]) obj);
    }
    ...
    public final boolean addAll(int i11, Collection collection) {
        ...
        boolean zAddAll = this.zzc.addAll(i11, collection);
        ((AbstractList) this).modCount++;
        return zAddAll;
    }
    ...
    public final /* bridge */ /* synthetic */ Object remove(int i11) {
        zza();
        Object objRemove = this.zzc.remove(i11);
        ((AbstractList) this).modCount++;
    ...
    public final String get(int i11) {
        ...
        if (obj instanceof zzaed) {
            ...
            String strZzm = zzaedVar.zzm(zzafh.zzb);
            if (zzaedVar.zzi()) {
                this.zzc.set(i11, strZzm);
            }
            return strZzm;
        }
        byte[] bArr = (byte[]) obj;
        String strZzg = zzafh.zzg(bArr);
        if (zzafh.zzh(bArr)) {
            this.zzc.set(i11, strZzg);
        }
        return strZzg;
    }
