...
public final class zzaac extends zzaey implements zzagh {
    ...
    static /* synthetic */ void zzd(zzaac zzaacVar, int i11) {
        zzaacVar.zzd |= 4;
        zzaacVar.zzg = i11;
    }

    static /* synthetic */ void zze(zzaac zzaacVar, zzaau zzaauVar) {
        zzaauVar.getClass();
        zzaacVar.zzh = zzaauVar;
        zzaacVar.zzd |= 8;
    }

    static /* synthetic */ void zzf(zzaac zzaacVar, int i11) {
        zzaacVar.zzf = i11 - 1;
        zzaacVar.zzd |= 2;
    }
