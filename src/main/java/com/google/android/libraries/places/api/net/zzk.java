...
final class zzk extends FindAutocompletePredictionsRequest {
    ...
    public final int hashCode() {
        ...
        LocationBias locationBias = this.zzb;
        int iHashCode2 = (iHashCode ^ (locationBias == null ? 0 : locationBias.hashCode())) * 1000003;
        LocationRestriction locationRestriction = this.zzc;
        int iHashCode3 = (iHashCode2 ^ (locationRestriction == null ? 0 : locationRestriction.hashCode())) * 1000003;
        LatLng latLng = this.zzd;
