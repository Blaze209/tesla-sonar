...
public final class zzaba extends zzaey implements zzagh {
    ...
    static /* synthetic */ void zzd(zzaba zzabaVar, String str) {
        str.getClass();
        zzabaVar.zzd |= 2;
        zzabaVar.zzf = str;
    }

    static /* synthetic */ void zze(zzaba zzabaVar, String str) {
        str.getClass();
        zzabaVar.zzd |= 4;
        zzabaVar.zzg = str;
    }

    static /* synthetic */ void zzf(zzaba zzabaVar, zzzv zzzvVar) {
        zzzvVar.getClass();
        zzabaVar.zzl = zzzvVar;
        zzabaVar.zzd |= 128;
    }

    static /* synthetic */ void zzg(zzaba zzabaVar, zzyy zzyyVar) {
        zzyyVar.getClass();
        zzabaVar.zzm = zzyyVar;
        zzabaVar.zzd |= 256;
    }

    static /* synthetic */ void zzh(zzaba zzabaVar, int i11) {
        zzabaVar.zze = i11 - 1;
        zzabaVar.zzd |= 1;
    }
