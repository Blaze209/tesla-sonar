...
final class zzex {
    ...
    static {
        ...
        zzjaVar2.zza(PlaceTypes.COUNTRY, Place.Type.COUNTRY);
    ...
    static List zzb(List list) {
        ...
        while (zzjwVarListIterator.hasNext()) {
            String str = (String) zzjwVarListIterator.next();
            zzjb zzjbVar = zzb;
    ...
    /* JADX WARN: Multi-variable type inference failed */
    static final Place zzc(zzfa zzfaVar, List list) throws ApiException {
        ...
        Integer numValueOf;
        ArrayList arrayList;
        OpeningHours openingHoursBuild;
        ...
        if (zzfaVar != null) {
            zziy zziyVarZzd = zzfaVar.zzd();
            PlusCode plusCodeBuild = null;
            if (zziyVarZzd == null) {
                addressComponentsNewInstance = null;
            } else {
                ArrayList arrayList3 = new ArrayList();
                zzjw zzjwVarListIterator = zziyVarZzd.listIterator(0);
                while (zzjwVarListIterator.hasNext()) {
                    zzfa.zza zzaVar = (zzfa.zza) zzjwVarListIterator.next();
                    if (zzaVar == null) {
                        ...
                        try {
                            ...
                            zziy zziyVarZza = zzaVar.zza();
                            if (zziyVarZza == null) {
                                throw null;
                            }
                            AddressComponent.Builder builder2 = AddressComponent.builder(strZzb, zziyVarZza);
                            builder2.setShortName(zzaVar.zzc());
                            addressComponentBuild = builder2.build();
                        } catch (IllegalStateException | NullPointerException e11) {
                            throw zzd(String.format("AddressComponent not properly defined (%s).", e11.getMessage()));
                        }
                    }
                    zzg(arrayList3, addressComponentBuild);
                }
                addressComponentsNewInstance = AddressComponents.newInstance(arrayList3);
            }
            zzfa.zzb zzbVarZza = zzfaVar.zza();
            if (zzbVarZza != null) {
                latLngZze = zze(zzbVarZza.zza());
                zzfa.zzb.C0657zzb c0657zzbZzb = zzbVarZza.zzb();
                if (c0657zzbZzb == null) {
                    latLngBounds = null;
                } else {
                    LatLng latLngZze2 = zze(c0657zzbZzb.zzb());
                    LatLng latLngZze3 = zze(c0657zzbZzb.zza());
                    if (latLngZze2 == null || latLngZze3 == null) {
                        latLngBounds = null;
                    } else {
                        latLngBounds = new LatLngBounds(latLngZze2, latLngZze3);
                    }
                }
            } else {
                latLngZze = null;
            ...
            String strZzr = zzfaVar.zzr();
            Uri uri = strZzr != null ? Uri.parse(strZzr) : null;
            String strZzn = zzfaVar.zzn();
            String strConcat = strZzn != null ? strZzn.concat(".png") : null;
            String strZzm = zzfaVar.zzm();
            if (strZzm != null) {
                try {
                    numValueOf = Integer.valueOf(Color.parseColor(strZzm));
            ...
            builder.setAddress(zzfaVar.zzl());
            builder.setAddressComponents(addressComponentsNewInstance);
            builder.setBusinessStatus((Place.BusinessStatus) zza.getOrDefault(zzfaVar.zzk(), null));
            builder.setId(zzfaVar.zzq());
            builder.setLatLng(latLngZze);
            builder.setName(zzfaVar.zzp());
            builder.setPhoneNumber(zzfaVar.zzo());
            zziy zziyVarZze = zzfaVar.zze();
            if (zziyVarZze != null) {
                arrayList = new ArrayList();
                zzjw zzjwVarListIterator2 = zziyVarZze.listIterator(0);
                while (zzjwVarListIterator2.hasNext()) {
                    zzfa.zzd zzdVar = (zzfa.zzd) zzjwVarListIterator2.next();
                    if (zzdVar == null) {
                        ...
                        Integer numZzb = zzdVar.zzb();
                        Integer numZzc = zzdVar.zzc();
                        PhotoMetadata.Builder builder3 = PhotoMetadata.builder(strZzd);
                        zziy zziyVarZza2 = zzdVar.zza();
                        builder3.setAttributions((zziyVarZza2 == null || zziyVarZza2.isEmpty()) ? "" : zzib.zzc(", ").zzd().zzf(zziyVarZza2));
                    ...
                    zzg(arrayList, photoMetadataBuild);
                }
            } else {
                arrayList = null;
            }
            builder.setPhotoMetadatas(arrayList);
            zzfa.zzc zzcVarZzb = zzfaVar.zzb();
            if (zzcVarZzb != null) {
                OpeningHours.Builder builder4 = OpeningHours.builder();
                zziy zziyVarZza3 = zzcVarZzb.zza();
                if (zziyVarZza3 != null) {
                    arrayList2 = new ArrayList();
                    zzjw zzjwVarListIterator3 = zziyVarZza3.listIterator(0);
                    while (zzjwVarListIterator3.hasNext()) {
                        zzfa.zzc.zza zzaVar2 = (zzfa.zzc.zza) zzjwVarListIterator3.next();
                        if (zzaVar2 != null) {
                            Period.Builder builder5 = Period.builder();
                            builder5.setOpen(zzf(zzaVar2.zzb()));
                            builder5.setClose(zzf(zzaVar2.zza()));
                            periodBuild = builder5.build();
                        } else {
                            periodBuild = null;
                        }
                        zzg(arrayList2, periodBuild);
                    }
                } else {
                    arrayList2 = null;
                }
                builder4.setPeriods(zza(arrayList2));
                builder4.setWeekdayText(zza(zzcVarZzb.zzb()));
                openingHoursBuild = builder4.build();
            } else {
                openingHoursBuild = null;
            }
            builder.setOpeningHours(openingHoursBuild);
            zzfa.zze zzeVarZzc = zzfaVar.zzc();
            if (zzeVarZzc != null) {
                PlusCode.Builder builder6 = PlusCode.builder();
                builder6.setCompoundCode(zzeVarZzc.zza());
                builder6.setGlobalCode(zzeVarZzc.zzb());
                plusCodeBuild = builder6.build();
            }
            builder.setPlusCode(plusCodeBuild);
            builder.setPriceLevel(zzfaVar.zzh());
            builder.setRating(zzfaVar.zzg());
            builder.setTypes(zzb(zzfaVar.zzf()));
            builder.setUserRatingsTotal(zzfaVar.zzi());
            builder.setUtcOffsetMinutes(zzfaVar.zzj());
    ...
    private static TimeOfWeek zzf(zzfa.zzc.zzb zzbVar) {
        ...
        try {
            Integer numZza = zzbVar.zza();
            zzig.zzc(numZza, "Unable to convert Pablo response to TimeOfWeek: The \"day\" field is missing.");
            String strZzb = zzbVar.zzb();
            zzig.zzc(strZzb, "Unable to convert Pablo response to TimeOfWeek: The \"time\" field is missing.");
            String str = String.format("Unable to convert %s to LocalTime, must be of format \"hhmm\".", strZzb);
            zzig.zze(strZzb.length() == 4, str);
            try {
                LocalTime localTimeNewInstance = LocalTime.newInstance(Integer.parseInt(strZzb.substring(0, 2)), Integer.parseInt(strZzb.substring(2, 4)));
                ...
                return TimeOfWeek.newInstance(dayOfWeek, localTimeNewInstance);
