...
final class zzgn extends zzgt {
    ...
    /* synthetic */ zzgn(int i11, String str, zziy zziyVar, Place place, AutocompletePrediction autocompletePrediction, Status status, zzgm zzgmVar) {
        this.zzf = i11;
        this.zza = str;
        this.zzb = zziyVar;
        this.zzc = place;
    ...
    public final int hashCode() {
        ...
        String str = this.zza;
        int iHashCode = (i11 ^ (str == null ? 0 : str.hashCode())) * 1000003;
        zziy zziyVar = this.zzb;
        int iHashCode2 = (iHashCode ^ (zziyVar == null ? 0 : zziyVar.hashCode())) * 1000003;
        Place place = this.zzc;
        int iHashCode3 = (iHashCode2 ^ (place == null ? 0 : place.hashCode())) * 1000003;
