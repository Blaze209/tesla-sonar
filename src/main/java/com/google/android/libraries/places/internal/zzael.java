...
public abstract class zzael extends zzadt {
    ...
    @Deprecated
    static int zzu(int i11, zzagg zzaggVar, zzagr zzagrVar) {
        int iZzA = zzA(i11 << 3);
        return iZzA + iZzA + ((zzadq) zzaggVar).zzr(zzagrVar);
    }
    ...
    public static int zzw(zzafm zzafmVar) {
        int iZza = zzafmVar.zza();
        return zzA(iZza) + iZza;
    }

    static int zzx(zzagg zzaggVar, zzagr zzagrVar) {
        int iZzr = ((zzadq) zzaggVar).zzr(zzagrVar);
        return zzA(iZzr) + iZzr;
    }
    ...
    final void zzE(String str, zzahv zzahvVar) throws zzaej {
    ...
    /* synthetic */ zzael(zzaek zzaekVar) {
    }
}
