    ...
    public static abstract class Builder {
        ...
        public Place build() {
            ...
            if (attributions != null) {
                ...
                while (it.hasNext()) {
                    zzig.zzi(!TextUtils.isEmpty(it.next()), "Attributions must not contain null or empty values.");
                }
            }
            ...
            if (rating != null) {
                ...
                zzig.zzk(zzjk.zzc(dValueOf, dValueOf2).zze(rating), "Rating must not be out-of-range: %s to %s, but was: %s.", dValueOf, dValueOf2, rating);
            }
