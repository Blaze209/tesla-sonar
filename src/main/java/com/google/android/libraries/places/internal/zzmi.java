...
class zzmi extends zzmj {
    final zzmf zzb;
    final Character zzc;

    zzmi(zzmf zzmfVar, Character ch2) {
        this.zzb = zzmfVar;
    ...
    final void zzc(Appendable appendable, byte[] bArr, int i11, int i12) {
    ...
    zzmi(String str, String str2, Character ch2) {
