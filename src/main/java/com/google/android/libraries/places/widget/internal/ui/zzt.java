...
public final class zzt extends RecyclerView.g0 {
    private final TextView zza;
    private final TextView zzb;
    private AutocompletePrediction zzc;
    private boolean zzd;

    public zzt(final zzb zzbVar, View view, byte[] bArr) {
        super(view);
        ...
        this.itemView.setOnClickListener(new View.OnClickListener(zzbVar, bArr2) { // from class: com.google.android.libraries.places.widget.internal.ui.zzs
            public final /* synthetic */ zzb zzb;

            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                this.zza.zzc(this.zzb, view2);
            }
        });
    }
    ...
    final /* synthetic */ void zzc(zzb zzbVar, View view) {
