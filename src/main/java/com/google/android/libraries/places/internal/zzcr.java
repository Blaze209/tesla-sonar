...
final class zzcr {
    static ApiException zza(VolleyError volleyError) {
        ...
        return new ApiException(new Status(i11, String.format("Unexpected server error (HTTP Code: %s. Message: %s.)", hVar == null ? "N/A" : String.valueOf(hVar.f20191a), volleyError)));
    }
}
