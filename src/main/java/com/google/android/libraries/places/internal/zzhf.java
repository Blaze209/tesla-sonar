...
public final class zzhf implements zzgy {
    ...
    public final Task zza(AutocompletePrediction autocompletePrediction) {
        ...
        Task taskContinueWithTask = placesClient.fetchPlace(builder2.build()).continueWithTask(new Continuation() { // from class: com.google.android.libraries.places.internal.zzgz
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                zzhc zzhcVar2 = zzgxVar;
                int i11 = zzhf.zza;
                return zzhcVar2.zza().getToken().isCancellationRequested() ? Tasks.forCanceled() : task;
            }
        });
        zzgxVar.zzd(taskContinueWithTask);
    ...
    public final Task zzb(String str) {
        ...
        Task taskContinueWithTask = placesClient.findAutocompletePredictions(builder.build()).continueWithTask(new Continuation() { // from class: com.google.android.libraries.places.internal.zzha
            @Override // com.google.android.gms.tasks.Continuation
            public final Object then(Task task) {
                zzhb zzhbVar2 = zzgwVar;
                int i11 = zzhf.zza;
                return zzhbVar2.zza().getToken().isCancellationRequested() ? Tasks.forCanceled() : task;
            }
        });
        zzgwVar.zzd(taskContinueWithTask);
        return taskContinueWithTask;
    }
