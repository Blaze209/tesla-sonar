...
public final class zzhl extends c1 {
    ...
    private final i0 zzf = new i0();

    /* synthetic */ zzhl(zzgy zzgyVar, zzho zzhoVar, zzhp zzhpVar, zzhk zzhkVar) {
        this.zza = zzgyVar;
        this.zzb = zzhoVar;
        this.zzc = zzhpVar;
    }
    ...
    final /* synthetic */ void zzb(String str, Task task) {
        ...
        if (zzp(statusZzn)) {
            zzo(zzgt.zzq(statusZzn));
        } else {
            zzo(zzgt.zzi(str, statusZzn));
        }
    }
    ...
    final /* synthetic */ void zzc(AutocompletePrediction autocompletePrediction, Task task) {
        ...
        if (zzp(statusZzn)) {
            ...
            zzo(zzgt.zzm(autocompletePrediction, statusZzn));
        }
    }
    ...
    public final void zzf(final AutocompletePrediction autocompletePrediction, int i11) {
        ...
        taskZza.addOnCompleteListener(new OnCompleteListener() { // from class: com.google.android.libraries.places.internal.zzhg
            @Override // com.google.android.gms.tasks.OnCompleteListener
            public final void onComplete(Task task) {
