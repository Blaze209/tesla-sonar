...
public class d {
    ...
    private static final ThreadLocal<Matrix> f42320a = new ThreadLocal<>();

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private static final ThreadLocal<RectF> f42321b = new ThreadLocal<>();
    ...
    public static void c(@NonNull ViewGroup viewGroup, @NonNull View view, @NonNull Rect rect) {
        ThreadLocal<Matrix> threadLocal = f42320a;
        ...
        ThreadLocal<RectF> threadLocal2 = f42321b;
