...
interface Reader {
    ...
    <T> void mergeGroupField(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);

    <T> void mergeMessageField(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite);
