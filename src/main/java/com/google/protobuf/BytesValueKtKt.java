...
public final class BytesValueKtKt {
    ...
    public static final BytesValue copy(BytesValue bytesValue, l<? super BytesValueKt.Dsl, h0> block) {
        s.k(bytesValue, "<this>");
        s.k(block, "block");
        BytesValueKt.Dsl.Companion companion = BytesValueKt.Dsl.INSTANCE;
