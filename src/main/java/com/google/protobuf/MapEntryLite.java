...
public class MapEntryLite<K, V> {
    ...
    static <K, V> int computeSerializedSize(Metadata<K, V> metadata, K k11, V v11) {
    ...
    static <K, V> void writeTo(CodedOutputStream codedOutputStream, Metadata<K, V> metadata, K k11, V v11) {
