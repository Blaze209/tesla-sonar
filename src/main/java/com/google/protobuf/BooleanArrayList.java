...
final class BooleanArrayList extends AbstractProtobufList<Boolean> implements Internal.BooleanList, RandomAccess, PrimitiveNonBoxingCollection {
    ...
    public int hashCode() {
        int iHashBoolean = 1;
        for (int i11 = 0; i11 < this.size; i11++) {
            iHashBoolean = (iHashBoolean * 31) + Internal.hashBoolean(this.array[i11]);
        }
        return iHashBoolean;
    }
    ...
    public int indexOf(Object obj) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            if (this.array[i11] == zBooleanValue) {
                return i11;
            }
        }
        return -1;
    ...
    public Internal.ProtobufList<Boolean> mutableCopyWithCapacity2(int i11) {
        if (i11 >= this.size) {
            return new BooleanArrayList(Arrays.copyOf(this.array, i11), this.size, true);
        }
