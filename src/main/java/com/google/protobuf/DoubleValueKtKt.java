...
public final class DoubleValueKtKt {
    ...
    public static final DoubleValue copy(DoubleValue doubleValue, l<? super DoubleValueKt.Dsl, h0> block) {
        s.k(doubleValue, "<this>");
        s.k(block, "block");
        DoubleValueKt.Dsl.Companion companion = DoubleValueKt.Dsl.INSTANCE;
