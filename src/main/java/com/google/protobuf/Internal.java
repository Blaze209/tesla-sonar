...
public final class Internal {
    ...
    public interface BooleanList extends ProtobufList<Boolean> {
        ...
        ProtobufList<Boolean> mutableCopyWithCapacity2(int i11);
    ...
    public interface DoubleList extends ProtobufList<Double> {
        ...
        ProtobufList<Double> mutableCopyWithCapacity2(int i11);
    ...
    public interface FloatList extends ProtobufList<Float> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Float> mutableCopyWithCapacity2(int i11);
    ...
    public interface IntList extends ProtobufList<Integer> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Integer> mutableCopyWithCapacity2(int i11);
    ...
    public interface LongList extends ProtobufList<Long> {
        ...
        @Override // com.google.protobuf.Internal.ProtobufList, com.google.protobuf.Internal.BooleanList
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<Long> mutableCopyWithCapacity2(int i11);
    ...
    public static class MapAdapter<K, V, RealValue> extends AbstractMap<K, V> {
        ...
        private class EntryAdapter implements Map.Entry<K, V> {
            ...
            public V setValue(V v11) {
                RealValue value = this.realEntry.setValue((RealValue) MapAdapter.this.valueConverter.doBackward(v11));
                if (value == null) {
                    return null;
                }
        ...
        public static <T extends EnumLite> Converter<Integer, T> newEnumConverter(final EnumLiteMap<T> enumLiteMap, final T t11) {
            return (Converter<Integer, T>) new Converter<Integer, T>() { // from class: com.google.protobuf.Internal.MapAdapter.1
                ...
                public EnumLite doForward(Integer num) {
                    ...
                    return enumLiteFindValueByNumber == null ? t11 : enumLiteFindValueByNumber;
                }
            };
        }
        ...
        public V put(K k11, V v11) {
            RealValue realvaluePut = this.realMap.put(k11, this.valueConverter.doBackward(v11));
    ...
    public interface ProtobufList<E> extends List<E>, RandomAccess {
        ...
        /* JADX INFO: renamed from: mutableCopyWithCapacity */
        ProtobufList<E> mutableCopyWithCapacity2(int i11);
    }
    ...
    static int partialHash(int i11, byte[] bArr, int i12, int i13) {
    ...
    static <T> T checkNotNull(T t11, String str) {
        if (t11 != null) {
            return t11;
        }
    ...
    static int hashCode(byte[] bArr, int i11, int i12) {
        int iPartialHash = partialHash(i12, bArr, i11, i12);
        if (iPartialHash == 0) {
            return 1;
        }
        return iPartialHash;
