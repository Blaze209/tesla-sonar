...
public final class FieldMaskKtKt {
    ...
    public static final FieldMask copy(FieldMask fieldMask, l<? super FieldMaskKt.Dsl, h0> block) {
        s.k(fieldMask, "<this>");
        s.k(block, "block");
        FieldMaskKt.Dsl.Companion companion = FieldMaskKt.Dsl.INSTANCE;
