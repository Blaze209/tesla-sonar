...
public final class BoolValueKtKt {
    ...
    public static final BoolValue copy(BoolValue boolValue, l<? super BoolValueKt.Dsl, h0> block) {
        s.k(boolValue, "<this>");
        s.k(block, "block");
        BoolValueKt.Dsl.Companion companion = BoolValueKt.Dsl.INSTANCE;
