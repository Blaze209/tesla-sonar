...
public final class BoolValueKt {
    ...
    public static final class Dsl {
        ...
        public final /* synthetic */ BoolValue _build() {
            ...
            s.j(boolValueBuild, "_builder.build()");
