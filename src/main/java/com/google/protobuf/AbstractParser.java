...
public abstract class AbstractParser<MessageType extends MessageLite> implements Parser<MessageType> {
    ...
    public MessageType parsePartialDelimitedFrom(InputStream inputStream, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
        try {
            ...
            return (MessageType) parsePartialFrom((InputStream) new AbstractMessageLite.Builder.LimitedInputStream(inputStream, CodedInputStream.readRawVarint32(i11, inputStream)), extensionRegistryLite);
    ...
    public MessageType parsePartialFrom(byte[] bArr, int i11, int i12) {
        return (MessageType) parsePartialFrom(bArr, i11, i12, EMPTY_REGISTRY);
    }
    ...
    public MessageType parseFrom(byte[] bArr, int i11, int i12, ExtensionRegistryLite extensionRegistryLite) {
        return (MessageType) checkMessageInitialized(parsePartialFrom(bArr, i11, i12, extensionRegistryLite));
    }
    ...
    public MessageType parseFrom(byte[] bArr, int i11, int i12) {
        return (MessageType) parseFrom(bArr, i11, i12, EMPTY_REGISTRY);
    }
