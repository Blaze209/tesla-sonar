...
public final class ListValueKtKt {
    ...
    public static final ListValue copy(ListValue listValue, l<? super ListValueKt.Dsl, h0> block) {
        s.k(listValue, "<this>");
        s.k(block, "block");
        ListValueKt.Dsl.Companion companion = ListValueKt.Dsl.INSTANCE;
