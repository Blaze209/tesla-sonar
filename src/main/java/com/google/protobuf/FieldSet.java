...
final class FieldSet<T extends FieldDescriptorLite<T>> {
    ...
    static final class Builder<T extends FieldDescriptorLite<T>> {
        ...
        private FieldSet<T> buildImpl(boolean z11) {
            ...
            if (this.hasNestedBuilders) {
                ...
                replaceBuilders(smallSortedMapCloneAllFieldsMap, z11);
            }
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(SmallSortedMap<T, Object> smallSortedMap, boolean z11) {
            ...
            while (it.hasNext()) {
                replaceBuilders((Map.Entry) it.next(), z11);
            }
        }
        ...
        Object getFieldAllowBuilders(T t11) {
        ...
        Object getRepeatedFieldAllowBuilders(T t11, int i11) {
            if (!t11.isRepeated()) {
        ...
        private static <T extends FieldDescriptorLite<T>> void replaceBuilders(Map.Entry<T, Object> entry, boolean z11) {
            entry.setValue(replaceBuilders(entry.getKey(), entry.getValue(), z11));
        }
            ...
            if (t11.isRepeated()) {
                if (obj instanceof List) {
                    ...
                    for (int i11 = 0; i11 < arrayList.size(); i11++) {
                        ...
                        Object objReplaceBuilder = replaceBuilder(obj2, z11);
                        if (objReplaceBuilder != obj2) {
                            if (arrayList == obj) {
                                arrayList = new ArrayList(arrayList);
                            }
                            arrayList.set(i11, objReplaceBuilder);
                        }
                    }
                    return arrayList;
                }
    ...
    public static <T extends FieldDescriptorLite<T>> SmallSortedMap<T, Object> cloneAllFieldsMap(SmallSortedMap<T, Object> smallSortedMap, boolean z11) {
        ...
        for (int i11 = 0; i11 < smallSortedMap.getNumArrayEntries(); i11++) {
            cloneFieldEntry(smallSortedMapNewFieldMap, smallSortedMap.getArrayEntryAt(i11), z11);
        }
        Iterator it = smallSortedMap.getOverflowEntries().iterator();
        while (it.hasNext()) {
            cloneFieldEntry(smallSortedMapNewFieldMap, (Map.Entry) it.next(), z11);
        }
    ...
    static int computeElementSize(WireFormat.FieldType fieldType, int i11, Object obj) {
    ...
    static int getWireFormatForFieldType(WireFormat.FieldType fieldType, boolean z11) {
        if (z11) {
            return 2;
        }
    ...
    public static Object readPrimitiveField(CodedInputStream codedInputStream, WireFormat.FieldType fieldType, boolean z11) {
        return z11 ? WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.STRICT) : WireFormat.readPrimitiveField(codedInputStream, fieldType, WireFormat.Utf8Validation.LOOSE);
    }
    ...
    static void writeElement(CodedOutputStream codedOutputStream, WireFormat.FieldType fieldType, int i11, Object obj) {
        if (fieldType == WireFormat.FieldType.GROUP) {
    ...
    public int getMessageSetSerializedSize() {
        ...
        for (int i11 = 0; i11 < this.fields.getNumArrayEntries(); i11++) {
            messageSetSerializedSize += getMessageSetSerializedSize(this.fields.getArrayEntryAt(i11));
        }
        Iterator it = this.fields.getOverflowEntries().iterator();
        while (it.hasNext()) {
    ...
    public int getSerializedSize() {
        ...
        for (int i11 = 0; i11 < this.fields.getNumArrayEntries(); i11++) {
            Map.Entry<K, Object> arrayEntryAt = this.fields.getArrayEntryAt(i11);
