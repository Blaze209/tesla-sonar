...
final class CodedInputStreamReader implements Reader {
    ...
    private <T> void mergeGroupFieldInternal(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) {
    ...
    private <T> void mergeMessageFieldInternal(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException {
    ...
    @Override // com.google.protobuf.Reader
    public <T> void mergeGroupField(T t11, Schema<T> schema, ExtensionRegistryLite extensionRegistryLite) throws InvalidProtocolBufferException.InvalidWireTypeException {
        requireWireType(3);
