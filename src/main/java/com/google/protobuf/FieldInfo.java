...
final class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static FieldInfo forExplicitPresenceField(java.lang.reflect.Field field, int i11, FieldType fieldType, java.lang.reflect.Field field2, int i12, boolean z11, Internal.EnumVerifier enumVerifier) {
    ...
    public static FieldInfo forLegacyRequiredField(java.lang.reflect.Field field, int i11, FieldType fieldType, java.lang.reflect.Field field2, int i12, boolean z11, Internal.EnumVerifier enumVerifier) {
        checkFieldNumber(i11);
        Internal.checkNotNull(field, "field");
        Internal.checkNotNull(fieldType, "fieldType");
        Internal.checkNotNull(field2, "presenceField");
