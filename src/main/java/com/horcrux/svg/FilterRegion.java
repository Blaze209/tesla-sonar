...
public class FilterRegion {
    ...
    private double getRelativeOrDefault(VirtualView virtualView, SVGLength sVGLength, float f11, double d11) {
        return (sVGLength == null || sVGLength.f45258b == SVGLength.UnitType.UNKNOWN) ? d11 : virtualView.relativeOn(sVGLength, f11);
    }
