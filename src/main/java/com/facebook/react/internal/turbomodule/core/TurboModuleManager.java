...
public class TurboModuleManager implements TurboModuleRegistry {
    ...
    public TurboModuleManager(RuntimeExecutor runtimeExecutor, final TurboModuleManagerDelegate turboModuleManagerDelegate, CallInvokerHolder callInvokerHolder, NativeMethodCallInvokerHolder nativeMethodCallInvokerHolder) {
        ...
        this.mEagerInitModuleNames = turboModuleManagerDelegate == null ? Collections.EMPTY_LIST : turboModuleManagerDelegate.getEagerInitModuleNames();
        ModuleProvider moduleProvider = new ModuleProvider() { // from class: com.facebook.react.internal.turbomodule.core.a
            ...
            public final NativeModule getModule(String str) {
                return TurboModuleManager.b(str);
            }
        };
        this.mTurboModuleProvider = turboModuleManagerDelegate == null ? moduleProvider : new ModuleProvider() { // from class: com.facebook.react.internal.turbomodule.core.b
            @Override // com.facebook.react.internal.turbomodule.core.TurboModuleManager.ModuleProvider
            public final NativeModule getModule(String str) {
                return TurboModuleManager.a(turboModuleManagerDelegate, str);
            }
        };
        if (turboModuleManagerDelegate != null && shouldEnableLegacyModuleInterop()) {
            moduleProvider = new ModuleProvider() { // from class: com.facebook.react.internal.turbomodule.core.c
                @Override // com.facebook.react.internal.turbomodule.core.TurboModuleManager.ModuleProvider
                public final NativeModule getModule(String str) {
                    return TurboModuleManager.c(turboModuleManagerDelegate, str);
                }
            };
        }
    ...
    public static /* synthetic */ NativeModule b(String str) {
        return null;
    }

    public static /* synthetic */ NativeModule c(TurboModuleManagerDelegate turboModuleManagerDelegate, String str) {
        NativeModule legacyModule = turboModuleManagerDelegate.getLegacyModule(str);
        if (legacyModule == null) {
            return null;
        }
        gn.a.b(!(legacyModule instanceof TurboModule), "NativeModule \"" + str + "\" is a TurboModule");
        return legacyModule;
    }
    ...
    private NativeModule getOrCreateModule(String str, @NonNull ModuleHolder moduleHolder, boolean z11) {
        boolean z12;
        NativeModule module;
        synchronized (moduleHolder) {
            try {
                ...
                if (module2 != null) {
                    ...
                    qk.a.o(TAG, "getOrCreateModule(): Unable to create module \"%s\" (legacy: %b, turbo: %b)", str, Boolean.valueOf(isLegacyModule(str)), Boolean.valueOf(isTurboModule(str)));
                }
    ...
    private native void installJSIBindings(boolean z11);
        ...
        synchronized (this.mModuleCleanupLock) {
            try {
                if (this.mModuleCleanupStarted) {
                    qk.a.o(TAG, "getModule(): Tried to get module \"%s\", but TurboModuleManager was tearing down (legacy: %b, turbo: %b)", str, Boolean.valueOf(isLegacyModule(str)), Boolean.valueOf(isTurboModule(str)));
                    return null;
                }
