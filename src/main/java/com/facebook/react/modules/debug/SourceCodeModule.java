...
@xn.a(name = NativeSourceCodeSpec.NAME)
...
public final class SourceCodeModule extends NativeSourceCodeSpec {
    ...
    protected Map<String, Object> getTypedExportedConstants() {
        return v0.f(x.a("scriptURL", gn.a.d(getReactApplicationContext().getSourceURL(), "No source URL loaded, have you initialised the instance?")));
    }
}
