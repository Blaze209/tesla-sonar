...
public class CatalystInstanceImpl implements CatalystInstance {
    ...
    public static class Builder {
        ...
        public CatalystInstanceImpl build() {
            return new CatalystInstanceImpl((ReactQueueConfigurationSpec) gn.a.c(this.mReactQueueConfigurationSpec), (JavaScriptExecutor) gn.a.c(this.mJSExecutor), (NativeModuleRegistry) gn.a.c(this.mRegistry), (JSBundleLoader) gn.a.c(this.mJSBundleLoader), (JSExceptionHandler) gn.a.c(this.mJSExceptionHandler), this.mInspectorTarget);
        }
    ...
    public void decrementPendingJSCalls() {
        ...
        boolean z11 = iDecrementAndGet == 0;
        ep.a.m(0L, this.mJsPendingCallsTitleForTrace, iDecrementAndGet);
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.g
            @Override // java.lang.Runnable
            public final void run() {
                this.f22308a.lambda$decrementPendingJSCalls$5();
            }
        });
    }
    ...
    private TurboModuleRegistry getTurboModuleRegistry() {
        if (tn.b.r()) {
            return (TurboModuleRegistry) gn.a.d(this.mTurboModuleRegistry, "TurboModules are enabled, but mTurboModuleRegistry hasn't been set.");
        }
        return null;
    }
    ...
    public void incrementPendingJSCalls() {
        ...
        ep.a.m(0L, this.mJsPendingCallsTitleForTrace, andIncrement + 1);
        if (!z11 || this.mBridgeIdleListeners.isEmpty()) {
            return;
        }
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.e
            @Override // java.lang.Runnable
            public final void run() {
                this.f22306a.lambda$incrementPendingJSCalls$4();
            }
        });
    }
    ...
    public /* synthetic */ void lambda$destroy$0() {
        ...
        qk.a.I("ReactNative", "CatalystInstanceImpl.destroy() end");
    ...
    public /* synthetic */ void lambda$destroy$2() {
        ...
        boolean z11 = this.mPendingJSCalls.getAndSet(0) == 0;
    ...
    public void onNativeException(Exception exc) {
        ...
        this.mReactQueueConfiguration.getUIQueueThread().runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.c
            @Override // java.lang.Runnable
            public final void run() {
                this.f22304a.lambda$onNativeException$6();
            }
        });
    }
    ...
    public void lambda$onNativeException$6() {
        qk.a.b("ReactNative", "CatalystInstanceImpl.destroy() start");
        ...
        if (reactInstanceManagerInspectorTarget != null) {
            gn.a.b(reactInstanceManagerInspectorTarget.isValid(), "ReactInstanceManager inspector target destroyed before instance was unregistered");
        }
        ...
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.a
            @Override // java.lang.Runnable
            public final void run() {
                this.f22302a.lambda$destroy$2();
            }
        });
        ep.a.p(this.mTraceListener);
    }
    ...
    public void initialize() {
        qk.a.b("ReactNative", "CatalystInstanceImpl.initialize()");
        gn.a.b(!this.mInitialized, "This catalyst instance has already been initialized");
        gn.a.b(this.mAcceptCalls, "RunJSBundle hasn't completed.");
        this.mInitialized = true;
        this.mNativeModulesQueueThread.runOnQueue(new Runnable() { // from class: com.facebook.react.bridge.f
            @Override // java.lang.Runnable
            public final void run() {
                this.f22307a.lambda$initialize$3();
            }
        });
    }
    ...
    public void invokeCallback(int i11, NativeArrayInterface nativeArrayInterface) {
        if (this.mDestroyed) {
            qk.a.I("ReactNative", "Invoking JS callback after bridge has been destroyed.");
        } else {
    ...
    public void runJSBundle() {
        qk.a.b("ReactNative", "CatalystInstanceImpl.runJSBundle()");
        gn.a.b(!this.mJSBundleHasLoaded, "JS bundle was already loaded!");
    ...
    private CatalystInstanceImpl(ReactQueueConfigurationSpec reactQueueConfigurationSpec, JavaScriptExecutor javaScriptExecutor, NativeModuleRegistry nativeModuleRegistry, JSBundleLoader jSBundleLoader, JSExceptionHandler jSExceptionHandler, ReactInstanceManagerInspectorTarget reactInstanceManagerInspectorTarget) {
        ...
        qk.a.b("ReactNative", "Initializing React Xplat Bridge.");
        ep.a.c(0L, "createCatalystInstanceImpl");
        ...
        this.mInspectorTarget = reactInstanceManagerInspectorTarget;
        ep.a.i(0L);
        qk.a.b("ReactNative", "Initializing React Xplat Bridge before initializeBridge");
        ep.a.c(0L, "initializeCxxBridge");
        ...
        qk.a.b("ReactNative", "Initializing React Xplat Bridge after initializeBridge");
        ep.a.i(0L);
    ...
    public void callFunction(PendingJSCall pendingJSCall) {
        if (this.mDestroyed) {
            qk.a.I("ReactNative", "Calling JS function after bridge has been destroyed: " + pendingJSCall.toString());
            return;
        }
