...
public final class ReactNoCrashBridgeNotAllowedSoftException extends ReactNoCrashSoftException {
    ...
    public ReactNoCrashBridgeNotAllowedSoftException(String m11) {
        super(m11);
        s.k(m11, "m");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReactNoCrashBridgeNotAllowedSoftException(Throwable e11) {
        super(e11);
        s.k(e11, "e");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReactNoCrashBridgeNotAllowedSoftException(String m11, Throwable e11) {
        super(m11, e11);
        s.k(m11, "m");
        s.k(e11, "e");
    }
