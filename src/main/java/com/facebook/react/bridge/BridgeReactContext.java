...
public class BridgeReactContext extends ReactApplicationContext {
    ...
    public CatalystInstance getCatalystInstance() {
        return (CatalystInstance) gn.a.c(this.mCatalystInstance);
    }
    ...
    public void handleException(Exception exc) {
        ...
        boolean z13 = getJSExceptionHandler() != null;
        if (z12 && z13) {
            getJSExceptionHandler().handleException(exc);
            return;
        }
        qk.a.n("ReactNative", "Unable to handle Exception - catalystInstanceVariableExists: " + z11 + " - isCatalystInstanceAlive: " + z12 + " - hasExceptionHandler: " + z13, exc);
    ...
    public void registerSegment(int i11, String str, Callback callback) {
        ((CatalystInstance) gn.a.c(this.mCatalystInstance)).registerSegment(i11, str);
