...
public final class MessageQueueThreadSpec {
    ...
    public /* synthetic */ MessageQueueThreadSpec(ThreadType threadType, String str, long j11, DefaultConstructorMarker defaultConstructorMarker) {
        this(threadType, str, j11);
    }
    ...
    public static final MessageQueueThreadSpec newBackgroundThreadSpec(String str, long j11) {
        return INSTANCE.newBackgroundThreadSpec(str, j11);
    }

    /* synthetic */ MessageQueueThreadSpec(ThreadType threadType, String str, long j11, int i11, DefaultConstructorMarker defaultConstructorMarker) {
        this(threadType, str, (i11 & 4) != 0 ? 0L : j11);
    }
}
