...
class DynamicFromArray implements Dynamic {
    ...
    public static DynamicFromArray create(ReadableArray readableArray, int i11) {
        DynamicFromArray dynamicFromArrayB = sPool.b();
        if (dynamicFromArrayB == null) {
            dynamicFromArrayB = new DynamicFromArray();
        }
        dynamicFromArrayB.mArray = readableArray;
        dynamicFromArrayB.mIndex = i11;
        return dynamicFromArrayB;
    }
