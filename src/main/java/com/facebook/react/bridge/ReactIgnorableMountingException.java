...
public final class ReactIgnorableMountingException extends RuntimeException {
    ...
    public static final class Companion {
        ...
        public final boolean isIgnorable(Throwable e11) {
            s.k(e11, "e");
            while (e11 != null) {
                if (e11 instanceof ReactIgnorableMountingException) {
                    return true;
                }
                e11 = e11.getCause();
            }
    ...
    public ReactIgnorableMountingException(String m11) {
        super(m11);
        s.k(m11, "m");
    }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReactIgnorableMountingException(Throwable e11) {
        super(e11);
        s.k(e11, "e");
    }

    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public ReactIgnorableMountingException(String m11, Throwable e11) {
        super(m11, e11);
        s.k(m11, "m");
        s.k(e11, "e");
    }
