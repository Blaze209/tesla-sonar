...
public class Arguments {
    ...
    public static WritableArray fromArray(Object obj) {
        ...
        if (obj instanceof String[]) {
            ...
            while (i11 < length) {
                writableArrayCreateArray.pushString(strArr[i11]);
                i11++;
            }
            ...
            while (i11 < length2) {
                writableArrayCreateArray.pushMap(fromBundle(bundleArr[i11]));
                i11++;
            }
            ...
            while (i11 < length3) {
                writableArrayCreateArray.pushInt(iArr[i11]);
                i11++;
            }
            ...
            while (i11 < length4) {
                writableArrayCreateArray.pushDouble(fArr[i11]);
                i11++;
            }
            ...
            while (i11 < length5) {
                writableArrayCreateArray.pushDouble(dArr[i11]);
                i11++;
            }
            ...
            while (i11 < length6) {
                writableArrayCreateArray.pushBoolean(zArr[i11]);
                i11++;
            }
        } else {
