...
class DynamicFromMap implements Dynamic {
    ...
    public static DynamicFromMap create(ReadableMap readableMap, String str) {
        DynamicFromMap dynamicFromMapB = sPool.get().b();
        if (dynamicFromMapB == null) {
            dynamicFromMapB = new DynamicFromMap();
        }
        dynamicFromMapB.mMap = readableMap;
        dynamicFromMapB.mName = str;
        return dynamicFromMapB;
    }
