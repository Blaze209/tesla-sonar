...
public class ReadableNativeArray extends NativeArray implements ReadableArray {
    ...
    protected ReadableNativeArray() {
        ...
        this.localArray = jn0.m.a(pVar, new wn0.a() { // from class: com.facebook.react.bridge.k
            @Override // wn0.a
            public final Object invoke() {
                return ReadableNativeArray.localArray_delegate$lambda$0(this.f22310a);
            }
        });
        this.localTypeArray = jn0.m.a(pVar, new wn0.a() { // from class: com.facebook.react.bridge.l
            @Override // wn0.a
            public final Object invoke() {
                return ReadableNativeArray.localTypeArray_delegate$lambda$1(this.f22311a);
            }
        });
    }
    ...
    public boolean equals(Object other) {
        if (other instanceof ReadableNativeArray) {
            return p013kotlin.collections.n.d(getLocalArray(), ((ReadableNativeArray) other).getLocalArray());
        }
        return false;
    }
    ...
    public ArrayList<Object> toArrayList() {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            switch (WhenMappings.$EnumSwitchMapping$0[getType(i11).ordinal()]) {
                case 1:
                    arrayList.add(null);
                    break;
                case 2:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    ReadableNativeMap map = getMap(i11);
                    arrayList.add(map != null ? map.toHashMap() : null);
                    break;
                case 6:
                    ReadableNativeArray array = getArray(i11);
