...
public final class ReadableNativeMap$entryIterator$1$1 implements Iterator<Map.Entry<? extends String, ? extends Object>>, xn0.a {
    ...
    public Map.Entry<? extends String, ? extends Object> next() {
        ...
        return new ReadableNativeMap$entryIterator$1$1$next$1(this.$iteratorKeys, i11, this.$iteratorValues);
    }
}
