...
public final class ReactMarkerConstants {
    ...
    static {
        ...
        boolean z11 = false;
        CREATE_REACT_CONTEXT_START = new ReactMarkerConstants("CREATE_REACT_CONTEXT_START", 2, z11, i11, defaultConstructorMarker);
        PROCESS_PACKAGES_START = new ReactMarkerConstants("PROCESS_PACKAGES_START", 6, z11, i11, defaultConstructorMarker);
        ...
        boolean z12 = false;
        DESTROY_CATALYST_INSTANCE_END = new ReactMarkerConstants("DESTROY_CATALYST_INSTANCE_END", 13, z12, i12, defaultConstructorMarker3);
        NATIVE_MODULE_INITIALIZE_START = new ReactMarkerConstants("NATIVE_MODULE_INITIALIZE_START", 16, z12, i12, defaultConstructorMarker3);
        ...
        $ENTRIES = on0.a.a(reactMarkerConstantsArr$values);
    }

    private ReactMarkerConstants(String str, int i11, boolean z11) {
        super(str, i11);
        this.hasMatchingNameMarker = z11;
    }
    ...
    /* synthetic */ ReactMarkerConstants(String str, int i11, boolean z11, int i12, DefaultConstructorMarker defaultConstructorMarker) {
