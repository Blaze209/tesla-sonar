...
public class ColorPropConverter {
    ...
    public static Integer getColor(Object obj, Context context) {
        ...
        try {
            ...
            qk.a.L("ReactNative", e11, "Error extracting color from WideGamut", new Object[0]);
        }
    ...
    public static Color getColorInstance(Object obj, Context context) {
        ...
        for (int i11 = 0; i11 < array.size(); i11++) {
            Integer numResolveResourcePath = resolveResourcePath(context, array.getString(i11));
    ...
    private static int resolveResource(Context context, String str) {
        ...
        return j5.h.d(context.getResources(), context.getResources().getIdentifier(strArrSplit2[1], str2, packageName), context.getTheme());
    }
    ...
    public static Integer getColor(Object obj, Context context, int i11) {
        try {
            return getColor(obj, context);
        } catch (JSApplicationCausedNativeException e11) {
            qk.a.L("ReactNative", e11, "Error converting ColorValue", new Object[0]);
