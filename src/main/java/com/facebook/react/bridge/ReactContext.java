...
public abstract class ReactContext extends ContextWrapper {
    ...
    public void assertOnJSQueueThread() {
        ((MessageQueueThread) gn.a.c(this.mJSMessageQueueThread)).assertIsOnThread();
    }
    ...
    public void assertOnNativeModulesQueueThread() {
        ...
        ((MessageQueueThread) gn.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread();
    }

    public void assertOnUiQueueThread() {
        ((MessageQueueThread) gn.a.c(this.mUiMessageQueueThread)).assertIsOnThread();
    }
    ...
    public synchronized void initializeMessageQueueThreads(ReactQueueConfiguration reactQueueConfiguration) {
        qk.a.b(TAG, "initializeMessageQueueThreads() is called.");
    ...
    public boolean isOnJSQueueThread() {
        return ((MessageQueueThread) gn.a.c(this.mJSMessageQueueThread)).isOnThread();
    }

    public boolean isOnNativeModulesQueueThread() {
        return ((MessageQueueThread) gn.a.c(this.mNativeModulesMessageQueueThread)).isOnThread();
    }

    public boolean isOnUiQueueThread() {
        return ((MessageQueueThread) gn.a.c(this.mUiMessageQueueThread)).isOnThread();
    }
    ...
    public void onWindowFocusChange(boolean z11) {
        ...
        while (it.hasNext()) {
            try {
                it.next().onWindowFocusChange(z11);
            } catch (RuntimeException e11) {
                handleException(e11);
            }
        }
    ...
    public abstract void registerSegment(int i11, String str, Callback callback);
    ...
    public boolean runOnJSQueueThread(Runnable runnable) {
        return ((MessageQueueThread) gn.a.c(this.mJSMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnNativeModulesQueueThread(Runnable runnable) {
        ((MessageQueueThread) gn.a.c(this.mNativeModulesMessageQueueThread)).runOnQueue(runnable);
    }

    public void runOnUiQueueThread(Runnable runnable) {
        ((MessageQueueThread) gn.a.c(this.mUiMessageQueueThread)).runOnQueue(runnable);
    }
    ...
    public void onHostDestroy(boolean z11) {
        if (!z11) {
            onHostDestroy();
        } else {
            onHostDestroyImpl();
    ...
    public void assertOnNativeModulesQueueThread(String str) {
        if (this.mIsInitialized) {
            ((MessageQueueThread) gn.a.c(this.mNativeModulesMessageQueueThread)).assertIsOnThread(str);
            return;
        }
