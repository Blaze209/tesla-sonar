...
public abstract class d<T extends d> {
    ...
    class a implements b {
        ...
        public boolean a(int i11, String str) {
            return i11 == d.this.getViewTag() && str.equals(d.this.getEventName());
        }
    }
    ...
    protected void init(int i11, int i12) {
        init(i11, i12, jn.j.c());
    }
    ...
    protected void init(int i11, int i12, long j11) {
        this.mSurfaceId = i11;
        this.mViewTag = i12;
