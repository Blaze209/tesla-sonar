...
public final class MountItemFactory {
    ...
    public static final MountItem createPreAllocateViewMountItem(int surfaceId, int reactTag, String component, ReadableMap props, u0 stateWrapper, boolean isLayoutable) {
