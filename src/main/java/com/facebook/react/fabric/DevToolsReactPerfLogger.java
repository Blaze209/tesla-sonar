...
public class DevToolsReactPerfLogger implements ReactMarker.FabricMarkerListener {
    ...
    public static class FabricCommitPoint {
        ...
        public String toString() {
            return "FabricCommitPoint{mCommitNumber=" + this.mCommitNumber + ", mPoints=" + this.mPoints + CoreConstants.CURLY_RIGHT;
        }

        private FabricCommitPoint(int i11) {
    ...
    private static class FabricCommitPointData {
        ...
        public FabricCommitPointData(long j11, int i11) {
            this.mTimeStamp = j11;
            this.mCounter = i11;
        }
    ...
    public void logFabricMarker(ReactMarkerConstants reactMarkerConstants, String str, int i11, long j11) {
    ...
    @Override // com.facebook.react.bridge.ReactMarker.FabricMarkerListener
    public void logFabricMarker(ReactMarkerConstants reactMarkerConstants, String str, int i11, long j11, int i12) {
        if (isFabricCommitMarker(reactMarkerConstants)) {
            FabricCommitPoint fabricCommitPoint = this.mFabricCommitMarkers.get(Integer.valueOf(i11));
            if (fabricCommitPoint == null) {
                fabricCommitPoint = new FabricCommitPoint(i11);
                this.mFabricCommitMarkers.put(Integer.valueOf(i11), fabricCommitPoint);
            }
            fabricCommitPoint.addPoint(reactMarkerConstants, new FabricCommitPointData(j11, i12));
            if (reactMarkerConstants != ReactMarkerConstants.FABRIC_BATCH_EXECUTION_END || j11 <= 0) {
                return;
            }
            onFabricCommitEnd(fabricCommitPoint);
            this.mFabricCommitMarkers.remove(Integer.valueOf(i11));
        }
    }
}
