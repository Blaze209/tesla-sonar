...
public final class y {
    ...
    public static boolean d(Type type, Type type2) {
        ...
        if (type instanceof ParameterizedType) {
            ...
            return d(parameterizedType.getOwnerType(), parameterizedType2.getOwnerType()) && parameterizedType.getRawType().equals(parameterizedType2.getRawType()) && Arrays.equals(parameterizedType instanceof v20.c.b ? ((v20.c.b) parameterizedType).f117649c : parameterizedType.getActualTypeArguments(), parameterizedType2 instanceof v20.c.b ? ((v20.c.b) parameterizedType2).f117649c : parameterizedType2.getActualTypeArguments());
        }
        if (type instanceof GenericArrayType) {
    ...
    static Type f(Type type) {
        Class<?> clsG = g(type);
        return v20.c.q(type, clsG, clsG.getGenericSuperclass());
    }
    ...
    static Type h(Type type, Class<?> cls, Class<?> cls2) {
        if (cls2.isAssignableFrom(cls)) {
            return v20.c.q(type, cls, v20.c.e(type, cls, cls2));
        }
    ...
    public static ParameterizedType j(Type type, Type... typeArr) {
        if (typeArr.length != 0) {
            return new v20.c.b(null, type, typeArr);
        }
        throw new IllegalArgumentException("Missing type arguments for " + type);
    }

    public static WildcardType k(Type type) {
        return new v20.c.C2527c(type instanceof WildcardType ? ((WildcardType) type).getUpperBounds() : new Type[]{type}, v20.c.f117642b);
    }

    public static WildcardType l(Type type) {
        return new v20.c.C2527c(new Type[]{Object.class}, type instanceof WildcardType ? ((WildcardType) type).getLowerBounds() : new Type[]{type});
    }
}
