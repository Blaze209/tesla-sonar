...
class WXAPiSecurityHelper {
    ...
    private final SharedPreferences f55571sp;
    ...
    public WXAPiSecurityHelper(Context context) {
        ...
        this.f55571sp = context.getSharedPreferences("__wx_opensdk_sp__", 0);
    }
    ...
    public int checkRuleCanPass(String str, PromiseShareRule promiseShareRule) {
        ...
        if (i11 == 2) {
            ...
            if (promiseShareRule.urlRuleList.size() == 0) {
                ...
                Log.d(TAG, "checkRuleCanPass, urlCheckResult = " + zCheckUrlParametersLegal);
            ...
            if (host.equals(urlRule.host)) {
                ...
                for (int i13 = 0; i13 < urlRule.mustQueryKey.size(); i13++) {
                    try {
                        ...
                        if (!b.b(uri.getQueryParameter(str2))) {
                            i12++;
                        }
                    } catch (Exception e11) {
    ...
    private void doRequest(final PassContext passContext, final IHttpCheckCallback iHttpCheckCallback) {
        b.f55574b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.WXAPiSecurityHelper.6
    ...
    private void storeCheckResp(String str, PromiseShareRule promiseShareRule) {
        ...
        Log.d(TAG, "cookStoreJson = " + strCookStoreJson);
        if (b.b(strCookStoreJson)) {
    ...
    protected void commitSp(String str, String str2) {
        SharedPreferences.Editor editorEdit = this.f55571sp.edit();
                ...
                for (int i11 = 0; i11 < jSONArrayOptJSONArray.length(); i11++) {
                    ...
                    if (jSONArrayOptJSONArray2 != null) {
                        for (int i12 = 0; i12 < jSONArrayOptJSONArray2.length(); i12++) {
                            if (!b.b(jSONArrayOptJSONArray2.optString(i12, ""))) {
                                urlRule.mustQueryKey.add(jSONArrayOptJSONArray2.optString(i12, ""));
                            }
                        }
                    }
    ...
    public int doExtraSecurityCheck(String str, String str2, String str3, final ISecurityCheck iSecurityCheck) {
        ...
        passContext.reqSessionId = String.format("%s", jCurrentTimeMillis + "" + new Random().nextInt(9999));
        ...
        boolean z11 = (storedData.lastStoreTimeStampSecond + promiseShareRuleConvert2ShareRule.getLegalReqInterval()) * 1000 < System.currentTimeMillis();
        ...
        if (!z11) {
            ...
            Log.d(TAG, "doExtraSecurityCheck: no needDoNextReq, read local rule: " + iCheckRuleCanPass);
    ...
    protected WXSecurityData getStoredData(String str) {
        ...
        try {
            if (this.f55571sp.contains(getStoreKey(str))) {
                JSONObject jSONObject = new JSONObject(this.f55571sp.getString(getStoreKey(str), ""));
