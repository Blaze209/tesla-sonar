...
class BaseWXApiImplV10 implements IWXAPI {
    ...
    BaseWXApiImplV10(Context context, String str, boolean z11, int i11) {
        ...
        this.launchMode = i11;
        b.f55573a = context.getApplicationContext();
    ...
    private String getTokenFromWX(Context context) {
        Cursor cursorQuery = context.getContentResolver().query(Uri.parse("content://com.tencent.mm.sdk.comm.provider/genTokenForOpenSdk"), null, null, new String[]{this.appId, "638066176"}, null);
    ...
    private void launchWXUsingPendingIntent() {
        ...
        try {
            ...
            PendingIntent.getActivity(this.context, 1, this.context.getPackageManager().getLaunchIntentForPackage("com.tencent.mm"), 201326592).send(this.context, 2, null, new PendingIntent.OnFinished() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.3
    ...
    public int getWXAppSupportAPI() {
        ...
        if (this.wxSdkVersion == 0) {
            ...
            b.f55574b.submit(new Runnable() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.1
    ...
    public boolean handleIntent(Intent intent, IWXAPIEventHandler iWXAPIEventHandler) {
        try {
            ...
            Log.e(TAG, "handleIntent fail, ex = " + e12.getMessage());
        }
        return false;
    }
    ...
    public boolean isWXAppInstalled() {
        ...
        try {
            ...
            Log.w(TAG, "isWXAppInstalled ex:" + e11.getMessage());
            return false;
        }
    }
    ...
    public void unregisterApp() {
        ...
        c1122a.f55531a = "com.tencent.mm";
        c1122a.f55532b = ConstantsAPI.ACTION_HANDLE_APP_UNREGISTER;
        c1122a.f55533c = "weixin://unregisterapp?appid=" + this.appId;
        a.a(this.context, c1122a);
    }
    ...
    public boolean registerApp(String str, long j11) {
        ...
        a.C1122a c1122a = new a.C1122a();
        c1122a.f55531a = "com.tencent.mm";
        c1122a.f55532b = ConstantsAPI.ACTION_HANDLE_APP_REGISTER;
        c1122a.f55533c = "weixin://registerapp?appid=" + this.appId;
        c1122a.f55534d = j11;
        return a.a(this.context, c1122a);
    }
    ...
    public boolean sendReq(BaseReq baseReq, final SendReqCallback sendReqCallback) {
        ...
        if (b.b(strExtractMayNeedDoSecurityCheckUrl)) {
            boolean zDoLaunchApp = doLaunchApp(bundle);
            callbackReq(sendReqCallback, zDoLaunchApp);
            return zDoLaunchApp;
        }
        int iDoExtraSecurityCheck = this.securityHelper.doExtraSecurityCheck(this.appId, "638066176", strExtractMayNeedDoSecurityCheckUrl, new WXAPiSecurityHelper.ISecurityCheck() { // from class: com.tencent.mm.opensdk.openapi.BaseWXApiImplV10.2
