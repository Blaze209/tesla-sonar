...
public final class PermissionsUtil {
    ...
    public static boolean requestPermission(String str, Activity activity) {
        ...
        if (str.equals("CAMERA") && b.checkSelfPermission(activity, "android.permission.CAMERA") != 0) {
            activity.requestPermissions(new String[]{"android.permission.CAMERA"}, 2);
            return false;
        }
        if (!str.equals("VIBRATE") || b.checkSelfPermission(activity, "android.permission.VIBRATE") == 0) {
            return true;
        }
