...
public class PeerConnectionFactory {
    ...
    private static native RtpCapabilities nativeGetRtpReceiverCapabilities(long j11, MediaStreamTrack.MediaType mediaType);

    private static native RtpCapabilities nativeGetRtpSenderCapabilities(long j11, MediaStreamTrack.MediaType mediaType);
