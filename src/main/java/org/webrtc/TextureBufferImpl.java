...
public class TextureBufferImpl implements VideoFrame.TextureBuffer {
    ...
    public VideoFrame.I420Buffer toI420() {
        return (VideoFrame.I420Buffer) ThreadUtils.invokeAtFrontUninterruptibly(this.toI420Handler, new Callable() { // from class: org.webrtc.c1
            ...
            public final Object call() {
                return this.f99896a.lambda$toI420$1();
            }
        });
    }

    TextureBufferImpl(int i11, int i12, VideoFrame.TextureBuffer.Type type, int i13, Matrix matrix, Handler handler, YuvConverter yuvConverter, RefCountMonitor refCountMonitor) {
    ...
    private TextureBufferImpl(int i11, int i12, int i13, int i14, VideoFrame.TextureBuffer.Type type, int i15, Matrix matrix, Handler handler, YuvConverter yuvConverter, final RefCountMonitor refCountMonitor) {
        ...
        this.refCountDelegate = new RefCountDelegate(new Runnable() { // from class: org.webrtc.b1
            ...
            public final void run() {
                this.f99892a.lambda$new$0(refCountMonitor);
            }
        });
    ...
    private TextureBufferImpl applyTransformMatrix(Matrix matrix, int i11, int i12, int i13, int i14) {
        ...
        retain();
        return new TextureBufferImpl(i11, i12, i13, i14, this.type, this.f99879id, matrix2, this.toI420Handler, this.yuvConverter, new RefCountMonitor() { // from class: org.webrtc.TextureBufferImpl.2
            @Override // org.webrtc.TextureBufferImpl.RefCountMonitor
            public void onDestroy(TextureBufferImpl textureBufferImpl) {
