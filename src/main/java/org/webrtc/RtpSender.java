...
public class RtpSender {
    ...
    public RtpSender(long j11) {
        ...
        if (!nativeGetMediaType(j11).equalsIgnoreCase(MediaStreamTrack.AUDIO_TRACK_KIND)) {
            this.dtmfSender = null;
        } else {
            long jNativeGetDtmfSender = nativeGetDtmfSender(j11);
    ...
    private static native String nativeGetMediaType(long j11);
