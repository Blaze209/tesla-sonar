...
public class RtpParameters {
    ...
    public static class Encoding {
        ...
        @CalledByNative("Encoding")
        Encoding(String str, boolean z11, double d11, int i11, Integer num, Integer num2, Integer num3, Integer num4, Double d12, String str2, Long l11, boolean z12) {
            this.rid = str;
            this.active = z11;
