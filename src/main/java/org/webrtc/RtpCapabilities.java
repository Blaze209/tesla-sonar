...
public class RtpCapabilities {
    ...
    public static class CodecCapability {
        ...
        @CalledByNative("CodecCapability")
        CodecCapability(int i11, String str, MediaStreamTrack.MediaType mediaType, Integer num, Integer num2, String str2, Map<String, String> map) {
            this.preferredPayloadType = i11;
            this.name = str;
            this.kind = mediaType;
            this.clockRate = num;
    ...
    public static class HeaderExtensionCapability {
        ...
        HeaderExtensionCapability(String str, int i11, boolean z11) {
            this.uri = str;
            this.preferredId = i11;
            this.preferredEncrypted = z11;
        }
