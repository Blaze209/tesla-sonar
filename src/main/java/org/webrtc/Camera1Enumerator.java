...
public class Camera1Enumerator implements CameraEnumerator {
    ...
    private static List<CameraEnumerationAndroid.CaptureFormat> enumerateFormats(int i11) {
        ...
        try {
            try {
                ...
                Logging.d(TAG, "Get supported formats for camera index " + i11 + " done. Time spent: " + (SystemClock.elapsedRealtime() - jElapsedRealtime) + " ms.");
                return arrayList;
    ...
    static String getDeviceName(int i11) {
        ...
        return "Camera " + i11 + ", Facing " + (cameraInfo.facing == 1 ? "front" : "back") + ", Orientation " + cameraInfo.orientation;
    }
