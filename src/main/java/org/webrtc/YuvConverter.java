...
public final class YuvConverter {
    ...
    private VideoFrame.I420Buffer convertInternal(VideoFrame.TextureBuffer textureBuffer) {
        ...
        int i12 = (height + 1) / 2;
        int i13 = height + i12;
        final ByteBuffer byteBufferNativeAllocateByteBuffer = JniCommon.nativeAllocateByteBuffer(i11 * i13);
        int i14 = i11 / 4;
        ...
        return JavaI420Buffer.wrap(width, height, byteBufferSlice, i11, byteBufferSlice2, i11, byteBufferSlice3, i11, new Runnable() { // from class: org.webrtc.m1
