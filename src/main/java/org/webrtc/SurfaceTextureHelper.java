...
public class SurfaceTextureHelper {
    ...
    public void returnTextureFrame() {
        this.handler.post(new Runnable() { // from class: org.webrtc.v0
            ...
            public final void run() {
                this.f99951a.lambda$returnTextureFrame$5();
            }
        });
    }
    ...
    public void forceFrame() {
        this.handler.post(new Runnable() { // from class: org.webrtc.y0
            @Override // java.lang.Runnable
            public final void run() {
                this.f99958a.lambda$forceFrame$3();
            }
        });
    }
    ...
    public void setFrameRotation(final int i11) {
        this.handler.post(new Runnable() { // from class: org.webrtc.x0
            @Override // java.lang.Runnable
            public final void run() {
                this.f99955a.lambda$setFrameRotation$4(i11);
            }
        });
    }
    ...
    public void setTextureSize(final int i11, final int i12) {
        ...
        if (i12 > 0) {
            ...
            this.handler.post(new Runnable() { // from class: org.webrtc.t0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f99944a.lambda$setTextureSize$2(i11, i12);
                }
            });
        } else {
    ...
    public void stopListening() {
        ...
        ThreadUtils.invokeAtFrontUninterruptibly(this.handler, new Runnable() { // from class: org.webrtc.s0
            @Override // java.lang.Runnable
            public final void run() {
                this.f99942a.lambda$stopListening$1();
            }
        });
    }
        ...
        try {
            ...
            surfaceTexture.setOnFrameAvailableListener(new SurfaceTexture.OnFrameAvailableListener() { // from class: org.webrtc.w0
                ...
                public final void onFrameAvailable(SurfaceTexture surfaceTexture2) {
                    this.f99954a.lambda$new$0(surfaceTexture2);
                }
            }, handler);
        } catch (RuntimeException e11) {
            this.eglBase.release();
