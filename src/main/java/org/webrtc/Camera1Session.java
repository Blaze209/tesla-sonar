...
class Camera1Session implements CameraSession {
    ...
    class AnonymousClass2 implements Camera.PreviewCallback {
        ...
        public /* synthetic */ void lambda$onPreviewFrame$1(final byte[] bArr) {
            Camera1Session.this.cameraThreadHandler.post(new Runnable() { // from class: org.webrtc.c
                ...
                public final void run() {
                    this.f99894a.lambda$onPreviewFrame$0(bArr);
                }
            });
        }
        ...
        public void onPreviewFrame(final byte[] bArr, Camera camera) {
            ...
            VideoFrame videoFrame = new VideoFrame(new NV21Buffer(bArr, Camera1Session.this.captureFormat.width, Camera1Session.this.captureFormat.height, new Runnable() { // from class: org.webrtc.b
                @Override // java.lang.Runnable
                public final void run() {
                    this.f99890a.lambda$onPreviewFrame$1(bArr);
                }
            ...
            try {
                ...
                try {
                    ...
                    try {
                        ...
                        updateCameraParameters(cameraOpen, parameters, captureFormatFindClosestCaptureFormat, findClosestPictureSize(parameters, i11, i12), z11);
                        if (!z11) {
                        ...
                        try {
                            ...
                            createSessionCallback.onDone(new Camera1Session(events, z11, context, surfaceTextureHelper, cameraIndex, cameraOpen, cameraInfo, captureFormatFindClosestCaptureFormat, jNanoTime));
    ...
    private static CameraEnumerationAndroid.CaptureFormat findClosestCaptureFormat(Camera.Parameters parameters, int i11, int i12, int i13) {
        ...
        CameraEnumerationAndroid.CaptureFormat.FramerateRange closestSupportedFramerateRange = CameraEnumerationAndroid.getClosestSupportedFramerateRange(listConvertFramerates, i13);
    ...
    private void listenForTextureFrames() {
        this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.a
            ...
            public final void onFrame(VideoFrame videoFrame) {
                this.f99882a.lambda$listenForTextureFrames$0(videoFrame);
            }
        });
    }
