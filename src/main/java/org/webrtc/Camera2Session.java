...
class Camera2Session implements CameraSession {
    ...
    private class CameraStateCallback extends CameraDevice.StateCallback {
        ...
        public void onOpened(CameraDevice cameraDevice) {
            ...
            try {
                ...
                Camera2Session.this.reportError("Failed to create capture session. " + e11);
            }
        }
            ...
            try {
                ...
                Camera2Session.this.surfaceTextureHelper.startListening(new VideoSink() { // from class: org.webrtc.d
                    ...
                    public final void onFrame(VideoFrame videoFrame) {
                        this.f99897a.lambda$onConfigured$0(videoFrame);
                    }
                });
                Logging.d(Camera2Session.TAG, "Camera device successfully started.");
                Camera2Session.this.callback.onDone(Camera2Session.this);
            } catch (CameraAccessException e11) {
                Camera2Session.this.reportError("Failed to start capture request. " + e11);
            }
        }
    ...
    private void start() {
        ...
        try {
            ...
            reportError("getCameraCharacteristics(): " + e11.getMessage());
        }
    }
