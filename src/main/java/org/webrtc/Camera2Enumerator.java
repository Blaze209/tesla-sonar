...
public class Camera2Enumerator implements CameraEnumerator {
    ...
    static List<CameraEnumerationAndroid.CaptureFormat.FramerateRange> convertFramerates(Range<Integer>[] rangeArr, int i11) {
        ArrayList arrayList = new ArrayList();
        for (Range<Integer> range : rangeArr) {
            arrayList.add(new CameraEnumerationAndroid.CaptureFormat.FramerateRange(((Integer) range.getLower()).intValue() * i11, ((Integer) range.getUpper()).intValue() * i11));
        }
        return arrayList;
    }
