...
class WebRtcAudioTrack {
    ...
    private int initPlayout(int i11, int i12, double d11) {
        ...
        ByteBuffer byteBufferAllocateDirect = ByteBuffer.allocateDirect(i12 * 2 * (i11 / 100));
        ...
        int minBufferSize = (int) (((double) AudioTrack.getMinBufferSize(i11, iChannelCountToConfiguration, 2)) * d11);
        ...
        try {
            if (!this.useLowLatency || Build.VERSION.SDK_INT < 26) {
                this.audioTrack = createAudioTrackBeforeOreo(i11, iChannelCountToConfiguration, minBufferSize, this.audioAttributes);
            } else {
                this.audioTrack = createAudioTrackOnOreoOrHigher(i11, iChannelCountToConfiguration, minBufferSize, this.audioAttributes);
            }
            AudioTrack audioTrack = this.audioTrack;
    ...
    private boolean startPlayout() {
        ...
        try {
            ...
            reportWebRtcAudioTrackStartError(JavaAudioDeviceModule.AudioTrackStartErrorCode.AUDIO_TRACK_START_EXCEPTION, "AudioTrack.play failed: " + e11.getMessage());
            releaseAudioResources();
            return false;
        }
    }
    ...
    private boolean stopPlayout() {
        ...
        if (this.audioTrack != null) {
            ...
            try {
                ...
                Logging.e(TAG, "AudioTrack.stop failed: " + e11.getMessage());
            }
        }
        releaseAudioResources();
        return true;
