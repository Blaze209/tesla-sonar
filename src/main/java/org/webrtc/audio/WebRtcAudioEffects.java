...
class WebRtcAudioEffects {
    ...
    private NoiseSuppressor f99887ns;
    ...
    public void enable(int i11) {
        ...
        if (isNoiseSuppressorSupported()) {
            ...
            this.f99887ns = noiseSuppressorCreate;
            ...
            if (this.f99887ns.setEnabled(z11) != 0) {
                Logging.e(TAG, "Failed to set the NoiseSuppressor state");
            }
            Logging.d(TAG, "NoiseSuppressor: was " + (enabled2 ? "enabled" : "disabled") + ", enable: " + z11 + ", is now: " + (this.f99887ns.getEnabled() ? "enabled" : "disabled"));
        }
    }
    ...
    public void release() {
        ...
        NoiseSuppressor noiseSuppressor = this.f99887ns;
    ...
    public boolean setNS(boolean z11) {
        ...
        if (this.f99887ns == null || z11 == this.shouldEnableNs) {
    ...
    public boolean toggleNS(boolean z11) {
        if (this.f99887ns == null) {
            Logging.e(TAG, "Attempting to enable or disable nonexistent NoiseSuppressor.");
            return false;
        }
        Logging.d(TAG, "toggleNS(" + z11 + ")");
        return this.f99887ns.setEnabled(z11) == 0;
    }
}
