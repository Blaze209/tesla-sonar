...
public class DefaultAlgorithmNameFinder implements AlgorithmNameFinder {
    ...
    static {
        ...
        map.put(aSN1ObjectIdentifier, "GOST3411WITHECGOST3410");
        map.put(aSN1ObjectIdentifier, "GOST3411WITHECGOST3410-2001");
        map.put(aSN1ObjectIdentifier, "GOST3411WITHGOST3410-2001");
        ASN1ObjectIdentifier aSN1ObjectIdentifier2 = CryptoProObjectIdentifiers.gostR3411_94_with_gostR3410_94;
        map.put(aSN1ObjectIdentifier2, "GOST3411WITHGOST3410");
        map.put(aSN1ObjectIdentifier2, "GOST3411WITHGOST3410-94");
        ...
        map.put(aSN1ObjectIdentifier3, "ECDSAWITHSHA1");
        map.put(aSN1ObjectIdentifier3, "SHA1WITHECDSA");
