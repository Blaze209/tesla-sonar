...
public class JceCMSContentEncryptorBuilder {
    ...
    private class CMSOutputEncryptor implements OutputEncryptor {
        ...
        CMSOutputEncryptor(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i11, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws CMSException {
            ...
            if (i11 < 0) {
                ...
                keyGeneratorCreateKeyGenerator.init(i11, secureRandom);
            }
