...
public class JceCMSMacCalculatorBuilder {
    ...
    private class CMSMacCalculator implements MacCalculator {
        ...
        CMSMacCalculator(ASN1ObjectIdentifier aSN1ObjectIdentifier, int i11, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws CMSException {
