...
public class CMSSignedDataStreamGenerator extends CMSSignedGenerator {
    ...
    private ASN1Integer calculateVersion(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        ...
        return !CMSObjectIdentifiers.data.equals(aSN1ObjectIdentifier) ? new ASN1Integer(3L) : new ASN1Integer(1L);
    }
    ...
    public OutputStream open(ASN1ObjectIdentifier aSN1ObjectIdentifier, OutputStream outputStream, boolean z11, OutputStream outputStream2) throws IOException {
