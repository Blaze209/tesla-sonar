...
public class TimeStampTokenGenerator {
    ...
    public TimeStampTokenGenerator(final SignerInfoGenerator signerInfoGenerator, DigestCalculator digestCalculator, ASN1ObjectIdentifier aSN1ObjectIdentifier, boolean z11) throws TSPException {
        this.resolution = 0;
        this.locale = null;
    ...
    public TimeStampToken generate(TimeStampRequest timeStampRequest, BigInteger bigInteger, Date date, Extensions extensions) throws TSPException {
        ...
        TSTInfo tSTInfo = new TSTInfo(aSN1ObjectIdentifier, messageImprint, new ASN1Integer(bigInteger), aSN1GeneralizedTimeCreateGeneralizedTime, accuracy, aSN1Boolean, aSN1Integer3, this.tsa, extensions3);
        try {
