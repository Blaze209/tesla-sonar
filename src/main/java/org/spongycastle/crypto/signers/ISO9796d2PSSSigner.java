...
public class ISO9796d2PSSSigner implements SignerWithRecovery {
    ...
    public byte[] generateSignature() {
        ...
        int length2 = (((length - i12) - bArr3.length) - this.hLen) - i11;
        bArr5[length2 - 1] = 1;
        System.arraycopy(this.mBuf, 0, bArr5, length2, i12);
        System.arraycopy(bArr3, 0, this.block, length2 + this.messageLength, bArr3.length);
        byte[] bArrMaskGeneratorFunction1 = maskGeneratorFunction1(bArr4, 0, digestSize2, (this.block.length - this.hLen) - i11);
        for (int i13 = 0; i13 != bArrMaskGeneratorFunction1.length; i13++) {
            byte[] bArr6 = this.block;
            bArr6[i13] = (byte) (bArr6[i13] ^ bArrMaskGeneratorFunction1[i13]);
        }
        ...
        this.fullMessage = i16 <= bArr12.length;
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        this.block = bArr;
        if (this.trailer == 188) {
            this.mBuf = new byte[((bArr.length - this.digest.getDigestSize()) - length) - 2];
        } else {
            this.mBuf = new byte[((bArr.length - this.digest.getDigestSize()) - length) - 3];
        }
        reset();
    }
