...
public class ECIESKeyEncapsulation implements KeyEncapsulation {
    ...
    public CipherParameters decrypt(byte[] bArr, int i11, int i12, int i13) {
        ...
        return deriveKey(i13, bArr2, eCPointDecodePoint.multiply(d11).normalize().getAffineXCoord().getEncoded());
    }
    ...
    public CipherParameters encrypt(byte[] bArr, int i11, int i12) {
        ...
        ECPoint[] eCPointArr = {createBasePointMultiplier().multiply(parameters.getG(), bigIntegerCreateRandomInRange), eCPublicKeyParameters.getQ().multiply(this.CofactorMode ? bigIntegerCreateRandomInRange.multiply(h11).mod(n11) : bigIntegerCreateRandomInRange)};
