...
public class SRP6Server {
    ...
    protected BigInteger f99434b;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f99435g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f99436u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    protected BigInteger f99437v;

    private BigInteger calculateS() {
        return this.f99437v.modPow(this.f99436u, this.N).multiply(this.A).mod(this.N).modPow(this.f99434b, this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f99436u = SRP6Util.calculateU(this.digest, this.N, bigIntegerValidatePublicValue, this.B);
    ...
    public BigInteger generateServerCredentials() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f99435g);
        this.f99434b = selectPrivateValue();
        BigInteger bigIntegerMod = bigIntegerCalculateK.multiply(this.f99437v).mod(this.N).add(this.f99435g.modPow(this.f99434b, this.N)).mod(this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f99435g = bigInteger2;
        this.f99437v = bigInteger3;
        this.random = secureRandom;
        this.digest = digest;
    }

    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f99435g, this.random);
    }
