...
public class SRP6Client {
    ...
    protected BigInteger f99430a;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f99431g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f99432u;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    protected BigInteger f99433x;

    private BigInteger calculateS() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f99431g);
        return this.B.subtract(this.f99431g.modPow(this.f99433x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.f99432u.multiply(this.f99433x).add(this.f99430a), this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f99432u = SRP6Util.calculateU(this.digest, this.N, this.A, bigIntegerValidatePublicValue);
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        this.f99433x = SRP6Util.calculateX(this.digest, this.N, bArr, bArr2, bArr3);
        BigInteger bigIntegerSelectPrivateValue = selectPrivateValue();
        this.f99430a = bigIntegerSelectPrivateValue;
        BigInteger bigIntegerModPow = this.f99431g.modPow(bigIntegerSelectPrivateValue, this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f99431g = bigInteger2;
        this.digest = digest;
        this.random = secureRandom;
    }

    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f99431g, this.random);
    }
