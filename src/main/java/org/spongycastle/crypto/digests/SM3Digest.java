...
public class SM3Digest extends GeneralDigest {
    ...
    public int doFinal(byte[] bArr, int i11) {
        finish();
        Pack.intToBigEndian(this.V[0], bArr, i11);
    ...
    protected void processBlock() {
        ...
        while (i25 < 16) {
            ...
            int iFF0 = FF0(i16, i17, i18) + i19 + (i28 ^ i26) + this.W1[i25];
            int iGG0 = GG0(iP0, i21, i24) + i23 + i28 + this.W[i25];
            int i29 = (i17 << 9) | (i17 >>> 23);
            i25++;
            int i31 = iP0;
            iP0 = P0(iGG0);
            i23 = i24;
        ...
        while (i35 < 64) {
            ...
            int i37 = i36 + iP0 + T[i35];
            int i38 = (i37 << 7) | (i37 >>> 25);
            int iFF1 = FF1(i34, i17, i18) + i19 + (i38 ^ i36) + this.W1[i35];
            int iGG1 = GG1(iP0, i21, i33) + i32 + i38 + this.W[i35];
            int i39 = (i17 << 9) | (i17 >>> 23);
            int i41 = (i21 << 19) | (i21 >>> 13);
            i35++;
            i21 = iP0;
            iP0 = P0(iGG1);
            i19 = i18;
