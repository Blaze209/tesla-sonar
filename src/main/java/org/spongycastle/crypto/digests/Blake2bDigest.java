...
public class Blake2bDigest implements ExtendedDigest {
    ...
    private long f99440t0;

    /* JADX INFO: renamed from: t1, reason: collision with root package name */
    private long f99441t1;
    ...
    private void G(long j11, long j12, int i11, int i12, int i13, int i14) {
        ...
        jArr[i11] = j13;
        jArr[i14] = rotr64(jArr[i14] ^ j13, 32);
        long[] jArr2 = this.internalState;
        long j14 = jArr2[i13] + jArr2[i14];
        jArr2[i13] = j14;
        jArr2[i12] = rotr64(j14 ^ jArr2[i12], 24);
        long[] jArr3 = this.internalState;
        long j15 = jArr3[i11] + jArr3[i12] + j12;
        jArr3[i11] = j15;
        jArr3[i14] = rotr64(jArr3[i14] ^ j15, 16);
        long[] jArr4 = this.internalState;
        long j16 = jArr4[i13] + jArr4[i14];
        jArr4[i13] = j16;
        jArr4[i12] = rotr64(j16 ^ jArr4[i12], 63);
    }
    ...
    private void init() {
        if (this.chainValue == null) {
            ...
            if (bArr2 != null) {
                jArr4[6] = bytes2long(bArr2, 0) ^ j12;
    ...
    private void initializeInternalState() {
        ...
        long[] jArr3 = this.internalState;
        jArr3[12] = this.f99440t0 ^ jArr2[4];
        jArr3[13] = this.f99441t1 ^ jArr2[5];
        jArr3[14] = this.f99439f0 ^ jArr2[6];
        jArr3[15] = jArr2[7];
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        ...
        while (true) {
            ...
            byte[] bArrLong2bytes = long2bytes(jArr[i14]);
            int i15 = this.digestLength;
            if (i12 < i15 - 8) {
                System.arraycopy(bArrLong2bytes, 0, bArr, i12 + i11, 8);
            } else {
                System.arraycopy(bArrLong2bytes, 0, bArr, i11 + i12, i15 - i12);
            }
            i14++;
        }
        Arrays.fill(jArr, 0L);
    ...
    public Blake2bDigest(Blake2bDigest blake2bDigest) {
        ...
        this.f99440t0 = blake2bDigest.f99440t0;
        this.f99441t1 = blake2bDigest.f99441t1;
        this.f99439f0 = blake2bDigest.f99439f0;
    }
