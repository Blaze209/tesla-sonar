...
public class KeccakDigest implements ExtendedDigest {
    ...
    private void fromBytesToWords(long[] jArr, byte[] bArr) {
        for (int i11 = 0; i11 < 25; i11++) {
            ...
            for (int i13 = 0; i13 < 8; i13++) {
                jArr[i11] = jArr[i11] | ((((long) bArr[i12 + i13]) & 255) << (i13 * 8));
            }
        }
    }
    ...
    private void theta(long[] jArr) {
        ...
        while (i13 < 5) {
            long[] jArr3 = this.C;
            int i14 = i13 + 1;
            long j11 = jArr3[i14 % 5];
            long j12 = ((j11 >>> 63) ^ (j11 << 1)) ^ jArr3[(i13 + 4) % 5];
            for (int i15 = 0; i15 < 5; i15++) {
                int i16 = (i15 * 5) + i13;
    ...
    protected void absorb(byte[] bArr, int i11, long j11) {
        ...
        while (j12 < j11) {
            ...
            if (i12 == 0) {
                int i13 = this.rate;
                if (j11 >= i13 && j12 <= j11 - ((long) i13)) {
                    long j14 = (j11 - j12) / ((long) i13);
                    long j15 = 0;
                    while (j15 < j14) {
                        byte[] bArr2 = this.chunk;
                        System.arraycopy(bArr, (int) (((long) i11) + (j12 / j13) + (((long) bArr2.length) * j15)), bArr2, 0, bArr2.length);
