...
public class HC256Engine implements StreamCipher {
    ...
    private byte[] f99484iv;
    private byte[] key;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private int[] f99485p = new int[1024];

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private int[] f99486q = new int[1024];
    private int cnt = 0;
    ...
    private void init() {
        ...
        byte[] bArr4 = this.f99484iv;
        if (bArr4.length < 32) {
            byte[] bArr5 = new byte[32];
            System.arraycopy(bArr4, 0, bArr5, 0, bArr4.length);
            byte[] bArr6 = this.f99484iv;
        ...
        for (int i13 = 0; i13 < 32; i13++) {
            int i14 = (i13 >> 2) + 8;
            iArr[i14] = iArr[i14] | ((this.f99484iv[i13] & 255) << ((i13 & 3) * 8));
        }
        ...
        System.arraycopy(iArr, 512, this.f99485p, 0, 1024);
        System.arraycopy(iArr, 1536, this.f99486q, 0, 1024);
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f99484iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f99484iv = new byte[0];
