...
public class RFC3394WrapEngine implements Wrapper {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f99494iv = parametersWithIV.getIV();
            this.param = (KeyParameter) parametersWithIV.getParameters();
            if (this.f99494iv.length != 8) {
    ...
    public byte[] unwrap(byte[] bArr, int i11, int i12) throws InvalidCipherTextException {
        ...
        if (Arrays.constantTimeAreEqual(bArr4, this.f99494iv)) {
            return bArr3;
        }
    ...
    public byte[] wrap(byte[] bArr, int i11, int i12) {
        ...
        System.arraycopy(bArr, i11, bArr3, this.f99494iv.length, i12);
        this.engine.init(this.wrapCipherMode, this.param);
        for (int i14 = 0; i14 != 6; i14++) {
            for (int i15 = 1; i15 <= i13; i15++) {
                System.arraycopy(bArr3, 0, bArr4, 0, this.f99494iv.length);
                int i16 = i15 * 8;
                System.arraycopy(bArr3, i16, bArr4, this.f99494iv.length, 8);
                this.engine.processBlock(bArr4, 0, bArr4, 0);
                int i17 = (i13 * i14) + i15;
                int i18 = 1;
                while (i17 != 0) {
                    int length = this.f99494iv.length - i18;
    ...
    public RFC3394WrapEngine(BlockCipher blockCipher, boolean z11) {
        this.f99494iv = new byte[]{-90, -90, -90, -90, -90, -90, -90, -90};
