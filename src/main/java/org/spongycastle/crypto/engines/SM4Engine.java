...
public class SM4Engine implements BlockCipher {
    ...
    private void R(int[] iArr, int i11) {
        ...
        int i13 = i11 + 2;
        int i14 = i11 + 3;
        int i15 = iArr[i11] ^ iArr[i14];
        iArr[i11] = i15;
        int i16 = i15 ^ iArr[i14];
        iArr[i14] = i16;
        iArr[i11] = iArr[i11] ^ i16;
        int i17 = iArr[i12] ^ iArr[i13];
        iArr[i12] = i17;
        int i18 = i17 ^ iArr[i13];
        iArr[i13] = i18;
        iArr[i12] = i18 ^ iArr[i12];
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        this.f99495rk = expandKey(z11, key);
    }

    @Override // org.spongycastle.crypto.BlockCipher
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        if (this.f99495rk == null) {
        ...
        for (int i13 = 0; i13 < 32; i13 += 4) {
            int[] iArr = this.X;
            iArr[0] = F0(iArr, this.f99495rk[i13]);
            int[] iArr2 = this.X;
            iArr2[1] = F1(iArr2, this.f99495rk[i13 + 1]);
            int[] iArr3 = this.X;
            iArr3[2] = F2(iArr3, this.f99495rk[i13 + 2]);
            int[] iArr4 = this.X;
            iArr4[3] = F3(iArr4, this.f99495rk[i13 + 3]);
        }
        R(this.X, 0);
