...
public class DESEngine implements BlockCipher {
    ...
    private static final int[] SP4 = {8396801, 8321, 8321, 128, 8396928, 8388737, 8388609, 8193, 0, 8396800, 8396800, 8396929, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 0, 8388736, 8388609, 1, PKIFailureInfo.certRevoked, 8388608, 8396801, 128, 8388608, 8193, 8320, 8388737, 1, 8320, 8388736, PKIFailureInfo.certRevoked, 8396928, 8396929, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 8388736, 8388609, 8396800, 8396929, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 0, 0, 8396800, 8320, 8388736, 8388737, 1, 8396801, 8321, 8321, 128, 8396929, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 1, PKIFailureInfo.certRevoked, 8388609, 8193, 8396928, 8388737, 8193, 8320, 8388608, 8396801, 128, 8388608, PKIFailureInfo.certRevoked, 8396928};
    ...
    protected void desFunc(int[] iArr, byte[] bArr, int i11, byte[] bArr2, int i12) {
        int i13 = ((bArr[i11] & 255) << 24) | ((bArr[i11 + 1] & 255) << 16) | ((bArr[i11 + 2] & 255) << 8) | (bArr[i11 + 3] & 255);
        int i14 = ((bArr[i11 + 4] & 255) << 24) | ((bArr[i11 + 5] & 255) << 16) | ((bArr[i11 + 6] & 255) << 8) | (bArr[i11 + 7] & 255);
        int i15 = ((i13 >>> 4) ^ i14) & 252645135;
        int i16 = i14 ^ i15;
        int i17 = i13 ^ (i15 << 4);
        int i18 = ((i17 >>> 16) ^ i16) & 65535;
        int i19 = i16 ^ i18;
        int i21 = i17 ^ (i18 << 16);
        ...
        int i26 = i23 ^ i25;
        int i27 = i24 ^ (i25 << 8);
        int i28 = ((i27 >>> 31) & 1) | (i27 << 1);
        int i29 = (i26 ^ i28) & (-1431655766);
        int i31 = i26 ^ i29;
        int i32 = i28 ^ i29;
        int i33 = ((i31 >>> 31) & 1) | (i31 << 1);
        for (int i34 = 0; i34 < 8; i34++) {
            int i35 = i34 * 4;
            int i36 = ((i32 << 28) | (i32 >>> 4)) ^ iArr[i35];
            int[] iArr2 = SP7;
            ...
            int i47 = iArr5[(i46 >>> 24) & 63] | iArr2[i46 & 63] | iArr3[(i46 >>> 8) & 63] | iArr4[(i46 >>> 16) & 63];
            int i48 = iArr[i35 + 3] ^ i33;
            i32 ^= (((i47 | iArr6[i48 & 63]) | iArr7[(i48 >>> 8) & 63]) | iArr8[(i48 >>> 16) & 63]) | iArr9[(i48 >>> 24) & 63];
        }
        ...
        int i59 = i56 ^ i58;
        int i61 = i57 ^ (i58 << 2);
        int i62 = ((i59 >>> 16) ^ i61) & 65535;
        int i63 = i61 ^ i62;
        int i64 = i59 ^ (i62 << 16);
        int i65 = ((i64 >>> 4) ^ i63) & 252645135;
        int i66 = i63 ^ i65;
        int i67 = i64 ^ (i65 << 4);
        bArr2[i12] = (byte) ((i67 >>> 24) & 255);
    ...
    protected int[] generateWorkingKey(boolean z11, byte[] bArr) {
        int i11;
        int[] iArr = new int[32];
