...
public class HC128Engine implements StreamCipher {
    ...
    private byte[] f99481iv;
    private byte[] key;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private int[] f99482p = new int[512];

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private int[] f99483q = new int[512];
    private int cnt = 0;
    ...
    private void init() {
        ...
        System.arraycopy(iArr, 256, this.f99482p, 0, 512);
        System.arraycopy(iArr, 768, this.f99483q, 0, 512);
        for (int i16 = 0; i16 < 512; i16++) {
            this.f99482p[i16] = step();
        }
        for (int i17 = 0; i17 < 512; i17++) {
            this.f99483q[i17] = step();
        }
        this.cnt = 0;
    }
    ...
    private int step() {
        ...
        if (this.cnt < 512) {
            int[] iArr = this.f99482p;
            iArr[iMod512] = iArr[iMod512] + g1(iArr[dim(iMod512, 3)], this.f99482p[dim(iMod512, 10)], this.f99482p[dim(iMod512, 511)]);
            iH2 = h1(this.f99482p[dim(iMod512, 12)]);
            i11 = this.f99482p[iMod512];
        } else {
            int[] iArr2 = this.f99483q;
            iArr2[iMod512] = iArr2[iMod512] + g2(iArr2[dim(iMod512, 3)], this.f99483q[dim(iMod512, 10)], this.f99483q[dim(iMod512, 511)]);
            iH2 = h2(this.f99483q[dim(iMod512, 12)]);
            i11 = this.f99483q[iMod512];
        }
        int i12 = i11 ^ iH2;
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (cipherParameters instanceof ParametersWithIV) {
            ...
            this.f99481iv = parametersWithIV.getIV();
            parameters = parametersWithIV.getParameters();
        } else {
            this.f99481iv = new byte[0];
