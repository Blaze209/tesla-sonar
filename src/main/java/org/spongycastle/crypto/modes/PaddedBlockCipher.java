    ...
    public int doFinal(byte[] bArr, int i11) throws InvalidCipherTextException {
        ...
        if (this.forEncryption) {
            if (this.bufOff != blockSize) {
                ...
                iProcessBlock2 = this.cipher.processBlock(this.buf, 0, bArr, i11);
                this.bufOff = 0;
            }
            ...
            iProcessBlock = iProcessBlock2 + this.cipher.processBlock(this.buf, 0, bArr, i11 + iProcessBlock2);
        } else {
            if (this.bufOff != blockSize) {
