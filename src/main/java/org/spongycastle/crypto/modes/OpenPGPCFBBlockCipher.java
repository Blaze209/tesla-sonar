...
public class OpenPGPCFBBlockCipher implements BlockCipher {
    ...
    private int encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        if (i16 > i15) {
            byte[] bArr3 = this.FR;
            int i19 = i15 - 2;
            byte bEncryptByte = encryptByte(bArr[i11], i15 - 2);
            bArr2[i12] = bEncryptByte;
            bArr3[i19] = bEncryptByte;
            byte[] bArr4 = this.FR;
            int i21 = this.blockSize;
            int i22 = i21 - 1;
            byte bEncryptByte2 = encryptByte(bArr[i11 + 1], i21 - 1);
            bArr2[i12 + 1] = bEncryptByte2;
            bArr4[i22] = bEncryptByte2;
            this.cipher.processBlock(this.FR, 0, this.FRE, 0);
            while (i17 < this.blockSize) {
                byte[] bArr5 = this.FR;
                int i23 = i17 - 2;
                byte bEncryptByte3 = encryptByte(bArr[i11 + i17], i23);
                bArr2[i12 + i17] = bEncryptByte3;
                bArr5[i23] = bEncryptByte3;
                i17++;
            }
        } else if (i16 == 0) {
            this.cipher.processBlock(this.FR, 0, this.FRE, 0);
            while (true) {
                ...
                byte[] bArr6 = this.FR;
                byte bEncryptByte4 = encryptByte(bArr[i11 + i18], i18);
                bArr2[i12 + i18] = bEncryptByte4;
                bArr6[i18] = bEncryptByte4;
                i18++;
            }
            this.count += i14;
        } else if (i16 == i15) {
            ...
            while (true) {
                ...
                byte[] bArr8 = this.FR;
                int i24 = i17 - 2;
                byte bEncryptByte5 = encryptByte(bArr[i11 + i17], i24);
                bArr2[i12 + i17] = bEncryptByte5;
                bArr8[i24] = bEncryptByte5;
                i17++;
            }
            this.count += i13;
        }
