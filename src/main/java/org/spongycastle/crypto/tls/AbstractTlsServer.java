...
public abstract class AbstractTlsServer extends AbstractTlsPeer implements TlsServer {
    ...
    public int getSelectedCipherSuite() throws TlsFatalAlert {
        ...
        for (int i11 : getCipherSuites()) {
            if (Arrays.contains(this.offeredCipherSuites, i11) && ((zSupportsClientECCCapabilities || !TlsECCUtils.isECCCipherSuite(i11)) && TlsUtils.isValidCipherSuiteForVersion(i11, this.serverVersion))) {
    ...
    @Override // org.spongycastle.crypto.tls.TlsServer
    public void notifyFallback(boolean z11) throws TlsFatalAlert {
