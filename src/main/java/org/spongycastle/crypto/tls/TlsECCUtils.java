...
public class TlsECCUtils {
    ...
    private static void checkNamedCurve(int[] iArr, int i11) throws TlsFatalAlert {
    ...
    public static BigInteger deserializeECFieldElement(int i11, byte[] bArr) throws TlsFatalAlert {
    ...
    static ECPrivateKeyParameters generateEphemeralServerKeyExchange(SecureRandom secureRandom, int[] iArr, short[] sArr, OutputStream outputStream) throws IOException {
        ...
        if (i11 >= 0) {
            parametersForNamedCurve = getParametersForNamedCurve(i11);
    ...
    public static int readECExponent(int i11, InputStream inputStream) throws TlsFatalAlert {
        int iIntValue;
        BigInteger eCParameter = readECParameter(inputStream);
        if (eCParameter.bitLength() >= 32 || (iIntValue = eCParameter.intValue()) <= 0 || iIntValue >= i11) {
            throw new TlsFatalAlert((short) 47);
        }
        return iIntValue;
    }
    ...
    public static ECDomainParameters readECParameters(int[] iArr, short[] sArr, InputStream inputStream) throws IOException {
        ...
        try {
            ...
            if (uint8 == 1) {
                ...
                ECCurve.Fp fp2 = new ECCurve.Fp(eCParameter, eCFieldElement, eCFieldElement2, eCParameter2, eCParameter3);
                return new ECDomainParameters(fp2, deserializeECPoint(sArr, fp2, opaque8), eCParameter2, eCParameter3);
            }
            if (uint8 != 2) {
                if (uint8 != 3) {
                    throw new TlsFatalAlert((short) 47);
    ...
    public static void writeECExponent(int i11, OutputStream outputStream) throws IOException {
    ...
    public static void writeNamedECParameters(int i11, OutputStream outputStream) throws IOException {
    ...
    public static void writeECFieldElement(int i11, BigInteger bigInteger, OutputStream outputStream) throws IOException {
