...
public class DTLSServerProtocol extends DTLSProtocol {
    ...
    public DTLSTransport accept(TlsServer tlsServer, DatagramTransport datagramTransport) {
        ...
        try {
            try {
                ...
                abortServerHandshake(serverHandshakeState, dTLSRecordLayer, e13.getAlertDescription());
                throw e13;
            }
        } catch (Throwable th2) {
            securityParameters.clear();
    ...
    protected void notifyClientCertificate(ServerHandshakeState serverHandshakeState, Certificate certificate) throws TlsFatalAlert {
    ...
    protected void processCertificateVerify(ServerHandshakeState serverHandshakeState, byte[] bArr, TlsHandshakeHash tlsHandshakeHash) throws TlsFatalAlert {
        byte[] sessionHash;
        if (serverHandshakeState.certificateRequest == null) {
            throw new IllegalStateException();
        }
    ...
    protected void processClientCertificate(ServerHandshakeState serverHandshakeState, byte[] bArr) throws TlsFatalAlert {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
    ...
    protected void processClientKeyExchange(ServerHandshakeState serverHandshakeState, byte[] bArr) throws TlsFatalAlert {
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
        serverHandshakeState.keyExchange.processClientKeyExchange(byteArrayInputStream);
        TlsProtocol.assertEmpty(byteArrayInputStream);
    }

    protected void processClientSupplementalData(ServerHandshakeState serverHandshakeState, byte[] bArr) throws TlsFatalAlert, EOFException {
