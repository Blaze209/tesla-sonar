...
public class TlsPSKKeyExchange extends AbstractTlsKeyExchange {
    ...
    protected byte[] generateOtherSecret(int i11) throws TlsFatalAlert {
        ...
        if (i12 != 24) {
            return i12 == 15 ? this.premasterSecret : new byte[i11];
        }
    ...
    protected RSAKeyParameters validateRSAPublicKey(RSAKeyParameters rSAKeyParameters) throws TlsFatalAlert {
