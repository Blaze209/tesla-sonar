...
public class TlsExtensionsUtils {
    ...
    public static byte[] createMaxFragmentLengthExtension(short s11) throws TlsFatalAlert {
    ...
    public static byte[] createPaddingExtension(int i11) throws TlsFatalAlert {
    ...
    public static HeartbeatExtension readHeartbeatExtension(byte[] bArr) throws TlsFatalAlert {
        if (bArr == null) {
            throw new IllegalArgumentException("'extensionData' cannot be null");
        }
    ...
    public static ServerNameList readServerNameExtension(byte[] bArr) throws TlsFatalAlert {
        if (bArr == null) {
            throw new IllegalArgumentException("'extensionData' cannot be null");
        }
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
    ...
    public static CertificateStatusRequest readStatusRequestExtension(byte[] bArr) throws TlsFatalAlert {
        if (bArr == null) {
            throw new IllegalArgumentException("'extensionData' cannot be null");
        }
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(bArr);
