...
public class CertificateRequest {
    ...
    public void encode(OutputStream outputStream) throws IOException {
        ...
        int length = 0;
        for (int i11 = 0; i11 < this.certificateAuthorities.size(); i11++) {
            byte[] encoded = ((X500Name) this.certificateAuthorities.elementAt(i11)).getEncoded("DER");
        ...
        for (int i12 = 0; i12 < vector3.size(); i12++) {
            TlsUtils.writeOpaque16((byte[]) vector3.elementAt(i12), outputStream);
        }
    }
