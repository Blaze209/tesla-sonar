...
public class TlsUtils {
    ...
    public static byte[] PRF(TlsContext tlsContext, byte[] bArr, String str, byte[] bArr2, int i11) {
        ...
        if (prfAlgorithm == 0) {
            return PRF_legacy(bArr, byteArray, bArrConcat, i11);
        }
    ...
    static byte[] calculateKeyBlock(TlsContext tlsContext, int i11) {
        ...
        return isSSL(tlsContext) ? calculateKeyBlock_SSL(masterSecret, bArrConcat, i11) : PRF(tlsContext, masterSecret, "key expansion", bArrConcat, i11);
    }
    ...
    static byte[] calculateKeyBlock_SSL(byte[] bArr, byte[] bArr2, int i11) {
        ...
        while (i12 < i11) {
            ...
            digestCreateHash.doFinal(bArr4, i12);
            i12 += digestSize;
            i13++;
        }
    ...
    static byte[] calculateMasterSecret_SSL(byte[] bArr, byte[] bArr2) {
        ...
        for (int i12 = 0; i12 < 3; i12++) {
            ...
            digestCreateHash.update(bArr, 0, bArr.length);
            digestCreateHash.update(bArr3, 0, digestSize2);
            digestCreateHash.doFinal(bArr4, i11);
            i11 += digestSize;
        }
        return bArr4;
    }
    ...
    public static void checkUint16(int i11) throws TlsFatalAlert {
    ...
    public static void checkUint32(long j11) throws TlsFatalAlert {
        if (!isValidUint32(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }

    public static void checkUint48(long j11) throws TlsFatalAlert {
        if (!isValidUint48(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }

    public static void checkUint64(long j11) throws TlsFatalAlert {
        if (!isValidUint64(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }

    public static void checkUint8(short s11) throws TlsFatalAlert {
        if (!isValidUint8(s11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }
    ...
    public static Digest clonePRFHash(int i11, Digest digest) {
        return i11 != 0 ? cloneHash(getHashAlgorithmForPRFAlgorithm(i11), digest) : new CombinedHash((CombinedHash) digest);
    }
    ...
    public static Digest createPRFHash(int i11) {
        return i11 != 0 ? createHash(getHashAlgorithmForPRFAlgorithm(i11)) : new CombinedHash();
    }
    ...
    public static void encodeSupportedSignatureAlgorithms(Vector vector, boolean z11, OutputStream outputStream) throws IOException {
    ...
    public static int getCipherType(int i11) throws TlsFatalAlert {
    ...
    static short getClientCertificateType(Certificate certificate, Certificate certificate2) throws TlsFatalAlert {
    ...
    /* JADX WARN: Code duplicated, block: B:45:0x0053 A[RETURN] */
    public static int getEncryptionAlgorithm(int i11) throws TlsFatalAlert {
        if (i11 != 1 && i11 != 2) {
            if (i11 != 4 && i11 != 5) {
                switch (i11) {
                    case 10:
    ...
    /* JADX WARN: Code duplicated, block: B:44:0x0050 A[RETURN] */
    public static int getKeyExchangeAlgorithm(int i11) throws TlsFatalAlert {
    ...
    /* JADX WARN: Can't fix incorrect switch cases order, some code will duplicate */
    /* JADX WARN: Code duplicated, block: B:25:0x0031 A[FALL_THROUGH, RETURN] */
    public static int getMACAlgorithm(int i11) throws TlsFatalAlert {
        if (i11 != 1) {
            if (i11 != 2) {
                if (i11 != 4) {
                    if (i11 != 5) {
    ...
    public static boolean hasExpectedEmptyExtensionData(Hashtable hashtable, Integer num, short s11) throws TlsFatalAlert {
    ...
    public static Vector parseSupportedSignatureAlgorithms(boolean z11, InputStream inputStream) throws IOException {
    ...
    public static byte[] readAllOrNothing(int i11, InputStream inputStream) throws EOFException {
        if (i11 < 1) {
            return EMPTY_BYTES;
        }
    ...
    public static byte[] readFully(int i11, InputStream inputStream) throws EOFException {
        if (i11 < 1) {
            return EMPTY_BYTES;
        }
        byte[] bArr = new byte[i11];
    ...
    public static byte[] readOpaque24(InputStream inputStream) throws EOFException {
    ...
    public static long readUint32(InputStream inputStream) throws IOException {
        ...
        if (i14 >= 0) {
            return ((long) (i14 | (i11 << 24) | (i12 << 16) | (i13 << 8))) & 4294967295L;
        }
        throw new EOFException();
    }
    ...
    static void validateKeyUsage(org.spongycastle.asn1.x509.Certificate certificate, int i11) throws TlsFatalAlert {
        KeyUsage keyUsageFromExtensions;
        Extensions extensions = certificate.getTBSCertificate().getExtensions();
        if (extensions != null && (keyUsageFromExtensions = KeyUsage.fromExtensions(extensions)) != null && (keyUsageFromExtensions.getBytes()[0] & 255 & i11) != i11) {
    ...
    public static void writeGMTUnixTime(byte[] bArr, int i11) {
        ...
        bArr[i11] = (byte) (iCurrentTimeMillis >>> 24);
        bArr[i11 + 1] = (byte) (iCurrentTimeMillis >>> 16);
        bArr[i11 + 2] = (byte) (iCurrentTimeMillis >>> 8);
        bArr[i11 + 3] = (byte) iCurrentTimeMillis;
    }
    ...
    public static void writeUint16(int i11, OutputStream outputStream) throws IOException {
    ...
    public static void writeUint32(long j11, OutputStream outputStream) throws IOException {
    ...
    public static void writeUint48(long j11, OutputStream outputStream) throws IOException {
    ...
    public static void writeUint64(long j11, OutputStream outputStream) throws IOException {
    ...
    public static void writeUint8(short s11, OutputStream outputStream) throws IOException {
    ...
    public static ProtocolVersion readVersion(InputStream inputStream) throws IOException {
        ...
        int i12 = inputStream.read();
        if (i12 >= 0) {
            return ProtocolVersion.get(i11, i12);
        }
        throw new EOFException();
    }
    ...
    public static void writeUint8(int i11, OutputStream outputStream) throws IOException {
        outputStream.write(i11);
    }

    public static void checkUint16(long j11) throws TlsFatalAlert {
        if (!isValidUint16(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }

    public static void checkUint24(long j11) throws TlsFatalAlert {
        if (!isValidUint24(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }

    public static void checkUint8(int i11) throws TlsFatalAlert {
        if (!isValidUint8(i11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }
    ...
    public static long readUint48(byte[] bArr, int i11) {
        int uint24 = readUint24(bArr, i11);
        return (((long) readUint24(bArr, i11 + 3)) & 4294967295L) | ((((long) uint24) & 4294967295L) << 24);
    }
    ...
    public static void writeUint8ArrayWithUint8Length(short[] sArr, byte[] bArr, int i11) throws TlsFatalAlert {
        checkUint8(sArr.length);
        writeUint8(sArr.length, bArr, i11);
        writeUint8Array(sArr, bArr, i11 + 1);
    }

    public static void checkUint8(long j11) throws TlsFatalAlert {
        if (!isValidUint8(j11)) {
            throw new TlsFatalAlert((short) 80);
        }
    }
    ...
    public static void writeUint16ArrayWithUint16Length(int[] iArr, byte[] bArr, int i11) throws TlsFatalAlert {
        int length = iArr.length * 2;
        checkUint16(length);
    ...
    public static long readUint32(byte[] bArr, int i11) {
        return ((long) ((bArr[i11 + 3] & 255) | ((bArr[i11] & 255) << 24) | ((bArr[i11 + 1] & 255) << 16) | ((bArr[i11 + 2] & 255) << 8))) & 4294967295L;
    }
