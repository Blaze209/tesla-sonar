...
public class PKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    public PKCS12ParametersGenerator(Digest digest) {
        ...
        if (digest instanceof ExtendedDigest) {
            this.f99513u = digest.getDigestSize();
            this.f99514v = ((ExtendedDigest) digest).getByteLength();
        } else {
    ...
    private byte[] generateDerivedKey(int i11, int i12) {
        ...
        int i23 = this.f99514v;
        byte[] bArr10 = new byte[i23];
        int i24 = this.f99513u;
        ...
        while (i26 <= i25) {
            ...
            if (i26 == i25) {
                ...
                i13 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i26 - 1) * this.f99513u, i24);
            }
            i26++;
            i15 = i13;
            i17 = 1;
