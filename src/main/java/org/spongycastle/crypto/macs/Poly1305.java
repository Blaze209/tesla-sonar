...
public class Poly1305 implements Mac {
    ...
    private void processBlock() {
        ...
        int i13 = (int) (((long) this.f99515h0) + (jLittleEndianToInt & 67108863));
        this.f99515h0 = i13;
        this.f99516h1 = (int) (((long) this.f99516h1) + ((((jLittleEndianToInt2 << 32) | j11) >>> 26) & 67108863));
        this.f99517h2 = (int) (((long) this.f99517h2) + (((jLittleEndianToInt2 | (jLittleEndianToInt3 << 32)) >>> 20) & 67108863));
        this.f99518h3 = (int) (((long) this.f99518h3) + ((((jLittleEndianToInt4 << 32) | jLittleEndianToInt3) >>> 14) & 67108863));
        int i14 = (int) (((long) this.f99519h4) + (jLittleEndianToInt4 >>> 8));
        this.f99519h4 = i14;
        if (this.currentBlockOffset == 16) {
            this.f99519h4 = i14 + Http2Connection.OKHTTP_CLIENT_WINDOW_SIZE;
        }
        long jMul32x32_64 = mul32x32_64(i13, this.f99524r0) + mul32x32_64(this.f99516h1, this.f99532s4) + mul32x32_64(this.f99517h2, this.f99531s3) + mul32x32_64(this.f99518h3, this.f99530s2) + mul32x32_64(this.f99519h4, this.f99529s1);
        long jMul32x32_65 = mul32x32_64(this.f99515h0, this.f99525r1) + mul32x32_64(this.f99516h1, this.f99524r0) + mul32x32_64(this.f99517h2, this.f99532s4) + mul32x32_64(this.f99518h3, this.f99531s3) + mul32x32_64(this.f99519h4, this.f99530s2);
        long jMul32x32_66 = mul32x32_64(this.f99515h0, this.f99526r2) + mul32x32_64(this.f99516h1, this.f99525r1) + mul32x32_64(this.f99517h2, this.f99524r0) + mul32x32_64(this.f99518h3, this.f99532s4) + mul32x32_64(this.f99519h4, this.f99531s3);
        long jMul32x32_67 = mul32x32_64(this.f99515h0, this.f99527r3) + mul32x32_64(this.f99516h1, this.f99526r2) + mul32x32_64(this.f99517h2, this.f99525r1) + mul32x32_64(this.f99518h3, this.f99524r0) + mul32x32_64(this.f99519h4, this.f99532s4);
        long jMul32x32_68 = mul32x32_64(this.f99515h0, this.f99528r4) + mul32x32_64(this.f99516h1, this.f99527r3) + mul32x32_64(this.f99517h2, this.f99526r2) + mul32x32_64(this.f99518h3, this.f99525r1) + mul32x32_64(this.f99519h4, this.f99524r0);
        long j12 = jMul32x32_65 + (jMul32x32_64 >>> 26);
        long j13 = jMul32x32_66 + (j12 >>> 26);
        this.f99517h2 = ((int) j13) & 67108863;
        long j14 = jMul32x32_67 + (j13 >>> 26);
        this.f99518h3 = ((int) j14) & 67108863;
        long j15 = jMul32x32_68 + (j14 >>> 26);
        this.f99519h4 = ((int) j15) & 67108863;
        int i15 = (((int) jMul32x32_64) & 67108863) + (((int) (j15 >>> 26)) * 5);
        this.f99516h1 = (((int) j12) & 67108863) + (i15 >>> 26);
        this.f99515h0 = i15 & 67108863;
    }
    ...
    private void setKey(byte[] bArr, byte[] bArr2) {
        ...
        this.f99524r0 = 67108863 & iLittleEndianToInt;
        ...
        this.f99520k0 = Pack.littleEndianToInt(bArr, i11);
        this.f99521k1 = Pack.littleEndianToInt(bArr, i11 + 4);
        this.f99522k2 = Pack.littleEndianToInt(bArr, i11 + 8);
        this.f99523k3 = Pack.littleEndianToInt(bArr, i11 + 12);
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        ...
        int i12 = this.f99516h1;
        int i13 = this.f99515h0;
        int i14 = i12 + (i13 >>> 26);
        int i15 = this.f99517h2 + (i14 >>> 26);
        int i16 = this.f99518h3 + (i15 >>> 26);
        int i17 = i15 & 67108863;
        int i18 = this.f99519h4 + (i16 >>> 26);
        ...
        this.f99519h4 = i38;
        long j11 = (((long) (i34 | (i35 << 26))) & 4294967295L) + (((long) this.f99520k0) & 4294967295L);
        long j12 = (((long) ((i35 >>> 6) | (i36 << 20))) & 4294967295L) + (((long) this.f99521k1) & 4294967295L);
        long j13 = (((long) ((i36 >>> 12) | (i37 << 14))) & 4294967295L) + (((long) this.f99522k2) & 4294967295L);
        long j14 = (((long) ((i37 >>> 18) | (i38 << 8))) & 4294967295L) + (4294967295L & ((long) this.f99523k3));
