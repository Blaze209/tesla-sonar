...
public class BaseBlockCipher extends BaseWrapCipher implements PBE {
        ...
        if (this.engineParams == null) {
            if (this.pbeSpec != null) {
                ...
                try {
                    ...
                    algorithmParametersCreateParametersInstance3.init(this.ivParam.getIV());
                } catch (Exception e12) {
    ...
    /* JADX WARN: Code duplicated, block: B:152:0x0301 A[PHI: r5
      0x0301: PHI (r5v3 org.spongycastle.crypto.CipherParameters) = 
      (r5v1 org.spongycastle.crypto.CipherParameters)
      (r5v1 org.spongycastle.crypto.CipherParameters)
      (r5v2 org.spongycastle.crypto.CipherParameters)
      (r5v2 org.spongycastle.crypto.CipherParameters)
      (r5v4 org.spongycastle.crypto.CipherParameters)
      (r5v4 org.spongycastle.crypto.CipherParameters)
     binds: [B:179:0x03bc, B:181:0x03c0, B:156:0x031b, B:158:0x031f, B:147:0x02ed, B:149:0x02f1] A[DONT_GENERATE, DONT_INLINE]] */
    /* JADX WARN: Code duplicated, block: B:242:0x04c2 A[Catch: Exception -> 0x04b9, TryCatch #2 {Exception -> 0x04b9, blocks: (B:237:0x049d, B:238:0x04b8, B:241:0x04bb, B:243:0x04c7, B:245:0x04cd, B:247:0x04d1, B:242:0x04c2), top: B:257:0x0494 }] */
    ...
    protected void engineInit(int i11, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyException, InvalidAlgorithmParameterException {
        ...
        if (this.ivLength != 0 && !(parametersWithIV instanceof ParametersWithIV) && !(parametersWithIV instanceof AEADParameters)) {
