...
public class DRBG {
    ...
    public static SecureRandom createBaseRandom(boolean z11) {
        if (System.getProperty("org.spongycastle.drbg.entropysource") == null) {
            ...
            return new SP800SecureRandomBuilder(secureRandomCreateInitialEntropySource, true).setPersonalizationString(generateDefaultPersonalizationString(secureRandomCreateInitialEntropySource.generateSeed(16))).buildHash(new SHA512Digest(), secureRandomCreateInitialEntropySource.generateSeed(32), z11);
        }
        ...
        return new SP800SecureRandomBuilder(entropySourceProviderCreateEntropySource).setPersonalizationString(generateDefaultPersonalizationString(entropySource.getEntropy())).buildHash(new SHA512Digest(), Arrays.concatenate(entropySource.getEntropy(), entropySource.getEntropy()), z11);
    }
    ...
    private static final Object[] findSource() {
        ...
        while (true) {
            ...
            try {
                return new Object[]{Class.forName(strArr2[c11]).newInstance(), Class.forName(strArr2[1]).newInstance()};
