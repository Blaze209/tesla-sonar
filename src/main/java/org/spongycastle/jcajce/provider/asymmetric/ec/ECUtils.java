...
class ECUtils {
    ...
    static X9ECParameters getDomainParametersFromName(String str) {
        try {
            if (str.charAt(0) < '0' || str.charAt(0) > '2') {
                return str.indexOf(32) > 0 ? ECUtil.getNamedCurveByName(str.substring(str.indexOf(32) + 1)) : ECUtil.getNamedCurveByName(str);
            }
    ...
    static X962Parameters getDomainParametersFromName(ECParameterSpec eCParameterSpec, boolean z11) {
        if (!(eCParameterSpec instanceof ECNamedCurveSpec)) {
            ...
            return new X962Parameters(new X9ECParameters(eCCurveConvertCurve, EC5Util.convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator(), z11), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed()));
        }
