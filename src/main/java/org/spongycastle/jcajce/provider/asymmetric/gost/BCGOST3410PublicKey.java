...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    private BigInteger f99631y;

    BCGOST3410PublicKey(GOST3410PublicKeySpec gOST3410PublicKeySpec) {
        this.f99631y = gOST3410PublicKeySpec.getY();
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCGOST3410PublicKey) {
            ...
            if (this.f99631y.equals(bCGOST3410PublicKey.f99631y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f99631y.hashCode() ^ this.gost3410Spec.hashCode();
    }
    ...
    BCGOST3410PublicKey(GOST3410PublicKey gOST3410PublicKey) {
        this.f99631y = gOST3410PublicKey.getY();
    ...
    BCGOST3410PublicKey(GOST3410PublicKeyParameters gOST3410PublicKeyParameters, GOST3410ParameterSpec gOST3410ParameterSpec) {
        this.f99631y = gOST3410PublicKeyParameters.getY();
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f99631y = new BigInteger(1, bArr);
