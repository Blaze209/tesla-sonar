...
public class CertificateFactory extends CertificateFactorySpi {
    ...
    public CRL engineGenerateCRL(InputStream inputStream) throws CRLException {
        ...
        try {
            ...
            inputStream.reset();
            return i11 != 48 ? readPEMCRL(inputStream) : readDERCRL(new ASN1InputStream(inputStream, true));
    ...
    public Certificate engineGenerateCertificate(InputStream inputStream) throws ExCertificateException {
        ...
        try {
            ...
            inputStream.reset();
            return i11 != 48 ? readPEMCertificate(inputStream) : readDERCertificate(new ASN1InputStream(inputStream));
        } catch (Exception e11) {
