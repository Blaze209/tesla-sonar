...
public class EC5Util {
    ...
    public static ECCurve convertCurve(EllipticCurve ellipticCurve) {
        ...
        return new ECCurve.F2m(m11, iArrConvertMidTerms[0], iArrConvertMidTerms[1], iArrConvertMidTerms[2], a11, b11);
    }
    ...
    public static org.spongycastle.jce.spec.ECParameterSpec convertSpec(ECParameterSpec eCParameterSpec, boolean z11) {
        ...
        return new org.spongycastle.jce.spec.ECParameterSpec(eCCurveConvertCurve, convertPoint(eCCurveConvertCurve, eCParameterSpec.getGenerator(), z11), eCParameterSpec.getOrder(), BigInteger.valueOf(eCParameterSpec.getCofactor()), eCParameterSpec.getCurve().getSeed());
    }
