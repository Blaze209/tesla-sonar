...
public class BCDSAPublicKey implements DSAPublicKey {
    ...
    private BigInteger f99623y;

    BCDSAPublicKey(DSAPublicKeySpec dSAPublicKeySpec) {
        this.f99623y = dSAPublicKeySpec.getY();
        this.dsaSpec = new DSAParameterSpec(dSAPublicKeySpec.getP(), dSAPublicKeySpec.getQ(), dSAPublicKeySpec.getG());
        this.lwKeyParams = new DSAPublicKeyParameters(this.f99623y, DSAUtil.toDSAParameters(this.dsaSpec));
    }
    ...
    BCDSAPublicKey(DSAPublicKey dSAPublicKey) {
        this.f99623y = dSAPublicKey.getY();
        this.dsaSpec = dSAPublicKey.getParams();
        this.lwKeyParams = new DSAPublicKeyParameters(this.f99623y, DSAUtil.toDSAParameters(this.dsaSpec));
    }

    BCDSAPublicKey(DSAPublicKeyParameters dSAPublicKeyParameters) {
        this.f99623y = dSAPublicKeyParameters.getY();
    ...
    public BCDSAPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        try {
            this.f99623y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
