...
class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f99633c.equals(((X509CRLEntryObject) obj).f99633c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f99633c.getEncoded("DER");
    ...
    public Date getRevocationDate() {
        return this.f99633c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f99633c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f99633c.getExtensions() != null;
    }
    ...
    protected X509CRLEntryObject(TBSCertList.CRLEntry cRLEntry, boolean z11, X500Name x500Name) {
        this.f99633c = cRLEntry;
