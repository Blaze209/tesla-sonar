...
public abstract class BaseAgreementSpi extends KeyAgreementSpi {
    ...
    static {
        ...
        map3.put(aSN1ObjectIdentifier11.getId(), "HmacSHA1");
        map3.put(PKCSObjectIdentifiers.id_hmacWithSHA224.getId(), "HmacSHA224");
        map3.put(aSN1ObjectIdentifier12.getId(), "HmacSHA256");
        map3.put(aSN1ObjectIdentifier13.getId(), "HmacSHA384");
        map3.put(aSN1ObjectIdentifier14.getId(), "HmacSHA512");
        ...
        map3.put(aSN1ObjectIdentifier15.getId(), "Camellia");
        ...
        map3.put(aSN1ObjectIdentifier16.getId(), "SEED");
    ...
    @Override // javax.crypto.KeyAgreementSpi
    protected int engineGenerateSecret(byte[] bArr, int i11) throws ShortBufferException {
        ...
        if (derivationFunction != null) {
            if (keySize >= 0) {
                ...
                if (derivationFunction instanceof DHKEKGenerator) {
                    try {
                        this.kdf.init(new DHKDFParameters(new ASN1ObjectIdentifier(id2), keySize, bArrCalcSecret, this.ukmParameters));
            ...
            System.arraycopy(bArrCalcSecret, 0, bArr2, 0, i12);
