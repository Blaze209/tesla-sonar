...
public class IESCipher extends CipherSpi {
    ...
    public byte[] engineDoFinal(byte[] bArr, int i11, int i12) throws BadBlockException {
        if (i12 != 0) {
    ...
    public int engineGetOutputSize(int i11) {
        ...
        if (this.engine.getCipher() != null) {
            ...
            if (i12 == 1 || i12 == 3) {
                ...
                i11 = this.engine.getCipher().getOutputSize((i11 - macSize) - iBitLength);
            }
        }
        int i13 = this.state;
        if (i13 == 1 || i13 == 3) {
    ...
    @Override // javax.crypto.CipherSpi
    public int engineDoFinal(byte[] bArr, int i11, int i12, byte[] bArr2, int i13) throws BadBlockException {
