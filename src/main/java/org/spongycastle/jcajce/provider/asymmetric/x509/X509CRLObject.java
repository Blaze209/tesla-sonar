...
class X509CRLObject extends X509CRL {
    ...
    private CertificateList f99634c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, InvalidKeyException, CRLException {
        if (!this.f99634c.getSignatureAlgorithm().equals(this.f99634c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f99634c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    static boolean isIndirectCRL(X509CRL x509crl) throws ExtCRLException {
        try {
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f99634c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f99634c.equals(x509CRLObject.f99634c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f99634c.getEncoded("DER");
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f99634c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f99634c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f99634c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f99634c.getNextUpdate() != null) {
            return this.f99634c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f99634c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f99634c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f99634c.getTBSCertList().getEncoded("DER");
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f99634c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f99634c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f99634c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f99634c.getIssuer();
