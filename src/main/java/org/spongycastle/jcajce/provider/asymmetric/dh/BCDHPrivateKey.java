...
public class BCDHPrivateKey implements DHPrivateKey, PKCS12BagAttributeCarrier {
    ...
    BCDHPrivateKey(DHPrivateKey dHPrivateKey) {
        this.f99617x = dHPrivateKey.getX();
        this.dhSpec = dHPrivateKey.getParams();
    }

    BCDHPrivateKey(DHPrivateKeySpec dHPrivateKeySpec) {
        this.f99617x = dHPrivateKeySpec.getX();
    ...
    public BCDHPrivateKey(PrivateKeyInfo privateKeyInfo) {
        ...
        this.f99617x = aSN1Integer.getValue();
    ...
    BCDHPrivateKey(DHPrivateKeyParameters dHPrivateKeyParameters) {
        this.f99617x = dHPrivateKeyParameters.getX();
