...
public class Keccak {
    ...
    public static class Digest288 extends DigestKeccak {
        public Digest288() {
            super(EnumC4419g.SDK_ASSET_ILLUSTRATION_CHECK_ALL_VALUE);
        }
    }
    ...
    public static class HashMac288 extends BaseMac {
        public HashMac288() {
            super(new HMac(new KeccakDigest(EnumC4419g.SDK_ASSET_ILLUSTRATION_CHECK_ALL_VALUE)));
        }
    }
    ...
    public static class KeyGenerator288 extends BaseKeyGenerator {
        public KeyGenerator288() {
            super("HMACKECCAK288", EnumC4419g.SDK_ASSET_ILLUSTRATION_CHECK_ALL_VALUE, new CipherKeyGenerator());
        }
    }
