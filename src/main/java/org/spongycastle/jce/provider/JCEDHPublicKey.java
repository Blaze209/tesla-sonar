...
public class JCEDHPublicKey implements DHPublicKey {
    ...
    private BigInteger f99645y;

    JCEDHPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f99645y = dHPublicKeySpec.getY();
    ...
    private void readObject(ObjectInputStream objectInputStream) {
        this.f99645y = (BigInteger) objectInputStream.readObject();
    ...
    public byte[] getEncoded() {
        ...
        return subjectPublicKeyInfo != null ? KeyUtil.getEncodedSubjectPublicKeyInfo(subjectPublicKeyInfo) : KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(PKCSObjectIdentifiers.dhKeyAgreement, new DHParameter(this.dhSpec.getP(), this.dhSpec.getG(), this.dhSpec.getL())), new ASN1Integer(this.f99645y));
    }
    ...
    JCEDHPublicKey(DHPublicKey dHPublicKey) {
        this.f99645y = dHPublicKey.getY();
        this.dhSpec = dHPublicKey.getParams();
    }

    JCEDHPublicKey(DHPublicKeyParameters dHPublicKeyParameters) {
        this.f99645y = dHPublicKeyParameters.getY();
    ...
    JCEDHPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f99645y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
