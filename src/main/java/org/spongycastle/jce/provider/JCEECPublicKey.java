...
public class JCEECPublicKey implements ECPublicKey, org.spongycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    private ECPoint f99647q;
    private boolean withCompression;

    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f99647q = jCEECPublicKey.f99647q;
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (subjectPublicKeyInfo.getAlgorithmId().getAlgorithm().equals(CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f99647q = curve2.createPoint(new BigInteger(1, bArr), new BigInteger(1, bArr2), false);
        ...
        if (bytes[0] == 4 && bytes[1] == bytes.length - 2 && (((b11 = bytes[2]) == 2 || b11 == 3) && new X9IntegerConverter().getByteLength(curve) >= bytes.length - 3)) {
            try {
        ...
        this.f99647q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f99647q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f99647q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f99647q.getDetachedPoint() : this.f99647q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return new java.security.spec.ECPoint(this.f99647q.getAffineXCoord().toBigInteger(), this.f99647q.getAffineYCoord().toBigInteger());
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f99647q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f99647q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f99647q = EC5Util.convertPoint(params, eCPublicKeySpec.getW(), false);
    }

    public JCEECPublicKey(String str, org.spongycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        this.algorithm = str;
        this.f99647q = eCPublicKeySpec.getQ();
        ...
        if (this.f99647q.getCurve() == null) {
            this.f99647q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f99647q.getAffineXCoord().toBigInteger(), this.f99647q.getAffineYCoord().toBigInteger(), false);
        }
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters, ECParameterSpec eCParameterSpec) {
        ...
        this.algorithm = str;
        this.f99647q = eCPublicKeyParameters.getQ();
        if (eCParameterSpec == null) {
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f99647q = EC5Util.convertPoint(params, eCPublicKey.getW(), false);
    }
