...
public class JCEElGamalPublicKey implements ElGamalPublicKey, DHPublicKey {
    ...
    public byte[] getEncoded() {
        return KeyUtil.getEncodedSubjectPublicKeyInfo(new AlgorithmIdentifier(OIWObjectIdentifiers.elGamalAlgorithm, new ElGamalParameter(this.elSpec.getP(), this.elSpec.getG())), new ASN1Integer(this.f99649y));
    }
    ...
    JCEElGamalPublicKey(DHPublicKeySpec dHPublicKeySpec) {
        this.f99649y = dHPublicKeySpec.getY();
    ...
    JCEElGamalPublicKey(ElGamalPublicKey elGamalPublicKey) {
        this.f99649y = elGamalPublicKey.getY();
        this.elSpec = elGamalPublicKey.getParameters();
    }

    JCEElGamalPublicKey(DHPublicKey dHPublicKey) {
        this.f99649y = dHPublicKey.getY();
    ...
    JCEElGamalPublicKey(ElGamalPublicKeyParameters elGamalPublicKeyParameters) {
        this.f99649y = elGamalPublicKeyParameters.getY();
    ...
    JCEElGamalPublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            this.f99649y = ((ASN1Integer) subjectPublicKeyInfo.parsePublicKey()).getValue();
