...
class OldPKCS12ParametersGenerator extends PBEParametersGenerator {
    ...
    private byte[] generateDerivedKey(int i11, int i12) {
        ...
        int i23 = this.f99653v;
        byte[] bArr10 = new byte[i23];
        int i24 = this.f99652u;
        int i25 = ((i12 + i24) - 1) / i24;
        int i26 = 1;
        while (i26 <= i25) {
            int i27 = this.f99652u;
            ...
            if (i26 == i25) {
                ...
                i13 = 0;
                System.arraycopy(bArr11, 0, bArr4, (i26 - 1) * this.f99652u, i27);
            }
            i26++;
            i15 = i13;
            i17 = 1;
