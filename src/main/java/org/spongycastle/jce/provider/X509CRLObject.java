...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f99655c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, InvalidKeyException, CRLException {
        if (!this.f99655c.getSignatureAlgorithm().equals(this.f99655c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f99655c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f99655c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f99655c.equals(x509CRLObject.f99655c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f99655c.getEncoded("DER");
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f99655c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f99655c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f99655c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f99655c.getNextUpdate() != null) {
            return this.f99655c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f99655c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f99655c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f99655c.getTBSCertList().getEncoded("DER");
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f99655c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f99655c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f99655c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f99655c.getIssuer();
