...
public final class Strings {
    ...
    public static String fromUTF8ByteArray(byte[] bArr) {
        ...
        while (i11 < bArr.length) {
            byte b12 = bArr[i11];
            if ((b12 & 240) == 240) {
                int i16 = (((((b12 & 3) << 18) | ((bArr[i11 + 1] & 63) << 12)) | ((bArr[i11 + 2] & 63) << 6)) | (bArr[i11 + 3] & 63)) - 65536;
                char c12 = (char) ((i16 >> 10) | 55296);
                c11 = (char) ((i16 & 1023) | 56320);
                cArr[i15] = c12;
                i11 += 4;
                i15++;
            } else if ((b12 & 224) == 224) {
                c11 = (char) (((b12 & 15) << 12) | ((bArr[i11 + 1] & 63) << 6) | (bArr[i11 + 2] & 63));
                i11 += 3;
            } else if ((b12 & 208) == 208 || (b12 & 192) == 192) {
                int i17 = (b12 & 31) << 6;
                byte b13 = bArr[i11 + 1];
                c11 = (char) (i17 | (b13 & 63));
                i11 += 2;
            ...
            if (c11 < 128) {
                ...
                if (i11 < cArr.length) {
                    ...
                    if (c11 <= 56319) {
                        ...
                        outputStream.write((i12 >> 18) | EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE);
