...
public class ASN1Dump {
    ...
    static void _dumpAsString(String str, boolean z11, ASN1Primitive aSN1Primitive, StringBuffer stringBuffer) {
        ...
        if (aSN1Primitive instanceof ASN1Sequence) {
            ...
            while (objects.hasMoreElements()) {
                ...
                if (objNextElement == null || objNextElement.equals(DERNull.INSTANCE)) {
                    ...
                    _dumpAsString(str2, z11, (ASN1Primitive) objNextElement, stringBuffer);
                } else {
                    _dumpAsString(str2, z11, ((ASN1Encodable) objNextElement).toASN1Primitive(), stringBuffer);
                }
            }
            return;
        }
        ...
        if (aSN1Primitive instanceof ASN1Set) {
            ...
            while (objects2.hasMoreElements()) {
                ...
                if (objNextElement2 == null) {
                    ...
                    _dumpAsString(str4, z11, (ASN1Primitive) objNextElement2, stringBuffer);
                } else {
                    _dumpAsString(str4, z11, ((ASN1Encodable) objNextElement2).toASN1Primitive(), stringBuffer);
                }
            }
            return;
        }
        ...
        if (aSN1Primitive instanceof BERApplicationSpecific) {
            stringBuffer.append(outputApplicationSpecific("BER", str, z11, aSN1Primitive, strLineSeparator));
            return;
        }
        if (aSN1Primitive instanceof DERApplicationSpecific) {
            stringBuffer.append(outputApplicationSpecific("DER", str, z11, aSN1Primitive, strLineSeparator));
            return;
        }
        ...
        if (dERExternal.getDataValueDescriptor() != null) {
            _dumpAsString(string, z11, dERExternal.getDataValueDescriptor(), stringBuffer);
        }
        stringBuffer.append(string + "Encoding: " + dERExternal.getEncoding() + strLineSeparator);
        _dumpAsString(string, z11, dERExternal.getExternalContent(), stringBuffer);
    }
