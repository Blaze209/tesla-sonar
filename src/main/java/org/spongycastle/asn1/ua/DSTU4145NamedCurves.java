...
public class DSTU4145NamedCurves {
    ...
    static {
        ...
        while (true) {
            ...
            aSN1ObjectIdentifierArr[i12] = new ASN1ObjectIdentifier(oidBase + i12);
            i12++;
        }
    }
