    ...
    private AuthEnvelopedData(ASN1Sequence aSN1Sequence) {
        ...
        if (aSN1Integer.getValue().intValue() == 0) {
            ...
            if (aSN1Set2.size() != 0) {
                ...
                int i12 = i11 + 2;
                ASN1Primitive aSN1Primitive2 = aSN1Sequence.getObjectAt(i11 + 1).toASN1Primitive();
                ...
                if (aSN1Sequence.size() > i12) {
                    this.unauthAttrs = ASN1Set.getInstance((ASN1TaggedObject) aSN1Sequence.getObjectAt(i12).toASN1Primitive(), false);
                    return;
                }
                return;
            }
