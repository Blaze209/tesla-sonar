...
public class X9FieldID extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private ASN1ObjectIdentifier f99409id;
    private ASN1Primitive parameters;

    public X9FieldID(BigInteger bigInteger) {
        this.f99409id = X9ObjectIdentifiers.prime_field;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f99409id);
    ...
    public X9FieldID(int i11, int i12, int i13, int i14) {
        this.f99409id = X9ObjectIdentifiers.characteristic_two_field;
        ASN1EncodableVector aSN1EncodableVector = new ASN1EncodableVector();
    ...
    private X9FieldID(ASN1Sequence aSN1Sequence) {
        this.f99409id = ASN1ObjectIdentifier.getInstance(aSN1Sequence.getObjectAt(0));
