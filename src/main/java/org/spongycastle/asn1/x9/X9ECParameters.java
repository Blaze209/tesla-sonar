...
public class X9ECParameters extends ASN1Object implements X9ObjectIdentifiers {
    ...
    private X9ECPoint f99403g;

    /* JADX INFO: renamed from: h, reason: collision with root package name */
    private BigInteger f99404h;

    /* JADX INFO: renamed from: n, reason: collision with root package name */
    private BigInteger f99405n;
    private byte[] seed;
    ...
    private X9ECParameters(ASN1Sequence aSN1Sequence) {
        ...
        if (objectAt instanceof X9ECPoint) {
            this.f99403g = (X9ECPoint) objectAt;
        } else {
            this.f99403g = new X9ECPoint(this.curve, (ASN1OctetString) objectAt);
        }
        this.f99405n = ((ASN1Integer) aSN1Sequence.getObjectAt(4)).getValue();
        this.seed = x9Curve.getSeed();
        if (aSN1Sequence.size() == 6) {
            this.f99404h = ((ASN1Integer) aSN1Sequence.getObjectAt(5)).getValue();
        }
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f99403g);
        aSN1EncodableVector.add(new ASN1Integer(this.f99405n));
        BigInteger bigInteger = this.f99404h;
        if (bigInteger != null) {
    ...
    public X9ECParameters(ECCurve eCCurve, X9ECPoint x9ECPoint, BigInteger bigInteger, BigInteger bigInteger2, byte[] bArr) {
        this.curve = eCCurve;
        this.f99403g = x9ECPoint;
        this.f99405n = bigInteger;
        this.f99404h = bigInteger2;
        this.seed = bArr;
