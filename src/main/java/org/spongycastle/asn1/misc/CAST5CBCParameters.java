...
public class CAST5CBCParameters extends ASN1Object {
    ...
    ASN1OctetString f99362iv;
    ASN1Integer keyLength;

    public CAST5CBCParameters(byte[] bArr, int i11) {
        this.f99362iv = new DEROctetString(Arrays.clone(bArr));
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f99362iv.getOctets());
    }
