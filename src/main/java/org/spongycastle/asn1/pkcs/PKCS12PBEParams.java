...
public class PKCS12PBEParams extends ASN1Object {
    ...
    ASN1OctetString f99369iv;

    public PKCS12PBEParams(byte[] bArr, int i11) {
        this.f99369iv = new DEROctetString(bArr);
    ...
    public byte[] getIV() {
        return this.f99369iv.getOctets();
    }
