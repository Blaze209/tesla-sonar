...
public class RC2CBCParameter extends ASN1Object {
    ...
    ASN1OctetString f99370iv;
    ASN1Integer version;

    public RC2CBCParameter(byte[] bArr) {
        this.version = null;
        this.f99370iv = new DEROctetString(bArr);
    }
    ...
    public byte[] getIV() {
        return this.f99370iv.getOctets();
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(this.f99370iv);
    ...
    private RC2CBCParameter(ASN1Sequence aSN1Sequence) {
        if (aSN1Sequence.size() == 1) {
            this.version = null;
            this.f99370iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
        } else {
            this.version = (ASN1Integer) aSN1Sequence.getObjectAt(0);
            this.f99370iv = (ASN1OctetString) aSN1Sequence.getObjectAt(1);
        }
    }
}
