...
public class RainbowPrivateKey extends ASN1Object {
    ...
    private RainbowPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f99747b1 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(2)).getObjectAt(0)).getOctets();
        ...
        this.f99748b2 = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(4)).getObjectAt(0)).getOctets();
        this.f99749vi = ((ASN1OctetString) ((ASN1Sequence) aSN1Sequence.getObjectAt(5)).getObjectAt(0)).getOctets();
        ...
        int length = this.f99749vi.length - 1;
        this.layers = new Layer[length];
        int i21 = 0;
        while (i21 < length) {
            byte[] bArr5 = this.f99749vi;
            int i22 = i21 + 1;
    ...
    public short[] getB1() {
        return RainbowUtil.convertArray(this.f99747b1);
    }

    public short[] getB2() {
        return RainbowUtil.convertArray(this.f99748b2);
    }
    ...
    public int[] getVi() {
        return RainbowUtil.convertArraytoInt(this.f99749vi);
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector3.add(new DEROctetString(this.f99747b1));
        ...
        aSN1EncodableVector5.add(new DEROctetString(this.f99748b2));
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector5));
        ASN1EncodableVector aSN1EncodableVector6 = new ASN1EncodableVector();
        aSN1EncodableVector6.add(new DEROctetString(this.f99749vi));
        ...
        for (int i13 = 0; i13 < this.layers.length; i13++) {
            ...
            for (byte[][] bArr3 : bArrConvertArray) {
                ...
                while (true) {
                    if (i14 < bArr3.length) {
                        aSN1EncodableVector10.add(new DEROctetString(bArr3[i14]));
                        i14++;
                    }
                }
            ...
            for (byte[][] bArr4 : bArrConvertArray2) {
                ...
                while (true) {
                    if (i15 < bArr4.length) {
                        aSN1EncodableVector12.add(new DEROctetString(bArr4[i15]));
                        i15++;
                    }
                }
    ...
    public RainbowPrivateKey(short[][] sArr, short[] sArr2, short[][] sArr3, short[] sArr4, int[] iArr, Layer[] layerArr) {
        ...
        this.f99747b1 = RainbowUtil.convertArray(sArr2);
        this.invA2 = RainbowUtil.convertArray(sArr3);
        this.f99748b2 = RainbowUtil.convertArray(sArr4);
        this.f99749vi = RainbowUtil.convertIntArray(iArr);
