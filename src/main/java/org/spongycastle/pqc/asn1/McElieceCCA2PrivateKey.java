...
public class McElieceCCA2PrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f99734n));
        aSN1EncodableVector.add(new ASN1Integer(this.f99733k));
    ...
    private McElieceCCA2PrivateKey(ASN1Sequence aSN1Sequence) {
        this.f99734n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).getValue().intValue();
        this.f99733k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).getValue().intValue();
