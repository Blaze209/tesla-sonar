...
public class SparseTernaryPolynomial implements TernaryPolynomial {
    ...
    public static SparseTernaryPolynomial fromBinary(InputStream inputStream, int i11, int i12, int i13) {
        ...
        return new SparseTernaryPolynomial(i11, ArrayEncoder.decodeModQ(Util.readFullLength(inputStream, ((i12 * iNumberOfLeadingZeros) + 7) / 8), i12, 2048), ArrayEncoder.decodeModQ(Util.readFullLength(inputStream, ((iNumberOfLeadingZeros * i13) + 7) / 8), i13, 2048));
    }
