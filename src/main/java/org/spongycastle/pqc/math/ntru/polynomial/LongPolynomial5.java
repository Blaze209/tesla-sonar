...
public class LongPolynomial5 {
    ...
    public LongPolynomial5(IntegerPolynomial integerPolynomial) {
        ...
        for (int i13 = 0; i13 < this.numCoeffs; i13++) {
            ...
            jArr[i11] = jArr[i11] | (((long) integerPolynomial.coeffs[i13]) << i12);
            i12 += 12;
            if (i12 >= 60) {
                i11++;
                i12 = 0;
    ...
    public LongPolynomial5 mult(TernaryPolynomial ternaryPolynomial) {
        ...
        for (int i12 = 0; i12 != ones.length; i12++) {
            ...
            while (true) {
                ...
                if (i16 < jArr2.length) {
                    long[] jArr3 = jArr[i15];
                    jArr3[i14] = (jArr3[i14] + jArr2[i16]) & 576319980446939135L;
                    i14++;
                    i16++;
                }
            }
        ...
        for (int i17 = 0; i17 != negOnes.length; i17++) {
            ...
            while (true) {
                ...
                if (i22 < jArr4.length) {
                    long[] jArr5 = jArr[i21];
                    jArr5[i19] = ((jArr5[i19] + 576601524159907840L) - jArr4[i22]) & 576319980446939135L;
                    i19++;
                    i22++;
                }
            }
        ...
        for (int i23 = 1; i23 <= 4; i23++) {
            ...
            while (i26 < length) {
                ...
                jArrCopyOf[i26] = (jArrCopyOf[i26] + ((j13 & j12) << i24)) & 576319980446939135L;
                i26++;
                jArrCopyOf[i26] = (jArrCopyOf[i26] + (j13 >> i25)) & 576319980446939135L;
            }
        }
        ...
        for (int length2 = this.coeffs.length - 1; length2 < jArrCopyOf.length; length2++) {
            ...
            if (length2 == jArr7.length - 1) {
                j11 = this.numCoeffs == 5 ? 0L : jArrCopyOf[length2] >> i27;
                i11 = 0;
            } else {
                j11 = jArrCopyOf[length2];
                i11 = (length2 * 5) - this.numCoeffs;
            }
            int i28 = i11 / 5;
            int i29 = i11 - (i28 * 5);
            long j14 = j11 << (i29 * 12);
            long j15 = j11 >> ((5 - i29) * 12);
            jArrCopyOf[i28] = (jArrCopyOf[i28] + j14) & 576319980446939135L;
            int i31 = i28 + 1;
            if (i31 < jArr7.length) {
                jArrCopyOf[i31] = (jArrCopyOf[i31] + j15) & 576319980446939135L;
            }
        }
