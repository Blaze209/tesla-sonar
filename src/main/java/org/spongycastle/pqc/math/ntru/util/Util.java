...
public class Util {
    ...
    public static TernaryPolynomial generateRandomTernary(int i11, int i12, int i13, boolean z11, SecureRandom secureRandom) {
        return z11 ? SparseTernaryPolynomial.generateRandom(i11, i12, i13, secureRandom) : DenseTernaryPolynomial.generateRandom(i11, i12, i13, secureRandom);
    }
    ...
    public static int invert(int i11, int i12) {
        ...
        return IntEuclidean.calculate(i13, i12).f99867x;
    }
    ...
    public static byte[] readFullLength(InputStream inputStream, int i11) throws IOException {
