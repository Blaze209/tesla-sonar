...
public class GMSSRootSig {
    ...
    public GMSSRootSig(Digest digest, byte[][] bArr, int[] iArr) {
        ...
        int i11 = this.f99756w;
        this.f99754k = (1 << i11) - 1;
    ...
    private void oneStep() {
        ...
        if (8 % i11 == 0) {
            ...
            if (i12 == 0) {
                ...
                int i13 = this.f99753ii;
                if (i13 < this.mdsize) {
                    byte[] bArr = this.hash;
                    byte b11 = bArr[i13];
                    this.test = this.f99754k & b11;
                    bArr[i13] = (byte) (b11 >>> this.f99756w);
                } else {
                    int i14 = this.checksum;
                    this.test = this.f99754k & i14;
                    this.checksum = i14 >>> this.f99756w;
                }
            } else if (i12 > 0) {
        ...
        if (i11 < 8) {
            ...
            if (i18 == 0) {
                ...
                if (i19 % 8 == 0) {
                    int i21 = this.f99753ii;
                    int i22 = this.mdsize;
                    if (i21 < i22) {
                        this.big8 = 0L;
                        if (i19 < ((i22 / i11) << 3)) {
                            for (int i23 = 0; i23 < this.f99756w; i23++) {
                                long j11 = this.big8;
                                byte[] bArr6 = this.hash;
                                int i24 = this.f99753ii;
                                this.big8 = j11 ^ ((long) ((bArr6[i24] & 255) << (i23 << 3)));
                                this.f99753ii = i24 + 1;
                            }
                        } else {
                            for (int i25 = 0; i25 < this.mdsize % this.f99756w; i25++) {
                                long j12 = this.big8;
                                byte[] bArr7 = this.hash;
                                int i26 = this.f99753ii;
                ...
                this.test = (int) (this.big8 & ((long) this.f99754k));
                this.privateKeyOTS = this.gmssRandom.nextSeed(this.seed);
            } else if (i18 > 0) {
            ...
            if (j13 == 0) {
                ...
                if (i32 < i33) {
                    if (i29 <= (i33 << 3) - i11) {
                        ...
                        this.f99755r = i29 + i11;
                    }
                    while (i32 < i33) {
                        long j14 = this.big8;
                        int i35 = this.hash[i32] & 255;
                        int i36 = this.f99753ii;
                        this.big8 = j14 ^ ((long) (i35 << (i36 << 3)));
                        this.f99753ii = i36 + 1;
                        i32++;
                    }
                    long j15 = this.big8 >>> i31;
                    this.big8 = j15;
                    this.test8 = j15 & ((long) this.f99754k);
                } else {
                    int i37 = this.checksum;
                    this.test8 = this.f99754k & i37;
    ...
    public int[] getStatInt() {
        return new int[]{this.counter, this.test, this.f99753ii, this.f99755r, this.steps, this.keysize, this.height, this.f99756w, this.checksum};
    }
    ...
    public void initSign(byte[] bArr, byte[] bArr2) {
        ...
        int log = getLog((this.messagesize << this.f99756w) + 1);
        int i14 = this.f99756w;
        int i15 = 8;
        if (8 % i14 == 0) {
            int i16 = 8 / i14;
            i11 = 0;
            for (int i17 = 0; i17 < this.mdsize; i17++) {
                for (int i18 = 0; i18 < i16; i18++) {
                    byte b11 = bArr4[i17];
                    i11 += this.f99754k & b11;
                    bArr4[i17] = (byte) (b11 >>> this.f99756w);
                }
            }
            int i19 = (this.messagesize << this.f99756w) - i11;
            this.checksum = i19;
            int i21 = 0;
            while (i21 < log) {
                i11 += this.f99754k & i19;
                int i22 = this.f99756w;
                i19 >>>= i22;
                i21 += i22;
            }
        } else if (i14 < 8) {
            ...
            for (int i26 = 0; i26 < i23; i26++) {
                long j11 = 0;
                for (int i27 = 0; i27 < this.f99756w; i27++) {
                    j11 ^= (long) ((bArr4[i24] & 255) << (i27 << 3));
                    i24++;
                }
                int i28 = 0;
                while (i28 < i15) {
                    i25 += (int) (((long) this.f99754k) & j11);
                    j11 >>>= this.f99756w;
                    i28++;
                    i15 = i15;
                    i23 = i23;
            ...
            int i29 = this.mdsize % this.f99756w;
            long j12 = 0;
            ...
            int i33 = 0;
            while (i33 < i32) {
                i25 += (int) (((long) this.f99754k) & j12);
                int i34 = this.f99756w;
                j12 >>>= i34;
                i33 += i34;
            }
            int i35 = (this.messagesize << this.f99756w) - i25;
            this.checksum = i35;
            int i36 = 0;
            i11 = i25;
            while (i36 < log) {
                i11 += this.f99754k & i35;
                int i37 = this.f99756w;
                i35 >>>= i37;
                i36 += i37;
            }
        } else if (i14 < 57) {
            ...
            while (true) {
                ...
                i39 = (int) (((long) i39) + ((j13 >>> i42) & ((long) this.f99754k)));
            }
            int i46 = i38 >>> 3;
            if (i46 < i12) {
                int i47 = i38 % 8;
                ...
                i39 = (int) (((long) i39) + ((j14 >>> i47) & ((long) this.f99754k)));
            }
            int i49 = (this.messagesize << this.f99756w) - i39;
            this.checksum = i49;
            int i51 = 0;
            i11 = i39;
            while (i51 < log) {
                i11 += this.f99754k & i49;
                int i52 = this.f99756w;
                i49 >>>= i52;
                i51 += i52;
            }
        } else {
        ...
        int iCeil = this.messagesize + ((int) Math.ceil(((double) log) / ((double) this.f99756w)));
        this.keysize = iCeil;
