...
public class SPHINCS256Signer implements MessageSigner {
    ...
    static void compute_authpath_wots(HashFunctions hashFunctions, byte[] bArr, byte[] bArr2, int i11, Tree.leafaddr leafaddrVar, byte[] bArr3, byte[] bArr4, int i12) {
        ...
        while (true) {
            ...
            long j15 = j11;
            byte[] bArr8 = bArr7;
            wots.wots_pkgen(hashFunctions, bArr8, (int) (j14 * 2144), bArr6, (int) (j14 * j15), bArr4, 0);
            bArr7 = bArr8;
            leafaddrVar2.subleaf++;
            j11 = j15;
        }
        ...
        while (true) {
            ...
            long j17 = leafaddrVar2.subleaf;
            if (j17 >= j16) {
                break;
            }
            Tree.l_tree(hashFunctions, bArr5, (int) ((j17 * j16) + 1024), bArr7, (int) (j17 * 2144), bArr4, 0);
