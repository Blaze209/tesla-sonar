...
class HashFunctions {
    ...
    int hash_2n_n_mask(byte[] bArr, int i11, byte[] bArr2, int i12, byte[] bArr3, int i13) {
    ...
    int hash_n_n(byte[] bArr, int i11, byte[] bArr2, int i12) {
        byte[] bArr3 = new byte[64];
        for (int i13 = 0; i13 < 32; i13++) {
            bArr3[i13] = bArr2[i12 + i13];
            bArr3[i13 + 32] = hashc[i13];
    ...
    int hash_n_n_mask(byte[] bArr, int i11, byte[] bArr2, int i12, byte[] bArr3, int i13) {
    ...
    int varlen_hash(byte[] bArr, int i11, byte[] bArr2, int i12) {
