...
public class McEliecePointchevalCipher implements MessageEncryptor {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (!z11) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f99788sr = new SecureRandom();
            ...
            this.f99788sr = parametersWithRandom.getRandom();
    ...
    public void initCipherDecrypt(McElieceCCA2PrivateKeyParameters mcElieceCCA2PrivateKeyParameters) {
        ...
        this.f99787n = mcElieceCCA2PrivateKeyParameters.getN();
        this.f99786k = mcElieceCCA2PrivateKeyParameters.getK();
        this.f99789t = mcElieceCCA2PrivateKeyParameters.getT();
    }

    public void initCipherEncrypt(McElieceCCA2PublicKeyParameters mcElieceCCA2PublicKeyParameters) {
        SecureRandom secureRandom = this.f99788sr;
        if (secureRandom == null) {
            secureRandom = new SecureRandom();
        }
        this.f99788sr = secureRandom;
        this.messDigest = Utils.getDigest(mcElieceCCA2PublicKeyParameters.getDigest());
        this.f99787n = mcElieceCCA2PublicKeyParameters.getN();
        this.f99786k = mcElieceCCA2PublicKeyParameters.getK();
        this.f99789t = mcElieceCCA2PublicKeyParameters.getT();
    }
    ...
    public byte[] messageDecrypt(byte[] bArr) throws InvalidCipherTextException {
        ...
        int i11 = (this.f99787n + 7) >> 3;
        int length = bArr.length - i11;
        byte[][] bArrSplit = ByteUtils.split(bArr, i11);
        byte[] bArr2 = bArrSplit[0];
        byte[] bArr3 = bArrSplit[1];
        GF2Vector[] gF2VectorArrDecryptionPrimitive = McElieceCCA2Primitives.decryptionPrimitive((McElieceCCA2PrivateKeyParameters) this.key, GF2Vector.OS2VP(this.f99787n, bArr2));
        ...
        if (Conversions.encode(this.f99787n, this.f99789t, bArr5).equals(gF2Vector)) {
            return ByteUtils.split(bArr4, length - (this.f99786k >> 3))[0];
        }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        int i11 = this.f99786k >> 3;
        byte[] bArr2 = new byte[i11];
        this.f99788sr.nextBytes(bArr2);
        GF2Vector gF2Vector = new GF2Vector(this.f99786k, this.f99788sr);
        ...
        byte[] encoded2 = McElieceCCA2Primitives.encryptionPrimitive((McElieceCCA2PublicKeyParameters) this.key, gF2Vector, Conversions.encode(this.f99787n, this.f99789t, bArr3)).getEncoded();
        DigestRandomGenerator digestRandomGenerator = new DigestRandomGenerator(new SHA1Digest());
        digestRandomGenerator.addSeedMaterial(encoded);
