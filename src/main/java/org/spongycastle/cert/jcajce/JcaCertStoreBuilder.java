...
public class JcaCertStoreBuilder {
    ...
    public CertStore build() {
        ...
        return obj instanceof Provider ? CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders, (Provider) obj) : CertStore.getInstance(this.type, collectionCertStoreParametersConvertHolders);
    }
