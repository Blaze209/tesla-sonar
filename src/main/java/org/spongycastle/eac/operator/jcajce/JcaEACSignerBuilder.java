...
public class JcaEACSignerBuilder {
    ...
    public static byte[] reencode(byte[] bArr) {
        ...
        copyUnsignedInt(byteArray2, bArr2, i11 - iUnsignedIntLength2);
        return bArr2;
    }
    ...
    private class SignatureOutputStream extends OutputStream {
        ...
        public void write(byte[] bArr, int i11, int i12) throws OperatorStreamException {
            try {
        ...
        @Override // java.io.OutputStream
        public void write(int i11) throws OperatorStreamException {
            try {
