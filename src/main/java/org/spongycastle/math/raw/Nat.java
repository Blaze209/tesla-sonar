...
public abstract class Nat {
    ...
    public static int[] fromBigInteger(int i11, BigInteger bigInteger) {
        ...
        int[] iArrCreate = create((i11 + 31) >> 5);
        int i12 = 0;
    ...
    public static int mulAddTo(int i11, int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        while (i12 < i11) {
            ...
            int[] iArr5 = iArr3;
            int i14 = i12 + i13;
            long jMulWordAddTo = (((long) mulWordAddTo(i13, iArr[i12], iArr4, 0, iArr5, i12)) & M) + j11 + (M & ((long) iArr5[i14]));
    ...
    public static int mulAddTo(int i11, int[] iArr, int i12, int[] iArr2, int i13, int[] iArr3, int i14) {
        ...
        for (int i16 = 0; i16 < i11; i16++) {
            int i17 = i15 + i11;
            long jMulWordAddTo = (((long) mulWordAddTo(i11, iArr[i12 + i16], iArr2, i13, iArr3, i15)) & M) + j11 + (M & ((long) iArr3[i17]));
            iArr3[i17] = (int) jMulWordAddTo;
            j11 = jMulWordAddTo >>> 32;
            i15++;
        }
        return (int) j11;
