...
public class SecP224K1FieldElement extends ECFieldElement {
    ...
    protected int[] f99710x;
    public static final BigInteger Q = SecP224K1Curve.f99709q;
    ...
    public SecP224K1FieldElement(BigInteger bigInteger) {
        ...
        this.f99710x = SecP224K1Field.fromBigInteger(bigInteger);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement add(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.add(this.f99710x, ((SecP224K1FieldElement) eCFieldElement).f99710x, iArrCreate);
    ...
    public ECFieldElement addOne() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.addOne(this.f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement divide(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        Mod.invert(SecP224K1Field.P, ((SecP224K1FieldElement) eCFieldElement).f99710x, iArrCreate);
        SecP224K1Field.multiply(iArrCreate, this.f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof SecP224K1FieldElement) {
            return Nat224.eq(this.f99710x, ((SecP224K1FieldElement) obj).f99710x);
        }
        return false;
    }
    ...
    public int hashCode() {
        return Q.hashCode() ^ Arrays.hashCode(this.f99710x, 0, 7);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement invert() {
        int[] iArrCreate = Nat224.create();
        Mod.invert(SecP224K1Field.P, this.f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean isOne() {
        return Nat224.isOne(this.f99710x);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean isZero() {
        return Nat224.isZero(this.f99710x);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement multiply(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.multiply(this.f99710x, ((SecP224K1FieldElement) eCFieldElement).f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement negate() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.negate(this.f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public ECFieldElement sqrt() {
        int[] iArr = this.f99710x;
    ...
    public ECFieldElement square() {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.square(this.f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }
    ...
    public ECFieldElement subtract(ECFieldElement eCFieldElement) {
        int[] iArrCreate = Nat224.create();
        SecP224K1Field.subtract(this.f99710x, ((SecP224K1FieldElement) eCFieldElement).f99710x, iArrCreate);
        return new SecP224K1FieldElement(iArrCreate);
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public boolean testBitZero() {
        return Nat224.getBit(this.f99710x, 0) == 1;
    }

    @Override // org.spongycastle.math.ec.ECFieldElement
    public BigInteger toBigInteger() {
        return Nat224.toBigInteger(this.f99710x);
    }

    public SecP224K1FieldElement() {
        this.f99710x = Nat224.create();
    }
