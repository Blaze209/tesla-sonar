...
public class SecT283R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT283R1Curve() {
        ...
        this.f99676a = fromBigInteger(BigInteger.valueOf(1L));
        this.f99677b = fromBigInteger(new BigInteger(1, Hex.decode("027B680AC8B8596DA5A4AF8A19A0303FCA97FD7645309FA2A581485AF6263E313B79A2F5")));
