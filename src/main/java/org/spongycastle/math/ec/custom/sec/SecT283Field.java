...
public class SecT283Field {
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        long j26 = jArr5[3];
        long j27 = j26 ^ j22;
        implMulw(j16 ^ j24, j18 ^ j26, jArr6, 18);
        implMulw(j21 ^ jArr4[1], j23 ^ jArr5[1], jArr6, 20);
        long j28 = j12 ^ j25;
        long j29 = j14 ^ j27;
        long j31 = j28 ^ jArr4[2];
        long j32 = jArr5[2] ^ j29;
        implMulw(j28, j29, jArr6, 22);
        implMulw(j31, j32, jArr6, 24);
        implMulw(j12, j14, jArr6, 10);
        implMulw(j16, j18, jArr6, 12);
        implMulw(j21, j23, jArr6, 14);
        implMulw(j25, j27, jArr6, 16);
        jArr3[0] = jArr6[0];
        jArr3[9] = jArr6[9];
        long j33 = jArr6[0];
        ...
        long j56 = jArr6[25];
        long j57 = jArr6[23];
        long j58 = j55 ^ (j56 ^ j47);
        jArr3[4] = (j58 ^ (j45 ^ j57)) ^ j54;
        long j59 = jArr6[21];
        jArr3[5] = ((j38 ^ j52) ^ j58) ^ (j59 ^ j46);
        jArr3[6] = (((((j43 ^ j33) ^ j49) ^ j44) ^ j59) ^ j57) ^ j56;
    ...
    protected static void implMulw(long j11, long j12, long[] jArr, int i11) {
        ...
        long j17 = jArr2[((int) j11) & 7];
        long j18 = 0;
        int i12 = 48;
        do {
            int i13 = (int) (j11 >>> i12);
            long j19 = (jArr2[i13 & 7] ^ (jArr2[(i13 >>> 3) & 7] << 3)) ^ (jArr2[(i13 >>> 6) & 7] << 6);
            j17 ^= j19 << i12;
            j18 ^= j19 >>> (-i12);
            i12 -= 9;
        } while (i12 > 0);
        jArr[i11] = M57 & j17;
        jArr[i11 + 1] = (((((j11 & 72198606942111744L) & ((j12 << 7) >> 63)) >>> 8) ^ j18) << 7) ^ (j17 >>> 57);
    }
