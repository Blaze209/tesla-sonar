...
public class SecT193Field {
    ...
    protected static void implMulwAcc(long j11, long j12, long[] jArr, int i11) {
        ...
        do {
            int i14 = (int) (j11 >>> i13);
            long j19 = (((jArr2[i14 & 7] ^ (jArr2[(i14 >>> 3) & 7] << 3)) ^ (jArr2[(i14 >>> 6) & 7] << 6)) ^ (jArr2[(i14 >>> 9) & 7] << 9)) ^ (jArr2[(i14 >>> 12) & 7] << 12);
            j17 ^= j19 << i13;
            j18 ^= j19 >>> (-i13);
            i13 -= 15;
        } while (i13 > 0);
        jArr[i11] = jArr[i11] ^ (M49 & j17);
        int i15 = i11 + 1;
        jArr[i15] = jArr[i15] ^ ((j17 >>> 49) ^ (j18 << 15));
    }
    ...
    public static void reduce63(long[] jArr, int i11) {
        ...
        long j11 = jArr[i12];
        long j12 = j11 >>> 1;
        jArr[i11] = (j12 ^ (j12 << 15)) ^ jArr[i11];
        int i13 = i11 + 1;
        jArr[i13] = jArr[i13] ^ (j11 >>> 50);
        jArr[i12] = j11 & 1;
    }
    ...
    public static void sqrt(long[] jArr, long[] jArr2) {
        ...
        long j13 = (jUnshuffle3 & 4294967295L) ^ (jArr[3] << 32);
        long j14 = jUnshuffle3 >>> 32;
        jArr2[0] = j11 ^ (j12 << 8);
        jArr2[1] = ((j13 ^ (j14 << 8)) ^ (j12 >>> 56)) ^ (j12 << 33);
        jArr2[2] = (j12 >>> 31) ^ (j14 << 33);
