...
public class SecP224K1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f99709q = new BigInteger(1, Hex.decode("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFE56D"));
    ...
    public SecP224K1Curve() {
        ...
        this.f99677b = fromBigInteger(BigInteger.valueOf(5L));
