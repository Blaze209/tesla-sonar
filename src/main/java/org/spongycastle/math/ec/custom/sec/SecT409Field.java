...
public class SecT409Field {
    ...
    protected static void implMulwAcc(long[] jArr, long j11, long[] jArr2, int i11) {
        ...
        long j14 = j11 << 2;
        long j15 = j13 << 1;
        long[] jArr3 = {0, j11, j12, j13, j14, j14 ^ j11, j15, j15 ^ j11};
        for (int i12 = 0; i12 < 7; i12++) {
            long j16 = jArr[i12];
            int i13 = (int) j16;
            long j17 = jArr3[i13 & 7] ^ (jArr3[(i13 >>> 3) & 7] << 3);
            long j18 = 0;
            int i14 = 54;
            do {
                int i15 = (int) (j16 >>> i14);
                long j19 = jArr3[i15 & 7] ^ (jArr3[(i15 >>> 3) & 7] << 3);
                j17 ^= j19 << i14;
                j18 ^= j19 >>> (-i14);
                i14 -= 6;
            } while (i14 > 0);
            int i16 = i11 + i12;
            jArr2[i16] = jArr2[i16] ^ (M59 & j17);
            int i17 = i16 + 1;
            jArr2[i17] = jArr2[i17] ^ ((j17 >>> 59) ^ (j18 << 5));
        }
    }
