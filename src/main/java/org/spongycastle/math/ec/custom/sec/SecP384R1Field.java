...
public class SecP384R1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        iArr[0] = (int) j11;
        long j12 = (j11 >> 32) + ((((long) iArr[1]) & M) - 1);
        iArr[1] = (int) j12;
        long j13 = j12 >> 32;
        if (j13 != 0) {
            long j14 = j13 + (((long) iArr[2]) & M);
            iArr[2] = (int) j14;
            j13 = j14 >> 32;
        }
        long j15 = j13 + (((long) iArr[3]) & M) + 1;
        iArr[3] = (int) j15;
        long j16 = (j15 >> 32) + (M & ((long) iArr[4])) + 1;
        iArr[4] = (int) j16;
        if ((j16 >> 32) != 0) {
            Nat.incAt(12, iArr, 5);
        }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        long j11 = ((long) iArr[16]) & M;
        long j12 = ((long) iArr[17]) & M;
        long j13 = ((long) iArr[18]) & M;
        long j14 = ((long) iArr[19]) & M;
        long j15 = ((long) iArr[20]) & M;
        long j16 = ((long) iArr[21]) & M;
        long j17 = ((long) iArr[22]) & M;
        long j18 = ((long) iArr[23]) & M;
        long j19 = ((((long) iArr[12]) & M) + j15) - 1;
        long j21 = (((long) iArr[13]) & M) + j17;
        long j22 = (((long) iArr[14]) & M) + j17 + j18;
        long j23 = (((long) iArr[15]) & M) + j18;
        long j24 = j12 + j16;
        long j25 = j16 - j18;
        long j26 = j17 - j18;
        long j27 = j19 + j25;
        long j28 = (((long) iArr[0]) & M) + j27;
        iArr2[0] = (int) j28;
        long j29 = (j28 >> 32) + (((((long) iArr[1]) & M) + j18) - j19) + j21;
        iArr2[1] = (int) j29;
        long j31 = (j29 >> 32) + (((((long) iArr[2]) & M) - j16) - j21) + j22;
        iArr2[2] = (int) j31;
        long j32 = (j31 >> 32) + ((((long) iArr[3]) & M) - j22) + j23 + j27;
        iArr2[3] = (int) j32;
        long j33 = (j32 >> 32) + (((((((long) iArr[4]) & M) + j11) + j16) + j21) - j23) + j27;
        iArr2[4] = (int) j33;
        long j34 = (j33 >> 32) + ((((long) iArr[5]) & M) - j11) + j21 + j22 + j24;
        iArr2[5] = (int) j34;
        long j35 = (j34 >> 32) + (((((long) iArr[6]) & M) + j13) - j12) + j22 + j23;
        iArr2[6] = (int) j35;
        long j36 = (j35 >> 32) + ((((((long) iArr[7]) & M) + j11) + j14) - j13) + j23;
        iArr2[7] = (int) j36;
        long j37 = (j36 >> 32) + (((((((long) iArr[8]) & M) + j11) + j12) + j15) - j14);
        iArr2[8] = (int) j37;
        long j38 = (j37 >> 32) + (((((long) iArr[9]) & M) + j13) - j15) + j24;
        iArr2[9] = (int) j38;
        long j39 = (j38 >> 32) + ((((((long) iArr[10]) & M) + j13) + j14) - j25) + j26;
        iArr2[10] = (int) j39;
        long j41 = (j39 >> 32) + ((((((long) iArr[11]) & M) + j14) + j15) - j26);
        iArr2[11] = (int) j41;
    ...
    public static void reduce32(int i11, int[] iArr) {
        ...
        if (i11 != 0) {
            ...
            iArr[0] = (int) j13;
            long j14 = (j13 >> 32) + ((((long) iArr[1]) & M) - j12);
            iArr[1] = (int) j14;
            long j15 = j14 >> 32;
            if (j15 != 0) {
                long j16 = j15 + (((long) iArr[2]) & M);
                iArr[2] = (int) j16;
                j15 = j16 >> 32;
            }
            long j17 = j15 + (((long) iArr[3]) & M) + j12;
            iArr[3] = (int) j17;
            long j18 = (j17 >> 32) + (M & ((long) iArr[4])) + j12;
            iArr[4] = (int) j18;
            j11 = j18 >> 32;
        } else {
            j11 = 0;
