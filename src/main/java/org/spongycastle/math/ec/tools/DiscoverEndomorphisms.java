...
public class DiscoverEndomorphisms {
    ...
    private static boolean isShorter(BigInteger[] bigIntegerArr, BigInteger[] bigIntegerArr2) {
        ...
        if (z11 == (bigIntegerAbs2.compareTo(bigIntegerAbs4) < 0)) {
            return z11;
        }
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters) {
        ...
        BigInteger[] bigIntegerArrSolveQuadraticEquation = solveQuadraticEquation(n11, bigInteger, bigInteger);
    ...
    private static void printGLVTypeBParameters(X9ECParameters x9ECParameters, BigInteger bigInteger, ECFieldElement[] eCFieldElementArr) {
        ...
        if (eCPointNormalize.getYCoord().equals(eCPointNormalize2.getYCoord())) {
            ...
            BigInteger n11 = x9ECParameters.getN();
            BigInteger[] bigIntegerArrExtEuclidGLV = extEuclidGLV(n11, bigInteger);
            ...
            if (!isVectorBoundedBySqrt(bigIntegerArrChooseShortest, n11) && areRelativelyPrime(bigIntegerArr[0], bigIntegerArr[1])) {
                BigInteger bigInteger2 = bigIntegerArr[0];
                BigInteger bigInteger3 = bigIntegerArr[1];
                BigInteger bigIntegerDivide = bigInteger2.add(bigInteger3.multiply(bigInteger)).divide(n11);
                ...
                if (bigIntegerArrExtEuclidBezout != null) {
                    ...
                    if (bigIntegerSubtract.equals(bigInteger4)) {
                        BigInteger bigIntegerSubtract2 = bigIntegerNegate2.multiply(n11).subtract(bigIntegerNegate.multiply(bigInteger));
                        BigInteger bigIntegerNegate3 = bigIntegerNegate.negate();
                        BigInteger bigIntegerNegate4 = bigIntegerSubtract2.negate();
                        BigInteger bigIntegerAdd = isqrt(n11.subtract(bigInteger4)).add(bigInteger4);
            ...
            int iBitLength = (n11.bitLength() + 16) - (n11.bitLength() & 7);
            ...
            printProperty(DateTokenConverter.CONVERTER_KEY, bigIntegerSubtract3.toString(16));
