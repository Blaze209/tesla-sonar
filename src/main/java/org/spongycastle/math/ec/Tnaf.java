...
class Tnaf {
    ...
    public static BigInteger[] getLucas(byte b11, int i11, boolean z11) {
        ...
        while (i12 < i11) {
            ...
            bigIntegerSubtract = (b11 == 1 ? bigIntegerSubtract : bigIntegerSubtract.negate()).subtract(bigInteger.shiftLeft(1));
    ...
    public static BigInteger norm(byte b11, ZTauElement zTauElement) {
        BigInteger bigInteger = zTauElement.f99694u;
        BigInteger bigIntegerMultiply = bigInteger.multiply(bigInteger);
        BigInteger bigIntegerMultiply2 = zTauElement.f99694u.multiply(zTauElement.f99695v);
        BigInteger bigInteger2 = zTauElement.f99695v;
    ...
    public static ZTauElement partModReduction(BigInteger bigInteger, int i11, byte b11, BigInteger[] bigIntegerArr, byte b12, byte b13) {
        BigInteger bigIntegerAdd = b12 == 1 ? bigIntegerArr[0].add(bigIntegerArr[1]) : bigIntegerArr[0].subtract(bigIntegerArr[1]);
        BigInteger bigInteger2 = getLucas(b12, i11, true)[1];
        ZTauElement zTauElementRound = round(approximateDivisionByN(bigInteger, bigIntegerArr[0], bigInteger2, b11, i11, b13), approximateDivisionByN(bigInteger, bigIntegerArr[1], bigInteger2, b11, i11, b13), b12);
        return new ZTauElement(bigInteger.subtract(bigIntegerAdd.multiply(zTauElementRound.f99694u)).subtract(BigInteger.valueOf(2L).multiply(bigIntegerArr[1]).multiply(zTauElementRound.f99695v)), bigIntegerArr[1].multiply(zTauElementRound.f99694u).subtract(bigIntegerArr[0].multiply(zTauElementRound.f99695v)));
    }
    ...
    */
    ...
    public static byte[] tauAdicNaf(byte b11, ZTauElement zTauElement) {
        ...
        BigInteger bigIntegerClearBit = zTauElement.f99694u;
        BigInteger bigInteger = zTauElement.f99695v;
        int i11 = 0;
        int i12 = 0;
        while (true) {
            BigInteger bigInteger2 = ECConstants.ZERO;
    ...
    public static byte[] tauAdicWNaf(byte b11, ZTauElement zTauElement, byte b12, BigInteger bigInteger, BigInteger bigInteger2, ZTauElement[] zTauElementArr) {
        ...
        int iBitLength = norm(b11, zTauElement).bitLength();
        byte[] bArr = new byte[iBitLength > 30 ? iBitLength + 4 + b12 : b12 + 34];
        BigInteger bigIntegerShiftRight = bigInteger.shiftRight(1);
        BigInteger bigIntegerAdd = zTauElement.f99694u;
        BigInteger bigIntegerAdd2 = zTauElement.f99695v;
        int i11 = 0;
        while (true) {
            ...
            if (bigIntegerAdd.testBit(0)) {
                ...
                if (z11) {
                    bigIntegerAdd = bigIntegerAdd.subtract(zTauElementArr[bIntValue].f99694u);
                    bigIntegerAdd2 = bigIntegerAdd2.subtract(zTauElementArr[bIntValue].f99695v);
                } else {
                    bigIntegerAdd = bigIntegerAdd.add(zTauElementArr[bIntValue].f99694u);
                    bigIntegerAdd2 = bigIntegerAdd2.add(zTauElementArr[bIntValue].f99695v);
                }
            } else {
                bArr[i11] = 0;
            }
            BigInteger bigIntegerAdd3 = b11 == 1 ? bigIntegerAdd2.add(bigIntegerAdd.shiftRight(1)) : bigIntegerAdd2.subtract(bigIntegerAdd.shiftRight(1));
