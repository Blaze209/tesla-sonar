...
public class MessageDigestUtils {
    ...
    static {
        ...
        digestAlgIdMap.put("SHA-1", new AlgorithmIdentifier(aSN1ObjectIdentifier, DERNull.INSTANCE));
        digestAlgIdMap.put("SHA-224", new AlgorithmIdentifier(aSN1ObjectIdentifier2));
