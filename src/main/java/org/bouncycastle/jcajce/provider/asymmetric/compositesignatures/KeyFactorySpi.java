...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    ...
    /* JADX INFO: renamed from: org.bouncycastle.jcajce.provider.asymmetric.compositesignatures.KeyFactorySpi$1, reason: invalid class name */
    ...
    public PrivateKey generatePrivate(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        try {
            ...
            for (int i11 = 0; i11 < aSN1Sequence.size(); i11++) {
                privateKeyArr[i11] = keyFactoriesFromIdentifier.get(i11).generatePrivate(new PKCS8EncodedKeySpec(PrivateKeyInfo.getInstance(aSN1Sequence.getObjectAt(i11)).getEncoded()));
            }
        ...
        try {
            ...
            for (int i11 = 0; i11 < aSN1Sequence.size(); i11++) {
                if (aSN1Sequence.getObjectAt(i11) instanceof DEROctetString) {
                    aSN1BitStringArr[i11] = new DERBitString(((DEROctetString) aSN1Sequence.getObjectAt(i11)).getOctets());
                } else {
                    aSN1BitStringArr[i11] = (DERBitString) aSN1Sequence.getObjectAt(i11);
                }
            }
            ...
            for (int i12 = 0; i12 < aSN1Sequence.size(); i12++) {
                publicKeyArr[i12] = keyFactoriesFromIdentifier.get(i12).generatePublic(keysSpecs[i12]);
            }
