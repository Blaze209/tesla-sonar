...
public class BCGOST3410PublicKey implements GOST3410PublicKey {
    ...
    public boolean equals(Object obj) {
        if (obj instanceof BCGOST3410PublicKey) {
            ...
            if (this.f98856y.equals(bCGOST3410PublicKey.f98856y) && this.gost3410Spec.equals(bCGOST3410PublicKey.gost3410Spec)) {
                return true;
            }
        }
        return false;
    ...
    public int hashCode() {
        return this.f98856y.hashCode() ^ this.gost3410Spec.hashCode();
    }

    public String toString() {
        try {
            return GOSTUtil.publicKeyToString("GOST3410", this.f98856y, ((GOST3410PublicKeyParameters) GOST3410Util.generatePublicKeyParameter(this)).getParameters());
    ...
    BCGOST3410PublicKey(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        try {
            ...
            this.f98856y = new BigInteger(1, bArr);
