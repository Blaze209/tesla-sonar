...
abstract class X509CRLImpl extends X509CRL {
    ...
    protected CertificateList f98859c;
    protected boolean isIndirect;
    protected String sigAlgName;
    protected byte[] sigAlgParams;

    X509CRLImpl(JcaJceHelper jcaJceHelper, CertificateList certificateList, String str, byte[] bArr, boolean z11) {
        this.bcHelper = jcaJceHelper;
        this.f98859c = certificateList;
        this.sigAlgName = str;
    ...
    private void checkSignature(PublicKey publicKey, Signature signature, ASN1Encodable aSN1Encodable, byte[] bArr) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        if (!X509SignatureUtil.areEquivalentAlgorithms(this.f98859c.getSignatureAlgorithm(), this.f98859c.getTBSCertList().getSignature())) {
        ...
        try {
            ...
            this.f98859c.getTBSCertList().encodeTo(bufferedOutputStream, "DER");
    ...
    private void doVerify(PublicKey publicKey, SignatureCreator signatureCreator) throws NoSuchAlgorithmException, SignatureException, InvalidKeyException, CRLException {
        if (!this.f98859c.getSignatureAlgorithm().equals(this.f98859c.getTBSCertList().getSignature())) {
            throw new CRLException("Signature algorithm on CertificateList does not match TBSCertList.");
        }
        int i11 = 0;
        if ((publicKey instanceof CompositePublicKey) && X509SignatureUtil.isCompositeAlgorithm(this.f98859c.getSignatureAlgorithm())) {
            List<PublicKey> publicKeys = ((CompositePublicKey) publicKey).getPublicKeys();
            ASN1Sequence aSN1Sequence = ASN1Sequence.getInstance(this.f98859c.getSignatureAlgorithm().getParameters());
            ASN1Sequence aSN1Sequence2 = ASN1Sequence.getInstance(this.f98859c.getSignature().getOctets());
            boolean z11 = false;
        ...
        if (!X509SignatureUtil.isCompositeAlgorithm(this.f98859c.getSignatureAlgorithm())) {
        ...
        ASN1Sequence aSN1Sequence3 = ASN1Sequence.getInstance(this.f98859c.getSignatureAlgorithm().getParameters());
        ASN1Sequence aSN1Sequence4 = ASN1Sequence.getInstance(this.f98859c.getSignature().getOctets());
        boolean z12 = false;
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f98859c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f98859c.getRevokedCertificateEnumeration();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f98859c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f98859c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        Time nextUpdate = this.f98859c.getNextUpdate();
        if (nextUpdate == null) {
            return null;
        }
    ...
    public String getSigAlgOID() {
        return this.f98859c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f98859c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f98859c.getTBSCertList().getEncoded("DER");
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f98859c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f98859c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f98859c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f98859c.getIssuer();
    ...
    public byte[] getExtensionValue(String str) {
        ASN1OctetString extensionValue = getExtensionValue(this.f98859c, str);
        if (extensionValue == null) {
            return null;
        }
        try {
