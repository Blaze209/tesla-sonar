...
public abstract class AlgorithmParametersSpi extends java.security.AlgorithmParametersSpi {
    ...
    public static class PSS extends AlgorithmParametersSpi {
        ...
        protected byte[] engineGetEncoded() {
            ...
            return new RSASSAPSSparams(algorithmIdentifier, new AlgorithmIdentifier(aSN1ObjectIdentifier), new ASN1Integer(pSSParameterSpec.getSaltLength()), new ASN1Integer(pSSParameterSpec.getTrailerField())).getEncoded("DER");
        }
