...
public class BCECGOST3410PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f98850d;
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && (ASN1Sequence.getInstance(aSN1Primitive).size() == 2 || ASN1Sequence.getInstance(aSN1Primitive).size() == 3)) {
            ...
            if (privateKey2 instanceof ASN1Integer) {
                this.f98850d = ASN1Integer.getInstance(privateKey2).getPositiveValue();
                return;
            }
            ...
            this.f98850d = new BigInteger(1, bArr);
            return;
        }
        ...
        org.bouncycastle.asn1.sec.ECPrivateKey eCPrivateKey2 = org.bouncycastle.asn1.sec.ECPrivateKey.getInstance(privateKey);
        this.f98850d = eCPrivateKey2.getKey();
        this.publicKey = eCPrivateKey2.getPublicKey();
    }
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f98850d, engineGetSpec());
    }
    ...
    public BCECGOST3410PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f98850d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98850d = eCPrivateKey.getS();
    ...
    public BCECGOST3410PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98850d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410PrivateKey(BCECGOST3410PrivateKey bCECGOST3410PrivateKey) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98850d = bCECGOST3410PrivateKey.f98850d;
    ...
    public BCECGOST3410PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98850d = eCPrivateKeySpec.getD();
