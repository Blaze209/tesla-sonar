...
public class BCECGOST3410_2012PrivateKey implements ECPrivateKey, org.bouncycastle.jce.interfaces.ECPrivateKey, PKCS12BagAttributeCarrier, ECPointEncoder {
    ...
    private transient BigInteger f98851d;
    ...
    private void populateFromPrivKeyInfo(PrivateKeyInfo privateKeyInfo) {
        ...
        if ((aSN1Primitive instanceof ASN1Sequence) && ASN1Sequence.getInstance(aSN1Primitive).size() <= 3) {
            ...
            if (privateKey.getOctets().length == 32 || privateKey.getOctets().length == 64) {
                this.f98851d = new BigInteger(1, Arrays.reverse(privateKey.getOctets()));
                return;
            }
            ASN1Encodable privateKey2 = privateKeyInfo.parsePrivateKey();
            if (privateKey2 instanceof ASN1Integer) {
                this.f98851d = ASN1Integer.getInstance(privateKey2).getPositiveValue();
                return;
            } else {
                this.f98851d = new BigInteger(1, Arrays.reverse(ASN1OctetString.getInstance(privateKey2).getOctets()));
                return;
            }
        }
    ...
    public byte[] getEncoded() {
        ...
        boolean z11 = this.f98851d.bitLength() > 256;
        ASN1ObjectIdentifier aSN1ObjectIdentifier = z11 ? RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512 : RosstandartObjectIdentifiers.id_tc26_gost_3410_12_256;
        int i11 = z11 ? 64 : 32;
    ...
    public String toString() {
        return ECUtil.privateKeyToString(this.algorithm, this.f98851d, engineGetSpec());
    }
    ...
    public BCECGOST3410_2012PrivateKey(String str, ECPrivateKeyParameters eCPrivateKeyParameters) {
        ...
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.algorithm = str;
        this.f98851d = eCPrivateKeyParameters.getD();
        this.ecSpec = null;
    }
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKey eCPrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98851d = eCPrivateKey.getS();
    ...
    public BCECGOST3410_2012PrivateKey(ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98851d = eCPrivateKeySpec.getS();
    ...
    public BCECGOST3410_2012PrivateKey(BCECGOST3410_2012PrivateKey bCECGOST3410_2012PrivateKey) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98851d = bCECGOST3410_2012PrivateKey.f98851d;
    ...
    public BCECGOST3410_2012PrivateKey(org.bouncycastle.jce.spec.ECPrivateKeySpec eCPrivateKeySpec) {
        this.algorithm = "ECGOST3410-2012";
        this.attrCarrier = new PKCS12BagAttributeCarrierImpl();
        this.f98851d = eCPrivateKeySpec.getD();
