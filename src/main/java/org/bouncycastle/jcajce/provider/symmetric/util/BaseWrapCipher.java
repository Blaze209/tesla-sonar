...
public abstract class BaseWrapCipher extends CipherSpi implements PBE {
    ...
    protected int engineDoFinal(byte[] bArr, int i11, int i12, byte[] bArr2, int i13) throws IOException {
        byte[] bArrWrap;
    ...
    protected byte[] engineGetIV() {
        return Arrays.clone(this.f98868iv);
    }
    ...
    protected AlgorithmParameters engineGetParameters() {
        if (this.engineParams == null && this.f98868iv != null) {
            ...
            try {
                ...
                algorithmParametersCreateParametersInstance.init(new IvParameterSpec(this.f98868iv));
            } catch (Exception e11) {
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int i11, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyOrParametersException, InvalidAlgorithmParameterException {
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int i11, Key key, SecureRandom secureRandom) throws InvalidKeyOrParametersException {
        try {
    ...
    @Override // javax.crypto.CipherSpi
    protected void engineInit(int i11, Key key, AlgorithmParameterSpec algorithmParameterSpec, SecureRandom secureRandom) throws InvalidKeyOrParametersException, InvalidAlgorithmParameterException {
        ...
        if ((keyParameter instanceof KeyParameter) && (i12 = this.ivSize) != 0 && (i11 == 3 || i11 == 1)) {
            ...
            keyParameter = new ParametersWithIV(keyParameter, this.f98868iv);
        }
