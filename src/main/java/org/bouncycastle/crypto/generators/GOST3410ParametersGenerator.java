    ...
    private int procedure_A(int i11, int i12, BigInteger[] bigIntegerArr, int i13) {
        ...
        while (i22 < i18) {
            ...
            while (true) {
                ...
                BigInteger bigInteger7 = new BigInteger(WebrtcBuildVersion.maint_version);
                int i26 = i16;
                while (i26 < i23) {
                ...
                while (true) {
                    ...
                    long j11 = i28;
                    BigInteger bigIntegerMultiply = bigIntegerArr4[i27].multiply(bigInteger10.add(BigInteger.valueOf(j11)));
                    ...
                    if (bigIntegerAdd2.compareTo(bigInteger12.pow(iArr[i21])) != 1) {
                        if (bigInteger12.modPow(bigIntegerArr4[i27].multiply(bigInteger10.add(BigInteger.valueOf(j11))), bigIntegerArr4[i21]).compareTo(bigInteger11) == 0 && bigInteger12.modPow(bigInteger10.add(BigInteger.valueOf(j11)), bigIntegerArr4[i21]).compareTo(bigInteger11) != 0) {
                            break;
                        }
                        i28 = i29 + 2;
        ...
        while (i18 < i16) {
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    long j13 = i26;
                    BigInteger bigIntegerMultiply = bigIntegerArr4[i25].multiply(bigInteger9.add(BigInteger.valueOf(j13)));
                    ...
                    if (bigIntegerAdd2.compareTo(bigInteger11.pow(iArr[i17])) != 1) {
                        if (bigInteger11.modPow(bigIntegerArr4[i25].multiply(bigInteger9.add(BigInteger.valueOf(j13))), bigIntegerArr4[i17]).compareTo(bigInteger10) == 0 && bigInteger11.modPow(bigInteger9.add(BigInteger.valueOf(j13)), bigIntegerArr4[i17]).compareTo(bigInteger10) != 0) {
                            break;
                        }
                        i26 += 2;
