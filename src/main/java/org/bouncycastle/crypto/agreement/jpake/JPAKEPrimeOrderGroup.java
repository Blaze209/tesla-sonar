...
public class JPAKEPrimeOrderGroup {
    ...
    private final BigInteger f98575g;

    /* JADX INFO: renamed from: p, reason: collision with root package name */
    private final BigInteger f98576p;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private final BigInteger f98577q;
    ...
    JPAKEPrimeOrderGroup(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, boolean z11) {
        ...
        this.f98576p = bigInteger;
        this.f98577q = bigInteger2;
        this.f98575g = bigInteger3;
    }
}
