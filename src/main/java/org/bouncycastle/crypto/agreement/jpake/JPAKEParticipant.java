...
public class JPAKEParticipant {
    ...
    private BigInteger f98569b;
    private final Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    private final BigInteger f98570g;
    ...
    private final BigInteger f98571p;
    private final String participantId;
    private String partnerParticipantId;
    private char[] password;

    /* JADX INFO: renamed from: q, reason: collision with root package name */
    private final BigInteger f98572q;
    private final SecureRandom random;
    private int state;

    /* JADX INFO: renamed from: x1, reason: collision with root package name */
    private BigInteger f98573x1;

    /* JADX INFO: renamed from: x2, reason: collision with root package name */
    private BigInteger f98574x2;
    ...
    private BigInteger calculateS() {
        try {
            return JPAKEUtil.calculateS(this.f98572q, this.password);
    ...
    public BigInteger calculateKeyingMaterial() {
        ...
        this.password = null;
        BigInteger bigIntegerCalculateKeyingMaterial = JPAKEUtil.calculateKeyingMaterial(this.f98571p, this.f98572q, this.gx4, this.f98574x2, bigIntegerCalculateS, this.f98569b);
        this.f98573x1 = null;
        this.f98574x2 = null;
        this.f98569b = null;
        this.state = 50;
    ...
    public JPAKERound1Payload createRound1PayloadToSend() {
        ...
        this.f98573x1 = JPAKEUtil.generateX1(this.f98572q, this.random);
        this.f98574x2 = JPAKEUtil.generateX2(this.f98572q, this.random);
        this.gx1 = JPAKEUtil.calculateGx(this.f98571p, this.f98570g, this.f98573x1);
        this.gx2 = JPAKEUtil.calculateGx(this.f98571p, this.f98570g, this.f98574x2);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f98571p, this.f98572q, this.f98570g, this.gx1, this.f98573x1, this.participantId, this.digest, this.random);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof2 = JPAKEUtil.calculateZeroKnowledgeProof(this.f98571p, this.f98572q, this.f98570g, this.gx2, this.f98574x2, this.participantId, this.digest, this.random);
        this.state = 10;
    ...
    public JPAKERound2Payload createRound2PayloadToSend() {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f98571p, this.gx1, this.gx3, this.gx4);
        BigInteger bigIntegerCalculateX2s = JPAKEUtil.calculateX2s(this.f98572q, this.f98574x2, calculateS());
        BigInteger bigIntegerCalculateA = JPAKEUtil.calculateA(this.f98571p, this.f98572q, bigIntegerCalculateGA, bigIntegerCalculateX2s);
        BigInteger[] bigIntegerArrCalculateZeroKnowledgeProof = JPAKEUtil.calculateZeroKnowledgeProof(this.f98571p, this.f98572q, bigIntegerCalculateGA, bigIntegerCalculateA, bigIntegerCalculateX2s, this.participantId, this.digest, this.random);
        this.state = 30;
    ...
    public void validateRound1PayloadReceived(JPAKERound1Payload jPAKERound1Payload) throws CryptoException {
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f98571p, this.f98572q, this.f98570g, this.gx3, knowledgeProofForX1, jPAKERound1Payload.getParticipantId(), this.digest);
        JPAKEUtil.validateZeroKnowledgeProof(this.f98571p, this.f98572q, this.f98570g, this.gx4, knowledgeProofForX2, jPAKERound1Payload.getParticipantId(), this.digest);
        this.state = 20;
    }
    ...
    public void validateRound2PayloadReceived(JPAKERound2Payload jPAKERound2Payload) throws CryptoException {
        ...
        BigInteger bigIntegerCalculateGA = JPAKEUtil.calculateGA(this.f98571p, this.gx3, this.gx1, this.gx2);
        this.f98569b = jPAKERound2Payload.getA();
        ...
        JPAKEUtil.validateZeroKnowledgeProof(this.f98571p, this.f98572q, bigIntegerCalculateGA, this.f98569b, knowledgeProofForX2s, jPAKERound2Payload.getParticipantId(), this.digest);
        this.state = 40;
    }
    ...
    public JPAKEParticipant(String str, char[] cArr, JPAKEPrimeOrderGroup jPAKEPrimeOrderGroup, Digest digest, SecureRandom secureRandom) {
        ...
        this.f98571p = jPAKEPrimeOrderGroup.getP();
        this.f98572q = jPAKEPrimeOrderGroup.getQ();
        this.f98570g = jPAKEPrimeOrderGroup.getG();
        this.digest = digest;
