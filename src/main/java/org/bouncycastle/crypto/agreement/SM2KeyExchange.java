...
public class SM2KeyExchange {
    ...
    private BigInteger reduce(BigInteger bigInteger) {
        return bigInteger.and(BigInteger.valueOf(1L).shiftLeft(this.f98568w).subtract(BigInteger.valueOf(1L))).setBit(this.f98568w);
    }
    ...
    public void init(CipherParameters cipherParameters) {
        ...
        this.f98568w = (this.ecParams.getCurve().getFieldSize() / 2) - 1;
