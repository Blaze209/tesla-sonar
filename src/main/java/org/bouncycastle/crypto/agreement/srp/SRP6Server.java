...
public class SRP6Server {
    ...
    protected BigInteger f98589b;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f98590g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f98591u;

    /* JADX INFO: renamed from: v, reason: collision with root package name */
    protected BigInteger f98592v;

    private BigInteger calculateS() {
        return this.f98592v.modPow(this.f98591u, this.N).multiply(this.A).mod(this.N).modPow(this.f98589b, this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f98591u = SRP6Util.calculateU(this.digest, this.N, bigIntegerValidatePublicValue, this.B);
    ...
    public BigInteger generateServerCredentials() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f98590g);
        this.f98589b = selectPrivateValue();
        BigInteger bigIntegerMod = bigIntegerCalculateK.multiply(this.f98592v).mod(this.N).add(this.f98590g.modPow(this.f98589b, this.N)).mod(this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, BigInteger bigInteger3, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f98590g = bigInteger2;
        this.f98592v = bigInteger3;
        this.random = secureRandom;
        this.digest = digest;
    }

    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f98590g, this.random);
    }
