...
public class SRP6Client {
    ...
    protected BigInteger f98585a;
    protected Digest digest;

    /* JADX INFO: renamed from: g, reason: collision with root package name */
    protected BigInteger f98586g;
    protected SecureRandom random;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    protected BigInteger f98587u;

    /* JADX INFO: renamed from: x, reason: collision with root package name */
    protected BigInteger f98588x;

    private BigInteger calculateS() {
        BigInteger bigIntegerCalculateK = SRP6Util.calculateK(this.digest, this.N, this.f98586g);
        return this.B.subtract(this.f98586g.modPow(this.f98588x, this.N).multiply(bigIntegerCalculateK).mod(this.N)).mod(this.N).modPow(this.f98587u.multiply(this.f98588x).add(this.f98585a), this.N);
    }
    ...
    public BigInteger calculateSecret(BigInteger bigInteger) throws CryptoException {
        ...
        this.f98587u = SRP6Util.calculateU(this.digest, this.N, this.A, bigIntegerValidatePublicValue);
    ...
    public BigInteger generateClientCredentials(byte[] bArr, byte[] bArr2, byte[] bArr3) {
        this.f98588x = SRP6Util.calculateX(this.digest, this.N, bArr, bArr2, bArr3);
        BigInteger bigIntegerSelectPrivateValue = selectPrivateValue();
        this.f98585a = bigIntegerSelectPrivateValue;
        BigInteger bigIntegerModPow = this.f98586g.modPow(bigIntegerSelectPrivateValue, this.N);
    ...
    public void init(BigInteger bigInteger, BigInteger bigInteger2, Digest digest, SecureRandom secureRandom) {
        this.N = bigInteger;
        this.f98586g = bigInteger2;
        this.digest = digest;
        this.random = secureRandom;
    }

    protected BigInteger selectPrivateValue() {
        return SRP6Util.generatePrivateValue(this.digest, this.N, this.f98586g, this.random);
    }
