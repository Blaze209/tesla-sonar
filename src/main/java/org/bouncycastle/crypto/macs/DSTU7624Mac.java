...
public class DSTU7624Mac implements Mac {
    ...
    private void processBlock(byte[] bArr, int i11) {
        xor(this.f98721c, 0, bArr, i11, this.cTemp);
        this.engine.processBlock(this.cTemp, 0, this.f98721c, 0);
    }
    ...
    public int doFinal(byte[] bArr, int i11) {
        ...
        xor(this.f98721c, 0, bArr2, 0, this.cTemp);
        xor(this.cTemp, 0, this.kDelta, 0, this.f98721c);
        DSTU7624Engine dSTU7624Engine = this.engine;
        byte[] bArr3 = this.f98721c;
        dSTU7624Engine.processBlock(bArr3, 0, bArr3, 0);
        int i13 = this.macSize;
        if (i13 + i11 > bArr.length) {
            throw new OutputLengthException("output buffer too short");
        }
        System.arraycopy(this.f98721c, 0, bArr, i11, i13);
        reset();
        return this.macSize;
    }
    ...
    @Override // org.bouncycastle.crypto.Mac
    public void reset() {
        Arrays.fill(this.f98721c, (byte) 0);
