    ...
    public int processBytes(byte[] bArr, int i11, int i12, byte[] bArr2, int i13) {
        ...
        if (i16 != 3) {
            ...
            for (int i18 = 0; i18 < i12; i18++) {
                ...
                if (i21 == bArr3.length) {
                    this.poly1305.update(bArr3, 0, 64);
                    processData(this.buf, 0, 64, bArr2, i13 + i17);
                    byte[] bArr4 = this.buf;
                    System.arraycopy(bArr4, 64, bArr4, 0, 16);
                    this.bufPos = 16;
                    i17 += 64;
        ...
        while (true) {
            ...
            this.bufPos = i24;
            if (i24 == 64) {
                processData(bArr5, 0, 64, bArr2, i13);
                this.poly1305.update(bArr2, i13, 64);
                this.bufPos = 0;
                i15 = 64;
                i14 = i23;
                break;
        ...
        while (i12 >= 64) {
            int i25 = i13 + i15;
            processData(bArr, i14, 64, bArr2, i25);
            this.poly1305.update(bArr2, i25, 64);
            i14 += 64;
            i12 -= 64;
            i15 += 64;
        }
        if (i12 > 0) {
            System.arraycopy(bArr, i14, this.buf, 0, i12);
            this.bufPos = i12;
        }
        return i15;
    }
