...
public abstract class GCMUtil {
    ...
    private static long implMul64(long j11, long j12) {
        ...
        long j22 = (((j13 * j17) ^ (j14 * j21)) ^ (j15 * j19)) ^ (j16 * j18);
        long j23 = (((j13 * j18) ^ (j14 * j17)) ^ (j15 * j21)) ^ (j16 * j19);
        long j24 = (((j13 * j19) ^ (j14 * j18)) ^ (j15 * j17)) ^ (j16 * j21);
        return (j22 & 1229782938247303441L) | (j23 & 2459565876494606882L) | (j24 & 4919131752989213764L) | (((((j13 * j21) ^ (j14 * j19)) ^ (j15 * j18)) ^ (j16 * j17)) & (-8608480567731124088L));
    }
    ...
    public static void square(long[] jArr, long[] jArr2) {
        ...
        jArr2[0] = j11 ^ ((((j15 >>> 1) ^ j15) ^ (j15 >>> 2)) ^ (j15 >>> 7));
    ...
    static void multiply(byte[] bArr, long[] jArr) {
        ...
        long jImplMul64 = implMul64(jBigEndianToLong, j11) << 1;
        long jReverse6 = Longs.reverse(implMul64(jReverse2, jReverse4));
        long jImplMul65 = implMul64(jBigEndianToLong2, j12);
        long j13 = jImplMul65 << 1;
        long jReverse7 = Longs.reverse(implMul64(jReverse ^ jReverse2, jReverse3 ^ jReverse4));
        long jImplMul66 = ((implMul64(jBigEndianToLong ^ jBigEndianToLong2, j11 ^ j12) << 1) ^ ((jReverse6 ^ jImplMul64) ^ j13)) ^ ((jImplMul65 << 63) ^ (jImplMul65 << 58));
        Pack.longToBigEndian(jReverse5 ^ (((jImplMul66 >>> 2) ^ ((jImplMul66 >>> 1) ^ jImplMul66)) ^ (jImplMul66 >>> 7)), bArr, 0);
        Pack.longToBigEndian(((jImplMul66 << 57) ^ ((jImplMul66 << 63) ^ (jImplMul66 << 62))) ^ ((jReverse7 ^ ((jImplMul64 ^ jReverse5) ^ jReverse6)) ^ (((j13 ^ (j13 >>> 1)) ^ (j13 >>> 2)) ^ (j13 >>> 7))), bArr, 8);
    }
    ...
    public static long areEqual(long[] jArr, long[] jArr2) {
        long j11 = (jArr2[1] ^ jArr[1]) | (jArr[0] ^ jArr2[0]);
    ...
    public static void multiply(long[] jArr, long[] jArr2) {
        ...
        long j13 = jArr2[0];
        long j14 = jArr2[1];
        long jReverse = Longs.reverse(j11);
        long jReverse2 = Longs.reverse(j12);
        long jReverse3 = Longs.reverse(j13);
        long jReverse4 = Longs.reverse(j14);
        long jReverse5 = Longs.reverse(implMul64(jReverse, jReverse3));
        long jImplMul64 = implMul64(j11, j13) << 1;
        long jReverse6 = Longs.reverse(implMul64(jReverse2, jReverse4));
        long jImplMul65 = implMul64(j12, j14);
        long j15 = jImplMul65 << 1;
        long jReverse7 = Longs.reverse(implMul64(jReverse ^ jReverse2, jReverse3 ^ jReverse4));
        long jImplMul66 = ((implMul64(j11 ^ j12, j13 ^ j14) << 1) ^ ((jReverse6 ^ jImplMul64) ^ j15)) ^ ((jImplMul65 << 63) ^ (jImplMul65 << 58));
        jArr[0] = jReverse5 ^ ((jImplMul66 >>> 7) ^ (((jImplMul66 >>> 1) ^ jImplMul66) ^ (jImplMul66 >>> 2)));
        jArr[1] = ((jImplMul66 << 57) ^ ((jImplMul66 << 63) ^ (jImplMul66 << 62))) ^ ((jReverse7 ^ ((jImplMul64 ^ jReverse5) ^ jReverse6)) ^ (((j15 ^ (j15 >>> 1)) ^ (j15 >>> 2)) ^ (j15 >>> 7)));
    }
