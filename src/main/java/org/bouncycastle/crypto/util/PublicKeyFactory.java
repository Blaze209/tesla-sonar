...
public class PublicKeyFactory {
    ...
    private static class DHAgreementConverter extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            return new DHPublicKeyParameters(aSN1Integer.getValue(), new DHParameters(dHParameter.getP(), dHParameter.getG(), null, l11 == null ? 0 : l11.intValue()));
        }
    }
    ...
    private static class ECConverter extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            if (bytes[0] == 4 && bytes[1] == bytes.length - 2 && (((b11 = bytes[2]) == 2 || b11 == 3) && new X9IntegerConverter().getByteLength(eCDomainParameters.getCurve()) >= bytes.length - 3)) {
                try {
    ...
    private static class GOST3410_2012Converter extends SubjectPublicKeyInfoConverter {
        ...
        AsymmetricKeyParameter getPublicKeyParameters(SubjectPublicKeyInfo subjectPublicKeyInfo, Object obj) {
            ...
            try {
                ...
                int i11 = algorithm2.equals((ASN1Primitive) RosstandartObjectIdentifiers.id_tc26_gost_3410_12_512) ? 64 : 32;
                int i12 = i11 * 2;
