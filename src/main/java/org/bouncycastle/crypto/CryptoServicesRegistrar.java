...
public final class CryptoServicesRegistrar {
    ...
    public static SecureRandom getSecureRandom() {
        ...
        i.a(atomicReference, null, defaultRandomProviderImpl);
    ...
    public static <T> T getSizedProperty(Property property, int i11) {
        ...
        if (property.type.isAssignableFrom(DHParameters.class)) {
            while (i12 != objArrLookupProperty.length) {
                ?? r11 = (T) ((DHParameters) objArrLookupProperty[i12]);
                if (r11.getP().bitLength() == i11) {
                    return r11;
                }
                i12++;
            }
            ...
            while (i12 != objArrLookupProperty.length) {
                ?? r12 = (T) ((DSAParameters) objArrLookupProperty[i12]);
                if (r12.getP().bitLength() == i11) {
                    return r12;
                }
                i12++;
            }
