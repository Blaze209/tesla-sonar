...
public class JPAKEExample {
    ...
    public static void main(String[] strArr) throws CryptoException {
        ...
        System.out.println("p (" + p11.bitLength() + " bits): " + p11.toString(16));
        System.out.println("q (" + q11.bitLength() + " bits): " + q11.toString(16));
        System.out.println("g (" + p11.bitLength() + " bits): " + g11.toString(16));
        PrintStream printStream = System.out;
        StringBuilder sb2 = new StringBuilder();
        sb2.append("p mod q = ");
        sb2.append(p11.mod(q11).toString(16));
        printStream.println(sb2.toString());
        System.out.println("g^{q} mod p = " + g11.modPow(q11, p11).toString(16));
        System.out.println("");
