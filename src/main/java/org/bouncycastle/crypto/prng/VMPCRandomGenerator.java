    ...
    public void nextBytes(byte[] bArr, int i11, int i12) {
        synchronized (this.P) {
            ...
            while (i11 != i13) {
                try {
                    byte[] bArr2 = this.P;
                    byte b11 = this.f98826s;
                    byte b12 = this.f98825n;
