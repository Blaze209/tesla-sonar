...
public class Zuc128CoreEngine implements StreamCipher, Memoable {
    ...
    private static int MAKEU31(byte b11, short s11, byte b12) {
        return ((b11 & 255) << 23) | ((s11 & HPKE.aead_EXPORT_ONLY) << 8) | (b12 & 255);
    }
    ...
    static int ROT(int i11, int i12) {
    ...
    int F() {
        ...
        int[] iArr3 = this.F;
        byte[] bArr = S0;
        byte b11 = bArr[iL1 >>> 24];
        byte[] bArr2 = S1;
        iArr3[0] = MAKEU32(b11, bArr2[(iL1 >>> 16) & 255], bArr[(iL1 >>> 8) & 255], bArr2[iL1 & 255]);
