...
public class AESEngine extends DefaultMultiBlockCipher {
    ...
    private static int FFmulX(int i11) {
        return (((i11 & f98637m1) >>> 7) * 27) ^ ((f98638m2 & i11) << 1);
    }

    private static int FFmulX2(int i11) {
        int i12 = (f98641m5 & i11) << 2;
        int i13 = i11 & f98640m4;
        int i14 = i13 ^ (i13 >>> 1);
    ...
    private void decryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12, int[][] iArr) {
        ...
        while (i18 > i15) {
            ...
            char c14 = c11;
            int i19 = i15;
            int iShift2 = (((iArr3[i14 & 255] ^ shift(iArr3[(iShift >> 8) & 255], 24)) ^ shift(iArr3[(i17 >> 16) & 255], 16)) ^ shift(iArr3[(i16 >> 24) & 255], 8)) ^ iArr[i18][c14];
            char c15 = c12;
            int iShift3 = (((iArr3[i16 & 255] ^ shift(iArr3[(i14 >> 8) & 255], 24)) ^ shift(iArr3[(iShift >> 16) & 255], 16)) ^ shift(iArr3[(i17 >> 24) & 255], 8)) ^ iArr[i18][i19];
            char c16 = c13;
            int iShift4 = (((iArr3[i17 & 255] ^ shift(iArr3[(i16 >> 8) & 255], 24)) ^ shift(iArr3[(i14 >> 16) & 255], 16)) ^ shift(iArr3[(iShift >> 24) & 255], 8)) ^ iArr[i18][c15];
            int iShift5 = ((iArr3[iShift & 255] ^ shift(iArr3[(i17 >> 8) & 255], 24)) ^ shift(iArr3[(i16 >> 16) & 255], 16)) ^ shift(iArr3[(i14 >> 24) & 255], 8);
            int i21 = i18 - 1;
            int i22 = iShift5 ^ iArr[i18][c16];
            int iShift6 = (((iArr3[iShift2 & 255] ^ shift(iArr3[(i22 >> 8) & 255], 24)) ^ shift(iArr3[(iShift4 >> 16) & 255], 16)) ^ shift(iArr3[(iShift3 >> 24) & 255], 8)) ^ iArr[i21][c14];
            ...
            int iShift8 = (((iArr3[iShift4 & 255] ^ shift(iArr3[(iShift3 >> 8) & 255], 24)) ^ shift(iArr3[(iShift2 >> 16) & 255], 16)) ^ shift(iArr3[(i22 >> 24) & 255], 8)) ^ iArr[i21][c15];
            i18 -= 2;
            iShift = (((iArr3[i22 & 255] ^ shift(iArr3[(iShift4 >> 8) & 255], 24)) ^ shift(iArr3[(iShift3 >> 16) & 255], 16)) ^ shift(iArr3[(iShift2 >> 24) & 255], 8)) ^ iArr[i21][c16];
            c11 = c14;
            i15 = i19;
            i14 = iShift6;
            i16 = iShift7;
        ...
        char c19 = c13;
        int[] iArr4 = Tinv0;
        int iShift9 = (((iArr4[i14 & 255] ^ shift(iArr4[(iShift >> 8) & 255], 24)) ^ shift(iArr4[(i17 >> 16) & 255], 16)) ^ shift(iArr4[(i16 >> 24) & 255], 8)) ^ iArr[i18][c17];
        int iShift10 = (((iArr4[i16 & 255] ^ shift(iArr4[(i14 >> 8) & 255], 24)) ^ shift(iArr4[(iShift >> 16) & 255], 16)) ^ shift(iArr4[(i17 >> 24) & 255], 8)) ^ iArr[i18][i23];
        int iShift11 = (((iArr4[i17 & 255] ^ shift(iArr4[(i16 >> 8) & 255], 24)) ^ shift(iArr4[(i14 >> 16) & 255], 16)) ^ shift(iArr4[(iShift >> 24) & 255], 8)) ^ iArr[i18][c18];
        int iShift12 = (((iArr4[iShift & 255] ^ shift(iArr4[(i17 >> 8) & 255], 24)) ^ shift(iArr4[(i16 >> 16) & 255], 16)) ^ shift(iArr4[(i14 >> 24) & 255], 8)) ^ iArr[i18][c19];
        byte[] bArr3 = Si;
        int i24 = bArr3[iShift9 & 255] & 255;
        byte[] bArr4 = this.f98642s;
        int i25 = ((i24 ^ ((bArr4[(iShift12 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(iShift11 >> 16) & 255] & 255) << 16)) ^ (bArr3[(iShift10 >> 24) & 255] << 24);
        int[] iArr5 = iArr[c17];
        int i26 = i25 ^ iArr5[c17];
        int i27 = ((((bArr4[iShift10 & 255] & 255) ^ ((bArr4[(iShift9 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(iShift12 >> 16) & 255] & 255) << 16)) ^ (bArr4[(iShift11 >> 24) & 255] << 24)) ^ iArr5[i23];
        int i28 = ((((bArr4[iShift11 & 255] & 255) ^ ((bArr3[(iShift10 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(iShift9 >> 16) & 255] & 255) << 16)) ^ (bArr4[(iShift12 >> 24) & 255] << 24)) ^ iArr5[c18];
        int i29 = ((((bArr3[iShift12 & 255] & 255) ^ ((bArr4[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(iShift10 >> 16) & 255] & 255) << 16)) ^ (bArr4[(iShift9 >> 24) & 255] << 24)) ^ iArr5[c19];
    ...
    private void encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12, int[][] iArr) {
        ...
        while (i17 < this.ROUNDS - i14) {
            ...
            char c14 = c11;
            int i18 = i14;
            int iShift2 = (((iArr3[i13 & 255] ^ shift(iArr3[(i15 >> 8) & 255], 24)) ^ shift(iArr3[(i16 >> 16) & 255], 16)) ^ shift(iArr3[(iShift >> 24) & 255], 8)) ^ iArr[i17][c14];
            char c15 = c12;
            int iShift3 = (((iArr3[i15 & 255] ^ shift(iArr3[(i16 >> 8) & 255], 24)) ^ shift(iArr3[(iShift >> 16) & 255], 16)) ^ shift(iArr3[(i13 >> 24) & 255], 8)) ^ iArr[i17][i18];
            char c16 = c13;
            int iShift4 = (((iArr3[i16 & 255] ^ shift(iArr3[(iShift >> 8) & 255], 24)) ^ shift(iArr3[(i13 >> 16) & 255], 16)) ^ shift(iArr3[(i15 >> 24) & 255], 8)) ^ iArr[i17][c15];
            int iShift5 = ((iArr3[iShift & 255] ^ shift(iArr3[(i13 >> 8) & 255], 24)) ^ shift(iArr3[(i15 >> 16) & 255], 16)) ^ shift(iArr3[(i16 >> 24) & 255], 8);
            int i19 = i17 + 1;
            int i21 = iShift5 ^ iArr[i17][c16];
            int iShift6 = (((iArr3[iShift2 & 255] ^ shift(iArr3[(iShift3 >> 8) & 255], 24)) ^ shift(iArr3[(iShift4 >> 16) & 255], 16)) ^ shift(iArr3[(i21 >> 24) & 255], 8)) ^ iArr[i19][c14];
            ...
            int iShift8 = (((iArr3[iShift4 & 255] ^ shift(iArr3[(i21 >> 8) & 255], 24)) ^ shift(iArr3[(iShift2 >> 16) & 255], 16)) ^ shift(iArr3[(iShift3 >> 24) & 255], 8)) ^ iArr[i19][c15];
            i17 += 2;
            iShift = (((iArr3[i21 & 255] ^ shift(iArr3[(iShift2 >> 8) & 255], 24)) ^ shift(iArr3[(iShift3 >> 16) & 255], 16)) ^ shift(iArr3[(iShift4 >> 24) & 255], 8)) ^ iArr[i19][c16];
            c11 = c14;
            i14 = i18;
            i13 = iShift6;
            i15 = iShift7;
        ...
        char c19 = c13;
        int[] iArr4 = T0;
        int iShift9 = (((iArr4[i13 & 255] ^ shift(iArr4[(i15 >> 8) & 255], 24)) ^ shift(iArr4[(i16 >> 16) & 255], 16)) ^ shift(iArr4[(iShift >> 24) & 255], 8)) ^ iArr[i17][c17];
        int iShift10 = (((iArr4[i15 & 255] ^ shift(iArr4[(i16 >> 8) & 255], 24)) ^ shift(iArr4[(iShift >> 16) & 255], 16)) ^ shift(iArr4[(i13 >> 24) & 255], 8)) ^ iArr[i17][i22];
        int iShift11 = (((iArr4[i16 & 255] ^ shift(iArr4[(iShift >> 8) & 255], 24)) ^ shift(iArr4[(i13 >> 16) & 255], 16)) ^ shift(iArr4[(i15 >> 24) & 255], 8)) ^ iArr[i17][c18];
        int iShift12 = (((iArr4[iShift & 255] ^ shift(iArr4[(i13 >> 8) & 255], 24)) ^ shift(iArr4[(i15 >> 16) & 255], 16)) ^ shift(iArr4[(i16 >> 24) & 255], 8)) ^ iArr[i17][c19];
        byte[] bArr3 = S;
        ...
        int i25 = i24 ^ iArr5[c17];
        int i26 = ((((bArr4[iShift10 & 255] & 255) ^ ((bArr3[(iShift11 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(iShift12 >> 16) & 255] & 255) << 16)) ^ (bArr4[(iShift9 >> 24) & 255] << 24)) ^ iArr5[i22];
        int i27 = ((((bArr4[iShift11 & 255] & 255) ^ ((bArr3[(iShift12 >> 8) & 255] & 255) << 8)) ^ ((bArr3[(iShift9 >> 16) & 255] & 255) << 16)) ^ (bArr3[(iShift10 >> 24) & 255] << 24)) ^ iArr5[c18];
        int i28 = ((((bArr4[iShift12 & 255] & 255) ^ ((bArr4[(iShift9 >> 8) & 255] & 255) << 8)) ^ ((bArr4[(iShift10 >> 16) & 255] & 255) << 16)) ^ (bArr3[(iShift11 >> 24) & 255] << 24)) ^ iArr5[c19];
    ...
    private int[][] generateWorkingKey(byte[] bArr, boolean z11) {
        ...
        if (i12 == 4) {
            ...
            while (true) {
                ...
                iArr7[c11] = iLittleEndianToInt14;
                i11 = i13;
                int i25 = i24 + 1;
                char c12 = c11;
                if (i25 >= 15) {
                ...
                iArr8[c12] = iLittleEndianToInt18;
                i24 += 2;
                i13 = i11;
                c11 = c12;
            }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (z11) {
            this.f98642s = Arrays.clone(S);
        } else {
            this.f98642s = Arrays.clone(Si);
        }
