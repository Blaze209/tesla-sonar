...
public class SM4Engine implements BlockCipher {
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        this.f98698rk = expandKey(z11, key);
    ...
    public int processBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        for (int i13 = 0; i13 < 32; i13 += 4) {
            int[] iArr = this.X;
            iArr[0] = F0(iArr, this.f98698rk[i13]);
            int[] iArr2 = this.X;
            iArr2[1] = F1(iArr2, this.f98698rk[i13 + 1]);
            int[] iArr3 = this.X;
            iArr3[2] = F2(iArr3, this.f98698rk[i13 + 2]);
            int[] iArr4 = this.X;
            iArr4[3] = F3(iArr4, this.f98698rk[i13 + 3]);
        }
