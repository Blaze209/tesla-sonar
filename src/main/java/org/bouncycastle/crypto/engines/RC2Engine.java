...
public class RC2Engine implements BlockCipher {
    ...
    private void encryptBlock(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        for (int i13 = 0; i13 <= 16; i13 += 4) {
            iRotateWordLeft4 = rotateWordLeft(iRotateWordLeft4 + ((~iRotateWordLeft) & iRotateWordLeft3) + (iRotateWordLeft2 & iRotateWordLeft) + this.workingKey[i13], 1);
        ...
        for (int i14 = 20; i14 <= 40; i14 += 4) {
            iRotateWordLeft5 = rotateWordLeft(iRotateWordLeft5 + ((~iRotateWordLeft8) & iRotateWordLeft6) + (iRotateWordLeft7 & iRotateWordLeft8) + this.workingKey[i14], 1);
