...
public final class CAST6Engine extends CAST5Engine {
    ...
    protected void setKey(byte[] bArr) {
        ...
        while (i17 < 12) {
            ...
            int i25 = i18 + 6;
            iArr7[c12] = iArr7[c12] ^ F1(iArr7[1], this._Tm[i25], this._Tr[i25]);
            int[] iArr8 = this._workingKey;
            int i26 = i18 + 7;
            iArr8[7] = F2(iArr8[c12], this._Tm[i26], this._Tr[i26]) ^ iArr8[7];
            int i27 = ((i17 * 2) + 1) * 8;
            ...
            int i34 = i27 + 6;
            iArr15[c12] = iArr15[c12] ^ F1(iArr15[1], this._Tm[i34], this._Tr[i34]);
            int[] iArr16 = this._workingKey;
            int i35 = i27 + 7;
            iArr16[7] = F2(iArr16[c12], this._Tm[i35], this._Tr[i35]) ^ iArr16[7];
            int[] iArr17 = this._Kr;
            int i36 = i17 * 4;
            int[] iArr18 = this._workingKey;
            iArr17[i36] = iArr18[c12] & 31;
            int i37 = i36 + 1;
