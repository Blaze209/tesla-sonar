...
public class DSTU7624Engine implements BlockCipher {
    ...
    private void decryptBlock_128(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        long[] jArr2 = jArr[i13];
        char c11 = 0;
        long j11 = jLittleEndianToLong - jArr2[0];
        char c12 = 1;
        long j12 = jLittleEndianToLong2 - jArr2[1];
        while (true) {
            long jMixColumnInv = mixColumnInv(j11);
            long jMixColumnInv2 = mixColumnInv(j12);
            ...
            byte[] bArr6 = T3;
            char c14 = c12;
            long j13 = (((long) ((bArr6[i14 >>> 24] << 24) | ((b13 & 255) << 16) | (b11 & 255) | ((b12 & 255) << 8))) & 4294967295L) | (((long) ((bArr6[i17 >>> 24] << 24) | (((bArr3[i17 & 255] & 255) | ((bArr4[(i17 >>> 8) & 255] & 255) << 8)) | ((bArr5[(i17 >>> 16) & 255] & 255) << 16)))) << 32);
            long j14 = (((long) ((bArr6[i16 >>> 24] << 24) | (bArr3[i16 & 255] & 255) | ((bArr4[(i16 >>> 8) & 255] & 255) << 8) | ((bArr5[(i16 >>> 16) & 255] & 255) << 16))) & 4294967295L) | (((long) ((bArr6[i15 >>> 24] << 24) | (((bArr3[i15 & 255] & 255) | ((bArr4[(i15 >>> 8) & 255] & 255) << 8)) | ((bArr5[(i15 >>> 16) & 255] & 255) << 16)))) << 32);
            i13--;
            long[][] jArr3 = this.roundKeys;
            if (i13 == 0) {
                long[] jArr4 = jArr3[c13];
                long j15 = j13 - jArr4[c13];
                long j16 = j14 - jArr4[c14];
                Pack.longToLittleEndian(j15, bArr2, i12);
                Pack.longToLittleEndian(j16, bArr2, i12 + 8);
                return;
            }
            long[] jArr5 = jArr3[i13];
            long j17 = jArr5[c13] ^ j13;
            j12 = j14 ^ jArr5[c14];
            j11 = j17;
            c11 = c13;
            c12 = c14;
    ...
    private void encryptBlock_128(byte[] bArr, int i11, byte[] bArr2, int i12) {
        ...
        long j11 = jLittleEndianToLong + jArr[0];
        char c12 = 1;
        long j12 = jLittleEndianToLong2 + jArr[1];
        int i13 = 0;
        while (true) {
            int i14 = (int) j11;
            int i15 = (int) (j11 >>> 32);
            ...
            byte[] bArr6 = S3;
            char c14 = c12;
            long j13 = (((long) (((b13 & 255) << 16) | (b11 & 255) | ((b12 & 255) << 8) | (bArr6[i14 >>> 24] << 24))) & 4294967295L) | (((long) ((bArr6[i17 >>> 24] << 24) | (((bArr3[i17 & 255] & 255) | ((bArr4[(i17 >>> 8) & 255] & 255) << 8)) | ((bArr5[(i17 >>> 16) & 255] & 255) << 16)))) << 32);
            long j14 = (((long) ((bArr6[i16 >>> 24] << 24) | (bArr3[i16 & 255] & 255) | ((bArr4[(i16 >>> 8) & 255] & 255) << 8) | ((bArr5[(i16 >>> 16) & 255] & 255) << 16))) & 4294967295L) | (((long) ((bArr6[i15 >>> 24] << 24) | (((bArr3[i15 & 255] & 255) | ((bArr4[(i15 >>> 8) & 255] & 255) << 8)) | ((bArr5[(i15 >>> 16) & 255] & 255) << 16)))) << 32);
            long jMixColumn = mixColumn(j13);
            long jMixColumn2 = mixColumn(j14);
            i13++;
            int i18 = this.roundsAmount;
            if (i13 == i18) {
                long[] jArr2 = this.roundKeys[i18];
                long j15 = jMixColumn + jArr2[c13];
                long j16 = jMixColumn2 + jArr2[c14];
                Pack.longToLittleEndian(j15, bArr2, i12);
                Pack.longToLittleEndian(j16, bArr2, i12 + 8);
                return;
            }
            long[] jArr3 = this.roundKeys[i13];
            long j17 = jMixColumn ^ jArr3[c13];
            j12 = jMixColumn2 ^ jArr3[c14];
            j11 = j17;
            c11 = c13;
            c12 = c14;
        }
    ...
    private static long mixColumn(long j11) {
        ...
        return ((rotate(32, mulX2((j11 ^ jRotate2) ^ jMulX)) ^ jRotate2) ^ rotate(40, jMulX)) ^ rotate(48, jMulX);
    }

    private static long mixColumnInv(long j11) {
        long jRotate = rotate(8, j11) ^ j11;
        long jRotate2 = (jRotate ^ rotate(32, jRotate)) ^ rotate(48, j11);
        long j12 = jRotate2 ^ j11;
        long jRotate3 = rotate(48, j11);
        long jRotate4 = rotate(56, j11);
        long jMulX = mulX(j12 ^ jRotate4) ^ rotate(56, j12);
        long jMulX2 = mulX(rotate(40, mulX(jMulX) ^ j11) ^ (rotate(16, j12) ^ j11)) ^ (j12 ^ jRotate3);
        return mulX(rotate(40, ((j11 ^ rotate(32, j12)) ^ jRotate4) ^ mulX(((jRotate3 ^ (rotate(24, j11) ^ j12)) ^ jRotate4) ^ mulX(mulX(jMulX2) ^ rotate(16, jRotate2))))) ^ jRotate2;
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (length == 128) {
            ...
            defaultServiceProperties = new DefaultServiceProperties(getAlgorithmName(), 128, cipherParameters, Utils.getPurpose(z11));
        } else {
            if (length != 256) {
                if (length == 512) {
                    this.roundsAmount = 18;
                    defaultServiceProperties = new DefaultServiceProperties(getAlgorithmName(), 256, cipherParameters, Utils.getPurpose(z11));
                }
