...
public class ARIAEngine implements BlockCipher {
    ...
    protected static byte SB1(byte b11) {
        return SB1_sbox[b11 & 255];
    }

    protected static byte SB2(byte b11) {
        return SB2_sbox[b11 & 255];
    }

    protected static byte SB3(byte b11) {
        return SB3_sbox[b11 & 255];
    }

    protected static byte SB4(byte b11) {
    ...
    protected static byte[][] keySchedule(boolean z11, byte[] bArr) {
    ...
    protected static void keyScheduleRound(byte[] bArr, byte[] bArr2, byte[] bArr3, int i11) {
        int i12 = i11 >>> 3;
        int i13 = i11 & 7;
        int i14 = 8 - i13;
