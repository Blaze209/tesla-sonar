...
public class Blake2sDigest implements ExtendedDigest {
    ...
    private int f98608f0;

    /* JADX INFO: renamed from: f1, reason: collision with root package name */
    private int f98609f1;
    private int fanout;
    ...
    private int f98610t0;

    /* JADX INFO: renamed from: t1, reason: collision with root package name */
    private int f98611t1;
    ...
    private void initializeInternalState() {
        ...
        int[] iArr3 = this.internalState;
        iArr3[12] = this.f98610t0 ^ iArr2[4];
        iArr3[13] = this.f98611t1 ^ iArr2[5];
        iArr3[14] = this.f98608f0 ^ iArr2[6];
        iArr3[15] = iArr2[7] ^ this.f98609f1;
    }
    ...
    Blake2sDigest(int i11, int i12, long j11) {
        this(i11, i12, j11, CryptoServicePurpose.ANY);
    }

    Blake2sDigest(int i11, int i12, long j11, CryptoServicePurpose cryptoServicePurpose) {
        this.keyLength = 0;
        this.salt = null;
    ...
    Blake2sDigest(int i11, byte[] bArr, byte[] bArr2, byte[] bArr3, long j11, CryptoServicePurpose cryptoServicePurpose) {
        this.keyLength = 0;
        this.salt = null;
        this.personalization = null;
        this.key = null;
    ...
    public Blake2sDigest(Blake2sDigest blake2sDigest) {
        ...
        this.f98610t0 = blake2sDigest.f98610t0;
        this.f98611t1 = blake2sDigest.f98611t1;
        this.f98608f0 = blake2sDigest.f98608f0;
