...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f98834iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f98834iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f98834iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f98834iv = new DEROctetString(Arrays.clone(bArr));
    }
}
