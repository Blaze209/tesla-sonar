...
public final class Arrays {
    ...
    public static int hashCode(byte[] bArr) {
        ...
        while (true) {
            ...
            i11 = (i11 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ bArr[length];
        }
    }
    ...
    public static int hashCode(byte[] bArr, int i11, int i12) {
        ...
        while (true) {
            ...
            i13 = (i13 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ bArr[i11 + i12];
        }
    }
    ...
    public static int hashCode(char[] cArr) {
        ...
        while (true) {
            ...
            i11 = (i11 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ cArr[length];
        }
    }
    ...
    public static int hashCode(int[] iArr) {
        ...
        while (true) {
            ...
            i11 = (i11 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ iArr[length];
        }
    }
    ...
    public static int hashCode(int[] iArr, int i11, int i12) {
        ...
        while (true) {
            ...
            i13 = (i13 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ iArr[i11 + i12];
        }
    }
    ...
    public static int hashCode(long[] jArr) {
        ...
        while (true) {
            ...
            i11 = (((i11 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) j11)) * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) (j11 >>> 32));
        }
    }
    ...
    public static int hashCode(long[] jArr, int i11, int i12) {
        ...
        while (true) {
            ...
            i13 = (((i13 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) j11)) * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ ((int) (j11 >>> 32));
        }
    }
    ...
    public static int hashCode(Object[] objArr) {
        ...
        while (true) {
            ...
            iHashCode = (iHashCode * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ Objects.hashCode(objArr[length]);
        }
    }
    ...
    public static int hashCode(short[] sArr) {
        ...
        while (true) {
            ...
            i11 = (i11 * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ (sArr[length] & 255);
        }
    }
    ...
    public static int hashCode(int[][] iArr) {
        ...
        for (int i11 = 0; i11 != iArr.length; i11++) {
            iHashCode = (iHashCode * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) + hashCode(iArr[i11]);
        }
        return iHashCode;
    }
    ...
    public static int hashCode(short[][] sArr) {
        ...
        for (int i11 = 0; i11 != sArr.length; i11++) {
            iHashCode = (iHashCode * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) + hashCode(sArr[i11]);
        }
        return iHashCode;
    }
