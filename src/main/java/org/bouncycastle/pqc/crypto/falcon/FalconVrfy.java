...
class FalconVrfy {
    ...
    boolean complete_private(byte[] bArr, int i11, byte[] bArr2, int i12, byte[] bArr3, int i13, byte[] bArr4, int i14, int i15, short[] sArr, int i16) {
        int i17 = 1 << i15;
        int i18 = i16 + i17;
        for (int i19 = 0; i19 < i17; i19++) {
            sArr[i16 + i19] = (short) mq_conv_small(bArr3[i13 + i19]);
            sArr[i18 + i19] = (short) mq_conv_small(bArr4[i14 + i19]);
        }
        mq_NTT(sArr, i16, i15);
        mq_NTT(sArr, i18, i15);
        mq_poly_tomonty(sArr, i16, i15);
        mq_poly_montymul_ntt(sArr, i16, sArr, i18, i15);
        for (int i21 = 0; i21 < i17; i21++) {
            sArr[i18 + i21] = (short) mq_conv_small(bArr2[i12 + i21]);
        }
        mq_NTT(sArr, i18, i15);
        boolean z11 = true;
        for (int i22 = 0; i22 < i17; i22++) {
            short s11 = sArr[i18 + i22];
            z11 &= s11 != 0;
            int i23 = i16 + i22;
            sArr[i23] = (short) mq_div_12289(sArr[i23], s11);
        }
        mq_iNTT(sArr, i16, i15);
        for (int i24 = 0; i24 < i17; i24++) {
            int i25 = sArr[i16 + i24] & HPKE.aead_EXPORT_ONLY;
            int i26 = i25 - ((~(-((i25 - 6144) >>> 31))) & 12289);
            z11 &= i26 >= -127 && i26 <= 127;
            bArr[i11 + i24] = (byte) i26;
        }
        return z11;
    }

    int compute_public(short[] sArr, int i11, byte[] bArr, int i12, byte[] bArr2, int i13, int i14, short[] sArr2, int i15) {
        int i16 = 1 << i14;
        for (int i17 = 0; i17 < i16; i17++) {
            sArr2[i15 + i17] = (short) mq_conv_small(bArr[i12 + i17]);
            sArr[i11 + i17] = (short) mq_conv_small(bArr2[i13 + i17]);
        }
        mq_NTT(sArr, i11, i14);
        mq_NTT(sArr2, i15, i14);
        for (int i18 = 0; i18 < i16; i18++) {
            short s11 = sArr2[i15 + i18];
            if (s11 == 0) {
                return 0;
            }
            int i19 = i11 + i18;
            sArr[i19] = (short) mq_div_12289(sArr[i19], s11);
        }
        mq_iNTT(sArr, i11, i14);
        return 1;
    }

    int count_nttzero(short[] sArr, int i11, int i12, short[] sArr2, int i13) {
        int i14 = 1 << i12;
        for (int i15 = 0; i15 < i14; i15++) {
            short s11 = sArr[i11 + i15];
            sArr2[i13 + i15] = (short) (s11 + ((-(s11 >>> 31)) & 12289));
        }
        mq_NTT(sArr2, i13, i12);
        int i16 = 0;
        for (int i17 = 0; i17 < i14; i17++) {
            i16 += ((sArr2[i13 + i17] & HPKE.aead_EXPORT_ONLY) - 1) >>> 31;
        }
        return i16;
    }

    int is_invertible(short[] sArr, int i11, int i12, short[] sArr2, int i13) {
        int i14 = 1 << i12;
        for (int i15 = 0; i15 < i14; i15++) {
            short s11 = sArr[i11 + i15];
            sArr2[i13 + i15] = (short) (s11 + ((-(s11 >>> 31)) & 12289));
        ...
        int i16 = 0;
        for (int i17 = 0; i17 < i14; i17++) {
            i16 |= (sArr2[i13 + i17] & HPKE.aead_EXPORT_ONLY) - 1;
        }
        return 1 - (i16 >>> 31);
    }

    void mq_NTT(short[] sArr, int i11, int i12) {
        int i13 = 1;
        int i14 = 1 << i12;
        int i15 = i14;
        while (i13 < i14) {
            ...
            int i18 = 0;
            while (i17 < i13) {
                short s11 = this.GMb[i13 + i17];
                int i19 = i18 + i16;
                for (int i21 = i18; i21 < i19; i21++) {
                    int i22 = i11 + i21;
                    int i23 = sArr[i22] & HPKE.aead_EXPORT_ONLY;
                    int i24 = i22 + i16;
                    int iMq_montymul = mq_montymul(sArr[i24], s11);
                    sArr[i22] = (short) mq_add(i23, iMq_montymul);
                    sArr[i24] = (short) mq_sub(i23, iMq_montymul);
                }
                i17++;
                i18 += i15;
            }
    ...
    int mq_add(int i11, int i12) {
        int i13 = (i11 + i12) - 12289;
        return i13 + ((-(i13 >>> 31)) & 12289);
    }

    int mq_conv_small(int i11) {
        return i11 + ((-(i11 >>> 31)) & 12289);
    }

    int mq_div_12289(int i11, int i12) {
        int iMq_montymul = mq_montymul(i12, 10952);
        ...
        return mq_montymul(mq_montymul(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(mq_montymul(mq_montysqr(mq_montysqr(iMq_montymul4)), iMq_montymul3))), iMq_montymul4)), iMq_montymul), i11);
    }

    void mq_iNTT(short[] sArr, int i11, int i12) {
        int i13;
        int i14 = 1 << i12;
        int i15 = 1;
        int i16 = i14;
        while (true) {
            ...
            while (i13 < i16) {
                int i19 = i18 + i15;
                short s11 = this.iGMb[i16 + i13];
                for (int i21 = i18; i21 < i19; i21++) {
                    int i22 = i11 + i21;
                    int i23 = sArr[i22] & HPKE.aead_EXPORT_ONLY;
                    int i24 = i22 + i15;
                    int i25 = 65535 & sArr[i24];
                    sArr[i22] = (short) mq_add(i23, i25);
                    sArr[i24] = (short) mq_montymul(mq_sub(i23, i25), s11);
                }
                i13++;
                i18 += i17;
            }
        ...
        for (int i26 = i14; i26 > 1; i26 >>= 1) {
            iMq_rshift1 = mq_rshift1(iMq_rshift1);
        }
        while (i13 < i14) {
            int i27 = i11 + i13;
            sArr[i27] = (short) mq_montymul(sArr[i27], iMq_rshift1);
            i13++;
        }
    }

    int mq_montymul(int i11, int i12) {
        int i13 = i11 * i12;
        int i14 = ((i13 + (((i13 * 12287) & 65535) * 12289)) >>> 16) - 12289;
        return i14 + ((-(i14 >>> 31)) & 12289);
    }

    int mq_montysqr(int i11) {
        return mq_montymul(i11, i11);
    }

    void mq_poly_montymul_ntt(short[] sArr, int i11, short[] sArr2, int i12, int i13) {
        int i14 = 1 << i13;
        for (int i15 = 0; i15 < i14; i15++) {
            int i16 = i11 + i15;
            sArr[i16] = (short) mq_montymul(sArr[i16], sArr2[i12 + i15]);
        }
    }

    void mq_poly_sub(short[] sArr, int i11, short[] sArr2, int i12, int i13) {
        int i14 = 1 << i13;
        for (int i15 = 0; i15 < i14; i15++) {
            int i16 = i11 + i15;
            sArr[i16] = (short) mq_sub(sArr[i16], sArr2[i12 + i15]);
        }
    }

    void mq_poly_tomonty(short[] sArr, int i11, int i12) {
        int i13 = 1 << i12;
        for (int i14 = 0; i14 < i13; i14++) {
            int i15 = i11 + i14;
            sArr[i15] = (short) mq_montymul(sArr[i15], 10952);
        }
    }

    int mq_rshift1(int i11) {
        return (i11 + ((-(i11 & 1)) & 12289)) >>> 1;
    }

    int mq_sub(int i11, int i12) {
        int i13 = i11 - i12;
        return i13 + ((-(i13 >>> 31)) & 12289);
    }

    void to_ntt_monty(short[] sArr, int i11, int i12) {
        mq_NTT(sArr, i11, i12);
        mq_poly_tomonty(sArr, i11, i12);
    }

    int verify_raw(short[] sArr, int i11, short[] sArr2, int i12, short[] sArr3, int i13, int i14, short[] sArr4, int i15) {
        int i16 = 1 << i14;
        for (int i17 = 0; i17 < i16; i17++) {
            short s11 = sArr2[i12 + i17];
            sArr4[i15 + i17] = (short) (s11 + ((-(s11 >>> 31)) & 12289));
        }
        mq_NTT(sArr4, i15, i14);
        mq_poly_montymul_ntt(sArr4, i15, sArr3, i13, i14);
        mq_iNTT(sArr4, i15, i14);
        mq_poly_sub(sArr4, i15, sArr, i11, i14);
        for (int i18 = 0; i18 < i16; i18++) {
            int i19 = i15 + i18;
            int i21 = sArr4[i19] & HPKE.aead_EXPORT_ONLY;
            sArr4[i19] = (short) (i21 - ((-((6144 - i21) >>> 31)) & 12289));
        }
        return this.common.is_short(sArr4, i15, sArr2, i12, i14);
    }

    int verify_recover(short[] sArr, int i11, short[] sArr2, int i12, short[] sArr3, int i13, short[] sArr4, int i14, int i15, short[] sArr5, int i16) {
        int i17 = 1 << i15;
        for (int i18 = 0; i18 < i17; i18++) {
            short s11 = sArr4[i14 + i18];
            sArr5[i16 + i18] = (short) (s11 + ((-(s11 >> 31)) & 12289));
            short s12 = sArr3[i13 + i18];
            sArr[i11 + i18] = (short) mq_sub(sArr2[i12 + i18], 65535 & (s12 + ((-(s12 >>> 31)) & 12289)));
        }
        mq_NTT(sArr5, i16, i15);
        mq_NTT(sArr5, i11, i15);
        int i19 = 0;
        for (int i21 = 0; i21 < i17; i21++) {
            short s13 = sArr5[i16 + i21];
            i19 |= (s13 & HPKE.aead_EXPORT_ONLY) - 1;
            int i22 = i11 + i21;
            sArr[i22] = (short) mq_div_12289(sArr[i22] & HPKE.aead_EXPORT_ONLY, s13 & HPKE.aead_EXPORT_ONLY);
        }
        mq_iNTT(sArr, i11, i15);
        return ((~i19) & (-this.common.is_short(sArr3, i13, sArr4, i14, i15))) >>> 31;
    }
}
