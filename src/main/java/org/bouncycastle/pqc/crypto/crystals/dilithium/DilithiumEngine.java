...
class DilithiumEngine {
    ...
    DilithiumEngine(int i11, SecureRandom secureRandom, boolean z11) {
        int i12;
        int i13;
        int i14;
        ...
        if (i11 != 2) {
            if (i11 == 3) {
                ...
                if (i11 != 5) {
                    throw new IllegalArgumentException("The mode " + i11 + "is not supported by Crystals Dilithium!");
                }
                this.DilithiumK = 8;
                this.DilithiumL = 7;
                this.DilithiumEta = 2;
        ...
        int i15 = this.DilithiumOmega;
        int i16 = this.DilithiumK;
        int i17 = i15 + i16;
        this.DilithiumPolyVecHPackedBytes = i17;
        this.CryptoPublicKeyBytes = (i16 * 320) + 32;
        int i18 = this.DilithiumL;
        int i19 = this.DilithiumPolyEtaPackedBytes;
        this.CryptoSecretKeyBytes = (i18 * i19) + 96 + (i19 * i16) + (i16 * 416);
        this.CryptoBytes = this.DilithiumCTilde + (i18 * this.DilithiumPolyZPackedBytes) + i17;
        int i21 = this.DilithiumGamma1;
        if (i21 == 131072) {
    ...
    public byte[] signSignature(byte[] bArr, int i11, byte[] bArr2, byte[] bArr3, byte[] bArr4, byte[] bArr5, byte[] bArr6, byte[] bArr7) {
        PolyVecK polyVecK;
        byte[] bArr8 = new byte[this.CryptoBytes + i11];
        ...
        while (i12 < 1000) {
            ...
            polyVecL2.uniformGamma1(bArr10, s11);
    ...
    public boolean signVerify(byte[] bArr, int i11, byte[] bArr2, int i12, byte[] bArr3, byte[] bArr4) {
        ...
        for (int i13 = 0; i13 < this.DilithiumCTilde; i13++) {
            if (bArrCopyOfRange[i13] != bArr6[i13]) {
                return false;
            }
        }
        return true;
