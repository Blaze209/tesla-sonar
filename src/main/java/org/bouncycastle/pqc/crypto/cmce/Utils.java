...
class Utils {
    ...
    static short bitrev(short s11, int i11) {
    ...
    static int load4(byte[] bArr, int i11) {
        return Pack.littleEndianToInt(bArr, i11);
    }

    static long load8(byte[] bArr, int i11) {
        return Pack.littleEndianToLong(bArr, i11);
    }

    static short load_gf(byte[] bArr, int i11, int i12) {
        return (short) (Pack.littleEndianToShort(bArr, i11) & i12);
    }

    static void store8(byte[] bArr, int i11, long j11) {
    ...
    static void store_gf(byte[] bArr, int i11, short s11) {
