...
public class NTRULPRimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRoundedDecodedPolynomial(sArr, nTRULPRimePublicKeyParameters.getRoundEncA(), p11, q11);
        short[] sArr2 = new short[p11];
        Utils.generatePolynomialInRQFromSeed(sArr2, nTRULPRimePublicKeyParameters.getSeed(), p11, q11);
        ...
        Utils.sortGenerateShortPolynomial(bArr3, iArr, p11, w11);
        short[] sArr3 = new short[p11];
        Utils.multiplicationInRQ(sArr3, sArr2, bArr3, p11, q11);
        short[] sArr4 = new short[p11];
        Utils.roundPolynomial(sArr4, sArr3);
        byte[] bArr4 = new byte[roundedPolynomialBytes];
        Utils.getRoundedEncodedPolynomial(bArr4, sArr4, p11, q11);
        short[] sArr5 = new short[p11];
        Utils.multiplicationInRQ(sArr5, sArr, bArr3, p11, q11);
        byte[] bArr5 = new byte[256];
        Utils.top(bArr5, sArr5, bArr, q11, tau0, tau1);
