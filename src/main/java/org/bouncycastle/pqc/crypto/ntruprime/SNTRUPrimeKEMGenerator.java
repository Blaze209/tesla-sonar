...
public class SNTRUPrimeKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        Utils.getRandomShortPolynomial(this.random, bArr, p11, w11);
        byte[] bArr2 = new byte[(p11 + 3) / 4];
        Utils.getEncodedSmallPolynomial(bArr2, bArr, p11);
        short[] sArr = new short[p11];
        Utils.getDecodedPolynomial(sArr, sNTRUPrimePublicKeyParameters.getEncH(), p11, q11);
