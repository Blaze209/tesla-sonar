...
import com.fourthline.reactplugin.FourthlineModule;
...
public class GeMSSParameters {
    ...
    static {
        ...
        GeMSSParameters geMSSParameters2 = new GeMSSParameters("gemss192", 192, EnumC4419g.SDK_ASSET_HEADER_SHIELD_VALUE, 20, 22, 4, 513, 9, 0);
        ...
        GeMSSParameters geMSSParameters4 = new GeMSSParameters("bluegemss128", 128, 175, 14, 13, 4, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        bluegemss128 = geMSSParameters4;
        GeMSSParameters geMSSParameters5 = new GeMSSParameters("bluegemss192", 192, EnumC4419g.SDK_ASSET_HEADER_SHIELD_VALUE, 23, 22, 4, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        bluegemss192 = geMSSParameters5;
        GeMSSParameters geMSSParameters6 = new GeMSSParameters("bluegemss256", 256, 358, 32, 34, 4, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        ...
        GeMSSParameters geMSSParameters8 = new GeMSSParameters("redgemss192", 192, EnumC4419g.SDK_ASSET_ILLUSTRATION_CRA_OVERLAY_ACCOUNT_VALUE, 25, 23, 4, 17, 4, 0);
        ...
        GeMSSParameters geMSSParameters11 = new GeMSSParameters("whitegemss192", 192, EnumC4419g.SDK_ASSET_HEADER_ENABLE_TRANSFERS_VALUE, 21, 21, 3, 513, 9, 0);
        ...
        GeMSSParameters geMSSParameters13 = new GeMSSParameters("cyangemss128", 128, 177, 13, 14, 3, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        cyangemss128 = geMSSParameters13;
        GeMSSParameters geMSSParameters14 = new GeMSSParameters("cyangemss192", 192, EnumC4419g.SDK_ASSET_HEADER_RTP_AUTHORIZE_MICRODEPOSITS_VALUE, 22, 23, 3, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        cyangemss192 = geMSSParameters14;
        GeMSSParameters geMSSParameters15 = new GeMSSParameters("cyangemss256", 256, 364, 32, 31, 3, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        ...
        GeMSSParameters geMSSParameters17 = new GeMSSParameters("magentagemss192", 192, EnumC4419g.SDK_ASSET_ILLUSTRATION_INSTITUTION_BRUSHSTROKE_VALUE, 24, 24, 3, 17, 4, 0);
        ...
        GeMSSParameters geMSSParameters19 = new GeMSSParameters("fgemss128", 128, EnumC4419g.SDK_ASSET_ILLUSTRATION_CRA_OVERLAY_ACCOUNT_VALUE, 11, 10, 1, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        ...
        GeMSSParameters geMSSParameters22 = new GeMSSParameters("dualmodems128", 128, EnumC4419g.SDK_ASSET_ILLUSTRATION_CRA_OVERLAY_ACCOUNT_VALUE, 11, 10, 1, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        dualmodems128 = geMSSParameters22;
        GeMSSParameters geMSSParameters23 = new GeMSSParameters("dualmodems192", 192, WalletConstants.ERROR_CODE_SERVICE_UNAVAILABLE, 18, 18, 1, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        dualmodems192 = geMSSParameters23;
        GeMSSParameters geMSSParameters24 = new GeMSSParameters("dualmodems256", 256, 544, 32, 32, 1, EnumC4419g.SDK_ASSET_ILLUSTRATION_FORM_VALUE, 7, 0);
        dualmodems256 = geMSSParameters24;
        Integer numValueOf = Integers.valueOf(EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE);
        gemss_128 = numValueOf;
        Integer numValueOf2 = Integers.valueOf(EnumC4419g.SDK_ASSET_HEADER_BOLT_VALUE);
        gemss_192 = numValueOf2;
        Integer numValueOf3 = Integers.valueOf(EnumC4419g.SDK_ASSET_HEADER_FINAL_ENROLLMENT_SUCCESS_VALUE);
        gemss_256 = numValueOf3;
        Integer numValueOf4 = Integers.valueOf(513);
        bluegemss_128 = numValueOf4;
        Integer numValueOf5 = Integers.valueOf(SyslogConstants.SYSLOG_PORT);
        ...
        Integer numValueOf24 = Integers.valueOf(FourthlineModule.LOCATION_REQUEST_CODE);
