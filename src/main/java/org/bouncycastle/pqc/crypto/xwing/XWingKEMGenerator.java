...
public class XWingKEMGenerator implements EncapsulatedSecretGenerator {
    ...
    private final SecureRandom f99196sr;

    public XWingKEMGenerator(SecureRandom secureRandom) {
        this.f99196sr = secureRandom;
    }
    ...
    public SecretWithEncapsulation generateEncapsulated(AsymmetricKeyParameter asymmetricKeyParameter) {
        ...
        SecretWithEncapsulation secretWithEncapsulationGenerateEncapsulated = new KyberKEMGenerator(this.f99196sr).generateEncapsulated(xWingPublicKeyParameters.getKyberPublicKey());
        ...
        x25519KeyPairGenerator.init(new X25519KeyGenerationParameters(this.f99196sr));
