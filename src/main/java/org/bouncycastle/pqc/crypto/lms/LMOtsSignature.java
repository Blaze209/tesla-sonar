...
class LMOtsSignature implements Encodable {
    ...
    public boolean equals(Object obj) {
        ...
        if (Arrays.equals(this.C, lMOtsSignature.C)) {
            return Arrays.equals(this.f99120y, lMOtsSignature.f99120y);
        }
        return false;
    }
    ...
    public byte[] getEncoded() {
        return Composer.compose().u32str(this.type.getType()).bytes(this.C).bytes(this.f99120y).build();
    }
    ...
    public int hashCode() {
        LMOtsParameters lMOtsParameters = this.type;
        return ((((lMOtsParameters != null ? lMOtsParameters.hashCode() : 0) * 31) + Arrays.hashCode(this.C)) * 31) + Arrays.hashCode(this.f99120y);
    }
}
