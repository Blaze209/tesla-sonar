...
public abstract class CipherSpiExt extends CipherSpi {
    ...
    @Override // javax.crypto.CipherSpi
    protected final void engineInit(int i11, Key key, AlgorithmParameters algorithmParameters, SecureRandom secureRandom) throws InvalidKeyException {
    ...
    @Override // javax.crypto.CipherSpi
    protected final void engineInit(int i11, Key key, SecureRandom secureRandom) throws InvalidKeyException {
        try {
            engineInit(i11, key, (AlgorithmParameterSpec) null, secureRandom);
