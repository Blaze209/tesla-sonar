...
public class GF2Vector extends Vector {
    ...
    public Vector add(Vector vector) {
        ...
        int[] iArrClone = IntUtils.clone(gF2Vector.f99264v);
        for (int length = iArrClone.length - 1; length >= 0; length--) {
            iArrClone[length] = iArrClone[length] ^ this.f99264v[length];
        }
    ...
    public boolean equals(Object obj) {
        ...
        return this.length == gF2Vector.length && IntUtils.equals(this.f99264v, gF2Vector.f99264v);
    }
    ...
    public GF2Vector extractLeftVector(int i11) {
        ...
        int i13 = i11 >> 5;
        int i14 = i11 & 31;
        System.arraycopy(this.f99264v, 0, gF2Vector.f99264v, 0, i13);
        if (i14 != 0) {
            gF2Vector.f99264v[i13] = ((1 << i14) - 1) & this.f99264v[i13];
        }
        return gF2Vector;
    }
    ...
    public GF2Vector extractRightVector(int i11) {
        ...
        int i18 = 0;
        if (i16 == 0) {
            System.arraycopy(this.f99264v, i15, gF2Vector.f99264v, 0, i17);
            return gF2Vector;
        }
        while (true) {
            i12 = i17 - 1;
            ...
            int[] iArr = gF2Vector.f99264v;
            int[] iArr2 = this.f99264v;
            int i19 = i15 + 1;
            iArr[i18] = (iArr2[i15] >>> i16) | (iArr2[i19] << (32 - i16));
            i18++;
            i15 = i19;
        }
        int[] iArr3 = gF2Vector.f99264v;
        int[] iArr4 = this.f99264v;
        int i21 = i15 + 1;
    ...
    public int getBit(int i11) {
        ...
        int i12 = i11 >> 5;
        int i13 = i11 & 31;
        return (this.f99264v[i12] & (1 << i13)) >>> i13;
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public byte[] getEncoded() {
        return LittleEndianConversions.toByteArray(this.f99264v, (this.length + 7) >> 3);
    }
    ...
    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public int hashCode() {
        return (this.length * 31) + Arrays.hashCode(this.f99264v);
    }

    @Override // org.bouncycastle.pqc.legacy.math.linearalgebra.Vector
    public boolean isZero() {
        for (int length = this.f99264v.length - 1; length >= 0; length--) {
            if (this.f99264v[length] != 0) {
                return false;
            }
        }
        return true;
    ...
    public GF2mVector toExtensionFieldVector(GF2mField gF2mField) {
        ...
        for (int i14 = i12 - 1; i14 >= 0; i14--) {
            for (int degree2 = gF2mField.getDegree() - 1; degree2 >= 0; degree2--) {
                if (((this.f99264v[i13 >>> 5] >>> (i13 & 31)) & 1) == 1) {
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.length; i11++) {
            ...
            stringBuffer.append((this.f99264v[i11 >> 5] & (1 << (i11 & 31))) == 0 ? '0' : '1');
        }
    ...
    public GF2Vector(int i11, SecureRandom secureRandom) {
        this.length = i11;
        int i12 = (i11 + 31) >> 5;
        this.f99264v = new int[i12];
        int i13 = i12 - 1;
        for (int i14 = i13; i14 >= 0; i14--) {
            this.f99264v[i14] = secureRandom.nextInt();
        }
        int i15 = i11 & 31;
        if (i15 != 0) {
            int[] iArr = this.f99264v;
    ...
    public GF2Vector(GF2Vector gF2Vector) {
        ...
        this.f99264v = IntUtils.clone(gF2Vector.f99264v);
    }
