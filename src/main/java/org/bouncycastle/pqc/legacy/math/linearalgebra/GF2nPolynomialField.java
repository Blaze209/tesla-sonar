...
public class GF2nPolynomialField extends GF2nField {
    ...
    public int[] getPc() {
        ...
        int[] iArr = new int[3];
        System.arraycopy(this.f99265pc, 0, iArr, 0, 3);
        return iArr;
    }
