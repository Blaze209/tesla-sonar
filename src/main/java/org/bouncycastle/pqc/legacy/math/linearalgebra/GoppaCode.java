...
public final class GoppaCode {
    ...
    public static class MaMaPe {
        ...
        private GF2Matrix f99267h;

        /* JADX INFO: renamed from: p, reason: collision with root package name */
        private Permutation f99268p;

        /* JADX INFO: renamed from: s, reason: collision with root package name */
        private GF2Matrix f99269s;

        public MaMaPe(GF2Matrix gF2Matrix, GF2Matrix gF2Matrix2, Permutation permutation) {
            this.f99269s = gF2Matrix;
            this.f99267h = gF2Matrix2;
            this.f99268p = permutation;
        }
    ...
    public static class MatrixSet {
        ...
        private GF2Matrix f99270g;
        private int[] setJ;

        public MatrixSet(GF2Matrix gF2Matrix, int[] iArr) {
            this.f99270g = gF2Matrix;
            this.setJ = iArr;
        }
