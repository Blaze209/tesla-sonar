...
public class McElieceCipher implements MessageEncryptor {
    ...
    private GF2Vector computeMessageRepresentative(byte[] bArr) {
        byte[] bArr2 = new byte[this.maxPlainTextSize + ((this.f99221k & 7) != 0 ? 1 : 0)];
        System.arraycopy(bArr, 0, bArr2, 0, bArr.length);
        bArr2[bArr.length] = 1;
        return GF2Vector.OS2VP(this.f99221k, bArr2);
    }

    private void initCipherDecrypt(McEliecePrivateKeyParameters mcEliecePrivateKeyParameters) {
        this.f99222n = mcEliecePrivateKeyParameters.getN();
        int k11 = mcEliecePrivateKeyParameters.getK();
        this.f99221k = k11;
        this.maxPlainTextSize = k11 >> 3;
        this.cipherTextSize = this.f99222n >> 3;
    }

    private void initCipherEncrypt(McEliecePublicKeyParameters mcEliecePublicKeyParameters) {
        this.f99222n = mcEliecePublicKeyParameters.getN();
        this.f99221k = mcEliecePublicKeyParameters.getK();
        this.f99224t = mcEliecePublicKeyParameters.getT();
        this.cipherTextSize = this.f99222n >> 3;
        this.maxPlainTextSize = this.f99221k >> 3;
    }
    ...
    public void init(boolean z11, CipherParameters cipherParameters) {
        ...
        if (!z11) {
            ...
            if (!(cipherParameters instanceof ParametersWithRandom)) {
                this.f99223sr = CryptoServicesRegistrar.getSecureRandom();
            ...
            this.f99223sr = parametersWithRandom.getRandom();
    ...
    public byte[] messageDecrypt(byte[] bArr) {
        ...
        GF2Vector gF2VectorOS2VP = GF2Vector.OS2VP(this.f99222n, bArr);
        ...
        return computeMessage((GF2Vector) sInv.leftMultiply(gF2Vector2.extractRightVector(this.f99221k)));
    }
    ...
    public byte[] messageEncrypt(byte[] bArr) {
        ...
        return ((GF2Vector) ((McEliecePublicKeyParameters) this.key).getG().leftMultiply(gF2VectorComputeMessageRepresentative).add(new GF2Vector(this.f99222n, this.f99224t, this.f99223sr))).getEncoded();
    }
}
