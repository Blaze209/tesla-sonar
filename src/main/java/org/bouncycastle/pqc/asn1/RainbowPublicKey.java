...
public class RainbowPublicKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        for (int i11 = 0; i11 < this.coeffQuadratic.length; i11++) {
            aSN1EncodableVector2.add(new DEROctetString(this.coeffQuadratic[i11]));
        }
        aSN1EncodableVector.add(new DERSequence(aSN1EncodableVector2));
        ASN1EncodableVector aSN1EncodableVector3 = new ASN1EncodableVector();
        for (int i12 = 0; i12 < this.coeffSingular.length; i12++) {
            aSN1EncodableVector3.add(new DEROctetString(this.coeffSingular[i12]));
        }
