...
public class McEliecePrivateKey extends ASN1Object {
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new ASN1Integer(this.f99009n));
        aSN1EncodableVector.add(new ASN1Integer(this.f99008k));
    ...
    private McEliecePrivateKey(ASN1Sequence aSN1Sequence) {
        this.f99009n = ((ASN1Integer) aSN1Sequence.getObjectAt(0)).intValueExact();
        this.f99008k = ((ASN1Integer) aSN1Sequence.getObjectAt(1)).intValueExact();
