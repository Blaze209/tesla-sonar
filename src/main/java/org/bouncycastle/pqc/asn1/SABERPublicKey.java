...
public class SABERPublicKey extends ASN1Object {
    ...
    private SABERPublicKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f99022b = Arrays.clone(ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(1)).getOctets());
    }
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new DEROctetString(this.f99022b));
