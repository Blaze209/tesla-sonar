...
public class GMSSPrivateKey extends ASN1Object {
    ...
    private ASN1Primitive encode(int[] iArr, byte[][] bArr, byte[][] bArr2, byte[][][] bArr3, byte[][][] bArr4, byte[][][] bArr5, Treehash[][] treehashArr, Treehash[][] treehashArr2, Vector[] vectorArr, Vector[] vectorArr2, Vector[][] vectorArr3, Vector[][] vectorArr4, GMSSLeaf[] gMSSLeafArr, GMSSLeaf[] gMSSLeafArr2, GMSSLeaf[] gMSSLeafArr3, int[] iArr2, byte[][] bArr6, GMSSRootCalc[] gMSSRootCalcArr, byte[][] bArr7, GMSSRootSig[] gMSSRootSigArr, GMSSParameters gMSSParameters, AlgorithmIdentifier[] algorithmIdentifierArr) {
        ...
        int i16 = 0;
        while (i16 < treehashArr.length) {
            int i17 = 0;
            while (i17 < treehashArr[i16].length) {
                aSN1EncodableVector11.add(new DERSequence(algorithmIdentifierArr[0]));
                int i18 = treehashArr[i16][i17].getStatInt()[1];
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i16][i17].getStatByte()[0]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i16][i17].getStatByte()[1]));
                aSN1EncodableVector12.add(new DEROctetString(treehashArr[i16][i17].getStatByte()[2]));
                int i19 = 0;
                while (i19 < i18) {
                    aSN1EncodableVector12.add(new DEROctetString(treehashArr[i16][i17].getStatByte()[i19 + 3]));
                    i19++;
                    treehashArr = treehashArr;
                }
                aSN1EncodableVector11.add(new DERSequence(aSN1EncodableVector12));
                aSN1EncodableVector12 = new ASN1EncodableVector();
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[0]));
                aSN1EncodableVector13.add(new ASN1Integer(i18));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[2]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[3]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[4]));
                aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[5]));
                int i21 = 0;
                while (i21 < i18) {
                    aSN1EncodableVector13.add(new ASN1Integer(treehashArr[i16][i17].getStatInt()[i21 + 6]));
                    i21++;
                    i16 = i16;
                    i17 = i17;
                }
        ...
        int i22 = 0;
        while (i22 < treehashArr2.length) {
            int i23 = 0;
            while (i23 < treehashArr2[i22].length) {
        ...
        for (int i44 : iArr2) {
            aSN1EncodableVector43.add(new ASN1Integer(i44));
        }
        ...
        while (i45 < gMSSRootCalcArr.length) {
            ...
            aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i45].getStatByte()[0]));
            int i48 = 0;
            while (i48 < i46) {
                i48++;
                aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i45].getStatByte()[i48]));
            }
            for (int i49 = 0; i49 < i47; i49++) {
                aSN1EncodableVector47.add(new DEROctetString(gMSSRootCalcArr[i45].getStatByte()[i46 + 1 + i49]));
            }
            ...
            aSN1EncodableVector48.add(new ASN1Integer(i46));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[1]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[2]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[3]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[4]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[5]));
            aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[6]));
            aSN1EncodableVector48.add(new ASN1Integer(i47));
            for (int i51 = 0; i51 < i46; i51++) {
                aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[i51 + 8]));
            }
            for (int i52 = 0; i52 < i47; i52++) {
                aSN1EncodableVector48.add(new ASN1Integer(gMSSRootCalcArr[i45].getStatInt()[i46 + 8 + i52]));
            }
            ...
            if (gMSSRootCalcArr[i45].getTreehash() != null) {
                ...
                while (i53 < gMSSRootCalcArr[i45].getTreehash().length) {
                    ...
                    aSN1EncodableVector54.add(new DEROctetString(gMSSRootCalcArr[i45].getTreehash()[i53].getStatByte()[0]));
                    aSN1EncodableVector54.add(new DEROctetString(gMSSRootCalcArr[i45].getTreehash()[i53].getStatByte()[1]));
                    aSN1EncodableVector54.add(new DEROctetString(gMSSRootCalcArr[i45].getTreehash()[i53].getStatByte()[2]));
                    int i55 = 0;
                    while (i55 < i54) {
                        aSN1EncodableVector54.add(new DEROctetString(gMSSRootCalcArr[i45].getTreehash()[i53].getStatByte()[i55 + 3]));
                        i55++;
                    ...
                    aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[0]));
                    aSN1EncodableVector55.add(new ASN1Integer(i54));
                    aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[2]));
                    aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[3]));
                    aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[4]));
                    aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[5]));
                    int i56 = 0;
                    while (i56 < i54) {
                        aSN1EncodableVector55.add(new ASN1Integer(gMSSRootCalcArr[i45].getTreehash()[i53].getStatInt()[i56 + 6]));
                        i56++;
            ...
            if (gMSSRootCalcArr[i45].getRetain() != null) {
                for (int i57 = 0; i57 < gMSSRootCalcArr[i45].getRetain().length; i57++) {
                    for (int i58 = 0; i58 < gMSSRootCalcArr[i45].getRetain()[i57].size(); i58++) {
                        aSN1EncodableVector59.add(new DEROctetString((byte[]) gMSSRootCalcArr[i45].getRetain()[i57].elementAt(i58)));
                    }
        ...
        for (int i59 = 0; i59 < gMSSRootSigArr.length; i59++) {
            ...
            new ASN1EncodableVector();
            aSN1EncodableVector63.add(new DEROctetString(gMSSRootSigArr[i59].getStatByte()[0]));
            aSN1EncodableVector63.add(new DEROctetString(gMSSRootSigArr[i59].getStatByte()[1]));
            aSN1EncodableVector63.add(new DEROctetString(gMSSRootSigArr[i59].getStatByte()[2]));
            aSN1EncodableVector63.add(new DEROctetString(gMSSRootSigArr[i59].getStatByte()[3]));
            aSN1EncodableVector63.add(new DEROctetString(gMSSRootSigArr[i59].getStatByte()[4]));
            aSN1EncodableVector62.add(new DERSequence(aSN1EncodableVector63));
            aSN1EncodableVector63 = new ASN1EncodableVector();
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[0]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[1]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[2]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[3]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[4]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[5]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[6]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[7]));
            aSN1EncodableVector64.add(new ASN1Integer(gMSSRootSigArr[i59].getStatInt()[8]));
        ...
        for (int i61 = 0; i61 < gMSSParameters.getHeightOfTrees().length; i61++) {
            aSN1EncodableVector66.add(new ASN1Integer(gMSSParameters.getHeightOfTrees()[i61]));
            aSN1EncodableVector67.add(new ASN1Integer(gMSSParameters.getWinternitzParameter()[i61]));
            aSN1EncodableVector68.add(new ASN1Integer(gMSSParameters.getK()[i61]));
        }
