...
public class SABERPrivateKey extends ASN1Object {
    ...
    private byte[] f99020s;
    private int version;

    /* JADX INFO: renamed from: z, reason: collision with root package name */
    private byte[] f99021z;
    ...
    public ASN1Primitive toASN1Primitive() {
        ...
        aSN1EncodableVector.add(new DEROctetString(this.f99021z));
        aSN1EncodableVector.add(new DEROctetString(this.f99020s));
    ...
    private SABERPrivateKey(ASN1Sequence aSN1Sequence) {
        ...
        this.f99021z = Arrays.clone(ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(1)).getOctets());
        this.f99020s = Arrays.clone(ASN1OctetString.getInstance(aSN1Sequence.getObjectAt(2)).getOctets());
