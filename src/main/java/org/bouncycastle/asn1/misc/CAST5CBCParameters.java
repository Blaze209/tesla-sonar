...
public class CAST5CBCParameters extends ASN1Object {
    ...
    ASN1OctetString f98520iv;
    ASN1Integer keyLength;

    private CAST5CBCParameters(ASN1Sequence aSN1Sequence) {
        this.f98520iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return Arrays.clone(this.f98520iv.getOctets());
    }
