...
public class IDEACBCPar extends ASN1Object {
    ...
    ASN1OctetString f98521iv;

    private IDEACBCPar(ASN1Sequence aSN1Sequence) {
        this.f98521iv = aSN1Sequence.size() == 1 ? (ASN1OctetString) aSN1Sequence.getObjectAt(0) : null;
    }
    ...
    public byte[] getIV() {
        ASN1OctetString aSN1OctetString = this.f98521iv;
    ...
    public IDEACBCPar(byte[] bArr) {
        this.f98521iv = new DEROctetString(Arrays.clone(bArr));
    }
}
