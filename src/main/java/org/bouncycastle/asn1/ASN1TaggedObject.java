...
public abstract class ASN1TaggedObject extends ASN1Primitive implements ASN1TaggedObjectParser {
    ...
    ASN1TaggedObject(int i11, int i12, int i13, ASN1Encodable aSN1Encodable) {
    ...
    static ASN1Primitive createConstructedDL(int i11, int i12, ASN1EncodableVector aSN1EncodableVector) {
    ...
    static ASN1Primitive createConstructedIL(int i11, int i12, ASN1EncodableVector aSN1EncodableVector) {
    ...
    static ASN1Primitive createPrimitive(int i11, int i12, byte[] bArr) {
    ...
    public int hashCode() {
        return (((this.tagClass * 7919) ^ this.tagNo) ^ (isExplicit() ? 15 : EnumC4419g.SDK_ASSET_ILLUSTRATION_PLAID_LOGO_CIRCLE_VALUE)) ^ this.obj.toASN1Primitive().hashCode();
    }
    ...
    public ASN1Encodable parseBaseUniversal(boolean z11, int i11) {
        ...
        if (i11 != 16) {
            return i11 != 17 ? baseUniversal : ((ASN1Set) baseUniversal).parser();
        }
    ...
    abstract ASN1TaggedObject replaceTag(int i11, int i12);
    ...
    protected ASN1TaggedObject(boolean z11, int i11, int i12, ASN1Encodable aSN1Encodable) {
    ...
    ASN1Primitive getBaseUniversal(boolean z11, ASN1UniversalType aSN1UniversalType) {
        if (z11) {
            if (isExplicit()) {
    ...
    protected ASN1TaggedObject(boolean z11, int i11, ASN1Encodable aSN1Encodable) {
