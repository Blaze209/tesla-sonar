...
public abstract class DERGenerator extends ASN1Generator {
    ...
    void writeDEREncoded(int i11, byte[] bArr) throws IOException {
        if (!this._tagged) {
        ...
        if ((i11 & 32) != 0) {
            writeDEREncoded(this._out, i12 | 160, bArr);
        } else {
    ...
    void writeDEREncoded(OutputStream outputStream, int i11, byte[] bArr) throws IOException {
