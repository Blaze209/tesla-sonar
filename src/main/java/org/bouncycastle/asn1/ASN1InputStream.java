...
public class ASN1InputStream extends FilterInputStream implements BERTags {
    ...
    ASN1Primitive readTaggedObjectDL(int i11, int i12, boolean z11, DefiniteLengthInputStream definiteLengthInputStream) {
    ...
    static int readLength(InputStream inputStream, int i11, boolean z11) throws IOException {
        ...
        throw new IOException("corrupted stream - out of bounds length found: " + i14 + " >= " + i11);
    }
