...
public abstract class ASN1Sequence extends ASN1Primitive implements Iterable<ASN1Encodable> {
    ...
    public int hashCode() {
        ...
        while (true) {
            ...
            iHashCode = (iHashCode * EnumC4419g.SDK_ASSET_ICON_LIGHTNING_WHITE_VALUE) ^ this.elements[length].toASN1Primitive().hashCode();
        }
    }
    ...
    ASN1Sequence(ASN1Encodable[] aSN1EncodableArr, boolean z11) {
