...
public class PKCS12PBEParams extends ASN1Object {
    ...
    ASN1OctetString f98527iv;

    private PKCS12PBEParams(ASN1Sequence aSN1Sequence) {
        this.f98527iv = (ASN1OctetString) aSN1Sequence.getObjectAt(0);
    ...
    public byte[] getIV() {
        return this.f98527iv.getOctets();
    }
