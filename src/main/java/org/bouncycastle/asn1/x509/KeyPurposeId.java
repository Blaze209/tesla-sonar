...
public class KeyPurposeId extends ASN1Object {
    ...
    private ASN1ObjectIdentifier f98550id;

    static {
        ASN1ObjectIdentifier aSN1ObjectIdentifier = new ASN1ObjectIdentifier("1.3.6.1.5.5.7.3");
        id_kp = aSN1ObjectIdentifier;
        anyExtendedKeyUsage = new KeyPurposeId(Extension.extendedKeyUsage.branch(WebrtcBuildVersion.maint_version));
    ...
    private KeyPurposeId(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        this.f98550id = aSN1ObjectIdentifier;
    }
    ...
    public String getId() {
        return this.f98550id.getId();
    }

    @Override // org.bouncycastle.asn1.ASN1Object, org.bouncycastle.asn1.ASN1Encodable
    public ASN1Primitive toASN1Primitive() {
        return this.f98550id;
    }
