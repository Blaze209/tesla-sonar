...
public class JCEECPublicKey implements ECPublicKey, org.bouncycastle.jce.interfaces.ECPublicKey, ECPointEncoder {
    ...
    public JCEECPublicKey(String str, ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.ecSpec = params;
        this.f98881q = EC5Util.convertPoint(params, eCPublicKeySpec.getW());
    }
    ...
    private void populateFromPubKeyInfo(SubjectPublicKeyInfo subjectPublicKeyInfo) {
        ...
        if (algorithm.getAlgorithm().equals((ASN1Primitive) CryptoProObjectIdentifiers.gostR3410_2001)) {
            ...
            try {
                ...
                this.f98881q = curve2.decodePoint(bArr);
        ...
        this.f98881q = new X9ECPoint(curve, dEROctetString).getPoint();
    }
    ...
    public byte[] getEncoded() {
        ...
        if (this.algorithm.equals("ECGOST3410")) {
            ...
            BigInteger bigInteger = this.f98881q.getAffineXCoord().toBigInteger();
            BigInteger bigInteger2 = this.f98881q.getAffineYCoord().toBigInteger();
    ...
    public ECPoint getQ() {
        return this.ecSpec == null ? this.f98881q.getDetachedPoint() : this.f98881q;
    }

    @Override // java.security.interfaces.ECPublicKey
    public java.security.spec.ECPoint getW() {
        return EC5Util.convertPoint(this.f98881q);
    }
    ...
    public String toString() {
        ...
        stringBuffer.append(this.f98881q.getAffineXCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
        stringBuffer.append("            Y: ");
        stringBuffer.append(this.f98881q.getAffineYCoord().toBigInteger().toString(16));
        stringBuffer.append(strLineSeparator);
    ...
    public JCEECPublicKey(String str, ECPublicKeyParameters eCPublicKeyParameters) {
        this.algorithm = str;
        this.f98881q = eCPublicKeyParameters.getQ();
        this.ecSpec = null;
    }
    ...
    public JCEECPublicKey(String str, JCEECPublicKey jCEECPublicKey) {
        this.algorithm = str;
        this.f98881q = jCEECPublicKey.f98881q;
    ...
    public JCEECPublicKey(String str, org.bouncycastle.jce.spec.ECPublicKeySpec eCPublicKeySpec) {
        ...
        this.algorithm = str;
        this.f98881q = eCPublicKeySpec.getQ();
        if (eCPublicKeySpec.getParams() != null) {
            ...
            if (this.f98881q.getCurve() == null) {
                this.f98881q = BouncyCastleProvider.CONFIGURATION.getEcImplicitlyCa().getCurve().createPoint(this.f98881q.getAffineXCoord().toBigInteger(), this.f98881q.getAffineYCoord().toBigInteger());
            }
    ...
    public JCEECPublicKey(ECPublicKey eCPublicKey) {
        ...
        this.ecSpec = params;
        this.f98881q = EC5Util.convertPoint(params, eCPublicKey.getW());
    }
