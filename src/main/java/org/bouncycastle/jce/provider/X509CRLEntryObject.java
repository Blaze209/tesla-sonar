...
public class X509CRLEntryObject extends X509CRLEntry {
    ...
    public boolean equals(Object obj) {
        ...
        return obj instanceof X509CRLEntryObject ? this.f98888c.equals(((X509CRLEntryObject) obj).f98888c) : super.equals(this);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f98888c.getEncoded("DER");
    ...
    public Date getRevocationDate() {
        return this.f98888c.getRevocationDate().getDate();
    }

    @Override // java.security.cert.X509CRLEntry
    public BigInteger getSerialNumber() {
        return this.f98888c.getUserCertificate().getValue();
    }

    @Override // java.security.cert.X509CRLEntry
    public boolean hasExtensions() {
        return this.f98888c.getExtensions() != null;
    }
