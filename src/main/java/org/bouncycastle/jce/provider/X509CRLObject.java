...
public class X509CRLObject extends X509CRL {
    ...
    private CertificateList f98889c;
    ...
    private void doVerify(PublicKey publicKey, Signature signature) throws SignatureException, InvalidKeyException, CRLException {
        if (!this.f98889c.getSignatureAlgorithm().equals(this.f98889c.getTBSCertList().getSignature())) {
    ...
    private Set getExtensionOIDs(boolean z11) {
        ...
        if (getVersion() != 2 || (extensions = this.f98889c.getTBSCertList().getExtensions()) == null) {
            return null;
        }
    ...
    private Set loadCRLEntries() {
        Extension extension;
        HashSet hashSet = new HashSet();
        Enumeration revokedCertificateEnumeration = this.f98889c.getRevokedCertificateEnumeration();
    ...
    public boolean equals(Object obj) {
        ...
        return this.f98889c.equals(x509CRLObject.f98889c);
    }
    ...
    public byte[] getEncoded() throws CRLException {
        try {
            return this.f98889c.getEncoded("DER");
    ...
    public byte[] getExtensionValue(String str) {
        Extension extension;
        Extensions extensions = this.f98889c.getTBSCertList().getExtensions();
    ...
    public Principal getIssuerDN() {
        return new X509Principal(X500Name.getInstance(this.f98889c.getIssuer().toASN1Primitive()));
    }

    @Override // java.security.cert.X509CRL
    public X500Principal getIssuerX500Principal() {
        try {
            return new X500Principal(this.f98889c.getIssuer().getEncoded());
    ...
    public Date getNextUpdate() {
        if (this.f98889c.getNextUpdate() != null) {
            return this.f98889c.getNextUpdate().getDate();
        }
        return null;
    }
    ...
    public String getSigAlgOID() {
        return this.f98889c.getSignatureAlgorithm().getAlgorithm().getId();
    }
    ...
    public byte[] getSignature() {
        return this.f98889c.getSignature().getOctets();
    }

    @Override // java.security.cert.X509CRL
    public byte[] getTBSCertList() throws CRLException {
        try {
            return this.f98889c.getTBSCertList().getEncoded("DER");
        } catch (IOException e11) {
            throw new CRLException(e11.toString());
        }
    }
    ...
    public Date getThisUpdate() {
        return this.f98889c.getThisUpdate().getDate();
    }

    @Override // java.security.cert.X509CRL
    public int getVersion() {
        return this.f98889c.getVersionNumber();
    }
    ...
    public boolean isRevoked(Certificate certificate) {
        ...
        Enumeration revokedCertificateEnumeration = this.f98889c.getRevokedCertificateEnumeration();
        X500Name issuer2 = this.f98889c.getIssuer();
