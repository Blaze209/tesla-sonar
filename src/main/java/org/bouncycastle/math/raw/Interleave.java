...
public class Interleave {
    ...
    public static long expand32to64(int i11) {
        int iBitPermuteStep = Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i11, CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB, 8), 15728880, 4), 202116108, 2), 572662306, 1);
        return ((((long) (iBitPermuteStep >>> 1)) & M32) << 32) | (M32 & ((long) iBitPermuteStep));
    }

    public static void expand64To128(long j11, long[] jArr, int i11) {
        long jBitPermuteStep = Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(j11, 4294901760L, 16), 280375465148160L, 8), 67555025218437360L, 4), 868082074056920076L, 2), 2459565876494606882L, 1);
    ...
    public static int shuffle(int i11) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i11, CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB, 8), 15728880, 4), 202116108, 2), 572662306, 1);
    }

    public static int shuffle2(int i11) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i11, 11141290, 7), 52428, 14), 15728880, 4), CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB, 8);
    }
    ...
    public static int unshuffle(int i11) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i11, 572662306, 1), 202116108, 2), 15728880, 4), CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB, 8);
    }

    public static int unshuffle2(int i11) {
        return Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(Bits.bitPermuteStep(i11, CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB, 8), 15728880, 4), 52428, 14), 11141290, 7);
    }
