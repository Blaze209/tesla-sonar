...
class LongArray implements Cloneable {
    ...
    private void addShiftedByBitsSafe(LongArray longArray, int i11, int i12) {
        ...
        long jAddShiftedUp = addShiftedUp(this.m_ints, i14, longArray.m_ints, 0, i13, i15);
        if (jAddShiftedUp != 0) {
            long[] jArr = this.m_ints;
            int i16 = i13 + i14;
            jArr[i16] = jAddShiftedUp ^ jArr[i16];
        }
    }
    ...
    private static int bitLength(long j11) {
        ...
        if (i14 == 0) {
            ...
            int i16 = i13 >>> 24;
            i11 = i16 == 0 ? bitLengths[i14] + org.spongycastle.math.ec.Tnaf.POW_2_WIDTH : bitLengths[i16] + 24;
        }
        return i12 + i11;
    }
    ...
    private static int reduceInPlace(long[] jArr, int i11, int i12, int i13, int[] iArr) {
        ...
        int iMin2 = (i16 + Math.min(iMin - iMax, i13 - i19)) >> 6;
        if (iMin2 > 1) {
            int i21 = i17 - iMin2;
            int i22 = i17;
    ...
    private static void reduceWordWise(long[] jArr, int i11, int i12, int i13, int i14, int[] iArr) {
        ...
        while (true) {
            ...
            if (j11 != 0) {
                jArr[i17] = 0;
                reduceWord(jArr, i11, i16 << 6, j11, i14, iArr);
            }
        }
        int i18 = i13 & 63;
        int i19 = i11 + i15;
        ...
        long j13 = j12 >>> i18;
        if (j13 != 0) {
            jArr[i19] = (j13 << i18) ^ j12;
            reduceWord(jArr, i11, i13, j13, i14, iArr);
        }
    }
    ...
    private static void squareInPlace(long[] jArr, int i11, int i12, int[] iArr) {
        ...
        while (true) {
            ...
            long j11 = jArr[i11];
            jArr[i13 - 1] = interleave2_32to64((int) (j11 >>> 32));
            i13 -= 2;
    ...
    public LongArray modMultiply(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i14 == 1) {
            ...
            multiplyWord(j11, longArray3.m_ints, i15, jArr3, 0);
        ...
        while (i25 < i14) {
            ...
            int i27 = i25;
            while (true) {
                addBoth(jArr8, i27, jArr6, iArr2[((int) j12) & 15], jArr5, iArr2[((int) (j12 >>> 4)) & 15], i26);
                jArr = jArr8;
                int i28 = i27;
                jArr2 = jArr6;
                i17 = i26;
    ...
    public LongArray modMultiplyAlt(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i17 == 1) {
            ...
            multiplyWord(j11, longArray3.m_ints, i18, jArr3, 0);
            return reduceResult(jArr3, 0, i19, i11, iArr);
        }
        int i23 = (i13 + 78) >>> 6;
        int i24 = i23 * 8;
        int[] iArr2 = new int[16];
        ...
        System.arraycopy(longArray3.m_ints, 0, jArr4, i27, i18);
        int i28 = i27;
        int i29 = 1;
        while (i29 < 8) {
            int i31 = i28 + i23;
            int i32 = i27;
            shiftUp(jArr4, i32, jArr4, i31, i23, i29);
            i27 = i32;
            i29++;
            i28 = i31;
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                int i36 = i27;
                int i37 = i21;
                long j12 = jArr4[i35] >>> i34;
                while (true) {
                    int i38 = ((int) j12) & i14;
                    if (i38 != 0) {
                        add(jArr4, iArr2[i38] + i35, jArr4, i36, i23);
                    }
                    int i39 = i37 + 1;
                    if (i39 == 8) {
                        break;
        ...
        while (true) {
            int i42 = i41 - 1;
            if (i42 <= i22) {
                return reduceResult(jArr4, iArr2[i22], i19, i11, iArr);
            }
            if ((((long) i42) & 1) == 0) {
                int i43 = i19;
                i16 = i22;
                jArr2 = jArr4;
                addShiftedUp(jArr2, iArr2[i42 >>> 1], jArr4, iArr2[i42], i43, 16);
                i15 = i43;
            } else {
                long[] jArr6 = jArr4;
                i15 = i19;
                i16 = i22;
                jArr2 = jArr6;
                distribute(jArr2, iArr2[i42], iArr2[i41 - 2], iArr2[i16], i15);
            }
            long[] jArr7 = jArr2;
            i22 = i16;
            i19 = i15;
    ...
    public LongArray modMultiplyLD(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i14 == 1) {
            ...
            multiplyWord(j11, longArray3.m_ints, i15, jArr2, 0);
    ...
    public LongArray multiply(LongArray longArray, int i11, int[] iArr) {
        ...
        if (i16 == 1) {
            ...
            multiplyWord(j11, longArray3.m_ints, i17, jArr, 0);
        ...
        while (i29 < i16) {
            ...
            while (true) {
                long[] jArr6 = jArr3;
                long[] jArr7 = jArr2;
                addBoth(jArr5, i31, jArr7, iArr2[((int) j12) & 15], jArr6, iArr2[((int) (j12 >>> 4)) & 15], i27);
                int i32 = i31;
                jArr2 = jArr7;
                jArr3 = jArr6;
                i14 = i27;
