...
public class SecP192R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f98943q = SecP192R1FieldElement.Q;
    ...
    public SecP192R1Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFFFFFFFFFFFFC")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("64210519E59C80E70FA7E9AB72243049FEB8DEECC146B9B1")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawXCoord()).f98944x, 0, iArr, i13);
            Nat192.copy(((SecP192R1FieldElement) eCPoint.getRawYCoord()).f98944x, 0, iArr, i13 + 6);
            i13 += 12;
        }
