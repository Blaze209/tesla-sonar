...
public class SecP256R1Field {
    ...
    private static void addPInvTo(int[] iArr) {
        ...
        long j19 = j16 + ((((long) iArr[6]) & M) - 1);
        iArr[6] = (int) j19;
        iArr[7] = (int) ((j19 >> 32) + (M & ((long) iArr[7])) + 1);
    }
    ...
    public static void reduce(int[] iArr, int[] iArr2) {
        ...
        long j27 = j17 + j18;
        long j28 = j26 - j21;
        long j29 = ((((long) iArr[0]) & M) - j24) - j28;
        iArr2[0] = (int) j29;
        long j31 = (j29 >> 32) + ((((((long) iArr[1]) & M) + j22) - j25) - j27);
        iArr2[1] = (int) j31;
        long j32 = (j31 >> 32) + (((((long) iArr[2]) & M) + j23) - j26);
        iArr2[2] = (int) j32;
        long j33 = (j32 >> 32) + ((((((long) iArr[3]) & M) + (j24 << 1)) + j28) - j27);
        iArr2[3] = (int) j33;
        long j34 = (j33 >> 32) + ((((((long) iArr[4]) & M) + (j25 << 1)) + j17) - j22);
        iArr2[4] = (int) j34;
        long j35 = (j34 >> 32) + (((((long) iArr[5]) & M) + (j26 << 1)) - j23);
        iArr2[5] = (int) j35;
        long j36 = (j35 >> 32) + (((long) iArr[6]) & M) + (j27 << 1) + j28;
        iArr2[6] = (int) j36;
        long j37 = (j36 >> 32) + (((((((long) iArr[7]) & M) + (j18 << 1)) + j19) - j23) - j25);
        iArr2[7] = (int) j37;
    ...
    public static void reduce32(int i11, int[] iArr) {
        ...
        if (i11 != 0) {
            ...
            long j17 = j14 + ((((long) iArr[3]) & M) - j12);
            iArr[3] = (int) j17;
            long j18 = j17 >> 32;
            if (j18 != 0) {
            ...
            long j22 = j18 + ((((long) iArr[6]) & M) - j12);
            iArr[6] = (int) j22;
            long j23 = (j22 >> 32) + (M & ((long) iArr[7])) + j12;
            iArr[7] = (int) j23;
            j11 = j23 >> 32;
        } else {
            j11 = 0;
