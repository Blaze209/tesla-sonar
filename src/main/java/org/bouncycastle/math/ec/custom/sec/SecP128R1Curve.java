...
public class SecP128R1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f98934q = SecP128R1FieldElement.Q;
    ...
    public SecP128R1Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFDFFFFFFFFFFFFFFFFFFFFFFFC")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("E87579C11079F43DD824993C2CEE5ED3")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawXCoord()).f98935x, 0, iArr, i13);
            Nat128.copy(((SecP128R1FieldElement) eCPoint.getRawYCoord()).f98935x, 0, iArr, i13 + 4);
            i13 += 8;
        }
