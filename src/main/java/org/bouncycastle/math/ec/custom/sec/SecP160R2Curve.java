...
public class SecP160R2Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f98939q = SecP160R2FieldElement.Q;
    ...
    public SecP160R2Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC70")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("B4E134D3FB59EB8BAB57274904664D5AF50388BA")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawXCoord()).f98940x, 0, iArr, i13);
            Nat160.copy(((SecP160R2FieldElement) eCPoint.getRawYCoord()).f98940x, 0, iArr, i13 + 5);
            i13 += 10;
        }
