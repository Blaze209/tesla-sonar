...
public class SM2P256V1Curve extends ECCurve.AbstractFp {
    ...
    public static final BigInteger f98932q = SM2P256V1FieldElement.Q;
    ...
    public SM2P256V1Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("FFFFFFFEFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFF00000000FFFFFFFFFFFFFFFC")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("28E9FA9E9D9F5E344D5A9E4BCF6509A7F39789F515AB8F92DDBCBD414D940E93")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawXCoord()).f98933x, 0, iArr, i13);
            Nat256.copy(((SM2P256V1FieldElement) eCPoint.getRawYCoord()).f98933x, 0, iArr, i13 + 8);
            i13 += 16;
        }
