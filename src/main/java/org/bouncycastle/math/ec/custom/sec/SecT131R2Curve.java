...
public class SecT131R2Curve extends ECCurve.AbstractF2m {
    ...
    public SecT131R2Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("03E5A88919D7CAFCBF415F07C2176573B2")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("04B8266A46C55657AC734CE38F018F2192")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawXCoord()).f98958x, 0, jArr, i13);
            Nat192.copy64(((SecT131FieldElement) eCPoint.getRawYCoord()).f98958x, 0, jArr, i13 + 3);
            i13 += 6;
        }
