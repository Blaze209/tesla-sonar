...
public class SecT163R1Curve extends ECCurve.AbstractF2m {
    ...
    public SecT163R1Curve() {
        ...
        this.f98910a = fromBigInteger(new BigInteger(1, Hex.decodeStrict("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.f98911b = fromBigInteger(new BigInteger(1, Hex.decodeStrict("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
    ...
    public ECLookupTable createCacheSafeLookupTable(ECPoint[] eCPointArr, int i11, final int i12) {
        ...
        for (int i14 = 0; i14 < i12; i14++) {
            ...
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawXCoord()).f98959x, 0, jArr, i13);
            Nat192.copy64(((SecT163FieldElement) eCPoint.getRawYCoord()).f98959x, 0, jArr, i13 + 3);
            i13 += 6;
        }
        return new AbstractECLookupTable() { // from class: org.bouncycastle.math.ec.custom.sec.SecT163R1Curve.1
            ...
            public ECPoint lookup(int i15) {
                ...
                for (int i17 = 0; i17 < i12; i17++) {
                    ...
                    for (int i18 = 0; i18 < 3; i18++) {
                        ...
                        jArrCreate65[i18] = jArrCreate65[i18] ^ (jArr2[(i16 + 3) + i18] & j11);
                    }
                    i16 += 6;
                }
            ...
            public ECPoint lookupVar(int i15) {
                ...
                for (int i17 = 0; i17 < 3; i17++) {
                    ...
                    jArrCreate65[i17] = jArr2[3 + i16 + i17];
                }
                return createPoint(jArrCreate64, jArrCreate65);
            }
        };
