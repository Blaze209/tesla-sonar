...
public class SecT283Field {
    ...
    public static long[] fromBigInteger(BigInteger bigInteger) {
        return Nat.fromBigInteger64(EnumC4419g.SDK_ASSET_ILLUSTRATION_CARD_VALUE, bigInteger);
    }
    ...
    protected static void implMultiply(long[] jArr, long[] jArr2, long[] jArr3) {
        ...
        long j11 = jArr4[0];
        long j12 = j11 ^ jArr4[1];
        long j13 = jArr5[0];
        long j14 = j13 ^ jArr5[1];
        long j15 = jArr4[2];
        long j16 = j11 ^ j15;
        long j17 = jArr5[2];
        long j18 = j13 ^ j17;
        ...
        long j26 = jArr5[3];
        long j27 = j26 ^ j22;
        implMulw(jArr3, j16 ^ j24, j18 ^ j26, jArr6, 18);
        implMulw(jArr3, j21 ^ jArr4[1], j23 ^ jArr5[1], jArr6, 20);
        long j28 = j12 ^ j25;
        long j29 = j14 ^ j27;
        long j31 = j28 ^ jArr4[2];
        long j32 = jArr5[2] ^ j29;
        implMulw(jArr3, j28, j29, jArr6, 22);
        implMulw(jArr3, j31, j32, jArr6, 24);
        implMulw(jArr3, j12, j14, jArr6, 10);
        implMulw(jArr3, j16, j18, jArr6, 12);
        implMulw(jArr3, j21, j23, jArr6, 14);
        implMulw(jArr3, j25, j27, jArr6, 16);
        jArr3[0] = jArr6[0];
        jArr3[9] = jArr6[9];
        long j33 = jArr6[0];
        long j34 = jArr6[1] ^ j33;
        long j35 = jArr6[2] ^ j34;
        long j36 = jArr6[10] ^ j35;
        jArr3[1] = j36;
        long j37 = jArr6[3] ^ jArr6[4];
        long j38 = j35 ^ (j37 ^ (jArr6[11] ^ jArr6[12]));
        jArr3[2] = j38;
        long j39 = j34 ^ j37;
        long j41 = jArr6[5] ^ jArr6[6];
        long j42 = jArr6[8];
        long j43 = (j39 ^ j41) ^ j42;
        long j44 = jArr6[13] ^ jArr6[14];
        long j45 = jArr6[18];
        long j46 = jArr6[22];
        long j47 = jArr6[24];
        jArr3[3] = (j43 ^ j44) ^ ((j45 ^ j46) ^ j47);
        long j48 = jArr6[7] ^ j42;
        long j49 = jArr6[9];
        long j51 = j48 ^ j49;
        long j52 = j51 ^ jArr6[17];
        jArr3[8] = j52;
        long j53 = (j51 ^ j41) ^ (jArr6[15] ^ jArr6[16]);
        jArr3[7] = j53;
        long j54 = j53 ^ j36;
        long j55 = jArr6[19] ^ jArr6[20];
        long j56 = jArr6[25];
        long j57 = j56 ^ j47;
        long j58 = jArr6[23];
        long j59 = j55 ^ j57;
        jArr3[4] = (j59 ^ (j45 ^ j58)) ^ j54;
        long j61 = jArr6[21];
        jArr3[5] = ((j38 ^ j52) ^ j59) ^ (j61 ^ j46);
        jArr3[6] = (((((j43 ^ j33) ^ j49) ^ j44) ^ j61) ^ j58) ^ j56;
    ...
    protected static void implMulw(long[] jArr, long j11, long j12, long[] jArr2, int i11) {
        ...
        jArr2[i11] = M57 & j17;
        jArr2[i11 + 1] = (((((j11 & 72198606942111744L) & ((j12 << 7) >> 63)) >>> 8) ^ j18) << 7) ^ (j17 >>> 57);
    }
