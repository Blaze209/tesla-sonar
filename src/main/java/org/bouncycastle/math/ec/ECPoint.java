...
public abstract class ECPoint {
    ...
    protected ECFieldElement f98925x;

    /* JADX INFO: renamed from: y, reason: collision with root package name */
    protected ECFieldElement f98926y;

    /* JADX INFO: renamed from: zs, reason: collision with root package name */
    protected ECFieldElement[] f98927zs;
    ...
    public static abstract class AbstractF2m extends ECPoint {
        ...
        protected boolean satisfiesCurveEquation() {
            ...
            ECFieldElement eCFieldElement4 = this.f98927zs[0];
            boolean zIsOne = eCFieldElement4.isOne();
            if (eCFieldElement.isZero()) {
                ECFieldElement eCFieldElementSquare = this.f98926y.square();
                if (!zIsOne) {
                    b11 = b11.multiply(eCFieldElement4.square());
                }
                return eCFieldElementSquare.equals(b11);
            }
            ECFieldElement eCFieldElement5 = this.f98926y;
        ...
        public AbstractF2m tau() {
            ...
            ECFieldElement eCFieldElement = this.f98925x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f98926y.square());
            } else {
                if (coordinateSystem != 1) {
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.square(), this.f98926y.square(), new ECFieldElement[]{this.f98927zs[0].square()});
            }
        ...
        public AbstractF2m tauPow(int i11) {
            ...
            ECFieldElement eCFieldElement = this.f98925x;
            if (coordinateSystem == 0) {
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i11), this.f98926y.squarePow(i11));
            } else {
                if (coordinateSystem != 1) {
                    if (coordinateSystem == 5) {
                        eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i11), this.f98926y.squarePow(i11));
                ...
                eCPointCreateRawPoint = curve.createRawPoint(eCFieldElement.squarePow(i11), this.f98926y.squarePow(i11), new ECFieldElement[]{this.f98927zs[0].squarePow(i11)});
            }
            return (AbstractF2m) eCPointCreateRawPoint;
        }
    ...
    public static class F2m extends AbstractF2m {
        ...
        public ECPoint add(ECPoint eCPoint) {
            ...
            ECCurve curve = getCurve();
            int coordinateSystem = curve.getCoordinateSystem();
            ECFieldElement eCFieldElementMultiply4 = this.f98925x;
            ECFieldElement eCFieldElement = eCPoint.f98925x;
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElement2 = this.f98926y;
                ECFieldElement eCFieldElement3 = eCPoint.f98926y;
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElement4 = this.f98926y;
                ECFieldElement eCFieldElementMultiply5 = this.f98927zs[0];
                ECFieldElement eCFieldElement5 = eCPoint.f98926y;
                ECFieldElement eCFieldElement6 = eCPoint.f98927zs[0];
            ...
            ECFieldElement eCFieldElement7 = this.f98926y;
            ECFieldElement eCFieldElement8 = this.f98927zs[0];
            ECFieldElement eCFieldElement9 = eCPoint.f98926y;
            ECFieldElement eCFieldElement10 = eCPoint.f98927zs[0];
        ...
        public ECPoint negate() {
            if (!isInfinity()) {
                ...
                if (!eCFieldElement.isZero()) {
                    int curveCoordinateSystem = getCurveCoordinateSystem();
                    if (curveCoordinateSystem == 0) {
                        return new F2m(this.curve, eCFieldElement, this.f98926y.add(eCFieldElement));
                    }
                    if (curveCoordinateSystem == 1) {
                        return new F2m(this.curve, eCFieldElement, this.f98926y.add(eCFieldElement), new ECFieldElement[]{this.f98927zs[0]});
                    }
                    if (curveCoordinateSystem == 5) {
                        return new F2m(this.curve, eCFieldElement, this.f98926y.addOne());
                    }
                    if (curveCoordinateSystem != 6) {
                        throw new IllegalStateException("unsupported coordinate system");
                    }
        ...
        public ECPoint twice() {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementMultiply = this.f98925x;
            if (eCFieldElementMultiply.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
            if (coordinateSystem == 0) {
                ECFieldElement eCFieldElementAdd2 = this.f98926y.divide(eCFieldElementMultiply).add(eCFieldElementMultiply);
            ...
            if (coordinateSystem == 1) {
                ECFieldElement eCFieldElementMultiply2 = this.f98926y;
                ECFieldElement eCFieldElement = this.f98927zs[0];
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = eCPoint.f98925x;
            ECFieldElement eCFieldElement3 = eCPoint.f98927zs[0];
            if (eCFieldElement2.isZero() || !eCFieldElement3.isOne()) {
                return twice().add(eCPoint);
            }
            ECFieldElement eCFieldElement4 = this.f98926y;
            ECFieldElement eCFieldElement5 = this.f98927zs[0];
            ECFieldElement eCFieldElement6 = eCPoint.f98926y;
    ...
    public static class Fp extends AbstractFp {
        ...
        public ECPoint negate() {
            ...
            ECCurve curve = getCurve();
            return curve.getCoordinateSystem() != 0 ? new Fp(curve, this.f98925x, this.f98926y.negate(), this.f98927zs) : new Fp(curve, this.f98925x, this.f98926y.negate());
        }
        ...
        public ECPoint threeTimes() {
            if (!isInfinity()) {
                ECFieldElement eCFieldElement = this.f98926y;
                if (!eCFieldElement.isZero()) {
                    ECCurve curve = getCurve();
                    int coordinateSystem = curve.getCoordinateSystem();
                    if (coordinateSystem != 0) {
                    ...
                    ECFieldElement eCFieldElement2 = this.f98925x;
        ...
        public ECPoint timesPow2(int i11) {
            ...
            ECCurve curve = getCurve();
            ECFieldElement eCFieldElementSubtract = this.f98926y;
            if (eCFieldElementSubtract.isZero()) {
                return curve.getInfinity();
            }
            int coordinateSystem = curve.getCoordinateSystem();
        ...
        public ECPoint twicePlus(ECPoint eCPoint) {
            ...
            ECFieldElement eCFieldElement2 = this.f98925x;
            ECFieldElement eCFieldElement3 = eCPoint.f98925x;
            ECFieldElement eCFieldElement4 = eCPoint.f98926y;
    ...
    boolean implIsValid(final boolean z11, final boolean z12) {
        if (isInfinity()) {
            return true;
        }
    ...
    public boolean isInfinity() {
        if (this.f98925x == null || this.f98926y == null) {
            return true;
        }
        ECFieldElement[] eCFieldElementArr = this.f98927zs;
    ...
    public boolean isNormalized() {
        int curveCoordinateSystem = getCurveCoordinateSystem();
        return curveCoordinateSystem == 0 || curveCoordinateSystem == 5 || isInfinity() || this.f98927zs[0].isOne();
    }
    ...
    public String toString() {
        ...
        for (int i11 = 0; i11 < this.f98927zs.length; i11++) {
            stringBuffer.append(CoreConstants.COMMA_CHAR);
            stringBuffer.append(this.f98927zs[i11]);
        }
    ...
    protected ECPoint(ECCurve eCCurve, ECFieldElement eCFieldElement, ECFieldElement eCFieldElement2, ECFieldElement[] eCFieldElementArr) {
        ...
        this.curve = eCCurve;
        this.f98925x = eCFieldElement;
        this.f98926y = eCFieldElement2;
        this.f98927zs = eCFieldElementArr;
    }
