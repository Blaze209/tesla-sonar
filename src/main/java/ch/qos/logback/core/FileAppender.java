...
public class FileAppender<E> extends OutputStreamAppender<E> {
    ...
    private void safeWrite(E e11) throws IOException {
        ...
        if (file != null) {
            ...
            if (this.lazyInit) {
                ...
                try {
                    ...
                    addError("openFile(" + absoluteFilePath + "," + this.append + ") failed", e11);
                    return;
                }
            }
            super.start();
    ...
    protected void subAppend(E e11) {
    ...
    @Override // ch.qos.logback.core.OutputStreamAppender
    protected void writeOut(E e11) throws IOException {
        if (this.prudent) {
            safeWrite(e11);
        } else {
            super.writeOut(e11);
