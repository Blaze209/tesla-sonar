...
public class FixedWindowRollingPolicy extends RollingPolicyBase {
    ...
    /* JADX INFO: renamed from: ch.qos.logback.core.rolling.FixedWindowRollingPolicy$1, reason: invalid class name */
    ...
    public void rollover() throws Throwable {
        if (this.maxIndex >= 0) {
            ...
            for (int i11 = this.maxIndex - 1; i11 >= this.minIndex; i11--) {
                String strConvertInt = this.fileNamePattern.convertInt(i11);
                if (new File(strConvertInt).exists()) {
                    this.util.rename(strConvertInt, this.fileNamePattern.convertInt(i11 + 1));
                } else {
