...
public class TimeBasedArchiveRemover extends ContextAwareBase implements ArchiveRemover {
    ...
    private final RollingCalendar f19344rc;
    ...
    private FilenameFilter createExpiredFileFilter(final Date date) {
        return new FilenameFilter() { // from class: ch.qos.logback.core.rolling.helper.TimeBasedArchiveRemover.1
            ...
            public boolean accept(File file, String str) {
                return TimeBasedArchiveRemover.this.f19344rc.normalizeDate(TimeBasedArchiveRemover.this.dateParser.parseFilename(str)).compareTo(TimeBasedArchiveRemover.this.f19344rc.normalizeDate(TimeBasedArchiveRemover.this.f19344rc.getEndOfNextNthPeriod(date, -TimeBasedArchiveRemover.this.maxHistory))) < 0;
            }
        };
    }
    ...
    public void clean(Date date) {
        List<String> listFindFiles = findFiles();
        Iterator<String> it = filterFiles(listFindFiles, createExpiredFileFilter(date)).iterator();
        while (it.hasNext()) {
