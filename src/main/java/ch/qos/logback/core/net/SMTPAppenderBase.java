...
public abstract class SMTPAppenderBase<E> extends AppenderBase<E> {
    ...
    long delayBetweenStatusMessages = DataPersistorKt.EXPIRATION_TIME;
    ...
    class SenderRunnable implements Runnable {
        ...
        public void run() {
            SMTPAppenderBase.this.sendBuffer(this.cyclicBuffer, this.f19339e);
        }
    }
    ...
    private List<InternetAddress> parseAddress(E e11) {
        ...
        for (int i11 = 0; i11 < size; i11++) {
            try {
                String strDoLayout = this.toPatternLayoutList.get(i11).doLayout(e11);
    ...
    protected void sendBuffer(CyclicBuffer<E> cyclicBuffer, E e11) {
        try {
            ...
            if (layout != null) {
                strDoLayout = layout.doLayout(e11);
            ...
            List<InternetAddress> address = parseAddress(e11);
            if (address.isEmpty()) {
