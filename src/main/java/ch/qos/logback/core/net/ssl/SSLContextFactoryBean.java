...
public class SSLContextFactoryBean {
    ...
    private KeyManager[] createKeyManagers(ContextAware contextAware) throws NoSuchAlgorithmException, UnrecoverableKeyException, KeyStoreException {
        if (getKeyStore() == null) {
            return null;
        }
    ...
    private TrustManager[] createTrustManagers(ContextAware contextAware) throws KeyStoreException {
