...
public class AsyncAppenderBase<E> extends UnsynchronizedAppenderBase<E> implements AppenderAttachable<E> {
    ...
    class Worker extends Thread {
        ...
        public void run() {
            ...
            for (E e11 : asyncAppenderBase.blockingQueue) {
                appenderAttachableImpl.appendLoopOnAppenders(e11);
                asyncAppenderBase.blockingQueue.remove(e11);
            }
    ...
    public void stop() {
        if (isStarted()) {
            ...
            try {
                ...
                addError("Failed to join worker thread. " + this.blockingQueue.size() + " queued events may be discarded.", e11);
            } finally {
