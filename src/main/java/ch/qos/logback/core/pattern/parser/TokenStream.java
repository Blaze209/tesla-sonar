...
class TokenStream {
    ...
    private void processOption(char c11, List<Token> list, StringBuffer stringBuffer) throws ScanException {
    ...
    List<Token> tokenize() throws ScanException {
        ...
        if (i13 == 4) {
            arrayList.add(new Token(GeofenceStatusCodes.GEOFENCE_INSUFFICIENT_LOCATION_PERMISSION, stringBuffer.toString()));
            return arrayList;
        }
        if (i13 != 5) {
            return arrayList;
