...
public class NestedComplexPropertyIA extends ImplicitAction {
    ...
    public void begin(InterpretationContext interpretationContext, String str, Attributes attributes) {
        ...
        try {
            ...
            iADataForComplexPropertyPeek.inError = true;
            addError("Could not create component [" + str + "] of type [" + strSubst + "]", e11);
        }
    }
    ...
    public void end(InterpretationContext interpretationContext, String str) {
        ...
        int i11 = AnonymousClass1.$SwitchMap$ch$qos$logback$core$util$AggregationType[iADataForComplexPropertyPop.aggregationType.ordinal()];
        if (i11 == 4) {
        ...
        addError("Unexpected aggregationType " + iADataForComplexPropertyPop.aggregationType);
    }
    ...
    public boolean isApplicable(ElementPath elementPath, Attributes attributes, InterpretationContext interpretationContext) {
        ...
        int i11 = AnonymousClass1.$SwitchMap$ch$qos$logback$core$util$AggregationType[aggregationTypeComputeAggregationType.ordinal()];
