...
public class SyslogAppender extends SyslogAppenderBase<ILoggingEvent> {
    ...
    private void handleThrowableFirstLine(OutputStream outputStream, IThrowableProxy iThrowableProxy, String str, boolean z11) throws IOException {
    ...
    protected void postProcess(Object obj, OutputStream outputStream) {
        ...
        while (throwableProxy != null) {
            ...
            try {
                handleThrowableFirstLine(outputStream, throwableProxy, strDoLayout, z11);
