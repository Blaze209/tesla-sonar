...
public class PatternLayout extends PatternLayoutBase<ILoggingEvent> {
    ...
    static {
        ...
        map.put(InquiryField.DateField.TYPE, DateConverter.class.getName());
        ...
        map.put(Gender.MALE, MethodOfCallerConverter.class.getName());
        ...
        map.put(Gender.FEMALE, FileOfCallerConverter.class.getName());
