...
public final /* data */ class SubmitButtonComponent implements h {
    ...
    /* JADX INFO: renamed from: oi0.f5$a */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    public static final class a implements Parcelable.Creator<SubmitButtonComponent> {
        ...
        public final SubmitButtonComponent[] newArray(int i11) {
            return new SubmitButtonComponent[i11];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return p013kotlin.jvm.internal.s.f(this.name, submitButtonComponent.name) && p013kotlin.jvm.internal.s.f(this.hidden, submitButtonComponent.hidden) && p013kotlin.jvm.internal.s.f(this.disabled, submitButtonComponent.disabled) && p013kotlin.jvm.internal.s.f(this.autoSubmitCountdownText, submitButtonComponent.autoSubmitCountdownText) && p013kotlin.jvm.internal.s.f(this.autoSubmitIntervalSeconds, submitButtonComponent.autoSubmitIntervalSeconds);
    }
