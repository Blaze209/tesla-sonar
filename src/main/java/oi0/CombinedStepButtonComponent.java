...
public final /* data */ class CombinedStepButtonComponent implements h {
    ...
    /* JADX INFO: renamed from: oi0.m$a */
    ...
    public static final class a implements Parcelable.Creator<CombinedStepButtonComponent> {
        ...
        public final CombinedStepButtonComponent[] newArray(int i11) {
            return new CombinedStepButtonComponent[i11];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return p013kotlin.jvm.internal.s.f(this.name, combinedStepButtonComponent.name) && p013kotlin.jvm.internal.s.f(this.hidden, combinedStepButtonComponent.hidden) && p013kotlin.jvm.internal.s.f(this.disabled, combinedStepButtonComponent.disabled) && p013kotlin.jvm.internal.s.f(this.autoSubmitCountdownText, combinedStepButtonComponent.autoSubmitCountdownText) && p013kotlin.jvm.internal.s.f(this.autoSubmitIntervalSeconds, combinedStepButtonComponent.autoSubmitIntervalSeconds);
    }
