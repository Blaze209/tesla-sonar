...
public final /* data */ class TextComponent implements n5, v, e0 {
    ...
    /* JADX INFO: renamed from: oi0.h5$a */
    ...
    public static final class a implements Parcelable.Creator<TextComponent> {
        ...
        public final TextComponent[] newArray(int i11) {
            return new TextComponent[i11];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return p013kotlin.jvm.internal.s.f(this.name, textComponent.name) && p013kotlin.jvm.internal.s.f(this.hidden, textComponent.hidden) && p013kotlin.jvm.internal.s.f(this.disabled, textComponent.disabled);
    }
