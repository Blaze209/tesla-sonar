...
public final /* data */ class CompleteButtonComponent implements h {
    ...
    /* JADX INFO: renamed from: oi0.o$a */
    ...
    public static final class a implements Parcelable.Creator<CompleteButtonComponent> {
        ...
        public final CompleteButtonComponent[] newArray(int i11) {
            return new CompleteButtonComponent[i11];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return p013kotlin.jvm.internal.s.f(this.name, completeButtonComponent.name) && p013kotlin.jvm.internal.s.f(this.hidden, completeButtonComponent.hidden) && p013kotlin.jvm.internal.s.f(this.disabled, completeButtonComponent.disabled) && p013kotlin.jvm.internal.s.f(this.autoSubmitCountdownText, completeButtonComponent.autoSubmitCountdownText) && p013kotlin.jvm.internal.s.f(this.autoSubmitIntervalSeconds, completeButtonComponent.autoSubmitIntervalSeconds);
    }
