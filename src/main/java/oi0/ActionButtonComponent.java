...
public final /* data */ class ActionButtonComponent implements h {
    ...
    /* JADX INFO: renamed from: oi0.a$a, reason: collision with other inner class name */
    @Metadata(k = 3, mv = {2, 0, 0}, xi = 48)
    public static final class C2103a implements Parcelable.Creator<ActionButtonComponent> {
        ...
        public final ActionButtonComponent[] newArray(int i11) {
            return new ActionButtonComponent[i11];
        }
    }
    ...
    public boolean equals(Object other) {
        ...
        return p013kotlin.jvm.internal.s.f(this.name, actionButtonComponent.name) && p013kotlin.jvm.internal.s.f(this.hidden, actionButtonComponent.hidden) && p013kotlin.jvm.internal.s.f(this.disabled, actionButtonComponent.disabled) && p013kotlin.jvm.internal.s.f(this.autoSubmitCountdownText, actionButtonComponent.autoSubmitCountdownText) && p013kotlin.jvm.internal.s.f(this.autoSubmitIntervalSeconds, actionButtonComponent.autoSubmitIntervalSeconds);
    }
