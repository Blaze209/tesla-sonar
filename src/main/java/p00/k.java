...
public final class k extends com.facebook.react.uimanager.events.d<k> {
    ...
    public k(int i11, WritableMap mData) {
        super(i11);
        s.k(mData, "mData");
        this.mData = mData;
