...
public interface CopyableThreadContextElement<S> extends ThreadContextElement<S> {
    ...
    public static final class DefaultImpls {
        public static <S, R> R fold(CopyableThreadContextElement<S> copyableThreadContextElement, R r11, p<? super R, ? super CoroutineContext.Element, ? extends R> pVar) {
            return (R) ThreadContextElement.DefaultImpls.fold(copyableThreadContextElement, r11, pVar);
        }
