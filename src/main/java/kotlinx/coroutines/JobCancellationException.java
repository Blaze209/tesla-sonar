...
public final class JobCancellationException extends CancellationException implements CopyableThrowable<JobCancellationException> {
    ...
    public boolean equals(Object other) {
        ...
        return s.f(jobCancellationException.getMessage(), getMessage()) && s.f(jobCancellationException.getJob$kotlinx_coroutines_core(), getJob$kotlinx_coroutines_core()) && s.f(jobCancellationException.getCause(), getCause());
    }
