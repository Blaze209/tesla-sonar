...
public final class FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9 implements Flow<Integer> {
    final /* synthetic */ j $this_asFlow$inlined;
    ...
    public FlowKt__BuildersKt$asFlow$$inlined$unsafeFlow$9(j jVar) {
        this.$this_asFlow$inlined = jVar;
    }

    /* JADX WARN: Code duplicated, block: B:7:0x0013  */
    @Override // kotlinx.coroutines.flow.Flow
    public Object collect(FlowCollector<? super Integer> flowCollector, Continuation<? super h0> continuation) {
        ...
        while (it.hasNext()) {
            Integer numBoxInt = Boxing.boxInt(((s0) it).nextInt());
