...
public final class FlowKt__LogicKt$any$$inlined$collectWhile$1<T> implements FlowCollector<T> {
    final /* synthetic */ j0 $found$inlined;
    ...
    public FlowKt__LogicKt$any$$inlined$collectWhile$1(p pVar, j0 j0Var) {
        this.$predicate$inlined = pVar;
        this.$found$inlined = j0Var;
    }
    ...
    public Object emit(T t11, Continuation<? super h0> continuation) {
        ...
        if (zBooleanValue) {
            flowKt__LogicKt$any$$inlined$collectWhile$1.$found$inlined.f86523a = true;
        }
        if (zBooleanValue) {
