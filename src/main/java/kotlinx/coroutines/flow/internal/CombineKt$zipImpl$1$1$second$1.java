...
final class CombineKt$zipImpl$1$1$second$1 extends SuspendLambda implements p<ProducerScope<? super Object>, Continuation<? super h0>, Object> {
    ...
    static final class AnonymousClass1<T> implements FlowCollector {
        ...
        public final Object emit(T2 t11, Continuation<? super h0> continuation) {
            ...
            if (continuation instanceof CombineKt$zipImpl$1$1$second$1$1$emit$1) {
                ...
                int i11 = combineKt$zipImpl$1$1$second$1$1$emit$1.label;
                if ((i11 & Integer.MIN_VALUE) != 0) {
                    combineKt$zipImpl$1$1$second$1$1$emit$1.label = i11 - Integer.MIN_VALUE;
                } else {
            ...
            int i12 = combineKt$zipImpl$1$1$second$1$1$emit$1.label;
            if (i12 == 0) {
                t.b(obj2);
    ...
    public final Object invoke2(ProducerScope<Object> producerScope, Continuation<? super h0> continuation) {
        return ((CombineKt$zipImpl$1$1$second$1) create(producerScope, continuation)).invokeSuspend(h0.f84049a);
    }
}
