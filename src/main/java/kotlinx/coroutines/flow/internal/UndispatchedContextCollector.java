...
final class UndispatchedContextCollector<T> implements FlowCollector<T> {
    ...
    public Object emit(T t11, Continuation<? super h0> continuation) {
        Object objWithContextUndispatched = ChannelFlowKt.withContextUndispatched(this.emitContext, t11, this.countOrElement, this.emitRef, continuation);
        return objWithContextUndispatched == IntrinsicsKt.getCOROUTINE_SUSPENDED() ? objWithContextUndispatched : h0.f84049a;
    }
}
