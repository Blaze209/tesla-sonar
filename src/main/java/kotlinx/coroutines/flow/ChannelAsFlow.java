...
final class ChannelAsFlow<T> extends ChannelFlow<T> {
    ...
    public ChannelAsFlow(ReceiveChannel<? extends T> receiveChannel, boolean z11, CoroutineContext coroutineContext, int i11, BufferOverflow bufferOverflow) {
