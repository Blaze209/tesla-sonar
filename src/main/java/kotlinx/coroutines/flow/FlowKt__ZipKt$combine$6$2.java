...
@DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__ZipKt$combine$6$2", f = "Zip.kt", i = {}, l = {EnumC4419g.SDK_ASSET_ILLUSTRATION_CHECK_ALL_VALUE, EnumC4419g.SDK_ASSET_ILLUSTRATION_CHECK_ALL_VALUE}, m = "invokeSuspend", n = {}, s = {})
public final class FlowKt__ZipKt$combine$6$2<R, T> extends SuspendLambda implements q<FlowCollector<? super R>, T[], Continuation<? super h0>, Object> {
    ...
    public FlowKt__ZipKt$combine$6$2(p<? super T[], ? super Continuation<? super R>, ? extends Object> pVar, Continuation<? super FlowKt__ZipKt$combine$6$2> continuation) {
    ...
    */
    ...
    public final Object invoke(FlowCollector<? super R> flowCollector, T[] tArr, Continuation<? super h0> continuation) {
        ...
        return flowKt__ZipKt$combine$6$2.invokeSuspend(h0.f84049a);
    }
}
