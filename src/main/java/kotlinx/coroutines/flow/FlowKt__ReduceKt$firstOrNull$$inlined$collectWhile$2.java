...
public final class FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2<T> implements FlowCollector<T> {
    ...
    public FlowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2(p pVar, n0 n0Var) {
    ...
    public Object emit(T t11, Continuation<? super h0> continuation) {
        ...
        flowKt__ReduceKt$firstOrNull$$inlined$collectWhile$2.$result$inlined.f86529a = t11;
