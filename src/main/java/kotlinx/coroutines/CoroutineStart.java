...
public enum CoroutineStart {
    ...
    @InternalCoroutinesApi
    public final <R, T> void invoke(p<? super R, ? super Continuation<? super T>, ? extends Object> block, R receiver, Continuation<? super T> completion) {
