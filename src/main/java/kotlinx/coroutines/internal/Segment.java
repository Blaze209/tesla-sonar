...
public abstract class Segment<S extends Segment<S>> extends ConcurrentLinkedListNode<S> implements NotCompleted {
    ...
    public Segment(long j11, S s11, int i11) {
        super(s11);
        this.id = j11;
    ...
    private final /* synthetic */ void setCleanedAndPointers$volatile(int i11) {
