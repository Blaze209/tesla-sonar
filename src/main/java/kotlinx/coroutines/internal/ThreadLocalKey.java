...
public final /* data */ class ThreadLocalKey implements CoroutineContext.Key<ThreadLocal<?>> {
    ...
    public static /* synthetic */ ThreadLocalKey copy$default(ThreadLocalKey threadLocalKey, ThreadLocal threadLocal, int i11, Object obj) {
        if ((i11 & 1) != 0) {
    ...
    public boolean equals(Object other) {
        ...
        return (other instanceof ThreadLocalKey) && s.f(this.threadLocal, ((ThreadLocalKey) other).threadLocal);
    }
