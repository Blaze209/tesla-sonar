...
public final class Concurrent_commonKt {
    ...
    public static final <T> void loop(AtomicReference<T> atomicReference, p<? super AtomicReference<T>, ? super T, h0> pVar) {
        while (true) {
