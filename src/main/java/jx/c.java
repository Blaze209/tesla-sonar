...
class c {
    ...
    private static void c(XmlPullParser xmlPullParser, HashMap<k, Object> map) {
        map.put(d.k(xmlPullParser), null);
    }

    private static void d(XmlPullParser xmlPullParser, HashMap<String, o> map) throws XmlPullParserException, IOException {
        if (xmlPullParser.getAttributeValue(null, "id") != null) {
            o oVarE = p.e(xmlPullParser);
            map.put(oVarE.s(), oVarE);
        }
    }

    private static void e(XmlPullParser xmlPullParser, HashMap<String, String> map) {
        map.putAll(p.f(xmlPullParser));
    }

    private static void f(XmlPullParser xmlPullParser, HashMap<String, String> map) throws XmlPullParserException, IOException {
        int eventType = xmlPullParser.getEventType();
