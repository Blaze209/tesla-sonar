...
public final class d {
    ...
    public static double c(ByteBuffer byteBuffer) {
        byte[] bArr = new byte[4];
        byteBuffer.get(bArr);
        return ((double) (((((bArr[0] << 24) & (-16777216)) | ((bArr[1] << Tnaf.POW_2_WIDTH) & 16711680)) | ((bArr[2] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB)) | (bArr[3] & 255))) / 1.073741824E9d;
    }

    public static double d(ByteBuffer byteBuffer) {
        byte[] bArr = new byte[4];
        byteBuffer.get(bArr);
        return ((double) (((((bArr[0] << 24) & (-16777216)) | ((bArr[1] << Tnaf.POW_2_WIDTH) & 16711680)) | ((bArr[2] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB)) | (bArr[3] & 255))) / 65536.0d;
    }

    public static float e(ByteBuffer byteBuffer) {
        byte[] bArr = new byte[2];
        byteBuffer.get(bArr);
        return ((short) (((short) ((bArr[0] << 8) & CipherSuite.DRAFT_TLS_DHE_RSA_WITH_AES_128_OCB)) | (bArr[1] & 255))) / 256.0f;
    }
    ...
    public static String f(ByteBuffer byteBuffer) {
        ...
        for (int i11 = 0; i11 < 3; i11++) {
            sb2.append((char) (((iH >> ((2 - i11) * 5)) & 31) + 96));
        }
        return sb2.toString();
    }
