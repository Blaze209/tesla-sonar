...
public class OsMap implements h {
    ...
    private static final long f78990d = nativeGetFinalizerPtr();

    /* JADX INFO: renamed from: a, reason: collision with root package name */
    private final long f78991a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    private final g f78992b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    private final Table f78993c;
    ...
    public OsMap(UncheckedRow uncheckedRow, long j11) {
        ...
        this.f78991a = jArrNativeCreate[0];
        if (jArrNativeCreate[1] != -1) {
            this.f78993c = new Table(osSharedRealmP, jArrNativeCreate[1]);
        } else {
            this.f78993c = null;
        }
    ...
    public long a() {
        return nativeSize(this.f78991a);
    }
