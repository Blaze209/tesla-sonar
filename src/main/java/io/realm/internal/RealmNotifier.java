...
public abstract class RealmNotifier implements Closeable {
    ...
    private static class b<T> extends j.b<T, h0<T>> {
        b(T t11, h0<T> h0Var) {
            super(t11, h0Var);
        }
    ...
    public <T> void addChangeListener(T t11, h0<T> h0Var) {
        this.realmObserverPairs.a(new b(t11, h0Var));
    }
    ...
    public <E> void removeChangeListener(E e11, h0<E> h0Var) {
        this.realmObserverPairs.e(e11, h0Var);
    }
