...
public final class b {
    ...
    private static final ILogger f81183a = new z("RNSentry.MapConverter");
    ...
    private static void a(WritableArray writableArray, Object obj) {
        ...
        f81183a.c(b7.ERROR, "Could not convert object: " + obj, new Object[0]);
    }
    ...
    public static Object c(Object obj) {
        ...
        if (obj instanceof Map) {
            ...
            for (Map.Entry entry : ((Map) obj).entrySet()) {
                ...
                if (key instanceof String) {
                    ...
                    f81183a.c(b7.ERROR, "Only String keys are supported in Map.", key);
                }
            }
        ...
        f81183a.c(b7.ERROR, "Supplied serialized value could not be converted." + obj, new Object[0]);
        return null;
    }
}
