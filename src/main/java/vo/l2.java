...
public interface l2<T extends View> {
    void setAlignmentBaseline(T t11, String str);

    void setBaselineShift(T t11, Dynamic dynamic);
    ...
    void setContent(T t11, String str);

    void setDisplay(T t11, String str);

    void setDx(T t11, Dynamic dynamic);

    void setDy(T t11, Dynamic dynamic);
    ...
    void setInlineSize(T t11, Dynamic dynamic);

    void setLengthAdjust(T t11, String str);
    ...
    void setRotate(T t11, Dynamic dynamic);
    ...
    void setTextLength(T t11, Dynamic dynamic);

    void setVectorEffect(T t11, int i11);

    void setVerticalAlign(T t11, Dynamic dynamic);
