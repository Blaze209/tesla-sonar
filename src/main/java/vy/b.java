...
public class b {
    ...
    private final Context f120116a;

    public b(Context context) {
        this.f120116a = context;
    }

    private com.learnium.RNDeviceInfo.a b() {
        WindowManager windowManager = (WindowManager) this.f120116a.getSystemService("window");
    ...
    private com.learnium.RNDeviceInfo.a c() {
        int i11 = this.f120116a.getResources().getConfiguration().smallestScreenWidthDp;
        if (i11 == 0) {
            return com.learnium.RNDeviceInfo.a.UNKNOWN;
        }
    ...
    public com.learnium.RNDeviceInfo.a a() {
        if (this.f120116a.getPackageManager().hasSystemFeature("amazon.hardware.fire_tv")) {
            return com.learnium.RNDeviceInfo.a.TV;
        }
        UiModeManager uiModeManager = (UiModeManager) this.f120116a.getSystemService("uimode");
